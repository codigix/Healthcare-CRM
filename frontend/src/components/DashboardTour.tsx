...
export default function DashboardTour({
 ...
 <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 9h-2v2h-2v-2h-2v-2h2V8h2v2h2v2z" />
                        ...
                        <div className="p-6 bg-dark-primary flex flex-col sm:flex-row gap-3 justify-center">
                            <button
                                onClick={handleCloseTour}
                                className="px-8 py-3 rounded bg-dark-tertiary hover:bg-dark-tertiary/80 text-white transition-colors font-medium"
                            >
                                Skip Tour
                            </button>
                            <button
                                onClick={handleNextStep}
                                className="px-8 py-3 rounded bg-accent hover:bg-accent-dark text-white transition-colors text-sm flex items-center justify-center gap-2"
                            >
                                <span>▶</span>
                                Start Guided Tour
                            </button>
