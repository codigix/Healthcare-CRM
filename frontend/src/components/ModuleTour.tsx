...
export default function ModuleTour({
 ...
 `}</style>
            ...
            <div className="module-tour-modal bg-dark-secondary border border-dark-tertiary rounded shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div className="flex justify-between items-start p-2 border-b border-dark-tertiary bg-gradient-to-r from-blue-600/10 to-blue-600/5">
                    <div>
                ...
                <div className="flex justify-between items-center my-3 my-3 p-6 border-t border-dark-tertiary bg-dark">
                    <button
                        onClick={onClose}
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded transition-colors font-medium"
                    >
