...
export default function AppointmentForm({
 ...
 {showPatientDropdown && (
 <div className="absolute z-50 w-full left-0 mt-1 bg-dark-secondary border border-dark-tertiary rounded-lg shadow-2xl max-h-48 overflow-y-auto">
 ...
 className={`px-4 py-2.5 hover:bg-dark-tertiary cursor-pointer border-b border-dark-tertiary/20 last:border-0 transition-colors flex items-center justify-between text-sm ${
 ...
 className="btn-primary w-full py-2.5 rounded-lg font-medium transition-all shadow-md hover:shadow-emerald-500/10 flex items-center justify-center gap-2"
 >
