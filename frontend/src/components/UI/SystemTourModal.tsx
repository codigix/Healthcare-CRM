...
export default function SystemTourModal({
  ...
  return (
    ...
    >
      ...
      <div
        ref={modalRef}
        className="system-tour-modal-container bg-dark-secondary border border-dark-tertiary rounded-lg shadow-2xl overflow-hidden flex flex-col absolute"
        style={{
          left: `${position.x}px`,
          top: `${position.y}px`,
      ...
      >
        {targetElement && (
          <div
            className={`system-tour-modal-arrow ${
              arrowPosition.top ? "top" : arrowPosition.bottom ? "bottom" : ""
        ...
        <div
          className="flex justify-between items-start p-6 border-b border-dark-tertiary cursor-grab active:cursor-grabbing select-none"
        ...
        <div
          className="flex justify-between items-center p-6 border-t border-dark-tertiary bg-dark"
        ...
        >
          <div className="flex gap-2">
            {onPrev && currentStep > 1 && (
              <button
                onClick={onPrev}
                className="flex items-center gap-2 px-4 py-2 bg-dark-tertiary hover:bg-dark-tertiary/80 text-white rounded-lg transition-colors duration-200"
          ...
          <div className="flex gap-2">
            {onSkip && (
              <button
                onClick={onSkip}
                className="px-4 py-2 bg-dark-tertiary hover:bg-dark-tertiary/80 text-gray-300 hover:text-white rounded-lg transition-colors duration-200"
            ...
            {onNext && currentStep < totalSteps && (
              <button
                onClick={onNext}
                className="flex items-center gap-2 px-4 py-2 bg-accent hover:bg-accent-dark text-white rounded-lg transition-colors duration-200"
