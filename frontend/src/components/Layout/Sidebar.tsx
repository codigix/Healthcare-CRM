...
export default function Sidebar() {
  ...
  const [expandedItems, setExpandedItems] = useState<string[]>(['Dashboard', 'Doctors', 'Patients', 'Appointments', 'Prescriptions', 'Ambulance', 'Pharmacy', 'Blood Bank', 'Departments', 'Inventory', 'Staff', 'Records', 'Room Allotment', 'Billing', 'Reports', 'Reviews']);
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider px-4 mb-3">Others</div>
