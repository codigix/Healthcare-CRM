...
export default function MedixProAI() {
 ...
 {/* Sidebar */}
 <div
 className={`fixed top-0 right-0 h-screen w-full sm:w-96 bg-gradient-to-b from-slate-900 to-slate-950 border-l border-border shadow-2xl transform transition-transform duration-300 z-50 flex flex-col ${
 ...
 suppressHydrationWarning
 className="text-white hover:bg-card/10 p-1 rounded-lg transition-colors"
 >
 ...
 <div className="bg-muted border border-border rounded-lg rounded-bl-none px-4 py-2">
 ...
 disabled={isLoading}
 className="flex-1 px-3 py-2 bg-muted border border-border rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all disabled:opacity-50 text-sm"
 />
 <button
 type="submit"
 suppressHydrationWarning
 ...
 {/* Footer */}
 <div className="bg-muted border-t border-border px-4 py-2 text-xs text-gray-500 text-center flex-shrink-0">
