        ...
        <div className="space-y-6 pr-2 font-sans text-xs">
          ...
          <div className="border-b border-dark-tertiary pb-4">
            ...
            <div className="flex flex-wrap gap-2 mt-2.5">
              ...
              <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-white/5 text-gray-300 capitalize border border-white/10">
                {medicine.medicineForm}
              </span>
              <span className={`px-2 py-0.5 rounded-full text-[10px] font-semibold ${getStatusColor(medicine.status)}`}>
                {medicine.status}
              </span>
              <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-white/5 text-teal-400 border border-teal-500/20">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-3 bg-white/[0.01] p-3 rounded-lg border border-white/5">
          ...
          <div className="bg-white/[0.01] p-3 rounded-lg border border-white/5">
            ...
            <div className="grid grid-cols-2 gap-3 mt-3">
              <div className="flex items-center gap-2">
                <span className={`w-2.5 h-2.5 rounded-full ${medicine.roomTemperature ? "bg-emerald-500" : "bg-white/10"}`}></span>
                <span className="text-gray-300">Room Temp (25°C)</span>
              </div>
              <div className="flex items-center gap-2">
                <span className={`w-2.5 h-2.5 rounded-full ${medicine.refrigerated ? "bg-emerald-500" : "bg-white/10"}`}></span>
                <span className="text-gray-300">Refrigerated (2-8°C)</span>
              </div>
              <div className="flex items-center gap-2">
                <span className={`w-2.5 h-2.5 rounded-full ${medicine.frozen ? "bg-emerald-500" : "bg-white/10"}`}></span>
                <span className="text-gray-300">Frozen (-20°C)</span>
              </div>
              <div className="flex items-center gap-2">
                <span className={`w-2.5 h-2.5 rounded-full ${medicine.protectFromLight ? "bg-emerald-500" : "bg-white/10"}`}></span>
          ...
          <div className="grid grid-cols-3 gap-x-4 gap-y-3 bg-white/[0.01] p-3 rounded-lg border border-white/5">
          ...
          <div className="pt-4 border-t border-dark-tertiary font-sans">
            ...
            {batches.length === 0 ? (
              ...
              <div className="border border-dark-tertiary rounded-lg overflow-hidden bg-white/[0.01]">
                <table className="w-full text-left text-xs border-collapse">
                  <thead>
                    <tr className="bg-white/5 border-b border-dark-tertiary text-gray-400 font-bold">
