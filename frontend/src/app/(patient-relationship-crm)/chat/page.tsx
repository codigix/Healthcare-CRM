                    ...
                    <div className="p-4 space-y-4">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 bg-dark-tertiary rounded text-mdtext-gray-300 placeholder-gray-500 border border-dark-secondary focus:border-emerald-500 outline-none"
                            />
                        </div>
                        <div className="flex gap-2">
                            <button className="p-2 rounded text-mdfont-medium text-gray-300 hover:bg-dark-tertiary transition-colors">
                                All
                            </button>
                            <button className="p-2 rounded text-mdfont-medium text-gray-300 hover:bg-dark-tertiary transition-colors">
                                Unread
                    ...
                    <div className="flex-1 overflow-y-auto space-y-1 px-2">
                        {conversations.map((conv) => (
                            <button
                                ...
                                className={`w-full p-3 rounded text-left transition-colors ${selectedConversation === conv.id
                                    ? "bg-dark-secondary"
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex justify-between items-start gap-2">
                                            <p className="font-medium text-mdtext-white">
                                                {conv.name}
                                            </p>
                                            {conv.unread > 0 && (
                        ...
                        <>
                            ...
                            <div className="flex-1 overflow-y-auto p-6 space-y-4">
                                {messages.map((msg) => (
                                    ...
                                    >
                                        <div
                                            className={`max-w-xs p-2 rounded ${msg.isOwn
                            ...
                            <div className="border-t border-dark-tertiary p-4">
                                <div className="flex gap-3">
                                    <input
                                        ...
                                        className="flex-1 bg-dark-tertiary rounded p-2 text-gray-300 placeholder-gray-500 border border-dark-secondary focus:border-emerald-500 outline-none"
                                    />
