...
export default function EmailDispatcherPage() {
  ...
  const columns = [
    ...
    { header: 'Opens/Clicks', accessor: 'opensclicks', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Track automated emails for reports, invoices, and updates.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8,540</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bounces</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>0.2%</p>
        </div>
      </div>
