    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage WhatsApp Business API messages and templates.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Messages Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>3,200</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Read Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>84%</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
