...
export default function ShiftRulesPage() {
  ...
  const columns = [
    ...
    { header: 'Action Triggered', accessor: 'actiontriggered', sortable: true },
    { header: 'Applies To', accessor: 'appliesto', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Global rules for grace periods, half-day deductions, and auto-shift mapping.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Late Grace Min</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15 Mins</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Auto-Deduction</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>Enabled</p>
        </div>
      </div>
