...
export default function SalaryComponentsPage() {
  ...
  const columns = [
    { header: 'Component Name', accessor: 'componentname', sortable: true },
    { header: 'Type', accessor: 'type', sortable: true },
    { header: 'Taxable', accessor: 'taxable', sortable: true },
    { header: 'Calculation Rule', accessor: 'calculationrule', sortable: true },
    { header: 'Appears in Payslip', accessor: 'appearsinpayslip', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Creating specific earning (HRA, DA) and deduction (PF, TDS) heads.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Earning Heads</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Deduction Heads</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Formula Configs</p>
