...
export default function ApprovalMatrixPage() {
  ...
  const columns = [
    { header: 'Workflow Name', accessor: 'workflowname', sortable: true },
    { header: 'Module', accessor: 'module', sortable: true },
    { header: 'Level 1 Approver', accessor: 'level1approver', sortable: true },
    { header: 'Level 2 Approver', accessor: 'level2approver', sortable: true },
    { header: 'Auto-Escalation', accessor: 'autoescalation', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Workflow definitions for leaves, appraisals, and expense reimbursements.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Escalations Active</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Yes (48H)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bypassed Approvals</p>
