...
export default function LeaveCalendarPage() {
  ...
  const columns = [
    ...
    { header: 'Staff on Leave', accessor: 'staffonleave', sortable: true },
    { header: 'Critical Shortages', accessor: 'criticalshortages', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Visual calendar showing all approved leaves across the hospital.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Peak Leave Period</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>December</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Max Allowed/Day</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>10%</p>
        </div>
      </div>
