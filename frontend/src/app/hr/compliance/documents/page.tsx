...
export default function ComplianceDocumentsPage() {
  ...
  const columns = [
    ...
    { header: 'Period/Year', accessor: 'periodyear', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hospital-level HR compliances like labor law registrations and PF/ESI challans.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Upcoming Filings</p>
