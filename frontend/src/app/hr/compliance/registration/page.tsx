...
export default function MedicalRegistrationPage() {
  ...
  const columns = [
    ...
    { header: 'Council Name', accessor: 'councilname', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking doctor registrations with national/state medical councils.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Doctors Registered</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Expiring (90D)</p>
