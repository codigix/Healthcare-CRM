...
export default function AttendanceReportPage() {
  ...
  const columns = [
    ...
    { header: 'Total Working Days', accessor: 'totalworkingdays', sortable: true },
    { header: 'Avg Presence %', accessor: 'avgpresence', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Aggregated attendance data for payroll or compliance audits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Hospital Presence</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>94%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Absenteeism</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>Housekeeping</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Automated Sync</p>
