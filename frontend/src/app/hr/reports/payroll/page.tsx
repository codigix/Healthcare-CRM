...
export default function PayrollRegisterPage() {
  ...
  const columns = [
    ...
    { header: 'Gross Payroll', accessor: 'grosspayroll', sortable: true },
    { header: 'Total Deductions', accessor: 'totaldeductions', sortable: true },
    { header: 'Net Payout', accessor: 'netpayout', sortable: true },
    { header: 'Employer PF/ESI', accessor: 'employerpfesi', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Financial audit report of all salaries, taxes, and net payouts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Payout (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$2.4M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Tax Deducted (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$450K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Variance (MoM)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>+2.4%</p>
        </div>
      </div>
