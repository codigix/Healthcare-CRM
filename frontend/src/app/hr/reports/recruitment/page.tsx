...
export default function RecruitmentFunnelPage() {
  ...
  const columns = [
    ...
    { header: 'Total Applied', accessor: 'totalapplied', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Metrics on time-to-hire, source effectiveness, and conversion rates.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Time to Hire</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>24 Days</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Offer Acceptance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>85%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cost Per Hire</p>
