...
export default function AttritionAnalysisPage() {
  ...
  const columns = [
    ...
    { header: 'Voluntary Exits', accessor: 'voluntaryexits', sortable: true },
    { header: 'Involuntary', accessor: 'involuntary', sortable: true },
    { header: 'Attrition Rate', accessor: 'attritionrate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Exit interview data, turnover rates, and retention metrics.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Annualized Attrition</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>14.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Exit Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>Nursing</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Tenure</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4.2 Yrs</p>
        </div>
      </div>
