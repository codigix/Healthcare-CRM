...
export default function ComplianceStatusReportPage() {
  ...
  const columns = [
    ...
    { header: 'Total Requirements', accessor: 'totalrequirements', sortable: true },
    { header: 'Compliant', accessor: 'compliant', sortable: true },
    { header: 'Non-Compliant', accessor: 'noncompliant', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Consolidated view of all statutory and accreditation HR compliances.</p>
        </div>
