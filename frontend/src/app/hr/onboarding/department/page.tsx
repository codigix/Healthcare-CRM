...
export default function DepartmentAllocationPage() {
  ...
  const columns = [
    ...
    { header: 'Allocated Dept', accessor: 'allocateddept', sortable: true },
    { header: 'Reporting Manager', accessor: 'reportingmanager', sortable: true },
    { header: 'Shift Default', accessor: 'shiftdefault', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Assigning new hires to their specific wards or units.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Allocation</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Managers</p>
