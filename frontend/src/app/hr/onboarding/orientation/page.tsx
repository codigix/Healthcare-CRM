...
export default function OrientationChecklistPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Emp ID', accessor: 'empid', sortable: true },
    { header: 'Name', accessor: 'name', sortable: true },
    { header: 'HR Induction', accessor: 'hrinduction', sortable: true },
    { header: 'Safety Training', accessor: 'safetytraining', sortable: true },
    { header: 'Dept Tour', accessor: 'depttour', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking completion of mandatory hospital induction programs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inductions This Week</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Checklist Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>98%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Sign-offs</p>
