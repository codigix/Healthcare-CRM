...
export default function EmployeeDirectoryPage() {
  ...
  const columns = [
    ...
    { header: 'Date of Joining', accessor: 'dateofjoining', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Central list of all active and inactive hospital staff.</p>
        </div>
