...
export default function JoiningProcessPage() {
  ...
  const columns = [
    { header: 'Candidate', accessor: 'candidate', sortable: true },
    { header: 'Designation', accessor: 'designation', sortable: true },
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Expected DOJ', accessor: 'expecteddoj', sortable: true },
    { header: 'Welcome Kit', accessor: 'welcomekit', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking candidates who have accepted offers until their day 1.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Joining This Week</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Joining Next Week</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Dropouts</p>
