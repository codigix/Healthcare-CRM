...
export default function PredictiveAttritionPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Emp Name', accessor: 'empname', sortable: true },
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Flight Risk', accessor: 'flightrisk', sortable: true },
    { header: 'Key Driver', accessor: 'keydriver', sortable: true },
    { header: 'Intervention', accessor: 'intervention', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Machine learning model highlighting flight risks based on commute, pay, and leaves.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Flight Risk</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>12 Staff</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Driver</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Stagnant Pay</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Retention Success</p>
