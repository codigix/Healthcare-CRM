...
export default function WorkforceDashboardPage() {
  ...
  const columns = [
    ...
    { header: 'Previous Period', accessor: 'previousperiod', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">High-level executive dashboard showing diversity, age, and tenure demographics.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Gender Ratio (M:F)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45:55</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Age</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>34 Yrs</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Contract vs Permanent</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>20:80</p>
        </div>
      </div>
