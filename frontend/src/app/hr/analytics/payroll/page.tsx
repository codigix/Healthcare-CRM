...
export default function PayrollAnalyticsPage() {
  ...
  const columns = [
    { header: 'Cost Center', accessor: 'costcenter', sortable: true },
    { header: 'Budgeted Payroll', accessor: 'budgetedpayroll', sortable: true },
    { header: 'Actual Payroll', accessor: 'actualpayroll', sortable: true },
    { header: 'Variance', accessor: 'variance', sortable: true },
    { header: 'OT % of Cost', accessor: 'otofcost', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking compensation costs, benefits utilization, and overtime budget variance.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total HR Cost</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$5.4M (YTD)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">OT Overrun</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$45,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
