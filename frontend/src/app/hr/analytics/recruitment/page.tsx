...
export default function RecruitmentAnalyticsPage() {
  ...
  const columns = [
    { header: 'Source Channel', accessor: 'sourcechannel', sortable: true },
    { header: 'Hires (YTD)', accessor: 'hiresytd', sortable: true },
    { header: 'Cost/Hire', accessor: 'costhire', sortable: true },
    { header: 'Avg Tenure', accessor: 'avgtenure', sortable: true },
    { header: 'Performance Avg', accessor: 'performanceavg', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">AI-driven insights on which sourcing channels yield the best long-term employees.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Best Source</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Referrals</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Cost</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>Agencies</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fastest Source</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Job Portals</p>
        </div>
      </div>
