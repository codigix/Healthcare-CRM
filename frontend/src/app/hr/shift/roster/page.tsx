...
export default function DutyRosterPage() {
  ...
  const columns = [
    ...
    { header: 'Published Date', accessor: 'publisheddate', sortable: true },
    { header: 'Conflicts', accessor: 'conflicts', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monthly or weekly scheduling of staff across different shifts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rosters Published</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12/15</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Draft Rosters</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Coverage Gaps</p>
