...
export default function ShiftAllocationPage() {
  ...
  const columns = [
    ...
    { header: 'Current Shift', accessor: 'currentshift', sortable: true },
    { header: 'Next Shift', accessor: 'nextshift', sortable: true },
    { header: 'Allocation Date', accessor: 'allocationdate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Individual employee view of their assigned shifts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unassigned Staff</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Allocations Active</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>820</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Changes Requested</p>
