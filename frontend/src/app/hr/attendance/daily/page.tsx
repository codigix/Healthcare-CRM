...
export default function DailyAttendancePage() {
  ...
  const columns = [
    ...
    { header: 'Out Time', accessor: 'outtime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Real-time dashboard of who is present, absent, or on leave today.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>780</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Absent</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">On Leave</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>29</p>
        </div>
      </div>
