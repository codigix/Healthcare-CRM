...
export default function CMEProgramsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Doctor Name', accessor: 'doctorname', sortable: true },
    { header: 'Event/Course', accessor: 'eventcourse', sortable: true },
    { header: 'Credit Hours', accessor: 'credithours', sortable: true },
    { header: 'Date', accessor: 'date', sortable: true },
    { header: 'Proof Document', accessor: 'proofdocument', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Continuing Medical Education tracking for doctors to maintain licenses.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total CME Hours</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,240</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Doctors Compliant</p>
