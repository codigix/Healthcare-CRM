...
export default function CertificationsPage() {
  ...
  const columns = [
    ...
    { header: 'Certificate Name', accessor: 'certificatename', sortable: true },
    { header: 'Issue Date', accessor: 'issuedate', sortable: true },
    { header: 'Expiry Date', accessor: 'expirydate', sortable: true },
    { header: 'Issuer', accessor: 'issuer', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking internal certifications and their validity periods.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Certs</p>
