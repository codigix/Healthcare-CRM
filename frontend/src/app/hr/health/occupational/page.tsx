...
export default function OccupationalHealthPage() {
  ...
  const columns = [
    ...
    { header: 'TLD Badge Status', accessor: 'tldbadgestatus', sortable: true },
    { header: 'Last Review', accessor: 'lastreview', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking exposure risks, radiation monitoring (TLD badges), and chemical hazards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Risk Staff</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">TLD Renewals Due</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Monitoring Active</p>
