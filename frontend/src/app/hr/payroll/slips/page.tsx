...
export default function SalarySlipsPage() {
  ...
  const columns = [
    ...
    { header: 'Net Pay', accessor: 'netpay', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Generated payslips for employees, available for view and download.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Slips Generated</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>824</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Downloads (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,200</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Discrepancies Raised</p>
