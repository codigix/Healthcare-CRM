...
export default function BonusPage() {
  ...
  const columns = [
    { header: 'Bonus Type', accessor: 'bonustype', sortable: true },
    { header: 'Applicable FY', accessor: 'applicablefy', sortable: true },
    { header: 'Eligible Staff', accessor: 'eligiblestaff', sortable: true },
    { header: 'Total Payout', accessor: 'totalpayout', sortable: true },
    { header: 'Disbursement Date', accessor: 'disbursementdate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Calculation and disbursement of annual or performance bonuses.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Upcoming Bonus</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Diwali Bonus</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Liability</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$120,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Disbursed (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$50,000</p>
        </div>
      </div>
