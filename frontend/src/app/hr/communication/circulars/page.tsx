...
export default function CircularsMemosPage() {
  ...
  const columns = [
    ...
    { header: 'Mandatory Ack.', accessor: 'mandatoryack', sortable: true },
    { header: 'Ack. Count', accessor: 'ackcount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Formal, mandated communications requiring digital signatures or acknowledgments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Circulars</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Acknowledgments</p>
