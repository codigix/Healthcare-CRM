...
export default function IncrementHistoryPage() {
  ...
  const columns = [
    ...
    { header: 'Previous CTC', accessor: 'previousctc', sortable: true },
    { header: 'Hike %', accessor: 'hike', sortable: true },
    { header: 'New CTC', accessor: 'newctc', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Historical log of salary hikes across the organization.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Hike (2026)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Hike</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>18%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Zero Increments</p>
