...
export default function PhysiotherapyOrdersPage() {
  ...
  const columns = [
    { header: 'Referral ID', accessor: 'referralid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Therapy Type', accessor: 'therapytype', sortable: true },
    { header: 'Sessions Ordered', accessor: 'sessionsordered', sortable: true },
    { header: 'Physiotherapist', accessor: 'physiotherapist', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Refer patients for physical therapy and rehabilitation.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Referrals Today</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Completed Tx</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>8</p>
        </div>
      </div>
