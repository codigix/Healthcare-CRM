...
export default function WaitingRoomPage() {
  ...
  const columns = [
    { header: 'Wait No', accessor: 'waitno', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Condition', accessor: 'condition', sortable: true },
    { header: 'Wait Duration', accessor: 'waitduration', sortable: true },
    { header: 'Assigned Nurse', accessor: 'assignednurse', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Live list of patients physically present and waiting.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Currently Waiting</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Wait</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>18 mins</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Next Turn</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>TKN-15</p>
        </div>
      </div>
