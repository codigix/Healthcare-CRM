...
export default function ScheduleCalendarPage() {
  ...
  const columns = [
    ...
    { header: 'Patient/Details', accessor: 'patientdetails', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monthly/Weekly view of appointments, procedures, and blocks.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Events This Week</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>42</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Appts Today</p>
