...
export default function LeaveManagementPage() {
  ...
  const columns = [
    { header: 'Leave ID', accessor: 'leaveid', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Apply for leaves, track balances, and manage absences.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Annual Leave Balance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>14 Days</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Sick Leave</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>5 Days</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
