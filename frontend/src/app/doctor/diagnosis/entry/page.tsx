...
export default function DiagnosisEntryPage() {
  ...
  const columns = [
    ...
    { header: 'Secondary Dx', accessor: 'secondarydx', sortable: true },
    { header: 'Entered By', accessor: 'enteredby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Input and finalize diagnoses for current encounters.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Diagnoses Entered</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Finalized</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>33</p>
        </div>
      </div>
