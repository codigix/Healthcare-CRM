...
export default function MissedFollowupsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Follow-up ID', accessor: 'followupid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Missed Date', accessor: 'misseddate', sortable: true },
    { header: 'Contact Attempts', accessor: 'contactattempts', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Track patients who missed their scheduled follow-up visits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missed This Week</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rescheduled</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lost to Follow-up</p>
