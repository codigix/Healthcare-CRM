...
export default function ConsultationPerformancePage() {
  ...
  const columns = [
    ...
    { header: 'Avg Consult Time', accessor: 'avgconsulttime', sortable: true },
    { header: 'Patients/Day', accessor: 'patientsday', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Metrics on OPD efficiency, wait times, and patient volume.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12m 30s</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Target</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>15m 00s</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
