...
export default function MajorProceduresPage() {
  ...
  const columns = [
    ...
    { header: 'OR Room', accessor: 'orroom', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Schedule and manage major surgical operations.</p>
        </div>
