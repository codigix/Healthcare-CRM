...
export default function ePrescriptionPortalPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Transmission ID', accessor: 'transmissionid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Destination Pharmacy', accessor: 'destinationpharmacy', sortable: true },
    { header: 'Sent Time', accessor: 'senttime', sortable: true },
    { header: 'Ack Status', accessor: 'ackstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Direct electronic routing to partnered pharmacies.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">e-Rx Sent Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>112</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Successful</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>110</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Failed/Retry</p>
