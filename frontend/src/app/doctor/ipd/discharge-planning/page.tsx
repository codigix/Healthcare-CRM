...
export default function DischargePlanningPage() {
  ...
  const columns = [
    ...
    { header: 'Admit Date', accessor: 'admitdate', sortable: true },
    { header: 'Planned Discharge', accessor: 'planneddischarge', sortable: true },
    { header: 'Summary Status', accessor: 'summarystatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Prepare discharge summaries, prescriptions, and follow-ups.</p>
        </div>
