...
export default function ERTriagePage() {
  ...
  const columns = [
    { header: 'Triage ID', accessor: 'triageid', sortable: true },
    { header: 'Patient/Demo', accessor: 'patientdemo', sortable: true },
    { header: 'Chief Complaint', accessor: 'chiefcomplaint', sortable: true },
    { header: 'Vitals', accessor: 'vitals', sortable: true },
    { header: 'Assigned Priority', accessor: 'assignedpriority', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Assess and prioritize incoming emergency patients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Waiting Triage</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Triaged Today</p>
