...
export default function ERDashboardPage() {
  ...
  const columns = [
    { header: 'Bed/Zone', accessor: 'bedzone', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Triage Level', accessor: 'triagelevel', sortable: true },
    { header: 'Time in ER', accessor: 'timeiner', sortable: true },
    { header: 'Primary Physician', accessor: 'primaryphysician', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Live metrics and status of the Emergency Department.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Cases</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>14</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical (Red)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-500"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Turnaround</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>2h 15m</p>
        </div>
      </div>
