...
export default function ClinicalOutcomesPage() {
  ...
  const columns = [
    ...
    { header: 'Cases Tracked', accessor: 'casestracked', sortable: true },
    { header: 'Positive Outcome', accessor: 'positiveoutcome', sortable: true },
    { header: 'Readmission Rate', accessor: 'readmissionrate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Reports measuring patient recovery rates and clinical success.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Success</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>94%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Readmissions (30d)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2.1%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Mortality</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>0.1%</p>
        </div>
      </div>
