...
export default function DiagnosisAnalyticsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Report ID', accessor: 'reportid', sortable: true },
    { header: 'ICD-10 Category', accessor: 'icd10category', sortable: true },
    { header: 'Total Cases', accessor: 'totalcases', sortable: true },
    { header: 'Most Affected Demo', accessor: 'mostaffecteddemo', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Trends and frequency reports of patient diagnoses.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Diagnosis</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Hypertension</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Seasonal Spike</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Influenza</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rare Cases</p>
