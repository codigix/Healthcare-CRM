...
export default function PatientJourneyPage() {
  ...
  const columns = [
    { header: 'Journey ID', accessor: 'journeyid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Current Stage', accessor: 'currentstage', sortable: true },
    { header: 'Days in Stage', accessor: 'daysinstage', sortable: true },
    { header: 'Next Action Due', accessor: 'nextactiondue', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Mapping the end-to-end experience from lead acquisition to post-discharge care.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Journeys</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,240</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Drop-off Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Conversion to IPD</p>
