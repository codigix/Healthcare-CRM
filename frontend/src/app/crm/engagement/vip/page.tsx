...
export default function VIPPatientsPage() {
  ...
  const columns = [
    ...
    { header: 'VIP Name', accessor: 'vipname', sortable: true },
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Concierge Assigned', accessor: 'conciergeassigned', sortable: true },
    { header: 'Upcoming Visit', accessor: 'upcomingvisit', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Special handling and concierge services for HNI, politicians, or celebrity patients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total VIPs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>345</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Visits Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Concierge Staff</p>
