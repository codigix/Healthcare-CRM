...
export default function PatientTimelinePage() {
  ...
  const columns = [
    { header: 'Interaction Date', accessor: 'interactiondate', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Touchpoint Type', accessor: 'touchpointtype', sortable: true },
    { header: 'Department/Agent', accessor: 'departmentagent', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Chronological view of all patient interactions, visits, calls, and campaigns.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Interactions Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>2,450</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Touchpoints/Pt</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4.5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unresolved Queries</p>
