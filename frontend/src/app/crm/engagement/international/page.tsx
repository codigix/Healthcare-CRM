...
export default function InternationalPatientsPage() {
  ...
  const columns = [
    { header: 'Passport No', accessor: 'passportno', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Country', accessor: 'country', sortable: true },
    { header: 'Arrival Date', accessor: 'arrivaldate', sortable: true },
    { header: 'Treatment Plan', accessor: 'treatmentplan', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Managing medical tourism, visa assistance, and language translation services.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Intl Patients (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Visa Letters Issued</p>
