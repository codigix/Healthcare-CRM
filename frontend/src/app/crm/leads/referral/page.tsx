...
export default function ReferralLeadsPage() {
  ...
  const columns = [
    ...
    { header: 'Referred By (Dr/Hosp)', accessor: 'referredbydrhosp', sortable: true },
    { header: 'Specialty', accessor: 'specialty', sortable: true },
    { header: 'Date Received', accessor: 'datereceived', sortable: true },
    { header: 'Appointment Set', accessor: 'appointmentset', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Patients referred by external doctors, requiring priority scheduling and updates.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Referrals (Mo)</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Contact</p>
