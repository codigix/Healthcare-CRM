...
export default function LeadConversionPage() {
  ...
  const columns = [
    { header: 'Lead ID', accessor: 'leadid', sortable: true },
    { header: 'Source', accessor: 'source', sortable: true },
    { header: 'Time to Convert', accessor: 'timetoconvert', sortable: true },
    { header: 'Converted By', accessor: 'convertedby', sortable: true },
    { header: 'First Revenue', accessor: 'firstrevenue', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analytics and tools focused specifically on turning warm leads into registered patients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Conversion</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>18%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Best Channel</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Referrals (45%)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cost Per Acquisition</p>
