...
export default function HealthCampLeadsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Camp Name', accessor: 'campname', sortable: true },
    { header: 'Lead Name', accessor: 'leadname', sortable: true },
    { header: 'Screening Result', accessor: 'screeningresult', sortable: true },
    { header: 'Recommended Consult', accessor: 'recommendedconsult', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Leads generated from community outreach programs and free health camps.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Camp Leads</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,240</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Camp Conversion Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>24%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Upcoming Camps</p>
