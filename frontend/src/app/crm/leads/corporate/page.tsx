...
export default function CorporateLeadsPage() {
  ...
  const columns = [
    ...
    { header: 'Deal Size/Emp', accessor: 'dealsizeemp', sortable: true },
    { header: 'Sales Rep', accessor: 'salesrep', sortable: true },
    { header: 'Proposal Sent', accessor: 'proposalsent', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">B2B leads for corporate tie-ups, annual health checks, and occupational health.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Deals</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pipeline Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$450K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Won (YTD)</p>
