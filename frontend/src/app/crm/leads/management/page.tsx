...
export default function LeadManagementPage() {
  ...
  const columns = [
    ...
    { header: 'Specialty Interest', accessor: 'specialtyinterest', sortable: true },
    { header: 'Assigned Rep', accessor: 'assignedrep', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking potential patients through the sales funnel (New > Contacted > Converted).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Leads</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lost Leads (Mo)</p>
