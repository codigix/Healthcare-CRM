...
export default function ReferralReportPage() {
  ...
  const columns = [
    { header: 'Referrer Group', accessor: 'referrergroup', sortable: true },
    { header: 'Total Referrals', accessor: 'totalreferrals', sortable: true },
    { header: 'Converted', accessor: 'converted', sortable: true },
    { header: 'Conversion %', accessor: 'conversion', sortable: true },
    { header: 'Revenue Generated', accessor: 'revenuegenerated', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking the source of patient inflows (Doctors, Corporates, Existing Patients).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Referral Revenue</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$245,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Referrer</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>External Docs (60%)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Growth (MoM)</p>
