...
export default function ComplaintReportPage() {
  ...
  const columns = [
    { header: 'Complaint Category', accessor: 'complaintcategory', sortable: true },
    { header: 'Total Registered', accessor: 'totalregistered', sortable: true },
    { header: 'Resolved within SLA', accessor: 'resolvedwithinsla', sortable: true },
    { header: 'SLA Breaches', accessor: 'slabreaches', sortable: true },
    { header: 'Avg Time', accessor: 'avgtime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">SLA adherence, resolution times, and root cause summaries of grievances.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Complaints</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>42 Hrs</p>
        </div>
      </div>
