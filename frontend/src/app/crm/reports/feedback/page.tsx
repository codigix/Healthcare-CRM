...
export default function FeedbackReportPage() {
  ...
  const columns = [
    { header: 'Target Entity', accessor: 'targetentity', sortable: true },
    { header: 'Total Feedbacks', accessor: 'totalfeedbacks', sortable: true },
    { header: 'Avg Score', accessor: 'avgscore', sortable: true },
    { header: 'Top Complaint', accessor: 'topcomplaint', sortable: true },
    { header: 'Top Compliment', accessor: 'topcompliment', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed breakdown of patient comments, ratings, and CSAT scores by doctor/ward.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall CSAT</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Actionable Items</p>
