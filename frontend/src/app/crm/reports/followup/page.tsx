...
export default function FollowupReportPage() {
  ...
  const columns = [
    ...
    { header: 'Follow-ups Due', accessor: 'followupsdue', sortable: true },
    { header: 'Calls Made', accessor: 'callsmade', sortable: true },
    { header: 'Converted to Visit', accessor: 'convertedtovisit', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking the success rate of follow-up calls and resultant outpatient visits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Conversions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Best Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Orthopedics (65%)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lost Revenue</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$12,500</p>
        </div>
      </div>
