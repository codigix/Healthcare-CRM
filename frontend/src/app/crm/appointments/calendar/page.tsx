...
export default function FollowupCalendarPage() {
  ...
  const columns = [
    ...
    { header: 'Total Slots', accessor: 'totalslots', sortable: true },
    { header: 'Booked Follow-ups', accessor: 'bookedfollowups', sortable: true },
    { header: 'New Patients', accessor: 'newpatients', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Visual calendar view for CRM agents to see peak follow-up days and availability.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Capacity Utilization</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>85%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overbooked Days</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Next Open Slot</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Tomorrow</p>
        </div>
      </div>
