...
export default function AppointmentRemindersPage() {
  ...
  const columns = [
    { header: 'Reminder ID', accessor: 'reminderid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Appointment Time', accessor: 'appointmenttime', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Automated queue for sending SMS/WhatsApp/Email reminders 24h before visits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reminders Sent (Today)</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cancellations via Link</p>
