...
export default function MissedAppointmentsPage() {
  ...
  const columns = [
    { header: 'Appointment ID', accessor: 'appointmentid', sortable: true },
    ...
    { header: 'Reschedule Action', accessor: 'rescheduleaction', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">No-show patients who need to be contacted for rescheduling to prevent revenue leak.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">No-Shows (Today)</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revenue Saved</p>
