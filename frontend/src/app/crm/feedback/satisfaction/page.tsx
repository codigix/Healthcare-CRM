...
export default function SatisfactionSurveyCSATPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Survey ID', accessor: 'surveyid', sortable: true },
    { header: 'Patient Type', accessor: 'patienttype', sortable: true },
    { header: 'Response Rate', accessor: 'responserate', sortable: true },
    { header: 'Overall CSAT', accessor: 'overallcsat', sortable: true },
    { header: 'Key Area to Improve', accessor: 'keyareatoimprove', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed post-discharge or post-consultation survey metrics.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Nursing Care</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lowest Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Billing Wait Time</p>
        </div>
      </div>
