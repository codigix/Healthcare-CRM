...
export default function DoctorFeedbackPage() {
  ...
  const columns = [
    ...
    { header: 'Consults', accessor: 'consults', sortable: true },
    { header: 'Reviews', accessor: 'reviews', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Specific feedback and ratings targeted at individual physicians.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Rated Doctor</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Dr. Smith (4.9)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Doctors < 4.0</p>
