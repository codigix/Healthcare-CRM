...
export default function ServiceRatingPage() {
  ...
  const columns = [
    { header: 'Touchpoint/Device', accessor: 'touchpointdevice', sortable: true },
    { header: 'Location', accessor: 'location', sortable: true },
    { header: 'Excellent', accessor: 'excellent', sortable: true },
    { header: 'Average', accessor: 'average', sortable: true },
    { header: 'Poor', accessor: 'poor', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Micro-feedback (e.g., smiley faces) captured via tablets at specific touchpoints.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Taps (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Happy Taps</p>
