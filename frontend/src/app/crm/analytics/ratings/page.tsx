...
export default function DoctorRatingsPage() {
  ...
  const columns = [
    { header: 'Doctor/Specialty', accessor: 'doctorspecialty', sortable: true },
    { header: 'Avg Rating', accessor: 'avgrating', sortable: true },
    { header: 'Avg Wait Time', accessor: 'avgwaittime', sortable: true },
    { header: 'Avg Bill Amount', accessor: 'avgbillamount', sortable: true },
    { header: 'Correlation Factor', accessor: 'correlationfactor', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Correlating doctor ratings with wait times, billing amounts, and clinical outcomes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Wait Time Impact</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>-0.8 (Strong)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bill Impact</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>-0.3 (Weak)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Driver</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Doctor Behavior</p>
        </div>
      </div>
