...
export default function PatientRetentionAnalyticsPage() {
  ...
  const columns = [
    { header: 'Factor/Variable', accessor: 'factorvariable', sortable: true },
    { header: 'Impact on Retention', accessor: 'impactonretention', sortable: true },
    { header: 'Cohort Size', accessor: 'cohortsize', sortable: true },
    { header: 'Lost Revenue', accessor: 'lostrevenue', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Identifying factors that cause patients to choose competitor hospitals.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Churn Reason</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>High Wait Times</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Loyalty Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$1.4M (LTV)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Win-back Success</p>
