...
export default function CommunicationAnalyticsPage() {
  ...
  const columns = [
    ...
    { header: 'Time of Day', accessor: 'timeofday', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Engagement rates across SMS, Email, and WhatsApp to optimize outreach timings.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Best Time to Send</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>10 AM - 11 AM</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Open Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>WhatsApp (85%)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
