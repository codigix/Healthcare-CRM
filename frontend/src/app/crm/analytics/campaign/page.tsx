...
export default function CampaignAnalyticsPage() {
  ...
  const columns = [
    { header: 'Campaign Group', accessor: 'campaigngroup', sortable: true },
    { header: 'Channel Mix', accessor: 'channelmix', sortable: true },
    { header: 'Spend', accessor: 'spend', sortable: true },
    { header: 'Conversions', accessor: 'conversions', sortable: true },
    { header: 'Cost Per Acquisition', accessor: 'costperacquisition', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">A/B testing results and multi-channel attribution for marketing efforts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Best Channel</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Google Ads</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg CPA</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Budget Utilization</p>
