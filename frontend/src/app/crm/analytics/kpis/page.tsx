...
export default function CRMKPIsPage() {
  ...
  const columns = [
    ...
    { header: 'Actual (YTD)', accessor: 'actualytd', sortable: true },
    { header: 'Variance', accessor: 'variance', sortable: true },
    { header: 'Trend (Last 6 Mo)', accessor: 'trendlast6mo', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Executive dashboard tracking lead conversion velocity, agent productivity, and SLA breaches.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lead Velocity Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>+12% MoM</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Agent Utilization</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>78%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Resolution SLA</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>94% Met</p>
        </div>
      </div>
