...
export default function PromotionalCampaignsPage() {
  ...
  const columns = [
    { header: 'Promo Name', accessor: 'promoname', sortable: true },
    { header: 'Promo Code', accessor: 'promocode', sortable: true },
    { header: 'Validity', accessor: 'validity', sortable: true },
    { header: 'Redemptions', accessor: 'redemptions', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Discounts, seasonal offers (e.g., Monsoon Health Check), and cross-selling.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Promos</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Redemptions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>340</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Discount Given</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$3,400</p>
        </div>
      </div>
