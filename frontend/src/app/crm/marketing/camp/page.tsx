...
export default function HealthCampManagementPage() {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Planning, budgeting, and lead tracking for physical health camps in the community.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Attendees (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ROI (Revenue/Cost)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>3.4x</p>
        </div>
      </div>
