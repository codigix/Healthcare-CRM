...
export default function WhatsAppCampaignsPage() {
  ...
  const columns = [
    ...
    { header: 'Media Type', accessor: 'mediatype', sortable: true },
    { header: 'Delivered', accessor: 'delivered', sortable: true },
    { header: 'Read Rate', accessor: 'readrate', sortable: true },
    { header: 'Bot Interactions', accessor: 'botinteractions', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Rich media (images/videos) campaigns via WhatsApp Business API.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lead Gen via Bot</p>
