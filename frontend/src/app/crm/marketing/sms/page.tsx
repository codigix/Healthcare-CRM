...
export default function SMSCampaignsPage() {
  ...
  const columns = [
    { header: 'Campaign Name', accessor: 'campaignname', sortable: true },
    { header: 'Sent To', accessor: 'sentto', sortable: true },
    { header: 'Cost ($)', accessor: 'cost', sortable: true },
    { header: 'Click Rate (Link)', accessor: 'clickratelink', sortable: true },
    { header: 'Opt-outs', accessor: 'optouts', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Short promotional broadcasts for immediate reach (e.g., Blood donation camps).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Sent (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Link Clicks</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Opt-out Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0.1%</p>
        </div>
      </div>
