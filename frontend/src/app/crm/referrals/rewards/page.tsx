...
export default function ReferralRewardsPage() {
  ...
  const columns = [
    { header: 'Referrer Name', accessor: 'referrername', sortable: true },
    { header: 'Type', accessor: 'type', sortable: true },
    { header: 'Reward Earned', accessor: 'rewardearned', sortable: true },
    { header: 'Amount/Points', accessor: 'amountpoints', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Managing payouts, discounts, or loyalty points given to referrers.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rewards Issued (Mo)</p>
