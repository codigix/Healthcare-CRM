...
export default function ReferralAnalyticsPage() {
  ...
  const columns = [
    ...
    { header: 'Referrals (YTD)', accessor: 'referralsytd', sortable: true },
    { header: 'Top Referrer', accessor: 'topreferrer', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analyzing which specialties or doctors receive the most external referrals.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Volume Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Orthopedics</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Revenue Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Cardiology</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Referral Drop-off</p>
