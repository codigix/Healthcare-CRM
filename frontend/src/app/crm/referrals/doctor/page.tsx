...
export default function DoctorReferralsPage() {
  ...
  const columns = [
    { header: 'External Doctor', accessor: 'externaldoctor', sortable: true },
    { header: 'Clinic/Hospital', accessor: 'clinichospital', sortable: true },
    { header: 'Referrals (YTD)', accessor: 'referralsytd', sortable: true },
    { header: 'Converted to IPD', accessor: 'convertedtoipd', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking patients sent by external GPs or partner clinics.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Referrers</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Referrals (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>340</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">IPD Conversion</p>
