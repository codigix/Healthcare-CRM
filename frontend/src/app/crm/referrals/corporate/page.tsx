...
export default function CorporateReferralsPage() {
  ...
  const columns = [
    { header: 'Corporate Partner', accessor: 'corporatepartner', sortable: true },
    { header: 'HR Contact', accessor: 'hrcontact', sortable: true },
    { header: 'Referrals Received', accessor: 'referralsreceived', sortable: true },
    { header: 'Health Checks Done', accessor: 'healthchecksdone', sortable: true },
    { header: 'IPD Admissions', accessor: 'ipdadmissions', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Leads generated via corporate HR or company doctors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Corp Referrals (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Corporate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>TechCorp Inc.</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Revenue/Patient</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$450</p>
        </div>
      </div>
