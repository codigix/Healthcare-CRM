...
export default function PatientReferralsPage() {
  ...
  const columns = [
    { header: 'Referring Patient', accessor: 'referringpatient', sortable: true },
    { header: 'UHID', accessor: 'uhid', sortable: true },
    { header: 'Referred Friends', accessor: 'referredfriends', sortable: true },
    { header: 'Converted', accessor: 'converted', sortable: true },
    { header: 'Reward Points Given', accessor: 'rewardpointsgiven', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Word-of-mouth tracking; patients referring friends or family members.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Patient Referrals (Mo)</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12,000</p>
        </div>
      </div>
