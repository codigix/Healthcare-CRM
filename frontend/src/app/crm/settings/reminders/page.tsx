...
export default function ReminderSettingsPage() {
  ...
  const columns = [
    { header: 'Trigger Event', accessor: 'triggerevent', sortable: true },
    { header: 'Time Before/After', accessor: 'timebeforeafter', sortable: true },
    { header: 'Primary Channel', accessor: 'primarychannel', sortable: true },
    { header: 'Fallback Channel', accessor: 'fallbackchannel', sortable: true },
    { header: 'Is Mandatory', accessor: 'ismandatory', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configuring the cadence (24h, 2h before) and channel fallback for appointments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Triggers</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fallback Success</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cost Saved</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$120/Mo</p>
        </div>
      </div>
