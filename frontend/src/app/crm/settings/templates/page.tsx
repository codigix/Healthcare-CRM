...
export default function CommunicationTemplatesPage() {
  ...
  const columns = [
    ...
    { header: 'Content Preview', accessor: 'contentpreview', sortable: true },
    { header: 'Variables Used', accessor: 'variablesused', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Pre-approved SMS, Email, and WhatsApp templates ensuring brand consistency.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">WhatsApp Approved</p>
