...
export default function FeedbackTemplatesPage() {
  ...
  const columns = [
    { header: 'Form Name', accessor: 'formname', sortable: true },
    { header: 'Touchpoint', accessor: 'touchpoint', sortable: true },
    { header: 'Question Count', accessor: 'questioncount', sortable: true },
    { header: 'Logic/Branching', accessor: 'logicbranching', sortable: true },
    { header: 'Active Since', accessor: 'activesince', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Dynamic questionnaire builder for various patient touchpoints (IPD, OPD, ER).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Forms</p>
