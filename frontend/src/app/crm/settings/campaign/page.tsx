...
export default function CampaignTemplatesPage() {
  ...
  const columns = [
    { header: 'Segment Rule', accessor: 'segmentrule', sortable: true },
    { header: 'Audience Size', accessor: 'audiencesize', sortable: true },
    { header: 'Last Calculated', accessor: 'lastcalculated', sortable: true },
    { header: 'Refresh Rate', accessor: 'refreshrate', sortable: true },
    { header: 'Assigned Campaigns', accessor: 'assignedcampaigns', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Visual email builders and audience segmentation rules for marketing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Saved Segments</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Reachable</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>145,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Dynamic Segments</p>
