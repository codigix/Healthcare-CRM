...
export default function LoyaltyRulesPage() {
  ...
  const columns = [
    ...
    { header: 'Points Earned/Redeemed', accessor: 'pointsearnedredeemed', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Defining how points are earned (e.g., 1 point per $10 spent) and redemption limits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Points Expiration</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12 Months</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Base Earn Rate</p>
