...
export default function MissedCallsAbandonedPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Caller Number', accessor: 'callernumber', sortable: true },
    { header: 'Abandoned After', accessor: 'abandonedafter', sortable: true },
    { header: 'IVR Node', accessor: 'ivrnode', sortable: true },
    { header: 'Callback Status', accessor: 'callbackstatus', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Missed Calls (Abandoned)
          </h1>
          <p className="text-sm text-gray-400 mt-1">Calls abandoned by patients while waiting in the queue, requiring callbacks.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Abandoned Calls (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Abandon Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>2.8%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Callbacks Pending</p>
