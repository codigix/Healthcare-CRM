...
export default function CallQueuePage() {
  ...
  const columns = [
    ...
    { header: 'IVR Selection', accessor: 'ivrselection', sortable: true },
    { header: 'Wait Time', accessor: 'waittime', sortable: true },
    { header: 'Priority', accessor: 'priority', sortable: true },
    { header: 'Assigned Agent', accessor: 'assignedagent', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Live view of patients waiting on hold in the IVR system.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Calls in Queue</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Max Wait Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2m 15s</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
