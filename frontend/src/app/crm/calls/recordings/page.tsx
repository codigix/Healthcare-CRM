...
export default function CallRecordingsPage() {
  ...
  const columns = [
    { header: 'Call ID', accessor: 'callid', sortable: true },
    { header: 'Agent', accessor: 'agent', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Duration', accessor: 'duration', sortable: true },
    { header: 'QA Score', accessor: 'qascore', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Quality assurance tool to listen to recorded agent-patient conversations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Calls Recorded</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>100%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Calls QA Assessed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg QA Score</p>
