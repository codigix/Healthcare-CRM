...
export default function CallHistoryPage() {
  ...
  const columns = [
    ...
    { header: 'Disposition', accessor: 'disposition', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Complete log of all call center activity for reporting and billing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Volume (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Peak Hour</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>10 AM - 12 PM</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Service Level (SLA)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>92% (<30s)</p>
        </div>
      </div>
