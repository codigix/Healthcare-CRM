...
export default function IncomingCallsPage() {
  ...
  const columns = [
    ...
    { header: 'Caller', accessor: 'caller', sortable: true },
    { header: 'Agent', accessor: 'agent', sortable: true },
    { header: 'Duration', accessor: 'duration', sortable: true },
    { header: 'Call Intent', accessor: 'callintent', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Log of all answered inbound calls with agent handling times.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inbound Calls (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Handle Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>3m 45s</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">First Call Resolution</p>
