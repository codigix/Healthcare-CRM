...
export default function SMSCenterPage() {
  ...
  const columns = [
    { header: 'Campaign/Alert', accessor: 'campaignalert', sortable: true },
    { header: 'Target Audience', accessor: 'targetaudience', sortable: true },
    { header: 'SMS Sent', accessor: 'smssent', sortable: true },
    { header: 'Delivered', accessor: 'delivered', sortable: true },
    { header: 'Failed', accessor: 'failed', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Bulk and transactional SMS dispatch for alerts, reports, and promotions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45,200</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Delivery Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>98.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Credits Remaining</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15,000</p>
        </div>
      </div>
