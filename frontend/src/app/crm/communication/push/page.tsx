...
export default function PushNotificationsPage() {
  ...
  const columns = [
    { header: 'Notification ID', accessor: 'notificationid', sortable: true },
    { header: 'Title', accessor: 'title', sortable: true },
    { header: 'Audience Segment', accessor: 'audiencesegment', sortable: true },
    { header: 'Sent', accessor: 'sent', sortable: true },
    { header: 'Opened', accessor: 'opened', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">App-based notifications for patients using the hospital mobile app.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active App Users</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Push CTR</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Scheduled Pushes</p>
