...
export default function VoiceCallsRobocallsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Broadcast ID', accessor: 'broadcastid', sortable: true },
    { header: 'Audio File', accessor: 'audiofile', sortable: true },
    { header: 'Target Numbers', accessor: 'targetnumbers', sortable: true },
    { header: 'Answered', accessor: 'answered', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Automated voice broadcasts for emergency alerts or mass camp announcements.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Calls Placed (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>5,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Answer Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>45%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cost (Mo)</p>
