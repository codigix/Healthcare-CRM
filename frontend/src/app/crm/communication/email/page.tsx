...
export default function EmailCenterPage() {
  ...
  const columns = [
    ...
    { header: 'Subject Line', accessor: 'subjectline', sortable: true },
    { header: 'Sent To', accessor: 'sentto', sortable: true },
    { header: 'Open Rate', accessor: 'openrate', sortable: true },
    { header: 'Click Rate', accessor: 'clickrate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Newsletters, detailed health tips, and corporate communication dispatch.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Emails Sent (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12,400</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Open Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>24%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unsubscribes</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>0.5%</p>
        </div>
      </div>
