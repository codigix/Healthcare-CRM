...
export default function FamilyMembershipPage() {
  ...
  const columns = [
    { header: 'Family ID', accessor: 'familyid', sortable: true },
    { header: 'Primary Member', accessor: 'primarymember', sortable: true },
    { header: 'Dependents', accessor: 'dependents', sortable: true },
    { header: 'Plan Type', accessor: 'plantype', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Grouped memberships where benefits and points are shared across family members.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Family Plans Active</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Dependents</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Renewals</p>
