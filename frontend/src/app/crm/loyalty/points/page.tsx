...
export default function LoyaltyPointsPage() {
  ...
  const columns = [
    ...
    { header: 'Points Balance', accessor: 'pointsbalance', sortable: true },
    { header: 'Lifetime Earned', accessor: 'lifetimeearned', sortable: true },
    { header: 'Last Redeemed', accessor: 'lastredeemed', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking reward points earned by patients on billing, and redemption history.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Points Issued</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1.2M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Points Redeemed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>850K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unredeemed Liability</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$3,500</p>
        </div>
      </div>
