...
export default function WellnessPackagesPage() {
  ...
  const columns = [
    ...
    { header: 'Tests Included', accessor: 'testsincluded', sortable: true },
    { header: 'Packages Sold (YTD)', accessor: 'packagessoldytd', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Pre-paid health checkup bundles (e.g., Master Health Check, Cardiac Check).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Packages Sold</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>2,450</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Seller</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Master Health Check</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Package Value</p>
