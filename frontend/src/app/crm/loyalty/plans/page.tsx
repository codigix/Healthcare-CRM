...
export default function MembershipPlansPage() {
  ...
  const columns = [
    { header: 'Plan Name', accessor: 'planname', sortable: true },
    { header: 'Annual Fee', accessor: 'annualfee', sortable: true },
    { header: 'OPD Discount', accessor: 'opddiscount', sortable: true },
    { header: 'Pharmacy Discount', accessor: 'pharmacydiscount', sortable: true },
    { header: 'Active Members', accessor: 'activemembers', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configuration of hospital membership tiers (Silver, Gold, Platinum) and benefits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Gold/Platinum %</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>30%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Renewal Rate</p>
