...
export default function CorporateMembershipPage() {
  ...
  const columns = [
    ...
    { header: 'Employees Covered', accessor: 'employeescovered', sortable: true },
    { header: 'OPD Discount', accessor: 'opddiscount', sortable: true },
    { header: 'IPD Tariff', accessor: 'ipdtariff', sortable: true },
    { header: 'Contract Expiry', accessor: 'contractexpiry', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Special discounted plans configured for employees of partner companies.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Corporate Partners</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Covered Lives</p>
