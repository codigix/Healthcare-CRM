...
export default function EscalationManagementPage() {
  ...
  const columns = [
    ...
    { header: 'Breach Type', accessor: 'breachtype', sortable: true },
    { header: 'Original Assignee', accessor: 'originalassignee', sortable: true },
    { header: 'Escalated To', accessor: 'escalatedto', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Complaints breaching SLA that have auto-escalated to Medical Director or CEO.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Escalated Cases</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">L1 Breaches</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">L2 Breaches (CEO)</p>
