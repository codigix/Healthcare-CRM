...
export default function ComplaintAnalyticsPage() {
  ...
  const columns = [
    { header: 'Root Cause Category', accessor: 'rootcausecategory', sortable: true },
    { header: 'Total Complaints', accessor: 'totalcomplaints', sortable: true },
    { header: 'Trend', accessor: 'trend', sortable: true },
    { header: 'Avg Cost to Resolve', accessor: 'avgcosttoresolve', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Trend analysis to identify systemic issues causing frequent patient dissatisfaction.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Issue</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Wait Times</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Complaint Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0.5% of visits</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cost of Quality</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$2,400 (Mo)</p>
        </div>
      </div>
