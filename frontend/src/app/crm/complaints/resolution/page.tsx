...
export default function ResolutionClosurePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Complaint ID', accessor: 'complaintid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Resolution Type', accessor: 'resolutiontype', sortable: true },
    { header: 'Approved By', accessor: 'approvedby', sortable: true },
    { header: 'Closed Date', accessor: 'closeddate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Finalizing the outcome, providing refunds/apologies, and closing the ticket.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Closed (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Refunds Issued</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$450</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Patient Satisfied %</p>
