...
export default function FAQsKnowledgeBasePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Article ID', accessor: 'articleid', sortable: true },
    { header: 'Question Category', accessor: 'questioncategory', sortable: true },
    { header: 'Views', accessor: 'views', sortable: true },
    { header: 'Usefulness Score', accessor: 'usefulnessscore', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Database of common questions (insurance, visiting hours) used by bots and agents.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bot Deflection Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Needs Update</p>
