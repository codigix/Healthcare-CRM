...
export default function TransportAssistancePage() {
  ...
  const columns = [
    ...
    { header: 'Transport Type', accessor: 'transporttype', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Booking cabs, wheelchairs, or ambulance drops for discharging patients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Requests Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>34</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Wheelchairs in Use</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12/20</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cab Bookings</p>
