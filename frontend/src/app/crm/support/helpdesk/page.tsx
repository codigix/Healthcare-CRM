...
export default function HelpDeskPage() {
  ...
  const columns = [
    { header: 'Ticket ID', accessor: 'ticketid', sortable: true },
    { header: 'Requestor', accessor: 'requestor', sortable: true },
    { header: 'Query Type', accessor: 'querytype', sortable: true },
    { header: 'Assigned Desk', accessor: 'assigneddesk', sortable: true },
    { header: 'Resolution Time', accessor: 'resolutiontime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Physical and virtual information desk for navigation, general queries, and assistance.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Time at Desk</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>3 Mins</p>
        </div>
      </div>
