...
export default function LostFoundPage() {
  ...
  const columns = [
    { header: 'Item ID', accessor: 'itemid', sortable: true },
    { header: 'Description', accessor: 'description', sortable: true },
    { header: 'Found Location', accessor: 'foundlocation', sortable: true },
    { header: 'Found Date', accessor: 'founddate', sortable: true },
    { header: 'Claimed By', accessor: 'claimedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Registry of items misplaced by patients and claimed/returned status.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Items Found (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Items Returned</p>
