...
export default function DigitalPrescriptionPage() {
  ...
  const columns = [
    ...
    { header: 'Drugs Prescribed', accessor: 'drugsprescribed', sortable: true },
    { header: 'Shared Via', accessor: 'sharedvia', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">E-prescriptions generated post-teleconsultation, shared via WhatsApp/App.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">E-Rx Generated</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>40 (Today)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pharmacy Fulfillment</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>65%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Rx</p>
