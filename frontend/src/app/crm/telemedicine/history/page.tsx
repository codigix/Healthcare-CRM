...
export default function TelemedicineHistoryPage() {
  ...
  const columns = [
    ...
    { header: 'Consult Type', accessor: 'consulttype', sortable: true },
    { header: 'Recording Available', accessor: 'recordingavailable', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logs, call recordings, and chat transcripts for medico-legal compliance.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Recordings Stored</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2.5 TB</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Audit Passing</p>
