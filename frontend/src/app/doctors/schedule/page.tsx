...
export default function DoctorSchedulePage() {
   ...
   const columns_0: Column<any>[] = [
      { header: "Patient", accessor: (apt) => (<>\n{apt.patient?.name || "Unknown Patient"}\n</>) },
      { header: "Doctor", accessor: (apt) => (<>\n{apt.doctor?.name || "Unassigned"}\n</>) },
      { header: "Date & Time", accessor: (apt) => (<>\n{new Date(apt.date).toLocaleDateString()}\n{" "}\n\n{formatTime(apt.time)}\n</>) },
      {
         header: "Status", accessor: (apt) => (<>\n<span
            className={`px-2 py-1 rounded-full text-xs font-medium ${apt.status === "completed"
      ...
      <>
         <div className="space-y-6">
            <div className="flex items-center gap-4">
               ...
               <div>
                  <h1 className="text-3xl  mb-2">Doctor Schedule</h1>
                           ...
                           {days.map((day, index) => {
                              ...
                              return (
                                 <button
                                    ...
                                    className={`aspect-square flex items-center justify-center text-mdrounded transition-colors ${day === null
                                       ? "invisible"
                                       : isSelected
                  ...
                  <div className="card">
                     <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex gap-2">
                           <button
                              onClick={() => setView("day")}
                              className={`p-2 rounded transition-colors ${view === "day"
                           ...
                           <button
                              ...
                              className={`p-2 rounded transition-colors ${view === "week"
                                 ? "bg-emerald-500 text-white"
                                 : "bg-dark-tertiary hover:bg-dark-tertiary/80"
                                 }`}
                           >
                           ...
                           <button
                              ...
                              className={`p-2 rounded transition-colors ${view === "month"
                                 ? "bg-emerald-500 text-white"
                                 : "bg-dark-tertiary hover:bg-dark-tertiary/80"
                                 }`}
                           >
                     ...
                     {loading ? (
                                       ...
                                       {appointmentsAtTime.length > 0 ? (
                                          <div className="space-y-2">
                                             {appointmentsAtTime.map((appointment) => (
                                                <div
                                                   key={appointment.id}
                                                   className={`p-4 rounded border-l-4 ${appointment.status === "emergency"
                                                ...
                                                >
                                                   <div className="flex items-start justify-between">
                                                      ...
                                                      <span
                                                         className={`px-3 py-1 rounded-full text-xs font-medium ${appointment.status === "completed"
                                                            ? "bg-emerald-500/20 text-emerald-500"
                                                            : "bg-blue-500/20 text-blue-500"
                                                            }`}
                                                      >
                                          ...
                                          <div className="text-center py-4 text-gray-500 text-mdborder border-dashed border-dark-tertiary rounded">
                                             No appointments
                                          </div>
                                       )}
                                    </div>
                           ...
                           {getWeekDates().map((date) => {
                              ...
                              return (
                                 <div
                                    ...
                                    className={`p-3 rounded border ${isToday
                                 ...
                                 >
                                    <div className="text-center mb-3">
                                       ...
                                       <p
                                          className={`text-mdfont-semibold ${isToday ? "text-emerald-500" : ""
                                             }`}
                                       >
                                          {dayNum}
                                       </p>
                           ...
                           <div className="grid grid-cols-7 gap-1">
                              ...
                              {days.map((day, index) => {
                                 ...
                                 return (
                                    <div
                                       key={index}
                                       className={`aspect-square p-2 rounded border transition-colors ${day === null
                                          ? "invisible"
                                          : dateAppointments.length > 0
                        ...
                        <div className="overflow-x-auto">
                           <DataTable columns={columns_0} data={appointments} enableLocalSearch enableLocalPagination />
                        </div>
                     )}
                  </div>
               </div>
