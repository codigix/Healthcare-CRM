...
export default function RegistrationReportsPage() {
  ...
  const columns = [
    ...
    { header: 'Total Registrations', accessor: 'totalregistrations', sortable: true },
    { header: 'Online', accessor: 'online', sortable: true },
    { header: 'Walk-in', accessor: 'walkin', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analytics on new patient registrations and demographics.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Registrations (MTD)</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Online Share</p>
