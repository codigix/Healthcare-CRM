...
export default function ReceptionPerformancePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Staff Name', accessor: 'staffname', sortable: true },
    { header: 'Patients Handled', accessor: 'patientshandled', sortable: true },
    { header: 'Avg Registration Time', accessor: 'avgregistrationtime', sortable: true },
    { header: 'Calls Answered', accessor: 'callsanswered', sortable: true },
    { header: 'Feedback Score', accessor: 'feedbackscore', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">KPIs and metrics for front desk staff efficiency.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Reg Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>3m 45s</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Handled</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,240</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Satisfaction</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4.8/5.0</p>
        </div>
      </div>
