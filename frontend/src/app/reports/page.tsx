            ...
            <div className="space-y-8">
                        ...
                        return (
                            ...
                            >
                                <div className="flex justify-between items-start mb-4">
                                    <div
                                        className={`p-3 rounded bg-dark-tertiary group-hover:bg-dark-secondary transition-colors`}
                                    >
                                ...
                                <p className="text-gray-400 text-mdmb-4">
                                    {report.description}
                                </p>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className="card">
                            <p className="text-gray-400 text-mdmb-2">Total Appointments</p>
                            <h3 className="text-3xl  text-blue-500">1,248</h3>
                        ...
                        <div className="card">
                            ...
                            <h3 className="text-3xl  text-emerald-500">₹1.28L</h3>
                            <p className="text-xs text-emerald-500 mt-2">
                                +15.2% from last month
                            </p>
                        </div>
                        <div className="card">
                            <p className="text-gray-400 text-mdmb-2">Inventory Items</p>
                            <h3 className="text-3xl  text-purple-500">1,245</h3>
                            <p className="text-xs text-emerald-500 mt-2">
                                +28 items this month
                            </p>
                        </div>
                        <div className="card">
                            <p className="text-gray-400 text-mdmb-2">Patient Visits</p>
                            <h3 className="text-3xl  text-yellow-500">3,842</h3>
                            <p className="text-xs text-emerald-500 mt-2">
