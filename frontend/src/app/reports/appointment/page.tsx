...
export default function AppointmentReportsPage() {
  ...
  const appointmentStatus = [
    { name: "Completed", value: 70, fill: "rgb(26, 188, 156)" },
    { name: "Scheduled", value: 8, fill: "rgb(132, 149, 171)" },
    { name: "Cancelled", value: 15, fill: "rgb(241, 92, 108)" },
    { name: "No-Show", value: 7, fill: "rgb(241, 92, 108)" },
  ];
