...
export default function PatientVisitReportsPage() {
  ...
  const visitStats = [
    {
      label: "Total Visits",
      value: "3,842",
      change: "+18.3% from previous period",
      color: "text-blue-500",
    ...
    },
    {
      ...
      value: "32 min",
      change: "-3.4 min from previous period",
  ...
  const visitTypeDistribution = [
    ...
    { name: "Consultation", value: 35, fill: "#1abc9c" },
    { name: "Check-up", value: 15, fill: "#f59e0b" },
    { name: "Emergency", value: 5, fill: "#ef4444" },
  ];

  const visitOutcomes = [
    { name: "Discharged", value: 50, fill: "#1abc9c" },
    ...
    <>
      <div className="space-y-6">
        <div className="flex justify-between items-center my-3 my-3">
          <div>
            <h1 className="text-3xl  mb-2">Patient Visit Report</h1>
          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="card">
                ...
                <p className="text-mdtext-gray-400 mb-4">
