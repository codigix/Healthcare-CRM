...
export default function AdmissionDischargeReportsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Period', accessor: 'period', sortable: true },
    { header: 'Total Admissions', accessor: 'totaladmissions', sortable: true },
    { header: 'Total Discharges', accessor: 'totaldischarges', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Trends and statistics on hospital admissions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Admissions (MTD)</p>
