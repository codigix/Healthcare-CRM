...
export default function MortalityMorbidityMMPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Report ID', accessor: 'reportid', sortable: true },
    { header: 'Case Type', accessor: 'casetype', sortable: true },
    { header: 'Date of Event', accessor: 'dateofevent', sortable: true },
    { header: 'Primary Cause', accessor: 'primarycause', sortable: true },
    { header: 'Reviewed By', accessor: 'reviewedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Confidential reporting for M&M conferences and clinical governance.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Mortality Rate (ICU)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">M&M Meetings Held</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>2 (Month)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Action Items Open</p>
