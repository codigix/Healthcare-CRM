...
export default function CriticalCareMetricsAPACHESOFAPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Month', accessor: 'month', sortable: true },
    { header: 'Avg APACHE II', accessor: 'avgapacheii', sortable: true },
    { header: 'Avg SOFA', accessor: 'avgsofa', sortable: true },
    { header: 'Predicted Mortality', accessor: 'predictedmortality', sortable: true },
    { header: 'Actual Mortality', accessor: 'actualmortality', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Critical Care Metrics (APACHE/SOFA)
          </h1>
          <p className="text-sm text-gray-400 mt-1">Analysis of patient severity scores and predicted vs actual outcomes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg APACHE II</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>18</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SMR (Standardized Mortality Ratio)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0.85</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Data Completeness</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>99%</p>
        </div>
      </div>
