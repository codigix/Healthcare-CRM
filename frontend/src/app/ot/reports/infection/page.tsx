...
export default function InfectionControlReportPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Month', accessor: 'month', sortable: true },
    { header: 'SSI Rate', accessor: 'ssirate', sortable: true },
    { header: 'CLABSI Rate', accessor: 'clabsirate', sortable: true },
    { header: 'CAUTI Rate', accessor: 'cautirate', sortable: true },
    { header: 'Hand Hygiene Compliance', accessor: 'handhygienecompliance', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking Surgical Site Infections (SSI), CLABSI, and CAUTI in critical care.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SSI Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0.8%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">CLABSI (per 1k days)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0.5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Hand Hygiene</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>95%</p>
        </div>
      </div>
