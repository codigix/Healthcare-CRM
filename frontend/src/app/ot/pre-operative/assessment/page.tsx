...
export default function SurgeryAssessmentPage() {
  ...
  const columns = [
    ...
    { header: 'ASA Grade', accessor: 'asagrade', sortable: true },
    { header: 'Assessed By', accessor: 'assessedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Pre-admission screening and surgical risk assessments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Assessments</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>14</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cleared for Surgery</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>30</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Risk Cases</p>
