...
export default function LiveVitalsBoardPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Unit/Bed', accessor: 'unitbed', sortable: true },
    ...
    { header: 'SpO2 / Resp Rate', accessor: 'spo2resprate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Centralized live feed of patient monitors across all critical care units.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Monitors Online</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>64/64</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Alarms</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Arrhythmias Detected</p>
