...
export default function CRRTDialysisPage() {
  ...
  const columns = [
    ...
    { header: 'Blood Flow (Qb)', accessor: 'bloodflowqb', sortable: true },
    { header: 'Fluid Removal Rate', accessor: 'fluidremovalrate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Continuous Renal Replacement Therapy and bedside hemodialysis monitoring.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active CRRT</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bedside HD Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Filter Clot Alarms</p>
