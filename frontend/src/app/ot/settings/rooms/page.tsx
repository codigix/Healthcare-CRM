...
export default function OTRoomsConfigurationPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Room Name', accessor: 'roomname', sortable: true },
    { header: 'Type', accessor: 'type', sortable: true },
    { header: 'Positive Pressure', accessor: 'positivepressure', sortable: true },
    { header: 'Specialized For', accessor: 'specializedfor', sortable: true },
    { header: 'Max Capacity', accessor: 'maxcapacity', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configure theater capabilities, positive pressure, and specialized equipment.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total OTs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Modular OTs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cath Lab</p>
