...
export default function SurgeryTypesCodesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Surgery Code', accessor: 'surgerycode', sortable: true },
    { header: 'Description', accessor: 'description', sortable: true },
    { header: 'Specialty', accessor: 'specialty', sortable: true },
    { header: 'Standard Duration', accessor: 'standardduration', sortable: true },
    { header: 'Base Price', accessor: 'baseprice', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Master list of surgical procedures, CPT codes, and standard durations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Recently Added</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inactive Codes</p>
