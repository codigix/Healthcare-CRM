...
export default function IntakeOutputIOPage() {
  ...
  const columns = [
    ...
    { header: 'Total Intake (24h)', accessor: 'totalintake24h', sortable: true },
    { header: 'Total Output (24h)', accessor: 'totaloutput24h', sortable: true },
    { header: 'Net Balance', accessor: 'netbalance', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hourly tracking of all fluids in (IV, feeds) and out (urine, drains, NG).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Hourly I/O Logged</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>100%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Positive Balance > 1L</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Oliguria Alerts</p>
