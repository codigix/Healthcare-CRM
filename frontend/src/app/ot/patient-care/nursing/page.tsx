...
export default function NursingCareNotesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Entry ID', accessor: 'entryid', sortable: true },
    { header: 'Bed ID', accessor: 'bedid', sortable: true },
    { header: 'Nurse', accessor: 'nurse', sortable: true },
    { header: 'GCS Score', accessor: 'gcsscore', sortable: true },
    { header: 'Pain Score', accessor: 'painscore', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hourly nursing assessments, interventions, and GCS charting.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Hourly Notes Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>98%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overdue Notes</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Entries</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>480</p>
        </div>
      </div>
