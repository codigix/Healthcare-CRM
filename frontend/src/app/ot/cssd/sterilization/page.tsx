...
export default function InstrumentSterilizationPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Batch ID', accessor: 'batchid', sortable: true },
    { header: 'Instrument Set', accessor: 'instrumentset', sortable: true },
    { header: 'Received From', accessor: 'receivedfrom', sortable: true },
    { header: 'Cleaning Method', accessor: 'cleaningmethod', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Central Sterile Services Department (CSSD) processing and decontamination.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Sets in Process</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>14</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Sterilized Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rejected/Damaged</p>
