...
export default function AutoclaveCycleLogPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Cycle ID', accessor: 'cycleid', sortable: true },
    { header: 'Machine', accessor: 'machine', sortable: true },
    { header: 'Load Type', accessor: 'loadtype', sortable: true },
    { header: 'Temp/Pressure', accessor: 'temppressure', sortable: true },
    { header: 'Validation Test', accessor: 'validationtest', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Validation logs (Bowie-Dick, Biological indicators) for sterilizers.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cycles Today</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Failed/Aborted</p>
