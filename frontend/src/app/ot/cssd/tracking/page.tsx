...
export default function OTInstrumentTrackingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Set ID', accessor: 'setid', sortable: true },
    { header: 'Set Name', accessor: 'setname', sortable: true },
    { header: 'Checked Out To', accessor: 'checkedoutto', sortable: true },
    { header: 'Time Out', accessor: 'timeout', sortable: true },
    { header: 'Time In', accessor: 'timein', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            OT Instrument Tracking
          </h1>
          <p className="text-sm text-gray-400 mt-1">Barcode/RFID tracking of instruments from CSSD to OT and back.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Sets in OT</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Returned to CSSD</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>18</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missing Items</p>
