...
export default function EquipmentUtilizationPage() {
  ...
  const columns = [
    { header: 'Equipment Category', accessor: 'equipmentcategory', sortable: true },
    { header: 'Total Assets', accessor: 'totalassets', sortable: true },
    { header: 'In Use', accessor: 'inuse', sortable: true },
    { header: 'Utilization %', accessor: 'utilization', sortable: true },
    { header: 'Maintenance Down', accessor: 'maintenancedown', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking usage rates for ventilators, ECMO, IABP, and dialysis machines.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Ventilator Utilization</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>65%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ECMO Active</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Equipment Shortage Alerts</p>
