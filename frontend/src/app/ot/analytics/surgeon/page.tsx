...
export default function SurgeonPerformancePage() {
  ...
  const columns = [
    { header: 'Surgeon Name', accessor: 'surgeonname', sortable: true },
    { header: 'Total Cases', accessor: 'totalcases', sortable: true },
    { header: 'Avg Duration vs Expected', accessor: 'avgdurationvsexpected', sortable: true },
    { header: 'Complications', accessor: 'complications', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analytics on individual surgeon volume, average duration, and outcomes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Volume Surgeon</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Dr. Grey</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Duration Variance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>+5 mins</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall SSI Rate</p>
