...
export default function BedsideProcedureOrdersPage() {
  ...
  const columns = [
    ...
    { header: 'Consent Status', accessor: 'consentstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Bedside Procedure Orders
          </h1>
          <p className="text-sm text-gray-400 mt-1">Orders for central line insertion, intubation, tracheostomy, etc.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Procedures</p>
