...
export default function PendingOrdersPage() {
  ...
  const columns = [
    ...
    { header: 'Bed/OT', accessor: 'bedot', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">New orders placed by intensivists and surgeons that require nursing action.</p>
        </div>
