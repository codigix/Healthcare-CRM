...
export default function AnesthesiaPlanPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Plan ID', accessor: 'planid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Induction Agents', accessor: 'inductionagents', sortable: true },
    { header: 'Maintenance', accessor: 'maintenance', sortable: true },
    { header: 'Analgesia Plan', accessor: 'analgesiaplan', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Pre-defined protocols for drug administration and pain management.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Plans Created</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Deviations</p>
