...
export default function IntraOpAnesthesiaAssessmentPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Log ID', accessor: 'logid', sortable: true },
    { header: 'Surgery ID', accessor: 'surgeryid', sortable: true },
    { header: 'Anesthesia Type', accessor: 'anesthesiatype', sortable: true },
    { header: 'Airway Device', accessor: 'airwaydevice', sortable: true },
    { header: 'BIS Index', accessor: 'bisindex', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Intra-Op Anesthesia Assessment
          </h1>
          <p className="text-sm text-gray-400 mt-1">Continuous logging of patient condition and depth of anesthesia.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">General Anesthesia</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Regional/Spinal</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">MAC/Sedation</p>
