...
export default function OTAllocationStaffingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'OT Room', accessor: 'otroom', sortable: true },
    { header: 'Scrub Nurse', accessor: 'scrubnurse', sortable: true },
    { header: 'Circulating Nurse', accessor: 'circulatingnurse', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            OT Allocation & Staffing
          </h1>
          <p className="text-sm text-gray-400 mt-1">Assignment of nurses, scrub techs, and support staff to specific rooms.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Staff on Duty</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rooms Fully Staffed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>8/8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Relief Needed</p>
