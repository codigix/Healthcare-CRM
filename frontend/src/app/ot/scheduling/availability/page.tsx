...
export default function OTAvailabilityPage() {
  ...
  const columns = [
    ...
    { header: 'Current Surgery', accessor: 'currentsurgery', sortable: true },
    { header: 'Next Scheduled', accessor: 'nextscheduled', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Real-time dashboard showing occupied and available operation theaters.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Currently Active</p>
