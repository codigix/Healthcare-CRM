...
export default function IntensiveCareUnitICUPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Bed ID', accessor: 'bedid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Admission Diagnosis', accessor: 'admissiondiagnosis', sortable: true },
    { header: 'Acuity Level', accessor: 'acuitylevel', sortable: true },
    { header: 'Days in ICU', accessor: 'daysinicu', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Central dashboard for general adult intensive care patients.</p>
        </div>
