...
export default function InternalBedTransfersPage() {
  ...
  const columns = [
    ...
    { header: 'From Bed', accessor: 'frombed', sortable: true },
    { header: 'To Bed', accessor: 'tobed', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Internal Bed Transfers
          </h1>
          <p className="text-sm text-gray-400 mt-1">Reallocating beds within the same critical care unit.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bed Swaps Today</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Cleaning</p>
