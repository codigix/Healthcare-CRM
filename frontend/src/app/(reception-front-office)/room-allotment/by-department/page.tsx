        ...
        <>
            <div className="space-y-6 pb-20">
                ...
                <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                    <div className="bg-dark-secondary border border-dark-tertiary rounded5 shadow-sm">
                ...
                <div className="bg-dark-secondary border border-dark-tertiary rounded6 shadow-md space-y-6">
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-16 text-gray-500 text-sm italic border border-dashed border-dark-tertiary/50 rounded
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-2">
                            {filteredRooms.map((room) => {
                                ...
                                return (
                                    <div
                                        key={room.id}
                                        className="bg-dark-tertiary/15 border border-dark-tertiary/70 rounded5 space-y-4 hover:border-dark-tertiary transition-all shadow-sm hover:shadow-lg relative flex flex-col justify-between"
                                    >
            ...
            {selectedBedDetails && (
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 animate-fadeIn">
                    <div className="bg-dark-secondary border border-dark-tertiary rounded6 w-full max-w-sm shadow-xl space-y-4">
