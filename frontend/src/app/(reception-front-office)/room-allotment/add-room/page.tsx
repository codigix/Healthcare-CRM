            ...
            <div className="space-y-6 pb-20">
                ...
                <div className="flex items-center gap-4 border-b border-dark-tertiary/40 pb-5">
                    <Link href="/room-allotment/by-department">
                        <button className="p-2.5 hover:bg-dark-tertiary roundedansition-colors border border-dark-tertiary bg-dark-tertiary/20">
                            <ChevronLeft size={15} className="text-gray-400" />
                        </button>
                    </Link>
                    <div>
                        <h1 className="text-3xl  text-white font-outfit">Add Clinical Room & Ward</h1>
                        <p className="text-gray-400 mt-1 text-xs">Configure a multi-specialty ward structure with automatic bed generation</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8 max-w-5xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-dark-secondary border border-dark-tertiary rounded6 shadow-md space-y-4">
                            <div className="flex items-center gap-2 border-b border-dark-tertiary/60 pb-3">
                                <LayoutGrid className="text-emerald-400" size={16} />
                                <h2 className="text-sm  text-white uppercase tracking-wider">SECTION 1 — Department Mapping</h2>
                            </div>
                            ...
                            <div className="space-y-4">
                                    ...
                                    <div className="relative" ref={deptDropdownRef}>
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-9 pr-4 py-2 bg-dark-tertiary border border-dark-tertiary/75 rounded text-xs text-white focus:outline-none focus:border-emerald-500 h-[38px] font-semibold"
                                            />
                                        </div>
                                        {showDeptDropdown && (
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full p-2.5 bg-dark-tertiary border border-dark-tertiary/75 rounded text-xs text-white focus:outline-none focus:border-emerald-500 h-[38px] font-semibold"
                                    >
                        ...
                        <div className="bg-dark-secondary border border-dark-tertiary rounded6 shadow-md space-y-4">
                            <div className="flex items-center gap-2 border-b border-dark-tertiary/60 pb-3">
                                <LayoutGrid className="text-emerald-400" size={16} />
                                <h2 className="text-sm  text-white uppercase tracking-wider">SECTION 2 — Room Information</h2>
                            </div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full p-2 bg-dark-tertiary border border-dark-tertiary/75 rounded text-xs text-white placeholder-gray-500 focus:outline-none focus:border-emerald-500 h-[38px]"
                                        />
                                    </div>
                    ...
                    <div className="bg-dark-secondary border border-dark-tertiary rounded6 shadow-md space-y-4">
                        <div className="flex items-center gap-2 border-b border-dark-tertiary/60 pb-3">
                            ...
                            <h2 className="text-sm  text-white uppercase tracking-wider">SECTION 3 — Bed Configuration (Real-time Preview)</h2>
                        </div>

                        {generatedBeds.length === 0 ? (
                            <div className="text-center py-6 border border-dashed border-dark-tertiary/60 rounded-dark-tertiary/10 text-gray-500 text-xs italic">
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5">
                                    {generatedBeds.map((bed, idx) => {
                                        ...
                                        return (
                                            <div
                                                key={bed.id}
                                                className="bg-dark-tertiary/20 border border-dark-tertiary p-4 roundedex flex-col justify-between items-center text-center gap-3 animate-fadeIn"
                                            >
                                                ...
                                                <div>
                                                    <span className="text-xs  text-white block truncate max-w-full font-mono">{bed.label}</span>
                                                    <span className="text-[9px] text-gray-500 block uppercase tracking-widest mt-0.5">Bed Suffix: {alphabeticalBeds[idx]}</span>
                                                </div>

                                                <div className="w-full">
                                                    <label className="block text-[8px]  text-gray-500 uppercase tracking-widest text-left mb-1">Status</label>
                                                    <select
                                                        value={currentStatus}
                                                        onChange={(e) => handleBedStatusChange(bed.id, e.target.value)}
                                                        className="w-full px-2 py-1 bg-dark-secondary border border-dark-tertiary rounded text-[10px] text-emerald-400  focus:outline-none focus:border-emerald-500 focus:text-white shrink-0"
                                                    >
                                ...
                                <p className="text-[10px] text-emerald-400 flex items-center gap-1.5 font-semibold bg-emerald-500/5 p-2 rounded border border-emerald-500/10 max-w-fit">
                                    <ShieldCheck size={13} />
                    ...
                    <div className="bg-dark-secondary border border-dark-tertiary rounded6 shadow-md space-y-4">
                        <div className="flex items-center gap-2 border-b border-dark-tertiary/60 pb-3">
                            ...
                            <h2 className="text-sm  text-white uppercase tracking-wider">SECTION 4 — Medical Facilities Checklist</h2>
                        </div>

                        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">

                            <label className="flex items-center gap-2 cursor-pointer hover:bg-dark-tertiary/20 p-2.5 rounded border border-transparent hover:border-dark-tertiary/40 transition-all group">
                                <input
                                    type="checkbox"
                                    name="oxygenSupply"
                    ...
                    <div className="bg-dark-secondary border border-dark-tertiary rounded6 shadow-md space-y-4">
                        <div className="flex items-center gap-2 border-b border-dark-tertiary/60 pb-3">
                            ...
                            <h2 className="text-sm  text-white uppercase tracking-wider">SECTION 5 — Additional Notes & Directives</h2>
                        </div>
                        <textarea
                            ...
                            rows={4}
                            className="w-full p-2 bg-dark-tertiary border border-dark-tertiary/75 rounded text-xs text-white placeholder-gray-500 focus:outline-none focus:border-emerald-500 resize-none font-sans"
                        />
                    </div>
                    ...
                    <div className="flex gap-4 justify-end pt-4">
                        <Link href="/room-allotment/by-department">
                            <button
                                type="button"
                                className="px-6 py-2.5 bg-dark-tertiary hover:bg-dark-tertiary/70 text-gray-300 rounded transition-colors text-xs  border border-dark-tertiary/40 shadow-sm"
                            >
                                Cancel
                            </button>
                        </Link>
                        <button
                            type="submit"
                            disabled={submitting}
                            className="px-6 py-2.5 bg-emerald-500 hover:bg-emerald-600 disabled:bg-gray-600 text-white rounded transition-all text-xs  flex items-center gap-1.5 shadow shadow-emerald-500/10 active:scale-95"
                        >
                            <Check size={14} />
