...
export default function AdmissionRoomAllotmentPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Allotment ID', accessor: 'allotmentid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Requested Type', accessor: 'requestedtype', sortable: true },
    { header: 'Assigned Room', accessor: 'assignedroom', sortable: true },
    { header: 'Allotted By', accessor: 'allottedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Admission Room Allotment
          </h1>
          <p className="text-sm text-gray-400 mt-1">Assign and allocate rooms for new inbound admissions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Allotments</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>14</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rooms Allotted</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>86</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Waitlist</p>
