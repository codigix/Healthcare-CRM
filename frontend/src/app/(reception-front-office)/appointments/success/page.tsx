        ...
        <>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <h1 className="text-3xl ">Appointment Confirmation</h1>
                    <div className="w-10" />
                </div>
                ...
                <div className="card border-2 border-emerald-500/30 bg-emerald-500/5">
                    <div className="flex items-center justify-center gap-3 mb-6">
                        ...
                        <div>
                            <h2 className="text-2xl  text-emerald-500">Appointment Successfully Booked!</h2>
                        ...
                        <div className="space-y-4">
                            ...
                            {appointment.tokenNumber && (
                                <div className="flex justify-between items-start">
                                    ...
                                    <span className="text-2xl  text-emerald-500">{appointment.tokenNumber}</span>
                                </div>
                            )}
