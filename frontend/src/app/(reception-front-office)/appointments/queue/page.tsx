...
export default function LivePatientQueuePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Queue No', accessor: 'queueno', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Doctor', accessor: 'doctor', sortable: true },
    { header: 'Est Wait Time', accessor: 'estwaittime', sortable: true },
    { header: 'Check-in Time', accessor: 'checkintime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monitor the live waiting room and ongoing consultations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Consulting Now</p>
