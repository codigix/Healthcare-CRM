...
export default function ApprovalCenterPage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    requestid: `${'Approval Center'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    type: `Sample ${'Approval Center'} ${i + 1}`,
    requestedby: `Sample Data ${i + 1}`,
    date: `Sample Data ${i + 1}`,
    priority: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Pending approvals and requests.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-amber-400">86</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
      ...
      <div className="my-3">
        <div className="p-4 border-b border-gray-800 flex justify-between items-center my-3 my-3 bg-dark-tertiary/20">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search approval center..."
              value={searchTerm}
