...
export default function CommunicationCenterPage() {
  ...
  const columns = [
    ...
    { header: 'Sender', accessor: 'sender', sortable: true },
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    messageid: `${'Communication Center'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    subject: `Sample ${'Communication Center'} ${i + 1}`,
    sender: `Sample Data ${i + 1}`,
    recipient: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Internal hospital communication.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Announcements</p>
      ...
      <div className="my-3">
        <div className="p-4 border-b border-gray-800 flex justify-between items-center my-3 my-3 bg-dark-tertiary/20">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search communication center..."
              value={searchTerm}
