...
export default function InternationalPatientsPage() {
  ...
  const columns = [
    ...
    { header: 'Visa Expiry', accessor: 'visaexpiry', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage patients traveling from overseas for medical tourism.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">International Patients</p>
          <p className="text-2xl  mt-2 text-indigo-400">45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Arrivals This Week</p>
          <p className="text-2xl  mt-2 text-emerald-400">8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Visa Issues</p>
