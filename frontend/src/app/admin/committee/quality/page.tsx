...
export default function QualityCommitteePage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    auditid: `${'Quality Committee'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    department: `Sample ${'Quality Committee'} ${i + 1}`,
    audittype: `Sample Data ${i + 1}`,
    score: `Sample Data ${i + 1}`,
    findings: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hospital quality assurance and standards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Quality</p>
          <p className="text-2xl  mt-2 text-emerald-400">96%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Audits</p>
          <p className="text-2xl  mt-2 text-amber-400">3</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Corrective Actions</p>
          <p className="text-2xl  mt-2 text-red-400">8</p>
        </div>
      </div>
