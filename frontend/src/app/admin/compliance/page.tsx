...
export default function CompliancePage() {
  ...
  const columns = [
    ...
    { header: 'Regulation', accessor: 'regulation', sortable: true },
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Last Audit', accessor: 'lastaudit', sortable: true },
    { header: 'Next Audit', accessor: 'nextaudit', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => (
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    recordid: `${'Compliance'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    regulation: `Sample ${'Compliance'} ${i + 1}`,
    category: `Sample Data ${i + 1}`,
    lastaudit: `Sample Data ${i + 1}`,
    nextaudit: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Regulatory and compliance tracking.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Upcoming Audits</p>
