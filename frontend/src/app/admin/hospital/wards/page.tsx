...
export default function WardManagementPage() {
  ...
  const columns = [
    { header: 'Ward ID', accessor: 'wardid', sortable: true },
    { header: 'Ward Name', accessor: 'wardname', sortable: true },
    { header: 'Floor', accessor: 'floor', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage inpatient wards and nursing stations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Wards</p>
          <p className="text-2xl  mt-2 text-blue-400">36</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">General Wards</p>
          <p className="text-2xl  mt-2 text-indigo-400">24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ICUs</p>
