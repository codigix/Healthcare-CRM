...
export default function FloorManagementPage() {
  ...
  const columns = [
    { header: 'Floor ID', accessor: 'floorid', sortable: true },
    { header: 'Floor Name', accessor: 'floorname', sortable: true },
    { header: 'Building', accessor: 'building', sortable: true },
    { header: 'Primary Dept', accessor: 'primarydept', sortable: true },
    { header: 'Zone Type', accessor: 'zonetype', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => (
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage floor layouts and department zoning.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Floors Managed</p>
          <p className="text-2xl  mt-2 text-blue-400">48</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Clinical Floors</p>
          <p className="text-2xl  mt-2 text-emerald-400">32</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Restricted Zones</p>
          <p className="text-2xl  mt-2 text-red-400">5</p>
        </div>
      </div>
