...
export default function NotificationPreferencesPage() {
  ...
  const columns = [
    { header: 'Notification Type', accessor: 'notificationtype', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configure global email and SMS alerts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Email Alerts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Enabled</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SMS Gateway</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Connected</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Push Service</p>
