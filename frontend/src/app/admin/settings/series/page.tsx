...
export default function IDSeriesPrefixesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Entity', accessor: 'entity', sortable: true },
    { header: 'Prefix', accessor: 'prefix', sortable: true },
    { header: 'Padding', accessor: 'padding', sortable: true },
    { header: 'Current Sequence', accessor: 'currentsequence', sortable: true },
    { header: 'Example', accessor: 'example', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configure prefixes for auto-generated IDs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Custom Series</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Sequences</p>
