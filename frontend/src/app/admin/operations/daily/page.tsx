...
export default function DailyOperationsPage() {
  ...
  const columns = [
    { header: 'Task Name', accessor: 'taskname', sortable: true },
    { header: 'Assigned Dept', accessor: 'assigneddept', sortable: true },
    { header: 'Check Time', accessor: 'checktime', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Day-to-day operational overview and checklists.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Tasks Today</p>
