...
export default function EmployeeAdministrationPage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    empid: `${'Employee Administration'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    name: `Sample ${'Employee Administration'} ${i + 1}`,
    role: `Sample Data ${i + 1}`,
    department: `Sample Data ${i + 1}`,
    shift: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage hospital staff and records.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-blue-400">1,450</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">On Duty</p>
          <p className="text-2xl  mt-2 text-emerald-400">420</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">On Leave</p>
          <p className="text-2xl  mt-2 text-amber-400">35</p>
        </div>
      </div>
      ...
      <div className="my-3">
        <div className="p-4 border-b border-gray-800 flex justify-between items-center my-3 my-3 bg-dark-tertiary/20">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search employee administration..."
              value={searchTerm}
