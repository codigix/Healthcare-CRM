...
export default function DutyAssignmentPage() {
  ...
  const columns = [
    { header: 'Duty ID', accessor: 'dutyid', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage daily duty rosters and shift timings.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Staff on Duty Today</p>
          <p className="text-2xl  mt-2 text-blue-400">450</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Night Shift Staff</p>
          <p className="text-2xl  mt-2 text-indigo-400">120</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Call Outs</p>
          <p className="text-2xl  mt-2 text-red-400">14</p>
        </div>
      </div>
