    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage functional units within departments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-blue-400">124</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Occupied</p>
          <p className="text-2xl  mt-2 text-amber-400">98</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
