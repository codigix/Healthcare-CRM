...
export default function IncidentManagementPage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    incidentid: `${'Incident Management'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    type: `Sample ${'Incident Management'} ${i + 1}`,
    location: `Sample Data ${i + 1}`,
    reportedby: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Track and resolve hospital incidents.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-red-400">42</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unresolved</p>
          <p className="text-2xl  mt-2 text-amber-400">8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Resolved</p>
          <p className="text-2xl  mt-2 text-emerald-400">34</p>
        </div>
      </div>
      ...
      <div className="my-3">
        <div className="p-4 border-b border-gray-800 flex justify-between items-center my-3 my-3 bg-dark-tertiary/20">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search incident management..."
              value={searchTerm}
