...
export default function IncidentReportsPage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    incidentid: `${'Incident Reports'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    category: `Sample ${'Incident Reports'} ${i + 1}`,
    location: `Sample Data ${i + 1}`,
    severity: `Sample Data ${i + 1}`,
    reporteddate: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Log and track all hospital incidents.</p>
        </div>
