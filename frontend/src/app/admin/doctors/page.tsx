...
export default function DoctorAdministrationPage() {
  ...
  const columns = [
    { header: 'Dr ID', accessor: 'drid', sortable: true },
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    drid: `${'Doctor Administration'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    name: `Sample ${'Doctor Administration'} ${i + 1}`,
    specialization: `Sample Data ${i + 1}`,
    department: `Sample Data ${i + 1}`,
    consultationfee: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage doctors and specialists.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-indigo-400">320</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Available</p>
          <p className="text-2xl  mt-2 text-emerald-400">145</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
      ...
      <div className="my-3">
        <div className="p-4 border-b border-gray-800 flex justify-between items-center my-3 my-3 bg-dark-tertiary/20">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search doctor administration..."
              value={searchTerm}
