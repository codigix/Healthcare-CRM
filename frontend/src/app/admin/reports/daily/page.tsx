...
export default function DailyHospitalReportPage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    reportid: `${'Daily Hospital Report'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    date: `Sample ${'Daily Hospital Report'} ${i + 1}`,
    generatedby: `Sample Data ${i + 1}`,
    totaladmissions: `Sample Data ${i + 1}`,
    totaldischarges: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Daily operational reports.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-purple-400">+44</p>
        </div>
      </div>
      ...
      <div className="my-3">
        <div className="p-4 border-b border-gray-800 flex justify-between items-center my-3 my-3 bg-dark-tertiary/20">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search daily hospital report..."
              value={searchTerm}
