...
export default function PolicySOPManagementPage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    policyid: `${'Policy & SOP Management'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    title: `Sample ${'Policy & SOP Management'} ${i + 1}`,
    category: `Sample Data ${i + 1}`,
    lastupdated: `Sample Data ${i + 1}`,
    version: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hospital policies and standard operating procedures.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Updates Needed</p>
      ...
      <div className="my-3">
        <div className="p-4 border-b border-gray-800 flex justify-between items-center my-3 my-3 bg-dark-tertiary/20">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search policy & sop management..."
              value={searchTerm}
