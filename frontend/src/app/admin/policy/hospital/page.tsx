...
export default function HospitalPoliciesPage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    policyid: `${'Hospital Policies'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    title: `Sample ${'Hospital Policies'} ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Core hospital-wide policies.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">New Drafts</p>
