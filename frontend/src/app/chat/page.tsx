          ...
          <div className="p-4 space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-dark-tertiary rounded-lg text-mdtext-gray-300 placeholder-gray-500 border border-dark-secondary focus:border-emerald-500 outline-none"
              />
            </div>
            <div className="flex gap-2">
              <button className="px-4 py-2 rounded-lg text-mdfont-medium text-gray-300 hover:bg-dark-tertiary transition-colors">
                All
              </button>
              <button className="px-4 py-2 rounded-lg text-mdfont-medium text-gray-300 hover:bg-dark-tertiary transition-colors">
                Unread
