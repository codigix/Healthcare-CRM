...
export default function InfectionAnalyticsPage() {
  ...
  const columns = [
    { header: 'Infection Type', accessor: 'infectiontype', sortable: true },
    { header: 'Incidents (MTD)', accessor: 'incidentsmtd', sortable: true },
    { header: 'Rate / 1000 Days', accessor: 'rate1000days', sortable: true },
    { header: 'Benchmark', accessor: 'benchmark', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hospital-Acquired Infection (HAI) rates, including CAUTI, CLABSI, and SSI.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall HAI Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>2.4%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Zero Infection Days</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Antibiotic Usage</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>High</p>
        </div>
      </div>
