...
export default function MortalityAnalysisPage() {
  ...
  const columns = [
    ...
    { header: 'Total Deaths', accessor: 'totaldeaths', sortable: true },
    { header: 'Gross Mortality', accessor: 'grossmortality', sortable: true },
    { header: 'Net Mortality (>48h)', accessor: 'netmortality48h', sortable: true },
    { header: 'Expected Range', accessor: 'expectedrange', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking and analyzing hospital-wide mortality rates by department and cause.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Gross Mortality</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1.8%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Net Mortality</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.2%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">M&M Reviews Pending</p>
