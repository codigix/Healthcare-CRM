...
export default function WaitingTimePage() {
  ...
  const columns = [
    { header: 'Touchpoint', accessor: 'touchpoint', sortable: true },
    { header: 'Target Wait', accessor: 'targetwait', sortable: true },
    { header: 'Avg Wait (MTD)', accessor: 'avgwaitmtd', sortable: true },
    { header: 'Max Wait', accessor: 'maxwait', sortable: true },
    { header: 'Patient Satisfaction', accessor: 'patientsatisfaction', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Granular analysis of patient waiting times across different touchpoints.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Global Wait</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24 Mins</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Target Wait</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>< 20 Mins</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Worst Touchpoint</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Pharmacy</p>
        </div>
      </div>
