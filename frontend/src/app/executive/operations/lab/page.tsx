...
export default function LaboratoryPerformancePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Test Category', accessor: 'testcategory', sortable: true },
    { header: 'Volume (MTD)', accessor: 'volumemtd', sortable: true },
    { header: 'Stat %', accessor: 'stat', sortable: true },
    { header: 'Avg TAT', accessor: 'avgtat', sortable: true },
    { header: 'TAT Compliance', accessor: 'tatcompliance', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Sample volume, Turnaround Time (TAT) compliance, and reagent wastage.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Tests (MTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global TAT Met</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>92%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Stat TAT Missed</p>
