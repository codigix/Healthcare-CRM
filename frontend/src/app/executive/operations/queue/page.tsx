...
export default function QueueAnalysisPage() {
  ...
  const columns = [
    { header: 'Counter/Area', accessor: 'counterarea', sortable: true },
    { header: 'Current Queue', accessor: 'currentqueue', sortable: true },
    { header: 'Avg Processing Time', accessor: 'avgprocessingtime', sortable: true },
    { header: 'Staff Deployed', accessor: 'staffdeployed', sortable: true },
    { header: 'Abandonment Rate', accessor: 'abandonmentrate', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Queue length tracking and staff allocation efficiency.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>OPD Billing</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Staffing Level</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Adequate</p>
        </div>
      </div>
