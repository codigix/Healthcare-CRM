...
export default function AppointmentAnalyticsPage() {
  ...
  const columns = [
    ...
    { header: 'Total Booked', accessor: 'totalbooked', sortable: true },
    { header: 'Walk-ins', accessor: 'walkins', sortable: true },
    { header: 'Online %', accessor: 'online', sortable: true },
    { header: 'No-Show Rate', accessor: 'noshowrate', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Trends in OPD bookings, walk-ins, and online vs offline mix.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,500 (MTD)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Online Booking</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">No-Show Rate</p>
