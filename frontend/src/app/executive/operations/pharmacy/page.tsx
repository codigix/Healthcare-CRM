...
export default function PharmacyPerformancePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Pharmacy Unit', accessor: 'pharmacyunit', sortable: true },
    { header: 'Prescriptions Filled', accessor: 'prescriptionsfilled', sortable: true },
    { header: 'Avg Dispense Time', accessor: 'avgdispensetime', sortable: true },
    { header: 'Generic Sub %', accessor: 'genericsub', sortable: true },
    { header: 'Stockouts', accessor: 'stockouts', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Prescription fill rates, wait times, and generic vs branded dispensing ratio.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Prescriptions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12,400</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Dispense Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>8 Mins</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inventory Turns</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12x</p>
        </div>
      </div>
