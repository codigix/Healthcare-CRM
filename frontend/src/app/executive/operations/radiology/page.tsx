...
export default function RadiologyPerformancePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Modality', accessor: 'modality', sortable: true },
    { header: 'Scans Performed', accessor: 'scansperformed', sortable: true },
    { header: 'Avg Scan Time', accessor: 'avgscantime', sortable: true },
    { header: 'Reporting TAT', accessor: 'reportingtat', sortable: true },
    { header: 'Machine Uptime', accessor: 'machineuptime', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Imaging volumes, reporting turnaround times, and machine utilization.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Scans (MTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,200</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reporting TAT</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>2.5 Hrs</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Machine Downtime</p>
