...
export default function ForecastingPage() {
  ...
  const columns = [
    { header: 'Forecast Metric', accessor: 'forecastmetric', sortable: true },
    { header: 'Current Month', accessor: 'currentmonth', sortable: true },
    { header: 'Next Month (Est)', accessor: 'nextmonthest', sortable: true },
    { header: 'Quarter End', accessor: 'quarterend', sortable: true },
    { header: 'Confidence Score', accessor: 'confidencescore', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Predictive models for patient volume and revenue for the next 12 months.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revenue Q3 Forecast</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$35M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">IPD Growth Est</p>
