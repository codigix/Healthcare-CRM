...
export default function GrowthAnalysisPage() {
  ...
  const columns = [
    { header: 'Service Line', accessor: 'serviceline', sortable: true },
    { header: 'Market Share (Est)', accessor: 'marketshareest', sortable: true },
    { header: 'YoY Growth', accessor: 'yoygrowth', sortable: true },
    { header: 'Margin Contribution', accessor: 'margincontribution', sortable: true },
    { header: 'Strategic Value', accessor: 'strategicvalue', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analyzing new service lines (e.g., Robotics) vs existing cash cows.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Growth Area</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Robotic Surgery</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Market Share Focus</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Oncology</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Stagnant Service</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>General Med</p>
        </div>
      </div>
