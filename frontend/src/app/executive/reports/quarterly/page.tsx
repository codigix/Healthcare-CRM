...
export default function QuarterlyMISPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Quarter', accessor: 'quarter', sortable: true },
    { header: 'Revenue Achieved', accessor: 'revenueachieved', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Quarterly strategic reviews and market share analysis.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Q1 Performance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>105% of Target</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Q2 Projected</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>On Track</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Strategic Goals Met</p>
