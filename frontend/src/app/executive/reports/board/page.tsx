...
export default function BoardReportsPage() {
  ...
  const columns = [
    { header: 'Meeting Date', accessor: 'meetingdate', sortable: true },
    { header: 'Report Package', accessor: 'reportpackage', sortable: true },
    { header: 'Prepared By', accessor: 'preparedby', sortable: true },
    { header: 'Financial Audit', accessor: 'financialaudit', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Extensive presentations and financials prepared for the Board of Directors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Next Board Meeting</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15 Aug 2026</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Prep Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>In Progress</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Past Reports</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12 Archived</p>
        </div>
      </div>
