...
export default function RecruitmentAnalyticsPage() {
  ...
  const columns = [
    { header: 'Role Category', accessor: 'rolecategory', sortable: true },
    { header: 'Open Roles', accessor: 'openroles', sortable: true },
    { header: 'Avg Time to Fill', accessor: 'avgtimetofill', sortable: true },
    { header: 'Offer Accept Rate', accessor: 'offeracceptrate', sortable: true },
    { header: 'Cost per Hire', accessor: 'costperhire', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Time-to-hire, cost-per-hire, and sourcing channel effectiveness.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Open Requisitions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global Time to Fill</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>42 Days</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Offer Accept %</p>
