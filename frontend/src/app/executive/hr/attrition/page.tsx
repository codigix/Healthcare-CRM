...
export default function AttritionAnalysisPage() {
  ...
  const columns = [
    ...
    { header: 'Annual Attrition %', accessor: 'annualattrition', sortable: true },
    { header: 'Regrettable Loss', accessor: 'regrettableloss', sortable: true },
    { header: 'Primary Exit Reason', accessor: 'primaryexitreason', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Staff turnover rates, exit interview insights, and retention strategies.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global Attrition</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>18%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Clinical Attrition</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>22%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Retention Cost Target</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$200K</p>
        </div>
      </div>
