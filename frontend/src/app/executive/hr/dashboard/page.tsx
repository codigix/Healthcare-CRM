...
export default function EmployeeDashboardPage() {
  ...
  const columns = [
    ...
    { header: 'New Hires (YTD)', accessor: 'newhiresytd', sortable: true },
    { header: 'Exits (YTD)', accessor: 'exitsytd', sortable: true },
    { header: 'Gender Ratio (M/F)', accessor: 'genderratiomf', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">High-level overview of hospital staffing, headcount, and diversity.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Headcount</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,250</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Clinical vs Non</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>60% / 40%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
