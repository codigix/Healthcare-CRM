    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Revenue per employee, patients per nurse, and clinical efficiency.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revenue/Employee</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$85K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Nurse-to-Patient</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1:6 (Ward)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Productivity Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>88/100</p>
        </div>
      </div>
