...
export default function RiskAnalysisPage() {
  ...
  const columns = [
    { header: 'Risk Category', accessor: 'riskcategory', sortable: true },
    { header: 'Identified Risk', accessor: 'identifiedrisk', sortable: true },
    { header: 'Probability', accessor: 'probability', sortable: true },
    { header: 'Impact Est ($)', accessor: 'impactest', sortable: true },
    { header: 'Mitigation Plan', accessor: 'mitigationplan', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Holistic risk scoring: Financial (bad debt), Clinical (lawsuits), and Operational (downtime).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Risk Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Low-Medium</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Risk</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Insurance Delays</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unmitigated</p>
