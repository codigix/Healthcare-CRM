...
export default function ExecutiveRecommendationsPage() {
  ...
  const columns = [
    ...
    { header: 'AI Recommendation', accessor: 'airecommendation', sortable: true },
    { header: 'Est. Value/Savings', accessor: 'estvaluesavings', sortable: true },
    { header: 'Effort Level', accessor: 'effortlevel', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">A consolidated list of Top 5 actionable insights generated by the AI engine daily.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Insights Gen. Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Potential Savings</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$125K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Implemented</p>
