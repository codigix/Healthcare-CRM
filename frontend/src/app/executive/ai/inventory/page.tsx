...
export default function InventoryForecastPage() {
  ...
  const columns = [
    { header: 'Item Category', accessor: 'itemcategory', sortable: true },
    { header: 'Current Stock (Days)', accessor: 'currentstockdays', sortable: true },
    { header: 'Predicted Usage', accessor: 'predictedusage', sortable: true },
    { header: 'Suggested Order Qty', accessor: 'suggestedorderqty', sortable: true },
    { header: 'Supplier SLA', accessor: 'suppliersla', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Predicting stockouts for vital drugs based on disease trends (e.g., stocking up on inhalers during winter).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical Low Stock</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>5 SKUs</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">AI Saved Cost</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$45K (Reduced Expiry)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Order Acc.</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>96%</p>
        </div>
      </div>
