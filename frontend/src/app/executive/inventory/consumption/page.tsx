...
export default function StockConsumptionPage() {
  ...
  const columns = [
    ...
    { header: 'Variance from Budget', accessor: 'variancefrombudget', sortable: true },
    { header: 'Top Consuming Dept', accessor: 'topconsumingdept', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Usage rates of high-value consumables and drugs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Monthly Consumption</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High-Value Usage</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$800K</p>
        </div>
      </div>
