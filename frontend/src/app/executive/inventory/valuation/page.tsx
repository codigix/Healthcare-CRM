...
export default function StockValuationPage() {
  ...
  const columns = [
    { header: 'Store/Department', accessor: 'storedepartment', sortable: true },
    { header: 'Total SKUs', accessor: 'totalskus', sortable: true },
    { header: 'Current Value', accessor: 'currentvalue', sortable: true },
    { header: 'MoM Change', accessor: 'momchange', sortable: true },
    { header: 'Dead Stock Value', accessor: 'deadstockvalue', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Current value of inventory held across central warehouse and sub-stores.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Inventory Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$2.4M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Dead Stock Estimate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$120K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Near Expiry (90d)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$45K</p>
        </div>
      </div>
