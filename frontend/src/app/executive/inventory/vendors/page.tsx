...
export default function VendorPerformancePage() {
  ...
  const columns = [
    ...
    { header: 'Total PO Value', accessor: 'totalpovalue', sortable: true },
    { header: 'On-Time Delivery', accessor: 'ontimedelivery', sortable: true },
    { header: 'Quality Rejects', accessor: 'qualityrejects', sortable: true },
    { header: 'Overall Rating', accessor: 'overallrating', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Evaluation of suppliers based on delivery timelines, quality, and pricing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>240</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg On-Time Del.</p>
