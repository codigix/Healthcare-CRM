...
export default function NPSScorePage() {
  ...
  const columns = [
    ...
    { header: 'Promoters', accessor: 'promoters', sortable: true },
    { header: 'Passives', accessor: 'passives', sortable: true },
    { header: 'Detractors', accessor: 'detractors', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Net Promoter Score tracking: "How likely are you to recommend this hospital?"</p>
        </div>
