...
export default function TelemedicineAnalyticsPage() {
  ...
  const columns = [
    ...
    { header: 'Virtual Consults', accessor: 'virtualconsults', sortable: true },
    { header: 'Growth (MoM)', accessor: 'growthmom', sortable: true },
    { header: 'Avg Duration', accessor: 'avgduration', sortable: true },
    { header: 'Tech Drop-offs', accessor: 'techdropoffs', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Adoption rates, platform reliability, and patient satisfaction with virtual consults.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Tele-consults</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>850 (MTD)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Tele-consult Rev</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$42K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Platform Uptime</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>99.9%</p>
        </div>
      </div>
