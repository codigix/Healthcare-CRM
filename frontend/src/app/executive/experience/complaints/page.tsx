...
export default function ComplaintAnalysisPage() {
  ...
  const columns = [
    ...
    { header: 'Total Received', accessor: 'totalreceived', sortable: true },
    { header: 'Resolved < 24h', accessor: 'resolved24h', sortable: true },
    { header: 'Escalated', accessor: 'escalated', sortable: true },
    { header: 'Avg Resolution Time', accessor: 'avgresolutiontime', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Grievance redressal tracking, resolution times, and escalations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Complaints (MTD)</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>48 Hrs</p>
        </div>
      </div>
