...
export default function MaintenanceKPIsPage() {
  ...
  const columns = [
    { header: 'System', accessor: 'system', sortable: true },
    { header: 'Open Tickets', accessor: 'opentickets', sortable: true },
    { header: 'Avg Repair Time', accessor: 'avgrepairtime', sortable: true },
    { header: 'PM Adherence', accessor: 'pmadherence', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">HVAC downtime, plumbing issues, and preventive maintenance adherence.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Open Tickets</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">PM Compliance</p>
