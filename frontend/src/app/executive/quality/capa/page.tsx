...
export default function CAPATrackingPage() {
  ...
  const columns = [
    ...
    { header: 'Open CAPAs', accessor: 'opencapas', sortable: true },
    { header: 'Overdue', accessor: 'overdue', sortable: true },
    { header: 'Avg Time to Close', accessor: 'avgtimetoclose', sortable: true },
    { header: 'Verification Status', accessor: 'verificationstatus', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Corrective and Preventive Actions closure rates across all departments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Open CAPAs</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Closure Rate</p>
