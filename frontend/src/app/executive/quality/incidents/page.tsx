...
export default function IncidentReportsPage() {
  ...
  const columns = [
    ...
    { header: 'Incidents Reported', accessor: 'incidentsreported', sortable: true },
    { header: 'Sentinel Events', accessor: 'sentinelevents', sortable: true },
    { header: 'Root Cause Defined', accessor: 'rootcausedefined', sortable: true },
    { header: 'CAPA Closed', accessor: 'capaclosed', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Medication errors, patient falls, and near-misses reporting trends.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Incidents (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Sentinel Events</p>
          <p className={"text-2xl font-bold mt-2 " + "text-green-500"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reporting Culture</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Improving</p>
        </div>
      </div>
