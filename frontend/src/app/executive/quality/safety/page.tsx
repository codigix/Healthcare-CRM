...
export default function PatientSafetyIndicatorsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Indicator (PSI)', accessor: 'indicatorpsi', sortable: true },
    { header: 'Observed Rate', accessor: 'observedrate', sortable: true },
    { header: 'Expected Rate', accessor: 'expectedrate', sortable: true },
    { header: 'O/E Ratio', accessor: 'oeratio', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Standardized AHRQ or WHO patient safety metrics.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Composite Safety Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>96/100</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Adverse Events</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Decreasing</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Safety Walkrounds</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Completed</p>
        </div>
      </div>
