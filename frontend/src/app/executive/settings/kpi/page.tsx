...
export default function KPIConfigurationPage() {
  ...
  const columns = [
    ...
    { header: 'Current Target', accessor: 'currenttarget', sortable: true },
    { header: 'Previous Target', accessor: 'previoustarget', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Defining hospital-wide benchmark targets (e.g., ALOS target = 4 days).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Targets Set</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>124</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revised This Year</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>85% Met</p>
        </div>
      </div>
