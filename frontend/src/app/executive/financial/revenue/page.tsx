...
export default function RevenueDashboardPage() {
  ...
  const columns = [
    { header: 'Revenue Stream', accessor: 'revenuestream', sortable: true },
    { header: 'YTD Revenue', accessor: 'ytdrevenue', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">High-level revenue trends, breakdowns by source, and forecasting.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Revenue (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$45.2M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Margin</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>18%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revenue vs Target</p>
