...
export default function DoctorRevenuePage() {
  ...
  const columns = [
    ...
    { header: 'Total Billed', accessor: 'totalbilled', sortable: true },
    { header: 'Hospital Share', accessor: 'hospitalshare', sortable: true },
    { header: 'Doctor Share', accessor: 'doctorshare', sortable: true },
    { header: 'Effective Margin', accessor: 'effectivemargin', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Consultant fee generation, share calculations, and revenue contribution.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Doctor Payouts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$4.5M (MTD)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Hosp Margin</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>40%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Earner</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Dr. Smith</p>
        </div>
      </div>
