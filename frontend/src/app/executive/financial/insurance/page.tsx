...
export default function InsuranceRevenuePage() {
  ...
  const columns = [
    ...
    { header: 'Total Claims', accessor: 'totalclaims', sortable: true },
    { header: 'Approved Amount', accessor: 'approvedamount', sortable: true },
    { header: 'Disallowance %', accessor: 'disallowance', sortable: true },
    { header: 'Avg Payment Time', accessor: 'avgpaymenttime', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">TPA claim realization, disallowance rates, and aging of insurance receivables.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Insurance Billed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$8.5M (YTD)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Disallowance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>6.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Realization Time</p>
