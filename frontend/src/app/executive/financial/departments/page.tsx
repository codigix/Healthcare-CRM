...
export default function DepartmentRevenuePage() {
  ...
  const columns = [
    ...
    { header: 'Direct Costs', accessor: 'directcosts', sortable: true },
    { header: 'Allocated Overhead', accessor: 'allocatedoverhead', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">P&L analysis at the individual clinical department level.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Profitable Depts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>18/22</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Loss-Making Depts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Margin</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Radiology (45%)</p>
        </div>
      </div>
