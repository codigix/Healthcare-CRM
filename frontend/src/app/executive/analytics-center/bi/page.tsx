...
export default function BusinessIntelligencePage() {
  ...
  const columns = [
    { header: 'Model/Cube Name', accessor: 'modelcubename', sortable: true },
    { header: 'Business Domain', accessor: 'businessdomain', sortable: true },
    { header: 'Query Latency', accessor: 'querylatency', sortable: true },
    { header: 'Used By', accessor: 'usedby', sortable: true },
    { header: 'Last Rebuild', accessor: 'lastrebuild', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Advanced BI models, OLAP cubes, and semantic layers.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">BI Cubes Active</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Daily Users</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45 Execs</p>
        </div>
      </div>
