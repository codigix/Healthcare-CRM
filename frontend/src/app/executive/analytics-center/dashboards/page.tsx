...
export default function InteractiveDashboardsPage() {
  ...
  const columns = [
    { header: 'Dashboard Name', accessor: 'dashboardname', sortable: true },
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Views (30d)', accessor: 'views30d', sortable: true },
    { header: 'Owner', accessor: 'owner', sortable: true },
    { header: 'Data Refresh', accessor: 'datarefresh', sortable: true },
    { 
      header: 'Action', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tableau/PowerBI embedded interactive visual dashboards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Dashboards</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Most Viewed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Daily Revenue</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Data Freshness</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Live</p>
        </div>
      </div>
