...
export default function DataWarehousePage() {
  ...
  const columns = [
    { header: 'Data Source', accessor: 'datasource', sortable: true },
    { header: 'Sync Frequency', accessor: 'syncfrequency', sortable: true },
    { header: 'Last Sync', accessor: 'lastsync', sortable: true },
    { header: 'Rows Updated', accessor: 'rowsupdated', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Status of ETL pipelines syncing HIS, LIS, RIS data into the central warehouse.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Storage</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12 TB</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pipelines Healthy</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>100%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Daily Data Processed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45 GB</p>
        </div>
      </div>
