...
export default function ReportBuilderPage() {
  ...
  const columns = [
    { header: 'Report Draft Name', accessor: 'reportdraftname', sortable: true },
    { header: 'Base Table', accessor: 'basetable', sortable: true },
    { header: 'Columns Selected', accessor: 'columnsselected', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Drag-and-drop interface for building tabular reports.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Draft Reports</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Build Time</p>
