...
export default function KPIBuilderPage() {
  ...
  const columns = [
    ...
    { header: 'Formula/Metric', accessor: 'formulametric', sortable: true },
    { header: 'Target Value', accessor: 'targetvalue', sortable: true },
    { header: 'Alert Threshold', accessor: 'alertthreshold', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tool to define custom KPIs and set target thresholds.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Custom KPIs</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Data Sync Errors</p>
