...
export default function HighValueClaimsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Claim ID', accessor: 'claimid', sortable: true },
    { header: 'Patient/Entity', accessor: 'patiententity', sortable: true },
    { header: 'Claim Value', accessor: 'claimvalue', sortable: true },
    { header: 'Legal Counsel Adv.', accessor: 'legalcounseladv', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Insurance claims or legal settlements above a critical threshold.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Legal Reserve</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$2M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cleared (MTD)</p>
