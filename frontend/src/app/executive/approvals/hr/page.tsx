...
export default function HRApprovalsPage() {
  ...
  const columns = [
    { header: 'Candidate/Emp', accessor: 'candidateemp', sortable: true },
    { header: 'Position', accessor: 'position', sortable: true },
    { header: 'Proposed CTC', accessor: 'proposedctc', sortable: true },
    { header: 'Variance from Band', accessor: 'variancefromband', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hiring of senior consultants, HODs, or out-of-band salary increments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Hires Pending Approval</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Increment Requests</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">HOD Approvals</p>
