...
export default function PurchaseApprovalsPage() {
  ...
  const columns = [
    ...
    { header: 'Budget Status', accessor: 'budgetstatus', sortable: true },
    { 
      header: 'Action', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Purchase Orders (POs) exceeding standard departmental limits requiring CEO/CFO sign-off.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">POs Pending</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rejected (MTD)</p>
