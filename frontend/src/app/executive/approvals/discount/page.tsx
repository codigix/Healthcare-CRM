...
export default function DiscountApprovalsPage() {
  ...
  const columns = [
    ...
    { header: 'Total Bill', accessor: 'totalbill', sortable: true },
    { header: 'Requested Discount', accessor: 'requesteddiscount', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Special VIP discounts or charity waivers on patient bills exceeding standard limits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Discount Requests</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Charity Quota</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45% Used</p>
        </div>
      </div>
