...
export default function TodaysSummaryPage() {
  ...
  const columns = [
    { header: 'Metric Area', accessor: 'metricarea', sortable: true },
    { header: 'Value', accessor: 'value', sortable: true },
    { header: 'Yesterday', accessor: 'yesterday', sortable: true },
    { header: 'Week Avg', accessor: 'weekavg', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">A quick snapshot of today's operational and financial performance.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Admissions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>124</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Daily Revenue</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$45K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Emergency Cases</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>22</p>
        </div>
      </div>
