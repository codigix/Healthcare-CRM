...
export default function HospitalKPIsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'KPI Category', accessor: 'kpicategory', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">High-level Key Performance Indicators for the entire hospital.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Hospital Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>92/100</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revenue YTD</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$12.5M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
