...
export default function EmergencyAnalyticsPage() {
  ...
  const columns = [
    { header: 'Triage Level', accessor: 'triagelevel', sortable: true },
    { header: 'Patient Count', accessor: 'patientcount', sortable: true },
    { header: 'Avg Time to Doctor', accessor: 'avgtimetodoctor', sortable: true },
    { header: 'Admitted to ICU', accessor: 'admittedtoicu', sortable: true },
    { header: 'Mortality Rate', accessor: 'mortalityrate', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analysis of ER footfall, triage categories, and critical case conversions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ER Visits (MTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>3,200</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Triage Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4 Mins</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Admission Rate</p>
