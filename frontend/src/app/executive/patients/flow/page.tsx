...
export default function PatientFlowMetricsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Flow Stage', accessor: 'flowstage', sortable: true },
    { header: 'Volume', accessor: 'volume', sortable: true },
    { header: 'Avg Duration', accessor: 'avgduration', sortable: true },
    { header: 'Bottleneck Risk', accessor: 'bottleneckrisk', sortable: true },
    { header: 'Resource Utilized', accessor: 'resourceutilized', sortable: true },
    { 
      header: 'Status', 
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Bottleneck analysis of patient journey from admission to discharge.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Total Journey</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>5.2 Days</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Major Bottleneck</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Discharge Billing</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Flow Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>78/100</p>
        </div>
      </div>
