...
export default function APIAuditPage() {
  ...
  const [data] = useState([
    {
      "c0": "ID-6439",
      "c1": "Sample Endpoint 1",
      "c2": "Sample Client IP 1",
      "c3": "Active"
    },
    {
      "c0": "ID-8023",
      "c1": "Sample Endpoint 2",
      "c2": "Sample Client IP 2",
      "c3": "Inactive"
    },
    {
      "c0": "ID-8177",
      "c1": "Sample Endpoint 3",
      "c2": "Sample Client IP 3",
      "c3": "Inactive"
    },
    {
      "c0": "ID-3416",
      "c1": "Sample Endpoint 4",
      "c2": "Sample Client IP 4",
      "c3": "Inactive"
    },
    {
      "c0": "ID-8388",
      "c1": "Sample Endpoint 5",
      "c2": "Sample Client IP 5",
      "c3": "Active"
    },
    {
      "c0": "ID-2174",
      "c1": "Sample Endpoint 6",
      "c2": "Sample Client IP 6",
      "c3": "Inactive"
    },
    {
      "c0": "ID-3885",
      "c1": "Sample Endpoint 7",
      "c2": "Sample Client IP 7",
      "c3": "Active"
    },
    {
      "c0": "ID-1630",
      "c1": "Sample Endpoint 8",
      "c2": "Sample Client IP 8",
      "c3": "Active"
    },
    {
      "c0": "ID-8109",
      "c1": "Sample Endpoint 9",
      "c2": "Sample Client IP 9",
      "c3": "Inactive"
    },
    {
      "c0": "ID-8237",
      "c1": "Sample Endpoint 10",
      "c2": "Sample Client IP 10",
      "c3": "Inactive"
    },
    {
      "c0": "ID-6173",
      "c1": "Sample Endpoint 11",
      "c2": "Sample Client IP 11",
      "c3": "Active"
    },
    {
      "c0": "ID-5689",
      "c1": "Sample Endpoint 12",
      "c2": "Sample Client IP 12",
      "c3": "Pending"
    }
  ]);

  const columns = [
    { header: "Request ID", accessor: "c0", sortable: true },
    { header: "Endpoint", accessor: "c1", sortable: true },
    { header: "Client IP", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage api audit configurations globally</p>
        </div>
