...
export default function SSLCertificatesPage() {
  ...
  const columns = [
    { header: "Domain", accessor: "c0", sortable: true },
    { header: "Issuer", accessor: "c1", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage ssl certificates configurations globally</p>
        </div>
