...
import { Building2, Plus, Search, Filter, MoreVertical, Edit2, Trash2 } from "lucide-react";
...
export default function DepartmentsPage() {
  ...
  const mockDepts = [
    { id: "DPT-01", name: "Cardiology", type: "Clinical", head: "Dr. A. Sharma", status: "Active" },
    { id: "DPT-02", name: "Neurology", type: "Clinical", head: "Dr. S. Gupta", status: "Active" },
    { id: "DPT-03", name: "Human Resources", type: "Administrative", head: "M. Johnson", status: "Active" },
    { id: "DPT-04", name: "Information Technology", type: "Support", head: "R. Patel", status: "Active" },
    { id: "DPT-05", name: "Billing & Finance", type: "Administrative", head: "K. Williams", status: "Active" },
  ];
  const columns = [
    { header: "Dept ID", accessor: "id", sortable: true },
    { header: "Department Name", accessor: "name", sortable: true },
    { header: "Type", accessor: "type", sortable: true },
    { header: "HOD / Manager", accessor: "head", sortable: true },
    ...
    <div className="p-2 space-y-2">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage hospital departments and structural units</p>
        </div>
