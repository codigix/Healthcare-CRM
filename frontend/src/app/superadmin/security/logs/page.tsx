...
export default function SecurityAuditLogsPage() {
  ...
  const columns = [
    { header: "Event ID", accessor: "c0", sortable: true },
    { header: "Action", accessor: "c1", sortable: true },
    { header: "User", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage security audit logs configurations globally</p>
        </div>
