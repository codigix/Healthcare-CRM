      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-2">
          <button
            ...
            className={`w-full flex items-center gap-2 p-2 rounded text-left transition-colors ${activeSection === 'basic' ? 'bg-blue-600/10 text-blue-400 border border-blue-500/20' : 'text-gray-400 hover:bg-dark-tertiary hover:text-gray-200'}`}
          >
            <Building2 size={15} />
          ...
          <button
            ...
            className={`w-full flex items-center gap-2 p-2 rounded text-left transition-colors ${activeSection === 'contact' ? 'bg-blue-600/10 text-blue-400 border border-blue-500/20' : 'text-gray-400 hover:bg-dark-tertiary hover:text-gray-200'}`}
          >
            <MapPin size={15} />
          ...
          <button
            ...
            className={`w-full flex items-center gap-2 p-2 rounded text-left transition-colors ${activeSection === 'compliance' ? 'bg-blue-600/10 text-blue-400 border border-blue-500/20' : 'text-gray-400 hover:bg-dark-tertiary hover:text-gray-200'}`}
          >
            <ShieldCheck size={15} />
          ...
          <button
            ...
            className={`w-full flex items-center gap-2 p-2 rounded text-left transition-colors ${activeSection === 'infrastructure' ? 'bg-blue-600/10 text-blue-400 border border-blue-500/20' : 'text-gray-400 hover:bg-dark-tertiary hover:text-gray-200'}`}
          >
            <Bed size={15} />
          ...
          <button
            ...
            className={`w-full flex items-center gap-2 p-2 rounded text-left transition-colors ${activeSection === 'billing' ? 'bg-blue-600/10 text-blue-400 border border-blue-500/20' : 'text-gray-400 hover:bg-dark-tertiary hover:text-gray-200'}`}
          >
            <CreditCard size={15} />
