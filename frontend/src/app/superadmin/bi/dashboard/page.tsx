...
export default function GlobalDashboardConfigPage() {
  ...
  const columns = [
    { header: "Widget Name", accessor: "c0", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage global dashboard config configurations globally</p>
        </div>
