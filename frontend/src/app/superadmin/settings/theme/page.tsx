...
export default function ThemeConfigurationPage() {
  ...
  const [data] = useState([
    {
      "c0": "ID-7494",
      "c1": "Sample Primary Color 1",
      "c2": "Sample Type 1",
      "c3": "Inactive"
    },
    {
      "c0": "ID-5730",
      "c1": "Sample Primary Color 2",
      "c2": "Sample Type 2",
      "c3": "Active"
    },
    {
      "c0": "ID-5838",
      "c1": "Sample Primary Color 3",
      "c2": "Sample Type 3",
      "c3": "Inactive"
    },
    {
      "c0": "ID-8517",
      "c1": "Sample Primary Color 4",
      "c2": "Sample Type 4",
      "c3": "Active"
    },
    {
      "c0": "ID-7477",
      "c1": "Sample Primary Color 5",
      "c2": "Sample Type 5",
      "c3": "Active"
    },
    {
      "c0": "ID-1207",
      "c1": "Sample Primary Color 6",
      "c2": "Sample Type 6",
      "c3": "Inactive"
    },
    {
      "c0": "ID-9457",
      "c1": "Sample Primary Color 7",
      "c2": "Sample Type 7",
      "c3": "Pending"
    },
    {
      "c0": "ID-5829",
      "c1": "Sample Primary Color 8",
      "c2": "Sample Type 8",
      "c3": "Active"
    },
    {
      "c0": "ID-5805",
      "c1": "Sample Primary Color 9",
      "c2": "Sample Type 9",
      "c3": "Pending"
    },
    {
      "c0": "ID-2738",
      "c1": "Sample Primary Color 10",
      "c2": "Sample Type 10",
      "c3": "Active"
    },
    {
      "c0": "ID-6522",
      "c1": "Sample Primary Color 11",
      "c2": "Sample Type 11",
      "c3": "Active"
    },
    {
      "c0": "ID-4367",
      "c1": "Sample Primary Color 12",
      "c2": "Sample Type 12",
      "c3": "Pending"
    }
  ]);
  ...
  const columns = [
    { header: "Theme Name", accessor: "c0", sortable: true },
    { header: "Primary Color", accessor: "c1", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage theme configuration configurations globally</p>
        </div>
