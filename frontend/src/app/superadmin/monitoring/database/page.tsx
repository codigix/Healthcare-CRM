...
export default function DatabaseMonitoringPage() {
  ...
  const [data] = useState([
    {
      "c0": "ID-9219",
      "c1": "Sample Connections 1",
      "c2": "Sample Queries/s 1",
      "c3": "Active"
    },
    {
      "c0": "ID-4854",
      "c1": "Sample Connections 2",
      "c2": "Sample Queries/s 2",
      "c3": "Active"
    },
    {
      "c0": "ID-7178",
      "c1": "Sample Connections 3",
      "c2": "Sample Queries/s 3",
      "c3": "Active"
    },
    {
      "c0": "ID-7382",
      "c1": "Sample Connections 4",
      "c2": "Sample Queries/s 4",
      "c3": "Pending"
    },
    {
      "c0": "ID-1964",
      "c1": "Sample Connections 5",
      "c2": "Sample Queries/s 5",
      "c3": "Active"
    },
    {
      "c0": "ID-6121",
      "c1": "Sample Connections 6",
      "c2": "Sample Queries/s 6",
      "c3": "Pending"
    },
    {
      "c0": "ID-2135",
      "c1": "Sample Connections 7",
      "c2": "Sample Queries/s 7",
      "c3": "Active"
    },
    {
      "c0": "ID-3436",
      "c1": "Sample Connections 8",
      "c2": "Sample Queries/s 8",
      "c3": "Inactive"
    },
    {
      "c0": "ID-2359",
      "c1": "Sample Connections 9",
      "c2": "Sample Queries/s 9",
      "c3": "Active"
    },
    {
      "c0": "ID-9749",
      "c1": "Sample Connections 10",
      "c2": "Sample Queries/s 10",
      "c3": "Active"
    },
    {
      "c0": "ID-8142",
      "c1": "Sample Connections 11",
      "c2": "Sample Queries/s 11",
      "c3": "Active"
    },
    {
      "c0": "ID-3863",
      "c1": "Sample Connections 12",
      "c2": "Sample Queries/s 12",
      "c3": "Active"
    }
  ]);

  const columns = [
    { header: "DB", accessor: "c0", sortable: true },
    { header: "Connections", accessor: "c1", sortable: true },
    { header: "Queries/s", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage database monitoring configurations globally</p>
        </div>
