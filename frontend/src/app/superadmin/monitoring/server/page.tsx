...
export default function ServerMonitoringPage() {
  ...
  const columns = [
    { header: "Server", accessor: "c0", sortable: true },
    { header: "CPU", accessor: "c1", sortable: true },
    { header: "RAM", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage server monitoring configurations globally</p>
        </div>
