...
export default function LicenseReportsPage() {
  ...
  const [data] = useState([
    ...
    {
      "c0": "ID-8629",
      "c1": "Sample Subject 10",
      "c2": "Sample Date 10",
      "c3": "Pending"
    },
    {
      "c0": "ID-7343",
      "c1": "Sample Subject 11",
      "c2": "Sample Date 11",
      "c3": "Active"
    },
    {
      "c0": "ID-3426",
      "c1": "Sample Subject 12",
      "c2": "Sample Date 12",
      "c3": "Active"
    }
  ]);
  ...
  const columns = [
    ...
    { header: "Subject", accessor: "c1", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage license reports configurations globally</p>
        </div>
