...
export default function RenewalHistoryPage() {
  ...
  const columns = [
    { header: "Invoice ID", accessor: "c0", sortable: true },
    { header: "Date", accessor: "c1", sortable: true },
    { header: "Amount", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage renewal history configurations globally</p>
        </div>
