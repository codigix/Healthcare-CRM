...
export default function VendorDirectoryPage() {
  ...
  const columns = [
    ...
    { header: 'Service Category', accessor: 'servicecategory', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Central registry of all facility and maintenance vendors.</p>
        </div>
