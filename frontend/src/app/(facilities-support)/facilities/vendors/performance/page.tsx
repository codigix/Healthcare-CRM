...
export default function VendorPerformancePage() {
  ...
  const columns = [
    ...
    { header: 'Actual Performance', accessor: 'actualperformance', sortable: true },
    { header: 'Penalties Levied', accessor: 'penaltieslevied', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">SLA tracking and penalty calculation for underperforming vendors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg SLA Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>92%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Penalties (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$4,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Vendor</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>SecureForce</p>
        </div>
      </div>
