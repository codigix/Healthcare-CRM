...
export default function FuelLogPage() {
  ...
  const columns = [
    ...
    { header: 'Fuel Added (Ltrs)', accessor: 'fueladdedltrs', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking fuel consumption, issuing fuel cards, and checking mileage efficiency.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fuel Cost (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$3,400</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Mileage</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>8 km/l</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
