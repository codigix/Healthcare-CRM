...
export default function DamagedLinenPage() {
  ...
  const columns = [
    ...
    { header: 'Damage Reason', accessor: 'damagereason', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logging torn or irreparably stained linen for condemnation and write-off.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Damaged (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>45 Pieces</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Write-off Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$250</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Sent for Repair</p>
