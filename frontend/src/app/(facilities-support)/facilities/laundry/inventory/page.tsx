...
export default function LinenInventoryPage() {
  ...
  const columns = [
    ...
    { header: 'In Use (Wards)', accessor: 'inusewards', sortable: true },
    { header: 'In Laundry', accessor: 'inlaundry', sortable: true },
    { header: 'In Store', accessor: 'instore', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking total hospital linen stock (Bed sheets, blankets, scrubs, gowns).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Pieces</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>15,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Shortage Alerts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Annual Loss %</p>
