...
export default function LaundryProcessingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Batch ID', accessor: 'batchid', sortable: true },
    { header: 'Vendor/Machine', accessor: 'vendormachine', sortable: true },
    { header: 'Weight (Kg)', accessor: 'weightkg', sortable: true },
    { header: 'Sent Time', accessor: 'senttime', sortable: true },
    { header: 'Expected Return', accessor: 'expectedreturn', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking internal washing cycles or dispatch/receipt from external laundry vendors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Current Wash Load</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>450 Kg</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Vendor Turnaround</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>24 Hrs</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Delayed Batches</p>
