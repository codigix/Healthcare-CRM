...
export default function LaundryReportsPage() {
  ...
  const columns = [
    { header: 'Report Name', accessor: 'reportname', sortable: true },
    { header: 'Period', accessor: 'period', sortable: true },
    { header: 'Total Wash Weight', accessor: 'totalwashweight', sortable: true },
    { header: 'Cost Incurred', accessor: 'costincurred', sortable: true },
    { header: 'Discrepancy %', accessor: 'discrepancy', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Consumption, stock discrepancy, and cost per wash cycle reporting.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Laundry Cost (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$4,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Cost/Kg</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$0.80</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Shortage</p>
