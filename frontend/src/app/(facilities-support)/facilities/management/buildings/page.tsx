...
export default function BuildingsPage() {
  ...
  const columns = [
    { header: 'Building Code', accessor: 'buildingcode', sortable: true },
    { header: 'Name', accessor: 'name', sortable: true },
    { header: 'Total Floors', accessor: 'totalfloors', sortable: true },
    { header: 'Square Footage', accessor: 'squarefootage', sortable: true },
    { header: 'Primary Use', accessor: 'primaryuse', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage hospital buildings, wings, and structural assets.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Area (SqFt)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>120,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Buildings Under Maint.</p>
