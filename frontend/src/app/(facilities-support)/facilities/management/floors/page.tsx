...
export default function FloorsPage() {
  ...
  const columns = [
    ...
    { header: 'Floor Level', accessor: 'floorlevel', sortable: true },
    { header: 'Total Wards', accessor: 'totalwards', sortable: true },
    { header: 'Key Departments', accessor: 'keydepartments', sortable: true },
    { header: 'Fire Exits', accessor: 'fireexits', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed floor plan mapping and department allocation per floor.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Floors</p>
