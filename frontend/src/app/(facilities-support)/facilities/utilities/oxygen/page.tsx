...
export default function OxygenSupplyLMOPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Tank/Manifold', accessor: 'tankmanifold', sortable: true },
    { header: 'Capacity', accessor: 'capacity', sortable: true },
    { header: 'Current Level', accessor: 'currentlevel', sortable: true },
    { header: 'Pressure (Bar)', accessor: 'pressurebar', sortable: true },
    { header: 'Est. Run Time', accessor: 'estruntime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Critical monitoring of Liquid Medical Oxygen tank levels and manifold pressure.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">LMO Level</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>65%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Days Remaining</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4 Days</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cylinder Backup</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>100% Full</p>
        </div>
      </div>
