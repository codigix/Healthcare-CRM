...
export default function WaterMonitoringPage() {
  ...
  const columns = [
    { header: 'Source/Meter', accessor: 'sourcemeter', sortable: true },
    { header: 'Intake (Ltrs)', accessor: 'intakeltrs', sortable: true },
    { header: 'Level (%)', accessor: 'level', sortable: true },
    { header: 'Quality Check (pH)', accessor: 'qualitycheckph', sortable: true },
    { header: 'Pump Status', accessor: 'pumpstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking municipal intake, borewell usage, and STP (Sewage Treatment Plant) output.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>50,000 L</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">STP Operational</p>
