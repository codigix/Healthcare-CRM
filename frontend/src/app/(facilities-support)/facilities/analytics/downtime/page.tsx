...
export default function EquipmentDowntimePage() {
  ...
  const columns = [
    ...
    { header: 'Total Downtime', accessor: 'totaldowntime', sortable: true },
    { header: 'Lost Revenue Impact', accessor: 'lostrevenueimpact', sortable: true },
    { header: 'Patients Affected', accessor: 'patientsaffected', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Financial and operational impact analysis of medical equipment being out of order.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lost Revenue (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$45,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Downtime</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>120 Hrs</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
