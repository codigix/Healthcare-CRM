...
export default function WasteCollectionPage() {
  ...
  const columns = [
    { header: 'Route ID', accessor: 'routeid', sortable: true },
    { header: 'Floor/Wing', accessor: 'floorwing', sortable: true },
    { header: 'Collected By', accessor: 'collectedby', sortable: true },
    { header: 'Bags Count', accessor: 'bagscount', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logging the internal collection route by housekeeping from wards to central storage.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Routes Completed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12/12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Routes</p>
          <p className={"text-2xl font-bold mt-2 " + "text-green-500"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Bags</p>
