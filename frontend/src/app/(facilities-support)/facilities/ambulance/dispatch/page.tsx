...
export default function EmergencyDispatchPage() {
  ...
  const columns = [
    ...
    { header: 'Ambulance Reg No', accessor: 'ambulanceregno', sortable: true },
    { header: 'Driver Assigned', accessor: 'driverassigned', sortable: true },
    { header: 'EMT Assigned', accessor: 'emtassigned', sortable: true },
    { header: 'Dispatched At', accessor: 'dispatchedat', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Assigning the nearest available ambulance and EMT crew to a booking.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Dispatches</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Dispatch Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>2 Mins</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Crews Available</p>
