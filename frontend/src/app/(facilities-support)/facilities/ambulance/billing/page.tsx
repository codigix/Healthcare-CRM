...
export default function AmbulanceBillingPage() {
  ...
  const columns = [
    { header: 'Billing ID', accessor: 'billingid', sortable: true },
    { header: 'Linked Trip', accessor: 'linkedtrip', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Distance', accessor: 'distance', sortable: true },
    { header: 'Amount Charged', accessor: 'amountcharged', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Integration with HIS for charging patients based on distance or zones.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revenue (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$12,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Free Trips (Camps)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Billing</p>
