...
export default function AmbulanceBookingPage() {
  ...
  const columns = [
    ...
    { header: 'Patient/Caller', accessor: 'patientcaller', sortable: true },
    { header: 'Pickup Location', accessor: 'pickuplocation', sortable: true },
    { header: 'Drop Location', accessor: 'droplocation', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logging requests for patient pickup or discharge drops.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Dispatch</p>
