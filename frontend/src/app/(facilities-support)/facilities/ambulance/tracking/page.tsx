...
export default function VehicleTrackingGPSPage() {
  ...
  const columns = [
    ...
    { header: 'Speed', accessor: 'speed', sortable: true },
    { header: 'Ignition Status', accessor: 'ignitionstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">GPS integration for live location tracking of the ambulance fleet.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">GPS Active</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12/12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Idle Vehicles</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>7</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Speeding Alerts</p>
