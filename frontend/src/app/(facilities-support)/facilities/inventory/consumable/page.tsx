...
export default function ConsumableRequestsPage() {
  ...
  const columns = [
    ...
    { header: 'Items Count', accessor: 'itemscount', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Requests for cleaning chemicals, mops, tissues, and stationery.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Monthly Budget</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$5,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Utilized YTD</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$2,400</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
