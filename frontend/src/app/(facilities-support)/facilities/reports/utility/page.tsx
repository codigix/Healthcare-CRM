...
export default function UtilityReportPage() {
  ...
  const columns = [
    ...
    { header: 'Consumption', accessor: 'consumption', sortable: true },
    { header: 'Peak Usage Time', accessor: 'peakusagetime', sortable: true },
    { header: 'Cost', accessor: 'cost', sortable: true },
    { header: 'Variance vs Budget', accessor: 'variancevsbudget', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Electricity and water consumption trends vs budget.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Power Cost (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$34,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Water Cost (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$4,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Green Energy %</p>
