...
export default function WasteReportPage() {
  ...
  const columns = [
    ...
    { header: 'Yellow (Kg)', accessor: 'yellowkg', sortable: true },
    { header: 'Red (Kg)', accessor: 'redkg', sortable: true },
    { header: 'Blue/White (Kg)', accessor: 'bluewhitekg', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Biomedical waste generation per department and disposal compliance.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Bio-Waste</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,500 Kg</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Disposal Cost</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$2,800</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Segregation Errors</p>
