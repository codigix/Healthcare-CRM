...
export default function HousekeepingReportPage() {
  ...
  const columns = [
    { header: 'Zone', accessor: 'zone', sortable: true },
    { header: 'Schedules Met', accessor: 'schedulesmet', sortable: true },
    { header: 'Missed', accessor: 'missed', sortable: true },
    { header: 'Consumables Cost', accessor: 'consumablescost', sortable: true },
    { header: 'Infection Incidents', accessor: 'infectionincidents', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Cleaning compliance, consumable usage, and infection control correlations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Chemicals Cost</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$2,400</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Staff Absenteeism</p>
