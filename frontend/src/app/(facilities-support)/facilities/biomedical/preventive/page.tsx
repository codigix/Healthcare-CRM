...
export default function PreventiveMaintenancePage() {
  ...
  const columns = [
    ...
    { header: 'Assigned Tech', accessor: 'assignedtech', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Scheduled servicing for medical devices as per manufacturer guidelines.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">PMs Due</p>
