...
export default function CalibrationPage() {
  ...
  const columns = [
    ...
    { header: 'Last Calibration', accessor: 'lastcalibration', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Mandatory statutory calibration tracking for precision medical equipment.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Calibrations Due (30D)</p>
