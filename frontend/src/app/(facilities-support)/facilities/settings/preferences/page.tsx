...
export default function PreferencesPage() {
  ...
  const columns = [
    { header: 'Preference Name', accessor: 'preferencename', sortable: true },
    { header: 'Setting Value', accessor: 'settingvalue', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">General settings for shifts, automated report generation, and dashboard defaults.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global Settings</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Custom Dashboards</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Notification Channels</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Email, SMS, App</p>
        </div>
      </div>
