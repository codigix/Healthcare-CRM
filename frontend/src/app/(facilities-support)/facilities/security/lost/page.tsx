...
export default function LostFoundPage() {
  ...
  const columns = [
    ...
    { header: 'Found By', accessor: 'foundby', sortable: true },
    { header: 'Location Found', accessor: 'locationfound', sortable: true },
    { header: 'Handed To', accessor: 'handedto', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Security log of items found on premises and handover records.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Claimed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">In Custody</p>
