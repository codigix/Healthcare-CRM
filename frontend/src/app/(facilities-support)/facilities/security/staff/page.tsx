...
export default function SecurityStaffPage() {
  ...
  const columns = [
    { header: 'Guard Name', accessor: 'guardname', sortable: true },
    { header: 'ID', accessor: 'id', sortable: true },
    { header: 'Agency', accessor: 'agency', sortable: true },
    { header: 'Current Post', accessor: 'currentpost', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Roster, shifts, and post deployment (e.g., Main Gate, ER Entrance) of security guards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Strength</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>65</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">On Duty</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>22</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reliever Available</p>
