...
export default function MortuaryReportsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Report Type', accessor: 'reporttype', sortable: true },
    { header: 'Month', accessor: 'month', sortable: true },
    { header: 'Total Admissions', accessor: 'totaladmissions', sortable: true },
    { header: 'Total Releases', accessor: 'totalreleases', sortable: true },
    { header: 'MLC Count', accessor: 'mlccount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monthly summaries of admissions, medico-legal cases, and storage utility.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Handled (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">MLC %</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>30%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Audit Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Pass</p>
        </div>
      </div>
