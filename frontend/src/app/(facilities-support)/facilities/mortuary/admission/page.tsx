...
export default function BodyAdmissionPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Admission ID', accessor: 'admissionid', sortable: true },
    { header: 'UHID (if IPD)', accessor: 'uhidifipd', sortable: true },
    { header: 'Cause of Death', accessor: 'causeofdeath', sortable: true },
    { header: 'Tagged By', accessor: 'taggedby', sortable: true },
    { header: 'Handover Form', accessor: 'handoverform', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Intake process, tagging, and assigning a cold storage unit.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Admissions (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">From IPD</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Brought Dead (MLC)</p>
