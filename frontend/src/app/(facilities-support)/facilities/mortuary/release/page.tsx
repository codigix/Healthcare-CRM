...
export default function BodyReleasePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Release ID', accessor: 'releaseid', sortable: true },
    { header: 'Deceased Name', accessor: 'deceasedname', sortable: true },
    { header: 'Released To', accessor: 'releasedto', sortable: true },
    { header: 'Relation', accessor: 'relation', sortable: true },
    { header: 'ID Proof', accessor: 'idproof', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Formal handover process to relatives or police with necessary documentation.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Releases (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending NOC</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Storage Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24 Hrs</p>
        </div>
      </div>
