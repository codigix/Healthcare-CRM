...
export default function PostmortemRegisterPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'PM ID', accessor: 'pmid', sortable: true },
    { header: 'Deceased Name', accessor: 'deceasedname', sortable: true },
    { header: 'Police Station', accessor: 'policestation', sortable: true },
    { header: 'Assigned Doctor', accessor: 'assigneddoctor', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking bodies requiring autopsy and coordination with forensic doctors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending PMs</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reports Dispatched</p>
