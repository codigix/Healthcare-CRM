...
export default function CalendarViewPage() {
    ...
    const getStatusColor = (status: string) => {
        switch (status.toLowerCase()) {
            ...
            default:
                return "bg-slate-600 border-border";
        }
    };
        ...
        <>
            <div className="space-y-6">
                <div className="flex justify-between items-center my-3 my-3">
                    <div>
                        <h1 className="text-3xl  mb-2">Appointment Calendar</h1>
                ...
                <div className="card">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="flex bg-dark-tertiary rounded p-1">
                                <button
                                    onClick={() => setView("day")}
                    ...
                    {loading ? (
                        ...
                        <div className="overflow-x-auto">
                            <div className="min-w-[600px]">
                                <div className="grid grid-cols-[100px_1fr] gap-0 border border-dark-tertiary rounded overflow-hidden">
                                    <div className="bg-blue-500/20 p-4 border-b border-dark-tertiary">
                                        <span className="text-mdfont-medium text-blue-100">
                                            Time
                                        </span>
                                    </div>
                                    <div className="bg-blue-500/20 p-4 border-b border-dark-tertiary">
                                    ...
                                    {timeSlots.map((time, index) => {
                                        ...
                                        return (
                                            <div key={time} className="contents">
                                                <div
                                                    className={`p-4 border-b border-dark-tertiary ${index % 2 === 0
                                                        ? "bg-blue-400/15"
                                                        : "bg-blue-400/20"
                                                        }`}
                                                >
                                                    <span className="text-mdfont-medium text-blue-50">
                                                        {time}
                                                    </span>
                                                </div>
                                                <div
                                                ...
                                                >
                                                    {slotAppointments.length > 0 ? (
                                                        ...
                                                        <div className="text-mdtext-blue-100/60 italic">
                                                            No appointments
                                                        </div>
                                                    )}
                                                </div>
                    ...
                    <div className="card">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <div>
                                ...
                                <div className="text-mdtext-gray-400">Today's Appointments</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <div>
                                ...
                                <div className="text-mdtext-gray-400">Confirmed</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <div>
                                ...
                                <div className="text-mdtext-gray-400">Pending</div>
                            </div>
                        </div>
                    </div>
                </div>
