        ...
        <>
            <div className="space-y-6">
                <div className="flex justify-between items-center my-3 my-3">
                    <div>
                        <h1 className="text-3xl  mb-2">Appointment Requests</h1>
                ...
                <div className="card">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        <div className="flex-1 flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 rounded px-4">
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-4">
                            {filteredRequests.map((request) => (
                                <div
                                    key={request.id}
                                    className="p-6 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded border border-emerald-500/30 hover:border-emerald-500/50 transition-all"
                                >
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                        ...
                                        <div className="flex md:flex-col gap-2">
                                            {activeTab === "pending" && (
                                                <>
                                                    <button
                                                        ...
                                                        className="flex items-center gap-2 p-2 bg-emerald-500 hover:bg-emerald-600 rounded transition-colors"
                                                    >
                                                        <CheckCircle size={15} />
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex items-center gap-2 p-2 bg-red-500/10 hover:bg-red-500/20 text-red-500 border border-red-500/20 rounded transition-colors"
                                                    >
                                                        <XCircle size={15} />
                                            ...
                                            {activeTab === "approved" && (
                                                <span className="flex items-center gap-2 p-2 bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 rounded">
                                                    <CheckCircle size={15} />
                                                    Approved
                                                </span>
                                            )}
                                            {activeTab === "rejected" && (
                                                <span className="flex items-center gap-2 p-2 bg-red-500/10 text-red-500 border border-red-500/20 rounded">
                                                    <XCircle size={15} />
                                                    Rejected
                                                </span>
                                            )}
