        ...
        <>
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl  mb-2 text-white">Add Appointment</h1>
                ...
                <form onSubmit={handleSubmit} className="w-full">
                    <div className="card bg-dark-secondary border border-dark-tertiary p-6 md:p-8 space-y-8 rounded">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="relative" ref={patientDropdownRef}>
                                    ...
                                    {showPatientDropdown && (
                                        <div className="absolute z-20 w-full left-0 mt-1 bg-dark-secondary border border-dark-tertiary rounded shadow-2xl max-h-60 overflow-y-auto">
                                            {filteredPatients.length > 0 ? (
                                                filteredPatients.map((patient) => (
                                                    <div
                                                        ...
                                                        className={`p-2 hover:bg-dark-tertiary cursor-pointer border-b border-dark-tertiary/20 last:border-0 transition-colors flex items-center justify-between text-sm ${formData.patientId === patient.id ? "bg-emerald-500/10 text-emerald-400" : "text-gray-300"
                                                            }`}
                                                    >
                                                        <div>
                                            ...
                                            {filteredDepartments.length > 0 ? (
                                                filteredDepartments.map((dept) => (
                                                    <div
                                                        ...
                                                        className={`p-2 hover:bg-dark-tertiary cursor-pointer border-b border-dark-tertiary/20 last:border-0 transition-colors flex items-center justify-between text-sm ${selectedDeptId === dept.id ? "bg-emerald-500/10 text-emerald-400" : "text-gray-300"
                                                            }`}
                                                    >
                                            ...
                                            {filteredDoctors.length > 0 ? (
                                                filteredDoctors.map((doctor) => (
                                                    <div
                                                        ...
                                                        className={`p-2 hover:bg-dark-tertiary cursor-pointer border-b border-dark-tertiary/20 last:border-0 transition-colors flex items-center justify-between text-sm ${formData.doctorId === doctor.id ? "bg-emerald-500/10 text-emerald-400" : "text-gray-300"
                                                            }`}
                                                    >
                                                        <div>
                        ...
                        {error && (
                            <div className="p-4 bg-red-500/10 border border-red-500/20 rounded text-red-400 text-sm font-medium">
                                {error}
                            </div>
                        )}
                        ...
                        <div className="flex justify-end gap-4 pt-2">
                            <Link href="/appointments/all" className="btn-secondary px-6 py-2.5 rounded transition-all font-medium">
                                Cancel
                            </Link>
                            <button
                                type="submit"
                                disabled={loading || !formData.patientId || !formData.doctorId}
                                className="btn-primary px-6 py-2.5 rounded transition-all font-medium flex items-center justify-center gap-2 shadow-lg hover:shadow-emerald-500/15"
                            >
                                <CheckCircle size={20} />
