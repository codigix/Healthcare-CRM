    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="btn-primary py-2.5 px-5 font-semibold flex items-center justify-center gap-2 rounded-xl transition-all self-start sm:self-auto"
        >
          <Plus size={18} />
          Request Blood
        </button>
      ...
      {/* Success Banner */}
      {submitted && (
        <div className="flex items-center gap-3 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 rounded-xl px-5 py-4 animate-fade-in">
          <CheckCircle size={20} />
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-dark-tertiary text-gray-400 text-xs uppercase">
              ...
              <tbody className="divide-y divide-dark-tertiary/50">
                {myRequests.map((req) => (
                  <tr key={req.id} className="hover:bg-dark-tertiary/20 transition-colors">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-dark-tertiary">
            <button
              ...
              className="px-4 py-2 bg-dark-tertiary/50 hover:bg-dark-tertiary text-gray-300 font-semibold rounded-lg transition-all"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={submitting}
              className="btn-primary px-5 py-2 font-semibold flex items-center justify-center gap-2 disabled:opacity-60 rounded-lg"
            >
              <Droplet size={18} />
