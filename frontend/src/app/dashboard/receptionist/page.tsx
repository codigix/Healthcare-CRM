            ...
            <div className="card card-hover">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-2xl font-bold">28 Bookings</p>
            ...
            <div className="card card-hover">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-2xl font-bold">19 Patients</p>
            ...
            <div className="card card-hover border-emerald-500/20">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-2xl font-bold text-emerald-500">18 Beds</p>
            ...
            <div className="card card-hover border-red-500/20">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-2xl font-bold text-red-500">₹8,450.00</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                <Link href="/patients/add" className="flex items-center gap-3 p-3 rounded-lg border border-dark-tertiary hover:border-gray-500 transition-colors w-full text-left">
                  <div className="p-2 rounded bg-yellow-500/10 text-yellow-500"><Users size={18} /></div>
                  <div>
                ...
                <Link href="/ambulance/calls" className="flex items-center gap-3 p-3 rounded-lg border border-dark-tertiary hover:border-gray-500 transition-colors w-full text-left">
                  <div className="p-2 rounded bg-red-500/10 text-red-500"><PhoneCall size={18} /></div>
                  <div>
                ...
                <Link href="/billing/create-invoice" className="flex items-center gap-3 p-3 rounded-lg border border-dark-tertiary hover:border-gray-500 transition-colors w-full text-left">
                  <div className="p-2 rounded bg-emerald-500/10 text-emerald-500"><FileText size={18} /></div>
                  <div>
