...
export default function PharmacyDashboard() {
   ...
   const columns_0: Column<any>[] = [
      { header: "Patient Name", accessor: (rx) => (<>{rx.patient?.name || "Patient Walk-In"}</>) },
      { header: "Attending Doctor", accessor: (rx) => (<>{rx.doctor?.name || "Clinic Doctor"}</>) },
      { header: "Diagnosis", accessor: (rx) => (<>"\n{rx.diagnosis || "General Symptoms"}\n"</>) },
      { header: "Medication Details", accessor: (rx) => (<>\n{getMedicationNames(rx.medications)}\n</>) },
      {
         header: "Consultation Type", accessor: (rx) => (<>\n<span className={`px-2 py-0.5 rounded text-xs font-semibold ${rx.prescriptionType === "IPD"
      ...
      {
         header: "Status", accessor: (rx) => (<>\n<span className="px-2 py-0.5 bg-amber-500/10 text-amber-500 border border-amber-500/20 rounded text-xs  uppercase animate-pulse">
            {rx.status}
         </span>\n</>)
      },
   ];
   ...
   return (
      <div className="space-y-6">
         <div className="flex justify-between items-center my-3 my-3">
            <div>
               <h1 className="text-3xl  mb-2 text-white">Pharmacy Dashboard</h1>
         ...
         {loading ? (
            ...
            <>
                  ...
                  <div className="card card-hover border-teal-500/20">
                     <div className="flex justify-between items-start">
                        <div>
                           ...
                           <p className="text-2xl  text-teal-400">{stats.totalMedicationsTypes} Types</p>
                  ...
                  <div className="card card-hover border-amber-500/20">
                     <div className="flex justify-between items-start">
                        <div>
                           ...
                           <p className="text-2xl  text-amber-500">{stats.lowStockAlerts} Low Stock</p>
                  ...
                  <div className="card card-hover border-purple-500/20">
                     <div className="flex justify-between items-start">
                        <div>
                           ...
                           <p className="text-2xl  text-purple-400">{stats.pendingPrescriptions} Pending</p>
                  ...
                  <div className="card card-hover border-emerald-500/20">
                     <div className="flex justify-between items-start">
                        <div>
                           ...
                           <p className="text-2xl  text-emerald-400">₹{stats.dailySales.toFixed(2)}</p>
               ...
               <div className="card bg-dark-secondary border border-dark-tertiary p-6 rounded-xl">
                  <div className="flex justify-between items-center my-3 my-3 mb-4 pb-2 border-b border-dark-tertiary">
                  ...
                  <div className="overflow-x-auto">
                     <DataTable columns={columns_0} data={pendingQueue} enableLocalSearch enableLocalPagination />
                  </div>
               </div>
            </>
         )}
