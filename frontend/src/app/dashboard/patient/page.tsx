    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            try {
                ...
                const [upcomingRes, allRes, recordsRes, prescriptionsRes] =
                    await Promise.all([
                ...
                const activities: RecentActivity[] = allAppts
                    .slice(0, 3)
                    .map((apt: any) => ({
                        id: apt.id,
    ...
    return (
        <>
            <div className="space-y-6">
                <div>
                    <h1 className="text-3xl ">Welcome back, Patient</h1>
                            ...
                            <div className="card card-hover border border-dark-tertiary">
                                <div className=" flex items-start justify-between gap-3 mb-3">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <div>
                                            <p className="text-mdtext-gray-400">Upcoming</p>
                                ...
                                <p className="text-mdtext-gray-400 mt-2">Next: Nov 15, 2025</p>
                            </div>
                            ...
                            <div className="card card-hover border border-dark-tertiary">
                                <div className=" flex items-start justify-between gap-3 mb-3">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <div>
                                            <p className="text-mdtext-gray-400">Medical</p>
                                            <p className="text-mdtext-gray-400">Records</p>
                                        </div>
                                    </div>
                                    <p className="text-3xl ">
                                ...
                                <p className="text-mdtext-gray-400 mt-2">Total documents</p>
                            </div>
                            ...
                            <div className="card card-hover border border-dark-tertiary">
                                <div className=" flex items-start justify-between gap-3 mb-3">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <div>
                                            <p className="text-mdtext-gray-400">Active</p>
                                            <p className="text-mdtext-gray-400">Prescriptions</p>
                                        </div>
                                    </div>
                                    <p className="text-3xl ">
                                        {patientStats.prescriptions}
                                    </p>
                                </div>

                                <p className="text-mdtext-gray-400 mt-2">Current medications</p>
                            </div>
                            ...
                            <div className="card card-hover border border-dark-tertiary">
                                <div className=" flex items-start justify-between gap-3 mb-3">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <div>
                                            <p className="text-mdtext-gray-400">Test</p>
                                            <p className="text-mdtext-gray-400">Results</p>
                                        </div>
                                    </div>
                                    <p className="text-3xl ">
                                        {patientStats.testResults}
                                    </p>
                                </div>

                                <p className="text-mdtext-gray-400 mt-2">Available reports</p>
                            </div>
                        </div>
                                                ...
                                                {recentActivities.length === 0 ? (
                                                    ...
                                                    <div className="space-y-3">
                                                        {recentActivities.map((activity) => (
                                                            <div
                                                                key={activity.id}
                                                                className="flex items-center justify-between p-3 bg-dark-secondary rounded"
                                                            >
                                                                <div>
                                    ...
                                    {activeTab === "appointments" && (
                                        <div className="space-y-4">
                                            ...
                                            {upcomingAppointments.map((apt) => (
                                                <div
                                                    key={apt.id}
                                                    className="p-4 bg-dark-secondary rounded border border-dark-tertiary hover:bg-dark-tertiary transition-colors"
                                                >
                                                    ...
                                                    <div className="flex gap-2 mt-4">
                                                        <button
                                                            ...
                                                            className="flex-1 p-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded text-mdtransition-colors"
                                                        >
                                                            View Details
                                                        </button>
                                                        <button className="p-2 bg-dark-tertiary hover:bg-red-500/20 text-red-400 rounded text-mdtransition-colors">
                                                            Cancel
                                                        </button>
                                                    </div>
                                                </div>
                                                    ...
                                                    {medicalRecords.map((record) => (
                                                        ...
                                                        >
                                                            <div className="flex items-start justify-between mb-3">
                                                                ...
                                                                <span
                                                                    className={`px-3 py-1 rounded-full text-xs font-medium border ${record.status === "Active"
                                                            ...
                                                            {record.details && (
                                                                <p className="text-mdtext-gray-300 mb-3">
                                                                    {record.details}
                                                                </p>
                                                            )}
                                                    ...
                                                    {prescriptions.map((prescription) => (
                                                        ...
                                                        >
                                                            <div className="flex items-start justify-between mb-3">
                                                                ...
                                                                <span
                                                                    className={`px-3 py-1 rounded-full text-xs font-medium border ${prescription.status === "Active"
                                                                        ? "bg-emerald-500/10 text-emerald-500 border-emerald-500/20"
                                                            ...
                                                            {prescription.medications && (
                                                                <div className="mb-3">
                                                                    ...
                                                                    <p className="text-mdtext-gray-300 bg-dark-primary rounded px-2 py-1">
                                                                        {prescription.medications}
                                                                    </p>
                                                                </div>
                                                            )}
                                                            {prescription.notesForPharmacist && (
                                                                <p className="text-xs text-gray-400 mb-3 italic">
                                                                    Note: {prescription.notesForPharmacist}
                                                                </p>
                                                            )}
                                                            <div className="flex items-center justify-between text-mdtext-gray-400">
                                                                <div className="flex items-center gap-2">
                                ...
                                <div className="card">
                                    ...
                                    <div className="space-y-2">
                                        <button
                                            ...
                                            className="w-full p-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded text-mdtransition-colors flex items-center justify-center gap-2"
                                        >
                                            <Calendar size={15} />
                                            Book Appointment
                                        </button>
                                        <button
                                            ...
                                            className="w-full p-2 bg-dark-secondary hover:bg-dark-tertiary text-white rounded text-mdtransition-colors flex items-center justify-center gap-2"
                                        >
                                            <FileText size={15} />
                                            View Records
                                        </button>
