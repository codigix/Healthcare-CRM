                        ...
                        <div className="grid grid-cols-2 gap-4">
                          {healthMetrics.map((metric, idx) => {
                            ...
                            return (
                              <div
                                key={idx}
                                className="p-4 bg-dark-secondary rounded-lg border border-dark-tertiary"
                              >
                  ...
                  {activeTab === "appointments" && (
                    <div className="space-y-4">
                      ...
                      {upcomingAppointments.map((apt) => (
                        <div
                          key={apt.id}
                          className="p-4 bg-dark-secondary rounded-lg border border-dark-tertiary hover:bg-dark-tertiary transition-colors"
                        >
                          ...
                          <div className="flex gap-2 mt-4">
                            <button
                              ...
                              className="flex-1 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg text-mdtransition-colors"
                            >
                              View Details
                            </button>
                            <button className="px-4 py-2 bg-dark-tertiary hover:bg-red-500/20 text-red-400 rounded-lg text-mdtransition-colors">
                              Cancel
                            </button>
                          </div>
                        </div>
                ...
                <div className="card">
                  ...
                  <div className="space-y-2">
                    <button
                      ...
                      className="w-full px-4 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg text-mdtransition-colors flex items-center justify-center gap-2"
                    >
                      <Calendar size={18} />
                      Book Appointment
                    </button>
                    <button
                      ...
                      className="w-full px-4 py-3 bg-dark-secondary hover:bg-dark-tertiary text-white rounded-lg text-mdtransition-colors flex items-center justify-center gap-2"
                    >
                      <FileText size={18} />
                      View Records
                    </button>
