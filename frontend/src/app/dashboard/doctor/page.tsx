...
export default function DoctorDashboard() {
  ...
  const columns_0: Column<any>[] = [
    ...
    { header: "Email", accessor: (patient) => (<>\n{patient.email}\n</>) },
    { header: "Phone", accessor: (patient) => (<>\n{patient.phone}\n</>) },
    {
      header: "Appointments", accessor: (patient) => (<>\n<span className="bg-blue-500/10 text-blue-400 px-3 py-1 rounded-full text-sm">
        {patient.appointmentCount}
      </span>\n</>)
    },
    { header: "Last Visit", accessor: (patient) => (<>\n{patient.lastAppointment || "N/A"}\n</>) },
  ];
  ...
  return (
    <>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl ">Welcome back, Doctor</h1>
              ...
              <div className="flex gap-4 border-b border-dark-tertiary mb-6 overflow-x-auto">
                {["schedule", "patients", "tasks", "stats", "issue blood"].map((tab) => (
                  <button
                    ...
                    className={`p-2 text-mdfont-medium capitalize transition-colors relative whitespace-nowrap ${activeTab === tab
                      ? "text-white"
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {todaySchedule.map((apt) => (
                        <div
                          key={apt.id}
                          className="flex items-center justify-between p-4 bg-dark-secondary rounded hover:bg-dark-tertiary transition-colors border border-dark-tertiary"
                        >
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {apt.status?.toLowerCase() === "completed" ? (
                              ...
                              <Link href={`/appointments/consultation/${apt.id}`}>
                                <button className="p-2 bg-dark-tertiary hover:bg-emerald-500 text-white rounded text-mdtransition-colors active:scale-95">
                                  Start Consultation
                                </button>
                              </Link>
                            )}
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {upcomingAppointments.map((apt) => (
                        <div
                          key={apt.id}
                          className="p-4 bg-dark-secondary rounded hover:bg-dark-tertiary transition-colors border border-dark-tertiary"
                        >
                ...
                <div>
                  ...
                  {patients.length === 0 ? (
                    ...
                    <div className="overflow-x-auto">
                      <DataTable columns={columns_0} data={patients} enableLocalSearch enableLocalPagination />
                    </div>
                  )}
                </div>
              )}
                  ...
                  {tasks.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      {tasks.map((task) => (
                        <div
                          key={task.id}
                          className="flex items-start justify-between p-4 bg-dark-secondary rounded hover:bg-dark-tertiary transition-colors border border-dark-tertiary"
                        >
                ...
                <div>
                  ...
                  {stats ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <div className="p-4 bg-dark-secondary rounded border border-dark-tertiary lg:col-span-2">
                        <div className="flex items-start justify-between">
                          <div>
                            <p className="text-gray-400 text-mdmb-1">
                              Total Revenue
