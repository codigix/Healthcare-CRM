...
export default function DashboardPage() {
 ...
 try {
 const [statsRes, appointmentsRes, revenueRes, growthRes] =
 await Promise.all([
 dashboardAPI.stats(),
 ...
 <div className="flex justify-between items-start">
 <div>
 <p className="text-gray-400 text-mdmb-2">Appointments</p>
 <p className="text-2xl font-bold">
 ...
 <div className="flex justify-between items-start">
 <div>
 <p className="text-gray-400 text-mdmb-2">Patients</p>
 <p className="text-2xl font-bold">
 ...
 <div className="flex justify-between items-start">
 <div>
 <p className="text-gray-400 text-mdmb-2">Doctors</p>
 <p className="text-2xl font-bold">
 ...
 />
 <Bar dataKey="value" fill="rgb(26, 188, 156)" />
 </BarChart>
 </ResponsiveContainer>
 </div>
 ...
 <div className="card" data-tour="recent-appointments">
