...
export default function ReportTemplatesPage() {
  ...
  const columns = [
    ...
    { header: 'Layout Style', accessor: 'layoutstyle', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Customize the PDF layout and formatting for patient reports.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Templates</p>
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Default</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>Standard A4</p>
        </div>
      </div>
