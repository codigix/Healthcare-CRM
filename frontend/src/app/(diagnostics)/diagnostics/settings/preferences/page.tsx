...
export default function DiagnosticPreferencesPage() {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Department-wide settings for TAT alerts, critical thresholds, and printing defaults.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Auto-Authorization</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Enabled</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical SMS Alerts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Enabled</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Barcode Format</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Code128</p>
        </div>
      </div>
