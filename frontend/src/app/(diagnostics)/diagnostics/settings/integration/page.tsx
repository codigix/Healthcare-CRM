...
export default function MachineIntegrationLISPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Interface ID', accessor: 'interfaceid', sortable: true },
    { header: 'Machine Name', accessor: 'machinename', sortable: true },
    { header: 'Protocol', accessor: 'protocol', sortable: true },
    { header: 'Port/IP', accessor: 'portip', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">HL7/ASTM interfacing configuration between analyzers and LIS.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Connected Machines</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bi-Directional</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>20</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Connection Errors</p>
