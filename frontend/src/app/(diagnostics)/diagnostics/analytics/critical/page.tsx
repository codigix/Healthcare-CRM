...
export default function CriticalResultAnalyticsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Month', accessor: 'month', sortable: true },
    { header: 'Total Criticals', accessor: 'totalcriticals', sortable: true },
    { header: 'Avg Reporting Time', accessor: 'avgreportingtime', sortable: true },
    { header: 'Doctor Notified <30m', accessor: 'doctornotified30m', sortable: true },
    { header: 'Missed SLAs', accessor: 'missedslas', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analysis of life-threatening results, reporting times, and clinical impact.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Criticals (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>340</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SLA Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>98%</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Time to Notify</p>
