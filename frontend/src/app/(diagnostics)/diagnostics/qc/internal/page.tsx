...
export default function InternalQualityControlIQCPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Control ID', accessor: 'controlid', sortable: true },
    { header: 'Analyzer', accessor: 'analyzer', sortable: true },
    { header: 'Test Parameter', accessor: 'testparameter', sortable: true },
    { header: 'Target Value', accessor: 'targetvalue', sortable: true },
    { header: 'Actual Value', accessor: 'actualvalue', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Daily calibration logs, Levy-Jennings charts, and rule violations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">IQC Runs Today</p>
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Westgard Rule Violations</p>
