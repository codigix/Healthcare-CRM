...
export default function ExternalQualityAssuranceEQASPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'EQAS ID', accessor: 'eqasid', sortable: true },
    { header: 'Agency', accessor: 'agency', sortable: true },
    { header: 'Month', accessor: 'month', sortable: true },
    { header: 'Parameters Tested', accessor: 'parameterstested', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Proficiency testing results from external accredited agencies.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">EQAS Cycle</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>July 2026</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Outliers</p>
