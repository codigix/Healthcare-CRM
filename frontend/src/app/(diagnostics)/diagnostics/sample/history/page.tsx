...
export default function CollectionHistoryPage() {
  ...
  const columns = [
    { header: 'Collection ID', accessor: 'collectionid', sortable: true },
    { header: 'Date', accessor: 'date', sortable: true },
    { header: 'Total Samples', accessor: 'totalsamples', sortable: true },
    { header: 'Successful Collections', accessor: 'successfulcollections', sortable: true },
    { header: 'Rejections', accessor: 'rejections', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Historical log of all sample collections and phlebotomy activity.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Daily Collections</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>150</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4.8/5</p>
        </div>
      </div>
