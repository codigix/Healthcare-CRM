...
export default function DowntimeLogPage() {
  ...
  const columns = [
    ...
    { header: 'Issue Reported', accessor: 'issuereported', sortable: true },
    { header: 'Downtime Start', accessor: 'downtimestart', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Record of machine breakdowns, TAT impact, and repair resolution.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Current Breakdown</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>1</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Repair Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4 hours</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Uptime (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>99.5%</p>
        </div>
      </div>
