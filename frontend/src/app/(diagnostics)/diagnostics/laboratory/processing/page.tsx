...
export default function SampleProcessingPage() {
  ...
  const columns = [
    { header: 'Run ID', accessor: 'runid', sortable: true },
    { header: 'Analyzer Machine', accessor: 'analyzermachine', sortable: true },
    { header: 'Test Panel', accessor: 'testpanel', sortable: true },
    { header: 'Samples Loaded', accessor: 'samplesloaded', sortable: true },
    { header: 'Est. Completion', accessor: 'estcompletion', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Samples currently loaded in analyzers and being tested.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Runs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Machine Alerts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Load</p>
