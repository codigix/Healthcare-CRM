...
export default function BloodDonationPage() {
  ...
  const columns = [
    { header: 'Donor ID', accessor: 'donorid', sortable: true },
    { header: 'Donor Name', accessor: 'donorname', sortable: true },
    { header: 'Blood Group', accessor: 'bloodgroup', sortable: true },
    { header: 'Screening', accessor: 'screening', sortable: true },
    { header: 'Bag Type', accessor: 'bagtype', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Donor registration, screening, and phlebotomy records.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Donors Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Accepted</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>10</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Deferred</p>
