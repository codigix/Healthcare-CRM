...
export default function ComponentSeparationPage() {
  ...
  const columns = [
    { header: 'Whole Blood Unit', accessor: 'wholebloodunit', sortable: true },
    { header: 'Collection Time', accessor: 'collectiontime', sortable: true },
    { header: 'Separation Time', accessor: 'separationtime', sortable: true },
    { header: 'Components Produced', accessor: 'componentsproduced', sortable: true },
    { header: 'Technician', accessor: 'technician', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Preparation of PRBC, FFP, and Platelets from Whole Blood.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Units to Separate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>10</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Separated Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>25</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
