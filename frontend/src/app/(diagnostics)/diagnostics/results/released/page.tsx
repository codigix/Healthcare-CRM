...
export default function ReleasedReportsPage() {
  ...
  const columns = [
    ...
    { header: 'Delivered Via', accessor: 'deliveredvia', sortable: true },
    { header: 'View Count', accessor: 'viewcount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Archive of all final reports delivered to patients and doctors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Released Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>210</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">App/Portal Views</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Physical Prints</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>65</p>
        </div>
      </div>
