...
export default function PatientRadiologyReportsPage() {
  ...
  const columns = [
    ...
    { header: 'PACS Link', accessor: 'pacslink', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Search and download X-Ray, USG, CT, and MRI reports.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Images Attached</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>95%</p>
        </div>
      </div>
