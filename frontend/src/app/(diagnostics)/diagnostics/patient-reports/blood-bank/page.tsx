...
export default function BloodBankReportsPage() {
  ...
  const columns = [
    { header: 'Patient/Donor ID', accessor: 'patientdonorid', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Cross-match reports, transfusion history, and donor certificates.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,500</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cross-matches</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>800</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Donor Certs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>700</p>
        </div>
      </div>
