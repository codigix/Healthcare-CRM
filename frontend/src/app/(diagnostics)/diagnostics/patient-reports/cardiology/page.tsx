...
export default function PatientCardiologyReportsPage() {
  ...
  const columns = [
    ...
    { header: 'Study Type', accessor: 'studytype', sortable: true },
    { header: 'Cardiologist', accessor: 'cardiologist', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Access ECG tracings, Echo reports, and TMT summaries.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>3,400</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Recent (30 Days)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>210</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Abnormal findings</p>
