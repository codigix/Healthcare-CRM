...
export default function PatientLabReportsPage() {
  ...
  const columns = [
    ...
    { header: 'Downloads', accessor: 'downloads', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Search and download patient biochemistry, hematology, and micro reports.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Recent (30 Days)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1,200</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Search Queries</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>450</p>
        </div>
      </div>
