...
export default function WhatsAppReportsPage() {
  ...
  const columns = [
    ...
    { header: 'Report Link', accessor: 'reportlink', sortable: true },
    { header: 'Read Status', accessor: 'readstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Log of reports delivered securely via WhatsApp Business API.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">WhatsApp Sent</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>200</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Read (Blue Tick)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>180</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Opt-outs</p>
