...
export default function FluoroscopyPage() {
  ...
  const columns = [
    ...
    { header: 'Contrast/Barium', accessor: 'contrastbarium', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Dynamic X-ray studies like Barium Swallows, HSG, etc.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Prep Incomplete</p>
