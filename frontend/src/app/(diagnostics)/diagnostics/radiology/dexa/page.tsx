...
export default function DEXAScanPage() {
  ...
  const columns = [
    ...
    { header: 'Sites Scanned', accessor: 'sitesscanned', sortable: true },
    { header: 'T-Score (Lowest)', accessor: 'tscorelowest', sortable: true },
    { header: 'Interpretation', accessor: 'interpretation', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Bone Densitometry scans and osteoporosis screening reports.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Scans Today</p>
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Osteoporosis Detected</p>
