              ...
              <div className="grid grid-cols-7 gap-2">
                ...
                {getMonthCalendarDays().map((day, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`aspect-square rounded-lg p-2 ${statusColor} cursor-pointer hover:opacity-80 transition-opacity flex flex-col items-center justify-center text-center`}
                    >
