                ...
                <div className="card">
                    <div className="flex gap-4 mb-6 border-b border-dark-tertiary">
                        <button
                            ...
                            className={`py-3 px-4 font-medium transition-colors ${activeTab === "profile"
                        ...
                        <button
                            ...
                            className={`py-3 px-4 font-medium transition-colors ${activeTab === "security"
                                ? "text-emerald-500 border-b-2 border-emerald-500"
                                : "text-gray-400 hover:text-gray-300"
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`py-3 px-4 font-medium transition-colors ${activeTab === "preferences"
                                ? "text-emerald-500 border-b-2 border-emerald-500"
                                : "text-gray-400 hover:text-gray-300"
                                }`}
                        >
                    ...
                    {activeTab === "preferences" && (
                        <div className="space-y-4 max-w-md">
                            <div className="flex items-center justify-between p-4 bg-dark-tertiary rounded">
                                <div>
