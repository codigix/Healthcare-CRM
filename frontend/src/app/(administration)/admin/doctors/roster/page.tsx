...
export default function OncallRosterPage() {
  ...
  const columns = [
    { header: 'Roster ID', accessor: 'rosterid', sortable: true },
    ...
    { header: 'On-Call Type', accessor: 'oncalltype', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => (
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage after-hours and emergency on-call doctors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Doctors on Call</p>
          <p className="text-2xl  mt-2 text-blue-400">24</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Primary Call</p>
          <p className="text-2xl  mt-2 text-emerald-400">12</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Backup Call</p>
