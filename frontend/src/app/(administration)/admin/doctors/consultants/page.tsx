...
export default function VisitingConsultantsPage() {
  ...
  const columns = [
    ...
    { header: 'Consultant Name', accessor: 'consultantname', sortable: true },
    { header: 'Specialty', accessor: 'specialty', sortable: true },
    { header: 'Affiliation', accessor: 'affiliation', sortable: true },
    { header: 'Visit Frequency', accessor: 'visitfrequency', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => (
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Track and manage external visiting specialists.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-blue-400">32</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Weekly Visits</p>
          <p className="text-2xl  mt-2 text-emerald-400">18</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Monthly Visits</p>
