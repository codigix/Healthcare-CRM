...
export default function ResourceUtilizationPage() {
  ...
  const columns = [
    { header: 'Resource Type', accessor: 'resourcetype', sortable: true },
    { header: 'Total Units', accessor: 'totalunits', sortable: true },
    { header: 'Active Usage', accessor: 'activeusage', sortable: true },
    { header: 'Downtime', accessor: 'downtime', sortable: true },
    { header: 'Utilization Rate', accessor: 'utilizationrate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analytics on equipment and room usage.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Utilization</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>78%</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Underutilized</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12%</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical Load</p>
