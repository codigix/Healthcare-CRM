...
export default function DischargeApprovalsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Discharge ID', accessor: 'dischargeid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Attending Dr', accessor: 'attendingdr', sortable: true },
    { header: 'Clearance', accessor: 'clearance', sortable: true },
    { header: 'Billing Status', accessor: 'billingstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Final review and sign-off for discharges.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Clearances</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Ready for Exit</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>98</p>
        </div>
      </div>
