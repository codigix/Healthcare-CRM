...
export default function BuildingManagementPage() {
  ...
  const columns = [
    { header: 'Bldg ID', accessor: 'bldgid', sortable: true },
    { header: 'Building Name', accessor: 'buildingname', sortable: true },
    { header: 'Branch', accessor: 'branch', sortable: true },
    { header: 'Floors', accessor: 'floors', sortable: true },
    { header: 'Fire Clearance', accessor: 'fireclearance', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => (
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage hospital buildings and physical structures.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fully Operational</p>
          <p className="text-2xl  mt-2 text-emerald-400">10</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
