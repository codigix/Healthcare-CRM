...
export default function BedAllocationPage() {
  ...
  const columns = [
    ...
    { header: 'Bed Type', accessor: 'bedtype', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Granular tracking of individual bed occupancy across wards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-amber-400">980</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Available</p>
          <p className="text-2xl  mt-2 text-emerald-400">270</p>
        </div>
      </div>
