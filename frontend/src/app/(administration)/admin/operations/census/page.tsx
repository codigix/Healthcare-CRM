...
export default function HospitalCensusPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Ward/Zone', accessor: 'wardzone', sortable: true },
    { header: 'Admitted', accessor: 'admitted', sortable: true },
    { header: 'Discharges', accessor: 'discharges', sortable: true },
    { header: 'Transfers In', accessor: 'transfersin', sortable: true },
    { header: 'Transfers Out', accessor: 'transfersout', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Live patient population and demographic tracking.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Census</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>842</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Net Change</p>
