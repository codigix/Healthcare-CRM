...
export default function WorkflowAutomationPage() {
  ...
  const columns = [
    { header: 'Workflow Rule', accessor: 'workflowrule', sortable: true },
    { header: 'Trigger', accessor: 'trigger', sortable: true },
    { header: 'Action', accessor: 'action', sortable: true },
    { header: 'Target Group', accessor: 'targetgroup', sortable: true },
    { header: 'Executions', accessor: 'executions', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configure automated approval and task workflows.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Automations Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.2k</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Failed Executions</p>
