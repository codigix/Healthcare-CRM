...
export default function DepartmentManagementPage() {
  ...
  const columns = [
    { header: 'Department ID', accessor: 'departmentid', sortable: true },
    ...
    { header: 'Beds', accessor: 'beds', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => (
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    departmentid: `${'Department Management'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    departmentname: `Sample ${'Department Management'} ${i + 1}`,
    hod: `Sample Data ${i + 1}`,
    staffcount: `Sample Data ${i + 1}`,
    beds: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage clinical and non-clinical departments.</p>
        </div>
      ...
      <div className="my-3">
        <div className="p-4 border-b border-gray-800 flex justify-between items-center my-3 my-3 bg-dark-tertiary/20">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search department management..."
              value={searchTerm}
