...
export default function VendorAdministrationPage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    vendorid: `${'Vendor Administration'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    companyname: `Sample ${'Vendor Administration'} ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage suppliers and vendors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-emerald-400">245</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-purple-400">86</p>
        </div>
      </div>
      ...
      <div className="my-3">
        <div className="p-4 border-b border-gray-800 flex justify-between items-center my-3 my-3 bg-dark-tertiary/20">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search vendor administration..."
              value={searchTerm}
