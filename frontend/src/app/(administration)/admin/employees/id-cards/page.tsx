...
export default function IDCardsPage() {
  ...
  const columns = [
    ...
    { header: 'Access Level', accessor: 'accesslevel', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Generate and manage staff ID cards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-emerald-400">1,210</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Print</p>
          <p className="text-2xl  mt-2 text-amber-400">15</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lost/Revoked</p>
