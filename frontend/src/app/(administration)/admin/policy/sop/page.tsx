...
export default function SOPLibraryPage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    sopid: `${'SOP Library'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    title: `Sample ${'SOP Library'} ${i + 1}`,
    department: `Sample Data ${i + 1}`,
    author: `Sample Data ${i + 1}`,
    nextreview: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Standard Operating Procedures library.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total SOPs</p>
          <p className="text-2xl  mt-2 text-blue-400">345</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Review Overdue</p>
          <p className="text-2xl  mt-2 text-red-400">12</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Updated This Month</p>
