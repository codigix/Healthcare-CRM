...
export default function DepartmentPoliciesPage() {
  ...
  const columns = [
    ...
    { header: 'Mandatory For', accessor: 'mandatoryfor', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Policies specific to individual departments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Department Docs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>350</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>94%</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Non-Compliant</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2 Depts</p>
        </div>
      </div>
