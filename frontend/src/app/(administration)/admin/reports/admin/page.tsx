...
export default function AdministrativeReportsPage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    reportid: `${'Administrative Reports'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    title: `Sample ${'Administrative Reports'} ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">General administrative reports.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-blue-400">1,245</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Failed Deliveries</p>
      ...
      <div className="my-3">
        <div className="p-4 border-b border-gray-800 flex justify-between items-center my-3 my-3 bg-dark-tertiary/20">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search administrative reports..."
              value={searchTerm}
