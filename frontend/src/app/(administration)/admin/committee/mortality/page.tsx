...
export default function MortalityCommitteePage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    reviewid: `${'Mortality Committee'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    patientid: `Sample ${'Mortality Committee'} ${i + 1}`,
    department: `Sample Data ${i + 1}`,
    dateofdeath: `Sample Data ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Review of mortality cases and outcomes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cases to Review</p>
          <p className="text-2xl  mt-2 text-amber-400">4</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reviewed YTD</p>
          <p className="text-2xl  mt-2 text-blue-400">42</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Preventable</p>
