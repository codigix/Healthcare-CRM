...
export default function RoomAllocationPage() {
  ...
  const columns = [
    ...
    { header: 'Next Booking', accessor: 'nextbooking', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage meeting rooms, conference halls, and multi-purpose rooms.</p>
        </div>
