...
export default function ResourceManagementPage() {
  ...
  const mockData = Array.from({ length: 12 }).map((_, i) => ({
    assetid: `${'Resource Management'.substring(0, 3).toUpperCase()}-${1000 + i}`,
    name: `Sample ${'Resource Management'} ${i + 1}`,
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage hospital resources and assets.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          ...
          <p className="text-2xl  mt-2 text-blue-400">12.4k</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">In Use</p>
          <p className="text-2xl  mt-2 text-emerald-400">11.8k</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Needs Maintenance</p>
          <p className="text-2xl  mt-2 text-red-400">142</p>
        </div>
      </div>
