...
export default function ServicesOfferedPage() {
   ...
   const columns_0: Column<any>[] = [
      {
         header: "Service Name", accessor: (service) => (<>\n<div className="font-medium text-white">
            {service.name}
         </div>\n\n<div className="text-mdtext-gray-400">{service.id}</div>\n</>)
      },
      { header: "Department", accessor: (service) => (<>\n{departmentMap[service.departmentId] || "N/A"}\n</>) },
      {
         header: "Type", accessor: (service) => (<>\n<span
      ...
      {
         header: "Duration", accessor: (service) => (<>\n{service.duration}\nmin
         </>)
      },
      { header: "Price", accessor: (service) => (<>₹\n{parseFloat(String(service.price)).toFixed(2)}\n</>) },
      {
         header: "Status", accessor: (service) => (<>\n<span
      ...
      {
         header: "Actions", accessor: (service) => (<>\n<div className="flex gap-2">
            <button
      ...
      <>
         <div className="space-y-6">
            <div className="flex justify-between items-center my-3 my-3">
               <div>
                  <h1 className="text-3xl  mb-2">Services Offered</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
               ...
               <div className="card">
                  <div className="flex items-center gap-2">
                     ...
                     <div>
                        <div className="text-2xl ">{avgDuration} min</div>
            ...
            <div className="card">
               ...
               <div className="flex gap-4 mb-6 border-b border-dark-tertiary">
                  ...
                  <button
                     ...
                     className={`pb-3 px-1 font-medium transition-colors ${activeTab === "diagnostic"
                        ? "text-emerald-500 border-b-2 border-emerald-500"
                        : "text-gray-400 hover:text-gray-300"
                        }`}
                  >
                  ...
                  <button
                     ...
                     className={`pb-3 px-1 font-medium transition-colors ${activeTab === "treatment"
                        ? "text-emerald-500 border-b-2 border-emerald-500"
                        : "text-gray-400 hover:text-gray-300"
                        }`}
                  >
                  ...
                  <button
                     ...
                     className={`pb-3 px-1 font-medium transition-colors ${activeTab === "preventive"
                        ? "text-emerald-500 border-b-2 border-emerald-500"
                        : "text-gray-400 hover:text-gray-300"
                        }`}
                  >
               ...
               {loading ? (
                  ...
                  <div className="overflow-x-auto">
                     <DataTable columns={columns_0} data={services} enableLocalSearch enableLocalPagination />
                  </div>
               )}
               ...
               {!loading && services.length > 0 && (
                  <div className="flex justify-between items-center my-3 my-3 mt-6 pt-4 border-t border-dark-tertiary">
                     ...
                     <div className="flex gap-2">
                        ...
                        <span className="p-2 text-mdtext-gray-300">
                           Page {page}
                        </span>
                        <button
