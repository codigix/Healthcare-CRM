            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
               ...
               <div className="card">
                  <div className="flex items-center gap-2">
                     ...
                     <div>
                        <div className="text-2xl ">{overdueInvoices}</div>
               ...
               <div className="card">
                  <div className="flex items-center gap-2">
                     ...
                     <div>
                        <div className="text-2xl ">{insuranceClaims}</div>
            ...
            <div className="card">
               ...
               <div className="flex gap-4 mb-6 border-b border-dark-tertiary">
                  ...
                  <button
                     ...
                     className={`pb-3 px-1 font-medium transition-colors ${activeTab === "unpaid"
                        ? "text-emerald-500 border-b-2 border-emerald-500"
                        : "text-gray-400 hover:text-gray-300"
                        }`}
                  >
                  ...
                  <button
                     ...
                     className={`pb-3 px-1 font-medium transition-colors ${activeTab === "paid"
                        ? "text-emerald-500 border-b-2 border-emerald-500"
                        : "text-gray-400 hover:text-gray-300"
                        }`}
                  >
                  ...
                  <button
                     ...
                     className={`pb-3 px-1 font-medium transition-colors ${activeTab === "overdue"
                        ? "text-emerald-500 border-b-2 border-emerald-500"
                        : "text-gray-400 hover:text-gray-300"
                        }`}
                  >
