                        ...
                        <div className="card">
                            ...
                            <div className="space-y-4">
                                {services.map((service, index) => (
                                    <div
                                        key={service.id}
                                        className="p-4 bg-dark-tertiary/30 rounded space-y-4"
                                    >
                            ...
                            <div className="mt-6 pt-6 border-t border-dark-tertiary space-y-3">
                                ...
                                <div className="flex justify-between text-lg  pt-3 border-t border-dark-tertiary">
                                    <span>Total:</span>
                    ...
                    <div className="space-y-6">
                        <div className="card">
                            ...
                            <div className="space-y-4">
                                ...
                                {formData.patient && (
                                    <div className="p-4 bg-dark-tertiary/30 rounded">
