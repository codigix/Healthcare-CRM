...
export default function AyushmanBharatPMJAYPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'URN No', accessor: 'urnno', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Package Blocked', accessor: 'packageblocked', sortable: true },
    { header: 'Auth Amount', accessor: 'authamount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Billing and claim tracking specific to the Ayushman Bharat scheme.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Claims Submitted</p>
