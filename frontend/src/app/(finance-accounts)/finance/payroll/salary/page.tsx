...
export default function SalaryPostingPage() {
  ...
  const columns = [
    ...
    { header: 'Total Employees', accessor: 'totalemployees', sortable: true },
    { header: 'Gross Salary', accessor: 'grosssalary', sortable: true },
    { header: 'Net Payable', accessor: 'netpayable', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Transferring processed HR payroll data into the financial ledger.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Payroll (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$450,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Disbursed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$450,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Clearance</p>
