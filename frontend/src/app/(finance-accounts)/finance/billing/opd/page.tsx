...
export default function OPDBillingPage() {
  ...
  const columns = [
    { header: 'Bill No', accessor: 'billno', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Consultant', accessor: 'consultant', sortable: true },
    { header: 'Services', accessor: 'services', sortable: true },
    { header: 'Total Amount', accessor: 'totalamount', sortable: true },
    { header: 'Payment Mode', accessor: 'paymentmode', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Outpatient consultation and service billing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">OPD Revenue Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$12,450</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bills Generated</p>
