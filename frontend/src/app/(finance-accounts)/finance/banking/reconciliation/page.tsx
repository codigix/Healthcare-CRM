...
export default function BankReconciliationPage() {
  ...
  const columns = [
    { header: 'Recon ID', accessor: 'reconid', sortable: true },
    { header: 'Bank Account', accessor: 'bankaccount', sortable: true },
    { header: 'Statement Date', accessor: 'statementdate', sortable: true },
    { header: 'Sys Balance', accessor: 'sysbalance', sortable: true },
    { header: 'Bank Balance', accessor: 'bankbalance', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Matching system entries with actual bank statements (BRS).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Recons</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Completed (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>14</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unreconciled Value</p>
