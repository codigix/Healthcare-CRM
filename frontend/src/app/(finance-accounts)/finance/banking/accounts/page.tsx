...
export default function BankAccountsPage() {
  ...
  const columns = [
    ...
    { header: 'Account No', accessor: 'accountno', sortable: true },
    { header: 'Account Type', accessor: 'accounttype', sortable: true },
    { header: 'Current Balance', accessor: 'currentbalance', sortable: true },
    { header: 'Last Reconciled', accessor: 'lastreconciled', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Management of all hospital bank accounts and their current balances.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Bank Balance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$1.4M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Accounts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>6</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Recon</p>
