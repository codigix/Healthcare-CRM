...
export default function AdvanceCollectionPage() {
  ...
  const columns = [
    { header: 'Advance ID', accessor: 'advanceid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'IPD No / Ref', accessor: 'ipdnoref', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Deposits taken prior to IPD admission or major procedures.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Advances Today</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Refunds Pending</p>
