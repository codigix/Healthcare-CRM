...
export default function ShiftClosingPage() {
  ...
  const columns = [
    { header: 'Shift ID', accessor: 'shiftid', sortable: true },
    { header: 'Cashier', accessor: 'cashier', sortable: true },
    { header: 'System Total', accessor: 'systemtotal', sortable: true },
    { header: 'Physical Cash', accessor: 'physicalcash', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">End-of-shift reconciliation for cashiers before handover.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Closed Successfully</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unresolved Variances</p>
