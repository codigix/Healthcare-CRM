...
export default function CashCollectionPage() {
  ...
  const columns = [
    { header: 'Counter', accessor: 'counter', sortable: true },
    { header: 'Cashier', accessor: 'cashier', sortable: true },
    { header: 'Cash', accessor: 'cash', sortable: true },
    { header: 'Card', accessor: 'card', sortable: true },
    { header: 'UPI/Digital', accessor: 'upidigital', sortable: true },
    { header: 'Total Collected', accessor: 'totalcollected', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Dashboard tracking daily cash, card, and UPI collections across all counters.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Collected Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$84,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cash Component</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$24,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Shortages</p>
