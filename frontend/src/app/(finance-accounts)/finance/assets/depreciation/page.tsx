...
export default function AssetDepreciationPage() {
  ...
  const columns = [
    ...
    { header: 'Asset Category', accessor: 'assetcategory', sortable: true },
    { header: 'Depreciation Method', accessor: 'depreciationmethod', sortable: true },
    { header: 'Depreciation Amount', accessor: 'depreciationamount', sortable: true },
    { header: 'Posted Status', accessor: 'postedstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Calculation and posting of monthly/annual depreciation entries.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Depreciation (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$450K</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Entries Posted</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12/12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Next Run</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>31 Jul</p>
        </div>
      </div>
