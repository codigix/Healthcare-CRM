...
export default function AssetCapitalizationPage() {
  ...
  const columns = [
    { header: 'Project ID', accessor: 'projectid', sortable: true },
    { header: 'Project Name', accessor: 'projectname', sortable: true },
    { header: 'Total Expenses', accessor: 'totalexpenses', sortable: true },
    { header: 'Capitalized Value', accessor: 'capitalizedvalue', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Converting project expenses (e.g., building a new ward) into fixed assets.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active WIP Projects</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Capitalized (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$1.2M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Cap.</p>
