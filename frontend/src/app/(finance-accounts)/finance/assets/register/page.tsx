...
export default function AssetRegisterPage() {
  ...
  const columns = [
    ...
    { header: 'Accumulated Dep.', accessor: 'accumulateddep', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Financial view of hospital capital assets, distinct from physical inventory.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Net Book Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$5.2M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Assets Added (Mo)</p>
