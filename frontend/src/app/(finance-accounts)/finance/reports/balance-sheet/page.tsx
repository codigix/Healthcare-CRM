...
export default function BalanceSheetPage() {
  ...
  const columns = [
    { header: 'Group', accessor: 'group', sortable: true },
    { header: 'Sub-Group', accessor: 'subgroup', sortable: true },
    { header: 'Amount (Current)', accessor: 'amountcurrent', sortable: true },
    { header: 'Amount (Previous)', accessor: 'amountprevious', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Snapshot of hospital assets, liabilities, and equity at a specific point in time.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Liabilities</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$12.4M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Current Ratio</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.8</p>
        </div>
      </div>
