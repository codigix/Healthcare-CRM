...
export default function IncomeStatementPLPage() {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Profit and Loss statement showing hospital profitability over a period.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>18.4%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Revenue</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$4.2M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Expenses</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$3.4M</p>
        </div>
      </div>
