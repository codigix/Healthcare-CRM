...
export default function CashFlowPage() {
  ...
  const columns = [
    { header: 'Activity Type', accessor: 'activitytype', sortable: true },
    ...
    { header: 'Net Cash', accessor: 'netcash', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analysis of cash inflows and outflows (Operating, Investing, Financing).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Free Cash Flow</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$450K</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cash at End</p>
