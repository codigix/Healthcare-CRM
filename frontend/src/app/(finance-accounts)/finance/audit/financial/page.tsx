...
export default function FinancialAuditPage() {
  ...
  const columns = [
    ...
    { header: 'Area Audited', accessor: 'areaaudited', sortable: true },
    { header: 'Findings Logged', accessor: 'findingslogged', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tools for internal auditors to sample and verify financial statements.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Open Audits</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Major Non-Compliances</p>
