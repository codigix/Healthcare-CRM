...
export default function TransactionAuditPage() {
  ...
  const columns = [
    { header: 'Txn ID', accessor: 'txnid', sortable: true },
    { header: 'Type', accessor: 'type', sortable: true },
    { header: 'Amount', accessor: 'amount', sortable: true },
    { header: 'Flag Reason', accessor: 'flagreason', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Flagging anomalous transactions (e.g., deleted bills, unusually high discounts).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Anomalies Flagged</p>
