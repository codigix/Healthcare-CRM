    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Complete historical log of all patient transactions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Transactions (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revenue (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$12.4M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Failed Txns</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>124</p>
        </div>
      </div>
