...
export default function PaymentModesPage() {
  ...
  const columns = [
    { header: 'Mode Name', accessor: 'modename', sortable: true },
    { header: 'Type', accessor: 'type', sortable: true },
    { header: 'Gateway/Provider', accessor: 'gatewayprovider', sortable: true },
    { header: 'MDR Charge %', accessor: 'mdrcharge', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configuring payment gateways, card machines, and accepted currencies.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Modes</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Default Gateway</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Stripe</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg MDR</p>
