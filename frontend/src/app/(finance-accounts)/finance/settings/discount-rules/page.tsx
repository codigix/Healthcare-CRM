...
export default function DiscountRulesPage() {
  ...
  const columns = [
    { header: 'Role/Designation', accessor: 'roledesignation', sortable: true },
    { header: 'Max Discount %', accessor: 'maxdiscount', sortable: true },
    { header: 'Max Absolute Discount', accessor: 'maxabsolutediscount', sortable: true },
    { header: 'Requires OTP', accessor: 'requiresotp', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Setting maximum permissible discount limits for various user roles.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Roles Configured</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cashier Limit</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>5%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Admin Limit</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>100%</p>
        </div>
      </div>
