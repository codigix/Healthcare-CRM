...
export default function BillingRulesPage() {
  ...
  const columns = [
    ...
    { header: 'Action/Modifier', accessor: 'actionmodifier', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logic for automatic tax application, night charges, or emergency surcharges.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Emergency Surcharge</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1.5x</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Night Surcharge</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>+20%</p>
        </div>
      </div>
