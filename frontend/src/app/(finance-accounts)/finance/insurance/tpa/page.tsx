...
export default function TPAManagementPage() {
  ...
  const columns = [
    ...
    { header: 'Active Contracts', accessor: 'activecontracts', sortable: true },
    { header: 'Discount Rate', accessor: 'discountrate', sortable: true },
    { header: 'Total Business (YTD)', accessor: 'totalbusinessytd', sortable: true },
    { header: 'Settlement TAT', accessor: 'settlementtat', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Managing contracts, rates, and contact details for Third Party Administrators.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active TPAs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top TPA</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>MediAssist</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Contract Renewals</p>
