...
export default function PackageRevenuePage() {
  ...
  const columns = [
    { header: 'Package Name', accessor: 'packagename', sortable: true },
    { header: 'Count (Mo)', accessor: 'countmo', sortable: true },
    { header: 'Total Revenue', accessor: 'totalrevenue', sortable: true },
    { header: 'Total Actual Cost', accessor: 'totalactualcost', sortable: true },
    { header: 'Margin', accessor: 'margin', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Profitability analysis of fixed-cost surgical and maternity packages.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Most Profitable</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Cataract</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Loss Making</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>1 Package</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Margin</p>
