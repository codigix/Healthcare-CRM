...
export default function DepartmentRevenuePage() {
  ...
  const columns = [
    ...
    { header: 'OPD Revenue', accessor: 'opdrevenue', sortable: true },
    { header: 'IPD Revenue', accessor: 'ipdrevenue', sortable: true },
    { header: 'Total Revenue', accessor: 'totalrevenue', sortable: true },
    { header: 'Growth (MoM)', accessor: 'growthmom', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Income generated breakdown by each clinical and non-clinical department.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Revenue (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$4.2M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Department</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Cardiology</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lowest Growth</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Dietetics</p>
        </div>
      </div>
