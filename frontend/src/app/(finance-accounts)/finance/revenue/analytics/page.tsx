...
export default function RevenueAnalyticsPage() {
  ...
  const columns = [
    { header: 'Insight Area', accessor: 'insightarea', sortable: true },
    { header: 'Observation', accessor: 'observation', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">AI-driven insights into pricing optimization and revenue leakage.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Leakages Identified</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Potential Uplift</p>
