...
export default function GeneralLedgerPage() {
  ...
  const columns = [
    ...
    { header: 'Debit Balance', accessor: 'debitbalance', sortable: true },
    { header: 'Credit Balance', accessor: 'creditbalance', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Master record of all accounts and their respective balances.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$4.5M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
