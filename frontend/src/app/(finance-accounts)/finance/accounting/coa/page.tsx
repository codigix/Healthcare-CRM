...
export default function ChartofAccountsPage() {
  ...
  const columns = [
    ...
    { header: 'Parent Account', accessor: 'parentaccount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hierarchical structure of all financial accounts used in the hospital.</p>
        </div>
