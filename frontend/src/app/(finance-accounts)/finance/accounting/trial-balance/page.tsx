...
export default function TrialBalancePage() {
  ...
  const columns = [
    ...
    { header: 'Debit Amount', accessor: 'debitamount', sortable: true },
    { header: 'Credit Amount', accessor: 'creditamount', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Summary of all ledger balances to ensure debits equal credits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Debits</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$5.4M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Credits</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$5.4M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Difference</p>
