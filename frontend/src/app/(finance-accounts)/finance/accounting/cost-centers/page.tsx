...
export default function CostCentersPage() {
  ...
  const columns = [
    { header: 'Cost Center ID', accessor: 'costcenterid', sortable: true },
    { header: 'Name', accessor: 'name', sortable: true },
    { header: 'Head/Manager', accessor: 'headmanager', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Financial tracking categorized by hospital departments or specific projects.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Cost Centers</p>
