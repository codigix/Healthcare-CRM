...
export default function PatientReceivablesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Patient ID', accessor: 'patientid', sortable: true },
    { header: 'Name', accessor: 'name', sortable: true },
    { header: 'Total Debt', accessor: 'totaldebt', sortable: true },
    { header: 'Oldest Due', accessor: 'oldestdue', sortable: true },
    { header: 'Last Contacted', accessor: 'lastcontacted', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Unpaid dues directly owed by individual patients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Patient AR</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$145,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Patients > 90 Days</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Recovered (Mo)</p>
