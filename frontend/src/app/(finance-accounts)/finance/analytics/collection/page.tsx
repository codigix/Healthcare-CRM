...
export default function CollectionAnalyticsPage() {
  ...
  const columns = [
    { header: 'Counter/Mode', accessor: 'countermode', sortable: true },
    { header: 'Collection Volume', accessor: 'collectionvolume', sortable: true },
    { header: 'Collection %', accessor: 'collection', sortable: true },
    { header: 'Avg Transaction', accessor: 'avgtransaction', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Deep dive into payment modes, counter efficiency, and AR recovery rates.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Digital Payments %</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>65%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cash Handling Risk</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Low</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Collections (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$4.1M</p>
        </div>
      </div>
