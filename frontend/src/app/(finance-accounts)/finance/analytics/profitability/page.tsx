...
export default function ProfitabilityAnalysisPage() {
  ...
  const columns = [
    { header: 'Analysis Entity', accessor: 'analysisentity', sortable: true },
    { header: 'Gross Margin', accessor: 'grossmargin', sortable: true },
    { header: 'Net Margin', accessor: 'netmargin', sortable: true },
    { header: 'Contribution %', accessor: 'contribution', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Identifying margins at the department, service, and doctor levels.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Most Profitable Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Cardiology (35%)</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Hospital Net Margin</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>18.4%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Loss Making Units</p>
