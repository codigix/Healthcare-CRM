...
export default function CreditNotesPage() {
  ...
  const columns = [
    { header: 'CN No', accessor: 'cnno', sortable: true },
    { header: 'Original Invoice', accessor: 'originalinvoice', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Issued when a tax invoice needs to be reduced (e.g., refunds, discounts post-billing).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Credit Notes (Mo)</p>
