...
export default function GSTPage() {
  ...
  const columns = [
    ...
    { header: 'Total Sales (Taxable)', accessor: 'totalsalestaxable', sortable: true },
    { header: 'GST Collected', accessor: 'gstcollected', sortable: true },
    { header: 'Total Purchases', accessor: 'totalpurchases', sortable: true },
    { header: 'Input Tax Credit (ITC)', accessor: 'inputtaxcredititc', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking of Goods and Services Tax (Inward and Outward).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">GST Payable (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$14,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ITC Available</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$8,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Net Payable</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$6,300</p>
        </div>
      </div>
