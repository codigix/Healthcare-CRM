...
export default function TDSPage() {
  ...
  const columns = [
    ...
    { header: 'Vendor/Doctor', accessor: 'vendordoctor', sortable: true },
    { header: 'Payment Amount', accessor: 'paymentamount', sortable: true },
    { header: 'TDS Rate', accessor: 'tdsrate', sortable: true },
    { header: 'TDS Deducted', accessor: 'tdsdeducted', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tax Deducted at Source for professional fees (doctors) and contractors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">TDS Deducted (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$24,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Deposited to Govt</p>
