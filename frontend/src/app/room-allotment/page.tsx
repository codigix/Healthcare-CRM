...
export default function GlobalRoomAllotmentPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Room Number', accessor: 'roomnumber', sortable: true },
    { header: 'Floor/Building', accessor: 'floorbuilding', sortable: true },
    { header: 'Room Category', accessor: 'roomcategory', sortable: true },
    { header: 'Daily Rate', accessor: 'dailyrate', sortable: true },
    { header: 'Current Patient', accessor: 'currentpatient', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Global Room Allotment
          </h1>
          <p className="text-sm text-gray-400 mt-1">High-level facility layout and room management.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">VIP Suites</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12 / 15</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Private Rooms</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45 / 50</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">General Wards</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>240 / 300</p>
        </div>
      </div>
