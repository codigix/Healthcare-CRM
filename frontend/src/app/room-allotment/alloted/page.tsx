   ...
   const columns_0: Column<any>[] = [
      ...
      { header: "Room", accessor: (room) => (<>\n{room.room.roomNumber}\n</>) },
      {
         header: "Bed Slot", accessor: (room) => (<>\n{room.bed ? (
            <span className="px-2.5 py-0.5 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded text-xs  font-sans">
               {room.bed}
            </span>
         ) : (
   ...
   return (
      <>
         <div className="space-y-6">
            <div>
               <h1 className="text-3xl  text-white">Alloted Rooms</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
               ...
               <div className="bg-dark-secondary border border-dark-tertiary rounded p-6">
                  <div className="flex items-center justify-between">
                     ...
                     <div className="w-12 h-12 bg-amber-500/10 rounded flex items-center justify-center">
            ...
            <div className="bg-dark-secondary border border-dark-tertiary rounded p-6">
               <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                  ...
                  <Link href="/room-allotment/new">
                     <button className="px-6 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded transition-colors font-medium">
                        + New Allotment
                     </button>
                  </Link>
               </div>
               ...
               <div className="flex gap-4 mb-6 flex-wrap">
                  <div className="flex items-center gap-2">
                     ...
                     <select
                        ...
                        className="p-2 bg-dark-tertiary border border-dark-tertiary rounded text-white text-mdfocus:outline-none focus:border-emerald-500"
                     >
            ...
            {(() => {
               ...
               return (
                  <div className="space-y-4 text-gray-300">
                     <div className="flex justify-between items-center my-3 my-3 pb-2 border-b border-dark-tertiary/40">
                        <span className="text-xs text-emerald-400  font-mono">Allotment: #{room.id.slice(0, 8).toUpperCase()}</span>
                     ...
                     <div>
                        ...
                        <div className="p-3 bg-dark-tertiary rounded min-h-[60px] text-sm">
            ...
            <div className="space-y-4">
               <div>
                  ...
                  <select
                     ...
                     className="w-full p-2 bg-dark-tertiary border border-dark-tertiary rounded text-white focus:outline-none focus:border-emerald-500"
                  >
                     <option value="Occupied">Occupied</option>
                     <option value="Discharged">Discharged</option>
                     <option value="Reserved">Reserved</option>
               ...
               <div>
                  ...
                  <textarea
                     ...
                     className="w-full p-2 bg-dark-tertiary border border-dark-tertiary rounded text-white focus:outline-none focus:border-emerald-500 resize-none h-24"
               ...
               <div className="flex justify-end gap-3 mt-6">
                  <button
                     ...
                     className="p-2 bg-dark-tertiary text-white rounded hover:bg-dark-tertiary/80 transition-colors"
                  >
                     Cancel
                  </button>
                  <button
                     ...
                     disabled={saving}
                     className="p-2 bg-emerald-500 text-white rounded hover:bg-emerald-600 transition-colors disabled:opacity-50"
                  >
