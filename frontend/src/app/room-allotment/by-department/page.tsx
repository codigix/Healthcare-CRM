  ...
  return (
    <>
      <div className="space-y-6 pb-20">
        <div>
          <h1 className="text-3xl font-bold text-white font-outfit">Rooms & Beds Dashboard</h1>
          <p className="text-gray-400 mt-1">Live clinical floor layout, bed occupancy metrics, and department ward statuses</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
          <div className="bg-dark-secondary border border-dark-tertiary rounded-xl p-5 shadow-sm">
            <p className="text-gray-500 text-[10px] uppercase font-bold tracking-wider">Total Rooms</p>
          ...
          <div className="bg-dark-secondary border border-dark-tertiary rounded-xl p-5 shadow-sm">
            <p className="text-gray-500 text-[10px] uppercase font-bold tracking-wider">Total Beds</p>
          ...
          <div className="bg-dark-secondary border border-dark-tertiary rounded-xl p-5 shadow-sm">
            <p className="text-gray-500 text-[10px] uppercase font-bold tracking-wider">Available Beds</p>
          ...
          <div className="bg-dark-secondary border border-dark-tertiary rounded-xl p-5 shadow-sm">
            <p className="text-gray-500 text-[10px] uppercase font-bold tracking-wider">Occupied Beds</p>
          ...
          <div className="bg-dark-secondary border border-dark-tertiary rounded-xl p-5 shadow-sm">
            <p className="text-gray-500 text-[10px] uppercase font-bold tracking-wider">ICU Beds</p>
          ...
          <div className="bg-dark-secondary border border-dark-tertiary rounded-xl p-5 shadow-sm">
            <p className="text-gray-500 text-[10px] uppercase font-bold tracking-wider">Ward Beds</p>
        ...
        <div className="bg-dark-secondary border border-dark-tertiary rounded-xl p-6 shadow-md space-y-6">
          ...
          <div>
            <h2 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">Clinical Departments</h2>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pt-4 border-t border-dark-tertiary/40">
            <div className="relative flex-1 md:flex-none">
              ...
              <input
                ...
                className="w-full md:w-60 pl-9 pr-4 py-2 bg-dark-tertiary border border-dark-tertiary/70 rounded-lg text-xs text-white placeholder-gray-500 focus:outline-none focus:border-emerald-500"
              />
            </div>
            ...
            <div className="flex items-center gap-3 w-full md:w-auto flex-wrap">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="px-3 py-1.5 bg-dark-tertiary border border-dark-tertiary rounded-lg text-xs text-white focus:outline-none focus:border-emerald-500 h-[36px] font-semibold"
                >
              ...
              <Link href="/room-allotment/add-room" className="ml-auto md:ml-0">
                <button className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg transition-all text-xs font-bold shadow-md shadow-emerald-500/10 active:scale-95">
                  + Add New Room
                </button>
              </Link>
            </div>
                  ...
                  >
                    <div className="space-y-2">
                      <div className="flex items-start justify-between">
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="text-white font-bold text-lg font-outfit">Room {room.roomNumber}</span>
                            <span className={`px-2 py-0.5 rounded text-[9px] font-bold border uppercase tracking-wider ${getRoomTypeColor(room.roomType)}`}>
                              {room.roomType}
                            </span>
                          </div>
                        ...
                        <div className="relative">
                          ...
                          {openDropdown === room.id && (
                            <div className="absolute right-0 mt-1 w-44 bg-dark-secondary border border-dark-tertiary rounded-lg shadow-xl z-20 overflow-hidden divide-y divide-dark-tertiary/50">
                              <button
                                onClick={() => {
                                ...
                                className="w-full flex items-center gap-2 px-4 py-2.5 text-gray-300 hover:bg-dark-tertiary hover:text-emerald-400 transition-colors text-xs font-semibold text-left"
                              >
                                <Edit2 size={13} />
                                Room Status
                              </button>
                              <button
                                ...
                                className="w-full flex items-center gap-2 px-4 py-2.5 text-gray-300 hover:bg-dark-tertiary hover:text-blue-400 transition-colors text-xs font-semibold text-left"
                              >
                                <Eye size={13} />
                                Room Features
                              </button>
                              <button
                                ...
                                className="w-full flex items-center gap-2 px-4 py-2.5 text-rose-500 hover:bg-rose-950/20 transition-colors text-xs font-semibold text-left"
                              >
                                <Trash2 size={13} />
                                Delete Room
                              </button>
                      ...
                      <div className="flex justify-between items-center text-[10px] text-gray-400 font-semibold mt-1">
                        ...
                        <span className={`px-2 py-0.5 rounded-full text-[9px] font-bold border uppercase ${getStatusColor(room.status)}`}>
                          {room.status}
                        </span>
                      </div>
                    </div>
                        ...
                        return (
                          <div
                            ...
                            className={`p-2.5 rounded-lg border text-left transition-all flex items-center gap-2 ${
                              isOccupied ? "cursor-pointer active:scale-95 hover:border-emerald-500/40" : "cursor-default"
                            } ${getBedIconColor(bedItem.status)}`}
                          >
                            <Bed size={13} className="shrink-0" />
                            <div className="min-w-0 flex-1">
                              <span className="text-[10px] font-bold block leading-none font-mono">{bedItem.name}</span>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 animate-fadeIn">
          <div className="bg-dark-secondary border border-dark-tertiary rounded-xl p-6 w-full max-w-sm shadow-xl space-y-4">
            <div className="flex items-center gap-2 border-b border-dark-tertiary pb-3">
              <ShieldAlert className="text-emerald-400 shrink-0 animate-pulse" size={18} />
              <h3 className="text-base font-bold text-white uppercase tracking-wider font-outfit">Bed Occupancy Details</h3>
            </div>

            <div className="space-y-3.5 text-xs text-gray-300">
              <div className="grid grid-cols-2 gap-4 bg-dark-tertiary/30 p-3 rounded-lg border border-dark-tertiary/40 font-mono">
                <div>
                  <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Bed Slot ID</p>
                  <p className="font-bold text-white text-xs mt-0.5">{selectedBedDetails.name}</p>
                </div>
                <div>
                  <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Location</p>
                  <p className="font-bold text-white text-xs mt-0.5">Room {selectedBedDetails.roomNumber}</p>
                </div>
              </div>

              <div>
                <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Admitted Patient Name</p>
                <p className="font-bold text-white text-xs mt-0.5">{selectedBedDetails.patientName}</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Clinical Status</p>
                  <span className={`px-2 py-0.5 rounded text-[10px] font-bold border uppercase mt-1 inline-block ${
                    selectedBedDetails.status.toLowerCase() === "occupied" ? "bg-rose-500/10 text-rose-400 border-rose-500/20" : "bg-amber-500/10 text-amber-400 border-amber-500/20"
                  }`}>
            ...
            <div className="flex justify-end pt-4 border-t border-dark-tertiary/40">
              <button
                ...
                className="px-5 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg text-xs font-bold transition-all shadow shadow-emerald-500/10 active:scale-95"
              >
                Close Details
              </button>
            </div>
      ...
      {statusUpdateModal && selectedRoom && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 animate-fadeIn">
          <div className="bg-dark-secondary border border-dark-tertiary rounded-xl p-6 w-full max-w-sm shadow-xl space-y-4">
            <h3 className="text-lg font-bold text-white font-outfit">Update Room Status</h3>
            ...
            <div>
              <label className="block text-gray-400 text-xs font-bold mb-2">New Status</label>
              <select
                value={newStatus}
                onChange={(e) => setNewStatus(e.target.value)}
                className="w-full px-3 py-2 bg-dark-tertiary border border-dark-tertiary rounded-lg text-xs text-white focus:outline-none focus:border-emerald-500 h-[38px] font-semibold"
              >
            ...
            <div className="flex gap-2 justify-end pt-4 border-t border-dark-tertiary/40">
              <button
                ...
                className="px-4 py-2 bg-dark-tertiary text-gray-300 rounded-lg hover:bg-dark-tertiary/70 transition-colors text-xs font-bold"
              >
                Cancel
              </button>
              <button
                onClick={handleUpdateStatus}
                className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg transition-all text-xs font-bold active:scale-95 animate-fadeIn"
              >
                Update Room
              </button>
            </div>
      ...
      {viewDetailsModal && selectedRoom && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 animate-fadeIn">
          <div className="bg-dark-secondary border border-dark-tertiary rounded-xl p-6 w-full max-w-sm shadow-xl space-y-4">
            <h3 className="text-lg font-bold text-white font-outfit border-b border-dark-tertiary pb-3 mb-2 flex items-center gap-2">
              <HeartPulse className="text-emerald-400" size={18} />
              Room Facilities & Features
            </h3>

            <div className="space-y-4 text-xs text-gray-300 leading-normal">
              <div className="grid grid-cols-2 gap-4 bg-dark-tertiary/20 p-3 rounded-lg border border-dark-tertiary/40 font-mono">
                <div>
                  <p className="text-gray-500 font-bold uppercase tracking-wider text-[9px]">Room ID</p>
                  <p className="text-white font-bold text-xs mt-0.5">{selectedRoom.roomNumber}</p>
                </div>
                <div>
                  <p className="text-gray-500 font-bold uppercase tracking-wider text-[9px]">Category</p>
                  <p className="text-white font-bold text-xs mt-0.5 truncate">{selectedRoom.roomType}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-y-2 gap-x-3">
                <div className="flex items-center justify-between bg-dark-tertiary/10 p-2 rounded">
                  ...
                  <span className={`font-bold ${selectedRoom.oxygenSupply ? "text-emerald-400" : "text-gray-600"}`}>
                ...
                <div className="flex items-center justify-between bg-dark-tertiary/10 p-2 rounded">
                  ...
                  <span className={`font-bold ${selectedRoom.ventilator ? "text-emerald-400" : "text-gray-600"}`}>
                ...
                <div className="flex items-center justify-between bg-dark-tertiary/10 p-2 rounded">
                  ...
                  <span className={`font-bold ${selectedRoom.patientMonitor ? "text-emerald-400" : "text-gray-600"}`}>
                ...
                <div className="flex items-center justify-between bg-dark-tertiary/10 p-2 rounded">
                  ...
                  <span className={`font-bold ${selectedRoom.nursecallButton ? "text-emerald-400" : "text-gray-600"}`}>
                ...
                <div className="flex items-center justify-between bg-dark-tertiary/10 p-2 rounded">
                  ...
                  <span className={`font-bold ${selectedRoom.attachedBathroom ? "text-emerald-400" : "text-gray-600"}`}>
                ...
                <div className="flex items-center justify-between bg-dark-tertiary/10 p-2 rounded">
                  ...
                  <span className={`font-bold ${selectedRoom.airConditioning ? "text-emerald-400" : "text-gray-600"}`}>
                ...
                <div className="flex items-center justify-between bg-dark-tertiary/10 p-2 rounded">
                  ...
                  <span className={`font-bold ${selectedRoom.wheelchairAccessible ? "text-emerald-400" : "text-gray-600"}`}>
                ...
                <div className="flex items-center justify-between bg-dark-tertiary/10 p-2 rounded">
                  ...
                  <span className={`font-bold ${selectedRoom.wifi ? "text-emerald-400" : "text-gray-600"}`}>
              ...
              <div>
                <p className="text-gray-500 font-bold uppercase tracking-wider text-[9px] mb-1">Additional Operational Notes</p>
                <div className="p-3 bg-dark-tertiary/30 rounded-lg min-h-[50px] border border-dark-tertiary/40 text-[11px] text-gray-400 italic">
            ...
            <div className="flex justify-end pt-4 border-t border-dark-tertiary/40">
              <button
                ...
                className="px-5 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg text-xs font-bold transition-all active:scale-95"
              >
                Close Panel
              </button>
            </div>
