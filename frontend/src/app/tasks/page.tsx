    ...
    const [tasks, setTasks] = useState<Task[]>([
        {
            ...
            description:
                "Go through the latest patient records and update the system",
            priority: "high",
            status: "to-do",
            dueDate: "Nov 15, 2025",
        ...
        },
        {
            ...
            description:
                "Complete statistics and prepare the monthly clinic performance report",
            priority: "high",
            status: "to-do",
            dueDate: "Due Nov 9, 2025",
            assignee: "Dr. Sarah Johnson",
        ...
        },
        {
            ...
            description:
                "Sort and organize physical patient files in the storage room",
            priority: "low",
            status: "to-do",
        ...
        <>
                ...
                <div className="flex justify-between items-center my-3 my-3">
                    <div>
                        ...
                        <p className="text-gray-400">
                            Manage your tasks and track progress • {filteredTasks.length}{" "}
                            tasks
                        </p>
                    </div>
                    <button
                ...
                <div className="flex gap-4 flex-wrap">
                    <div className="flex-1 min-w-[300px] relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 bg-dark-tertiary rounded text-white border border-dark-secondary focus:border-emerald-500 outline-none"
                        />
                    </div>
                    <select
                        value={filterStatus}
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-dark-secondary rounded p-6 w-full max-w-md mx-4 space-y-4">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full p-2 bg-dark-tertiary rounded text-white border border-dark-secondary focus:border-emerald-500 outline-none"
                                />
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select className="w-full p-2 bg-dark-tertiary rounded text-white border border-dark-secondary focus:border-emerald-500 outline-none">
                                        <option>To Do</option>
                            ...
                            <div className="flex gap-3 justify-end pt-4">
                                <button
                                    onClick={() => setShowModal(false)}
                                    className="p-2 rounded text-gray-300 border border-dark-tertiary hover:bg-dark-tertiary transition-colors"
                                >
                                    Cancel
                                </button>
                                <button className="btn-primary p-2">Create Task</button>
                            </div>
                        </div>
                    </div>
                </div>
