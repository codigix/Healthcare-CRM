...
export default function RefundManagementPage() {
  ...
  const columns = [
    ...
    { header: 'Original Receipt', accessor: 'originalreceipt', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Processing refunds for cancelled services or excess advance payments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Refunds Processed</p>
