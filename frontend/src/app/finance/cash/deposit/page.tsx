...
export default function BankDepositManagementPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Deposit ID', accessor: 'depositid', sortable: true },
    { header: 'Date', accessor: 'date', sortable: true },
    { header: 'Amount', accessor: 'amount', sortable: true },
    { header: 'Bank', accessor: 'bank', sortable: true },
    { header: 'Deposited By', accessor: 'depositedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logging the handover of physical cash to the bank.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cash In Hand</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$14,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Deposited Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$45,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Variances</p>
