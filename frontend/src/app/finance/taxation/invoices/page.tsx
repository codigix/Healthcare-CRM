...
export default function TaxInvoicesPage() {
  ...
  const columns = [
    ...
    { header: 'Billed To', accessor: 'billedto', sortable: true },
    { header: 'Taxable Amount', accessor: 'taxableamount', sortable: true },
    { header: 'Total Tax', accessor: 'totaltax', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Formal tax invoices generated for B2B and specific patient requests.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Tax Billed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$18,400</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
