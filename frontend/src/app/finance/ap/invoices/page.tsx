...
export default function PurchaseInvoicesPage() {
  ...
  const columns = [
    ...
    { header: 'PO/GRN Ref', accessor: 'pogrnref', sortable: true },
    { header: 'Vendor', accessor: 'vendor', sortable: true },
    { header: 'Invoice Value', accessor: 'invoicevalue', sortable: true },
    { header: 'Matched Value', accessor: 'matchedvalue', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Invoices directly linked to and matched with POs and GRNs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Invoices Matched</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>85</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Variance Pending</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Ready for Payment</p>
