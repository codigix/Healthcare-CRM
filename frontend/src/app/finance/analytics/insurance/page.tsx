...
export default function InsuranceAnalyticsPage() {
  ...
  const columns = [
    ...
    { header: 'Approval Rate', accessor: 'approvalrate', sortable: true },
    { header: 'Rejection Rate', accessor: 'rejectionrate', sortable: true },
    { header: 'Avg Payment TAT', accessor: 'avgpaymenttat', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Evaluating TPA performance, rejection rates, and payment TATs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Approval Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>94%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fastest Payer</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Allianz (15D)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Rejections</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>Bupa (8%)</p>
        </div>
      </div>
