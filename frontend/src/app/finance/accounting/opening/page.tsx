...
export default function OpeningBalancesPage() {
  ...
  const columns = [
    ...
    { header: 'Previous Year Close', accessor: 'previousyearclose', sortable: true },
    { header: 'Opening Debit', accessor: 'openingdebit', sortable: true },
    { header: 'Opening Credit', accessor: 'openingcredit', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Initial balances brought forward at the start of the financial year.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">FY 2026-27 Set</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Yes</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Reconciliations</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Accounts Set</p>
