...
export default function JournalEntriesPage() {
  ...
  const columns = [
    ...
    { header: 'Total Debit', accessor: 'totaldebit', sortable: true },
    { header: 'Total Credit', accessor: 'totalcredit', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manual double-entry accounting records for adjustments and non-standard transactions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Entries Today</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Imbalanced</p>
