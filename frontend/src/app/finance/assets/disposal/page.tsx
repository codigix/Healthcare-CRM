...
export default function AssetDisposalPage() {
  ...
  const columns = [
    { header: 'Disposal ID', accessor: 'disposalid', sortable: true },
    { header: 'Asset Name', accessor: 'assetname', sortable: true },
    { header: 'Net Book Value', accessor: 'netbookvalue', sortable: true },
    { header: 'Sale/Scrap Value', accessor: 'salescrapvalue', sortable: true },
    { header: 'Gain/Loss', accessor: 'gainloss', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Financial accounting for scrapped, sold, or lost assets (gain/loss calculation).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Assets Disposed (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Net Loss on Sale</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$2,400</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Value Recovered</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$15K</p>
        </div>
      </div>
