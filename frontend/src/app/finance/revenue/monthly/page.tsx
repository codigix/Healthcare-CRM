...
export default function MonthlyRevenuePage() {
  ...
  const columns = [
    ...
    { header: 'OPD %', accessor: 'opd', sortable: true },
    { header: 'IPD %', accessor: 'ipd', sortable: true },
    { header: 'Total Revenue', accessor: 'totalrevenue', sortable: true },
    { header: 'Target Achieved', accessor: 'targetachieved', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Month-on-Month comparison for board reporting and trend analysis.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">YTD Revenue</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$24.5M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Target Achievement</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>105%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Month</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>May</p>
        </div>
      </div>
