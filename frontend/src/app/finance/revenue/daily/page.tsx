...
export default function DailyRevenuePage() {
  ...
  const columns = [
    ...
    { header: 'Discounts Given', accessor: 'discountsgiven', sortable: true },
    { header: 'Net Revenue', accessor: 'netrevenue', sortable: true },
    { header: 'Actual Collected', accessor: 'actualcollected', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Day-end snapshot of all billed services versus actual collections.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Daily Rev</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$145K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Collection Ratio</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>92%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Daily Discount</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$4.5K</p>
        </div>
      </div>
