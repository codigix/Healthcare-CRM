...
export default function DoctorRevenuePage() {
  ...
  const columns = [
    ...
    { header: 'Consultation Rev', accessor: 'consultationrev', sortable: true },
    { header: 'Procedure Rev', accessor: 'procedurerev', sortable: true },
    { header: 'Total Share', accessor: 'totalshare', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Revenue generated per consultant and their corresponding payout shares.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Dr. Smith</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Payouts (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$850K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Disbursal</p>
