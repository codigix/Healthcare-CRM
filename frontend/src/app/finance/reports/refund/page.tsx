...
export default function RefundReportPage() {
  ...
  const columns = [
    { header: 'Refund ID', accessor: 'refundid', sortable: true },
    { header: 'Date', accessor: 'date', sortable: true },
    { header: 'Beneficiary', accessor: 'beneficiary', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Audit log of all money returned to patients or vendors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Refunds (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$12,400</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Refund Count</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Refund TAT</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>2 Days</p>
        </div>
      </div>
