...
export default function GSTReportPage() {
  ...
  const columns = [
    ...
    { header: 'GSTIN', accessor: 'gstin', sortable: true },
    { header: 'Taxable Value', accessor: 'taxablevalue', sortable: true },
    { header: 'CGST', accessor: 'cgst', sortable: true },
    { header: 'SGST', accessor: 'sgst', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Itemized list of B2B and B2C sales for GST portal upload.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">B2B Invoices</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">B2C Invoices</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>14,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Tax</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$14,500</p>
        </div>
      </div>
