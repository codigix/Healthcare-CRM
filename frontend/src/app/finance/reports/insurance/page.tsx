...
export default function InsuranceReportPage() {
  ...
  const columns = [
    ...
    { header: 'Claims Sent', accessor: 'claimssent', sortable: true },
    { header: 'Claimed Value', accessor: 'claimedvalue', sortable: true },
    { header: 'Settled Value', accessor: 'settledvalue', sortable: true },
    { header: 'Deduction %', accessor: 'deduction', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Summary of claims sent, settled, and rejected per TPA/Provider.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Deduction %</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Settled (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$850K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Reject Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>Bupa</p>
        </div>
      </div>
