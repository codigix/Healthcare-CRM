...
export default function GeneralLedgerReportPage() {
  ...
  const columns = [
    ...
    { header: 'Voucher', accessor: 'voucher', sortable: true },
    ...
    { header: 'Running Balance', accessor: 'runningbalance', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Transaction level detail for every account in the chart of accounts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Transactions (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>14,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pages</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>450</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Report Size</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>12 MB</p>
        </div>
      </div>
