...
export default function DepartmentRevenueReportPage() {
  ...
  const columns = [
    ...
    { header: 'Budgeted Rev', accessor: 'budgetedrev', sortable: true },
    { header: 'Actual Rev', accessor: 'actualrev', sortable: true },
    { header: 'Variance', accessor: 'variance', sortable: true },
    { header: 'Direct Expenses', accessor: 'directexpenses', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Performance sheet of all departments compared against budgets.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Revenue Variance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>+5.2%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Performer</p>
