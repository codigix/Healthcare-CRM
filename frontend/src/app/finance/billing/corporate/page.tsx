...
export default function CorporateBillingPage() {
  ...
  const columns = [
    ...
    { header: 'Employees Treated', accessor: 'employeestreated', sortable: true },
    { header: 'Period', accessor: 'period', sortable: true },
    { header: 'Total Invoice Amount', accessor: 'totalinvoiceamount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Consolidated invoices sent to corporate partners and organizations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Corporate Revenue (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$120,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Invoices Generated</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>14</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overdue Payments</p>
