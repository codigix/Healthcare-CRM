...
export default function LaboratoryBillingPage() {
  ...
  const columns = [
    { header: 'Lab Bill No', accessor: 'labbillno', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Tests Ordered', accessor: 'testsordered', sortable: true },
    { header: 'Referring Doctor', accessor: 'referringdoctor', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Billing for pathology, biochemistry, and microbiology tests.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lab Revenue</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$9,200</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lab Bills</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>320</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Corporate Tie-ups</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>$1,500</p>
        </div>
      </div>
