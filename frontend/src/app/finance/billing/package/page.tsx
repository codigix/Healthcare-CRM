...
export default function PackageBillingPage() {
  ...
  const columns = [
    { header: 'Package Bill No', accessor: 'packagebillno', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Package Name', accessor: 'packagename', sortable: true },
    { header: 'Inclusions', accessor: 'inclusions', sortable: true },
    { header: 'Total Package Cost', accessor: 'totalpackagecost', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Fixed-cost packages (e.g., Maternity, Cardiac surgeries).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Package Revenue</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$85,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Packages</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Exclusions Billed</p>
