...
export default function PharmacyBillingPage() {
  ...
  const columns = [
    ...
    { header: 'Patient/Customer', accessor: 'patientcustomer', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Direct medicine sales to walk-ins and inpatients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pharmacy Sales</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$15,400</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Transactions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Refunds</p>
