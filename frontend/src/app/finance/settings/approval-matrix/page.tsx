...
export default function ApprovalMatrixPage() {
  ...
  const columns = [
    { header: 'Process Name', accessor: 'processname', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configuring multi-level approvals for refunds, AP payments, and journal entries.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4.5 Hrs</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Escalations Enabled</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>Yes</p>
        </div>
      </div>
