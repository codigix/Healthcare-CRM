...
export default function FinancialYearPage() {
  ...
  const columns = [
    { header: 'FY Name', accessor: 'fyname', sortable: true },
    { header: 'Start Date', accessor: 'startdate', sortable: true },
    { header: 'End Date', accessor: 'enddate', sortable: true },
    { header: 'Books Status', accessor: 'booksstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Setting the active financial period and locking closed accounting periods.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Current FY</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>FY 2026-27</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Previous FY Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Closed & Audited</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Months Locked</p>
