...
export default function ChargeMasterPage() {
  ...
  const columns = [
    { header: 'Service Code', accessor: 'servicecode', sortable: true },
    { header: 'Service Name', accessor: 'servicename', sortable: true },
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Standard Rate', accessor: 'standardrate', sortable: true },
    { header: 'Corporate Rate', accessor: 'corporaterate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Central repository defining the prices of every service, test, and bed in the hospital.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Services Defined</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Recent Updates</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12 (This Week)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unpriced Services</p>
