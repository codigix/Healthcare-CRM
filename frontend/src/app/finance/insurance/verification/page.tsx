...
export default function InsuranceVerificationPage() {
  ...
  const columns = [
    ...
    { header: 'Policy Number', accessor: 'policynumber', sortable: true },
    { header: 'Coverage Limit', accessor: 'coveragelimit', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Verifying active policies and coverage limits for new patients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Invalid Policies</p>
