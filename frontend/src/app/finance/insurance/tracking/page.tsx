...
export default function ClaimTrackingPage() {
  ...
  const columns = [
    ...
    { header: 'Submitted On', accessor: 'submittedon', sortable: true },
    { header: 'Days Pending', accessor: 'dayspending', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monitoring the status of submitted claims with insurance providers.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Pending Claims</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Value Locked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$850,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overdue > 30 Days</p>
