...
export default function ClaimRejectionPage() {
  ...
  const columns = [
    ...
    { header: 'Rejection Reason', accessor: 'rejectionreason', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Handling denied claims, appeals, and transferring dues to patient accounts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rejected (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Value Denied</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$24,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Appeals Won</p>
