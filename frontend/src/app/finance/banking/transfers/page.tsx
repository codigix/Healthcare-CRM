...
export default function BankTransfersPage() {
  ...
  const columns = [
    ...
    { header: 'From Account', accessor: 'fromaccount', sortable: true },
    { header: 'To Account', accessor: 'toaccount', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Internal fund transfers between different hospital bank accounts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Transfers (Mo)</p>
