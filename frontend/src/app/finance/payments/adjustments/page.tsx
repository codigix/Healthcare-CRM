...
export default function PaymentAdjustmentsPage() {
  ...
  const columns = [
    ...
    { header: 'Original Bill', accessor: 'originalbill', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Adjustment Reason', accessor: 'adjustmentreason', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manual corrections for overcharges, missing discounts, or wrong billing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Adjustments</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Value Impact</p>
