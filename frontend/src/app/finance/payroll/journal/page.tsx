...
export default function PayrollJournalPage() {
  ...
  const columns = [
    ...
    { header: 'Debit (Expense)', accessor: 'debitexpense', sortable: true },
    { header: 'Credit (Liability/Bank)', accessor: 'creditliabilitybank', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed accounting journal entries for salaries, taxes, and benefits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Entries (Mo)</p>
