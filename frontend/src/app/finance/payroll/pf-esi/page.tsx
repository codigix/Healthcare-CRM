...
export default function PFESIPostingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Month', accessor: 'month', sortable: true },
    { header: 'Contribution Type', accessor: 'contributiontype', sortable: true },
    { header: 'Employee Share', accessor: 'employeeshare', sortable: true },
    { header: 'Employer Share', accessor: 'employershare', sortable: true },
    { header: 'Total Deposit', accessor: 'totaldeposit', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Provident Fund and State Insurance contributions (Employee + Employer).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">PF/ESI Liability</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ECR Filed</p>
