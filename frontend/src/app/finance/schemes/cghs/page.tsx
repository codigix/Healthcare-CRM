...
export default function CGHSPage() {
  ...
  const columns = [
    { header: 'CGHS ID', accessor: 'cghsid', sortable: true },
    { header: 'Beneficiary Name', accessor: 'beneficiaryname', sortable: true },
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Bill Amount', accessor: 'billamount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Central Government Health Scheme billing and receivables.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Receivable</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$120K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Settled (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$300K</p>
        </div>
      </div>
