...
export default function ESICPage() {
  ...
  const columns = [
    { header: 'ESIC No', accessor: 'esicno', sortable: true },
    { header: 'Employee Name', accessor: 'employeename', sortable: true },
    { header: 'Employer', accessor: 'employer', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Employees State Insurance Corporation billing and claims.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$200K</p>
        </div>
      </div>
