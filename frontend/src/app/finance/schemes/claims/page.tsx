...
export default function ClaimManagementPage() {
  ...
  const columns = [
    { header: 'Claim ID', accessor: 'claimid', sortable: true },
    { header: 'Scheme', accessor: 'scheme', sortable: true },
    { header: 'Total Bills Submitted', accessor: 'totalbillssubmitted', sortable: true },
    { header: 'Claim Amount', accessor: 'claimamount', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Central tracking for all government scheme claims and settlements.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Pending Govt.</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$1.2M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Under Process</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>450 Claims</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Settled (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$240K</p>
        </div>
      </div>
