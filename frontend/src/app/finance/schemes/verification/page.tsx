...
export default function SchemeVerificationPage() {
  ...
  const columns = [
    ...
    { header: 'Aadhar/ID', accessor: 'aadharid', sortable: true },
    { header: 'Eligibility', accessor: 'eligibility', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Portal to verify beneficiary eligibility via government APIs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Verifications Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Eligible</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>40</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Not Eligible</p>
