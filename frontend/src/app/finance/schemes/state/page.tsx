...
export default function StateHealthSchemesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'State Scheme', accessor: 'statescheme', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'ID Number', accessor: 'idnumber', sortable: true },
    { header: 'Treatment', accessor: 'treatment', sortable: true },
    { header: 'Est Amount', accessor: 'estamount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Other localized state government health scheme billing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Receivables</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$45K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Settled</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$85K</p>
        </div>
      </div>
