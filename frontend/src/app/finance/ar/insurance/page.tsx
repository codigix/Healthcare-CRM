...
export default function InsuranceReceivablesPage() {
  ...
  const columns = [
    ...
    { header: 'Total Claims Pending', accessor: 'totalclaimspending', sortable: true },
    { header: 'AR < 30 Days', accessor: 'ar30days', sortable: true },
    { header: 'AR > 90 Days', accessor: 'ar90days', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Money owed by TPAs and Insurance companies for cashless treatments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Insurance AR</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$2.4M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Risk (>120D)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$450K</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cleared (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$800K</p>
        </div>
      </div>
