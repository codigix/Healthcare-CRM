...
export default function CorporateReceivablesPage() {
  ...
  const columns = [
    { header: 'Corporate Name', accessor: 'corporatename', sortable: true },
    { header: 'Total Invoices Pending', accessor: 'totalinvoicespending', sortable: true },
    { header: 'Oldest Invoice', accessor: 'oldestinvoice', sortable: true },
    { header: 'Total AR', accessor: 'totalar', sortable: true },
    { header: 'Account Manager', accessor: 'accountmanager', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Unpaid invoices from corporate tie-ups and partner organizations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Corporate AR</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$850,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overdue Companies</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Payments Expected</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$150K</p>
        </div>
      </div>
