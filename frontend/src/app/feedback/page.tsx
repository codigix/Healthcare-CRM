...
export default function FeedbackManagementPage() {
    ...
    const avgRating = (
        surveys.reduce((sum, s) => sum + s.averageRating, 0) / surveys.length
    ).toFixed(2);
                ...
                <div className="bg-dark-secondary border border-dark-tertiary rounded p-6">
                    ...
                    <div className="flex gap-2 mb-6 border-b border-dark-tertiary">
                        <button
                            ...
                            className={`p-2 font-medium transition-colors ${activeTab === "surveys"
                        ...
                        <button
                            ...
                            className={`p-2 font-medium transition-colors ${activeTab === "recent"
                                ? "text-emerald-400 border-b-2 border-emerald-400"
                                : "text-gray-400 hover:text-gray-300"
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`p-2 font-medium transition-colors ${activeTab === "analytics"
                                ? "text-emerald-400 border-b-2 border-emerald-400"
                                : "text-gray-400 hover:text-gray-300"
                                }`}
                        >
                    ...
                    {activeTab === "surveys" && (
                        <div className="space-y-4">
                            {filteredSurveys.map((survey) => (
                                <div
                                    key={survey.id}
                                    className="bg-dark-tertiary rounded p-4 hover:bg-dark-tertiary/70 transition-colors"
                                >
                                    ...
                                    <p className="text-xs text-gray-500 mt-2">
                                        Created on {survey.createdDate} • Last updated{" "}
                                        {survey.lastUpdated}
                                    </p>
                                </div>
                            ))}
