                        ...
                        {record.status?.toLowerCase() === "pending" ? (
                          ...
                          <div className="flex gap-2 justify-end items-center">
                            <button
                              ...
                              className="px-3 py-1.5 text-xs font-bold bg-dark-tertiary hover:bg-dark-tertiary/70 text-gray-300 rounded-lg transition-all flex items-center gap-1.5 border border-dark-tertiary/50"
                            >
                              <Eye size={13} />
                              View Findings
                            </button>
                            <button
                              ...
                              className="px-3 py-1.5 text-xs font-bold bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg transition-all flex items-center gap-1.5 shadow shadow-emerald-600/10 active:scale-95 hover:shadow-emerald-500/20"
                            >
            ...
            return (
              <div className="space-y-6 text-gray-300 py-2">
                <div className="bg-amber-500/10 border border-amber-500/20 p-4 rounded-xl flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-white">Scanner Linkage Required</h4>
                ...
                <div className="flex flex-col items-center justify-center p-6 bg-dark-secondary/50 rounded-2xl border border-dark-tertiary/20 shadow-2xl relative overflow-hidden">
                  ...
                  <p className="text-xs text-gray-400 font-semibold mb-4 text-center max-w-[320px]">
                    Open <span className="text-white font-bold">WhatsApp</span> on your phone → tap <span className="text-white font-bold">Settings / Menu</span> → select <span className="text-white font-bold">Linked Devices</span> → scan this code:
                  </p>

                  {qrCodeUrl ? (
                    <div className="relative p-3 bg-white rounded-xl shadow-lg border-2 border-emerald-500/30">
                      <img 
                        src={qrCodeUrl} 
                  ...
                  <div className="mt-5 flex items-center gap-2 text-xs text-emerald-400 font-bold bg-emerald-500/10 py-1.5 px-4 rounded-full border border-emerald-500/20">
          ...
          return (
            <div className="space-y-5 text-gray-300">
              <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-xl flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-sm font-bold text-white">Linked & Ready (Background Sending)</h4>
              ...
              <div className="grid grid-cols-2 gap-4 bg-dark-secondary/20 p-3 rounded-lg border border-dark-tertiary/10">
                <div>
                  <p className="text-[10px] text-gray-500 uppercase font-bold">Patient Name</p>
                  <p className="text-sm text-white font-bold mt-0.5">{whatsappRecord.patientName}</p>
                </div>
                <div>
                  <p className="text-[10px] text-gray-500 uppercase font-bold">Requested Test</p>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="w-full text-xs bg-dark-tertiary border border-dark-tertiary rounded-lg p-3 outline-none text-white focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 font-mono"
                  />
                  <button
                    type="button"
                    onClick={() => lookupPatientPhone(whatsappRecord.patientName)}
                    disabled={searchingPhone}
                    className="px-4 bg-dark-tertiary hover:bg-dark-tertiary/70 disabled:opacity-50 text-gray-300 rounded-lg text-xs font-semibold whitespace-nowrap border border-dark-tertiary/50"
                  >
              ...
              <div>
                ...
                <div className="text-xs bg-dark-tertiary/30 p-3 rounded-lg border border-dark-tertiary/30 whitespace-pre-line text-gray-300 max-h-[140px] overflow-y-auto font-mono leading-relaxed select-all">
              ...
              <div className="flex gap-3 justify-end pt-3 border-t border-dark-tertiary">
                <button
                  type="button"
                  onClick={() => setShowWhatsAppModal(false)}
                  className="px-5 py-2.5 bg-dark-tertiary hover:bg-dark-tertiary/70 text-white rounded-lg transition-colors font-semibold text-xs"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 disabled:bg-gray-700 text-white rounded-lg transition-all font-semibold text-xs flex items-center justify-center gap-1.5 shadow-lg shadow-emerald-500/15"
                >
                  {sendingMessage ? (
                    <>
