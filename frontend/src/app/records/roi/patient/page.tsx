...
export default function PatientRequestsPage() {
  ...
  const columns = [
    ...
    { header: 'Expected TAT', accessor: 'expectedtat', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Requests directly from patients for copies of their own medical records.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fulfilled (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,240</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Processing Time</p>
