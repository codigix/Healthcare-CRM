...
export default function OPDRecordsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Visit ID', accessor: 'visitid', sortable: true },
    { header: 'UHID', accessor: 'uhid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Consulting Dept', accessor: 'consultingdept', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Outpatient consultation notes, prescriptions, and follow-up data.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">OPD Visits (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Prescriptions Gen</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4,200</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Follow-ups Due</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>150</p>
        </div>
      </div>
