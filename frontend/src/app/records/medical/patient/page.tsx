...
export default function PatientMedicalRecordsPage() {
  ...
  const columns = [
    ...
    { header: 'Primary Doctor', accessor: 'primarydoctor', sortable: true },
    { header: 'Record Status', accessor: 'recordstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Central repository of all longitudinal patient health records (EMR).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Active Records</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>124,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missing Data</p>
