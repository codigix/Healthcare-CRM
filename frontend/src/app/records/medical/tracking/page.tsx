...
export default function RecordTrackingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'File No', accessor: 'fileno', sortable: true },
    { header: 'UHID', accessor: 'uhid', sortable: true },
    { header: 'Current Location', accessor: 'currentlocation', sortable: true },
    { header: 'Issued To', accessor: 'issuedto', sortable: true },
    { header: 'Issued On', accessor: 'issuedon', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Barcode/RFID tracking system for movement of physical medical files.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Files in Circulation</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overdue Returns</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lost Files</p>
