...
export default function DuplicateRecordCheckPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Potential Duplicates', accessor: 'potentialduplicates', sortable: true },
    { header: 'Match Score', accessor: 'matchscore', sortable: true },
    { header: 'Name 1 (UHID 1)', accessor: 'name1uhid1', sortable: true },
    { header: 'Name 2 (UHID 2)', accessor: 'name2uhid2', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Identifying and merging duplicate patient UHIDs to maintain data integrity.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Suspected Duplicates</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>18</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Merged (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">False Positives</p>
