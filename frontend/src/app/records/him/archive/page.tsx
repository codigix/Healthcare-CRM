...
export default function DigitalArchivePage() {
  ...
  const columns = [
    { header: 'File ID', accessor: 'fileid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Size', accessor: 'size', sortable: true },
    { header: 'Encryption Level', accessor: 'encryptionlevel', sortable: true },
    { header: 'Archive Date', accessor: 'archivedate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Secure, long-term storage vault for all finalized electronic health records.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Archive Size</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4.5 TB</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Files Secured</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.2M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Backup Status</p>
