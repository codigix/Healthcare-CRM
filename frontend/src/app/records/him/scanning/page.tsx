...
export default function DocumentScanningPage() {
  ...
  const columns = [
    ...
    { header: 'Document Count', accessor: 'documentcount', sortable: true },
    { header: 'Scanned By', accessor: 'scannedby', sortable: true },
    { header: 'QA Check', accessor: 'qacheck', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Queue management for digitization of old physical files or external reports.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pages Scanned (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>14,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Queue</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">QA Rejects</p>
