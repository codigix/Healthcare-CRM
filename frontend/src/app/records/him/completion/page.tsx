...
export default function RecordCompletionPage() {
  ...
  const columns = [
    ...
    { header: 'Discharge Date', accessor: 'dischargedate', sortable: true },
    { header: 'Missing Elements', accessor: 'missingelements', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Ensuring all discharged patient files have required signatures and notes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Files for Review</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overdue (>30D)</p>
