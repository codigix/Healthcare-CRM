...
export default function VersionControlPage() {
  ...
  const columns = [
    { header: 'Document ID', accessor: 'documentid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Edit Timestamp', accessor: 'edittimestamp', sortable: true },
    { header: 'Edited By', accessor: 'editedby', sortable: true },
    { header: 'Previous Version', accessor: 'previousversion', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Audit trail of edits made to clinical notes or consent forms after initial saving.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Edits Tracked (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Major Revisions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Locked Documents</p>
