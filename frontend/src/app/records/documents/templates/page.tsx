...
export default function DocumentTemplatesPage() {
  ...
  const columns = [
    { header: 'Template Name', accessor: 'templatename', sortable: true },
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Format Type', accessor: 'formattype', sortable: true },
    { header: 'Created By', accessor: 'createdby', sortable: true },
    { header: 'Last Used', accessor: 'lastused', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Standardized letterheads, medical certificate formats, and discharge summary layouts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Templates</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>85</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Most Used</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Fitness Cert.</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Draft Templates</p>
