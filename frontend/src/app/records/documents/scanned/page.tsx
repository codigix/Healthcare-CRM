...
export default function ScannedDocumentsPage() {
  ...
  const columns = [
    ...
    { header: 'Source Machine', accessor: 'sourcemachine', sortable: true },
    { header: 'Page Count', accessor: 'pagecount', sortable: true },
    { header: 'Scan Quality', accessor: 'scanquality', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Raw scanned image files waiting to be tagged and assigned to a patient.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unassigned Scans</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>124</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">OCR Accuracy</p>
