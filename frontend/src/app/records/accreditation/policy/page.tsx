...
export default function PolicyManagementPage() {
  ...
  const columns = [
    ...
    { header: 'Chapter Reference', accessor: 'chapterreference', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Centralized control for all hospital policies required by accrediting bodies.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Up to Date</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reviews Due</p>
