...
export default function JCIStandardsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Chapter', accessor: 'chapter', sortable: true },
    { header: 'Measurable Element', accessor: 'measurableelement', sortable: true },
    { header: 'Current Practice', accessor: 'currentpractice', sortable: true },
    { header: 'Gap Identified', accessor: 'gapidentified', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking requirements for Joint Commission International (if applicable/aspiring).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">JCI Readiness</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>75%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Target Assessment</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Dec 2026</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Open Gaps</p>
