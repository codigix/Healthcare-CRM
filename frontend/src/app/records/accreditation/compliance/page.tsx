...
export default function ComplianceTrackingPage() {
  ...
  const columns = [
    { header: 'Regulatory Body', accessor: 'regulatorybody', sortable: true },
    { header: 'License/Certificate', accessor: 'licensecertificate', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Real-time dashboard showing the hospital's readiness for unannounced inspections.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Expiring < 90 Days</p>
