...
export default function DepartmentChecklistsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Checklist Type', accessor: 'checklisttype', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Daily/Weekly self-assessment checklists for wards and departments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Daily Submissions</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missed Checklists</p>
