...
export default function ComplianceReportsPage() {
  ...
  const columns = [
    { header: 'Compliance Area', accessor: 'compliancearea', sortable: true },
    { header: 'Report Frequency', accessor: 'reportfrequency', sortable: true },
    { header: 'Last Submitted', accessor: 'lastsubmitted', sortable: true },
    { header: 'Authority', accessor: 'authority', sortable: true },
    { header: 'Filing Ref', accessor: 'filingref', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Summary of statutory reporting (MLCs, Births, Deaths, Notifiable diseases).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Filings Due This Week</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Compliance</p>
