...
export default function CodingReportsPage() {
  ...
  const columns = [
    ...
    { header: 'Top Diagnosis', accessor: 'topdiagnosis', sortable: true },
    { header: 'Case Count', accessor: 'casecount', sortable: true },
    { header: 'Exported On', accessor: 'exportedon', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Summary of ICD/CPT codes assigned and frequency of specific diseases.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top ICD-10 Code</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>I10 (Hypertension)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Uncoded Cases</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Coding TAT</p>
