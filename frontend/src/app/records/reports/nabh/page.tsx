...
export default function NABHReportsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Report Title', accessor: 'reporttitle', sortable: true },
    { header: 'NABH Chapter', accessor: 'nabhchapter', sortable: true },
    { header: 'Reporting Month', accessor: 'reportingmonth', sortable: true },
    { header: 'Data Points', accessor: 'datapoints', sortable: true },
    { header: 'Validation', accessor: 'validation', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Structured reports formatted exactly as required for NABH submission.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Mandatory Reports</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Sign-off</p>
