...
export default function AuditReportsPage() {
  ...
  const columns = [
    { header: 'Audit Topic', accessor: 'audittopic', sortable: true },
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Audit Period', accessor: 'auditperiod', sortable: true },
    { header: 'Overall Score', accessor: 'overallscore', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Output of clinical and documentation audits for department heads.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Audits Completed (YTD)</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Continuous Improv.</p>
