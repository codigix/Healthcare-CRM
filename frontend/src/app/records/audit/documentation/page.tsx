...
export default function DocumentationAuditPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Audit ID', accessor: 'auditid', sortable: true },
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Records Sampled', accessor: 'recordssampled', sortable: true },
    { header: 'Compliance Score', accessor: 'compliancescore', sortable: true },
    { header: 'Major Deficiencies', accessor: 'majordeficiencies', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Reviewing clinical notes for legibility, timeliness, and completeness.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Dept Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>88%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Dept (Docs)</p>
