...
export default function DRGCodingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'IPD No', accessor: 'ipdno', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Primary ICD', accessor: 'primaryicd', sortable: true },
    { header: 'Secondary ICDs', accessor: 'secondaryicds', sortable: true },
    { header: 'Assigned DRG', accessor: 'assigneddrg', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Diagnosis-Related Group assignments for inpatient insurance billing and case mix analysis.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">DRG Assigned (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Case Mix Index</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">DRG Denials</p>
