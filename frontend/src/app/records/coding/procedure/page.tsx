...
export default function ProcedureCodingInternalPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Internal Code', accessor: 'internalcode', sortable: true },
    { header: 'Service Name', accessor: 'servicename', sortable: true },
    { header: 'Standard Mapping', accessor: 'standardmapping', sortable: true },
    { header: 'Charge Head', accessor: 'chargehead', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Procedure Coding (Internal)
          </h1>
          <p className="text-sm text-gray-400 mt-1">Hospital-specific tariff/procedure codes mapping to standard CPT/ICD.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Internal Codes</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unmapped Codes</p>
