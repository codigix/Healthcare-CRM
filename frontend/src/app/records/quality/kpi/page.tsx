...
export default function QualityKPIDashboardPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'KPI Metric', accessor: 'kpimetric', sortable: true },
    { header: 'Target', accessor: 'target', sortable: true },
    { header: 'Achieved', accessor: 'achieved', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Executive dashboard visualizing performance across all quality parameters.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Hospital Quality Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>94%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Quality Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>ICU</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Requires Action</p>
