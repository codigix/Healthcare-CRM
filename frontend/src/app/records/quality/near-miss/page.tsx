...
export default function NearMissEventsPage() {
  ...
  const columns = [
    ...
    { header: 'Event Description', accessor: 'eventdescription', sortable: true },
    { header: 'Harm Prevented', accessor: 'harmprevented', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Reporting of errors caught just before they reached the patient (Good Catches).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Good Catches (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Reporting Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Pharmacy</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reward Points Distributed</p>
