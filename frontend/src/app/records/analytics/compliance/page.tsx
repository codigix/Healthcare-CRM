...
export default function ComplianceDashboardPage() {
  ...
  const columns = [
    { header: 'Compliance Category', accessor: 'compliancecategory', sortable: true },
    { header: 'Readiness Score', accessor: 'readinessscore', sortable: true },
    { header: 'Critical Gaps', accessor: 'criticalgaps', sortable: true },
    { header: 'Upcoming Deadlines', accessor: 'upcomingdeadlines', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Executive view of all statutory, legal, and accreditation risks.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Hospital Risk Profile</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Low Risk</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical Gaps</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Licensing Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>100% Valid</p>
        </div>
      </div>
