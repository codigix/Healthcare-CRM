...
export default function CodingAnalyticsPage() {
  ...
  const columns = [
    ...
    { header: 'Case Mix Index', accessor: 'casemixindex', sortable: true },
    { header: 'Coding Denials', accessor: 'codingdenials', sortable: true },
    { header: 'Revenue Impact', accessor: 'revenueimpact', sortable: true },
    { header: 'Avg DRG Weight', accessor: 'avgdrgweight', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Revenue impact analysis based on coding accuracy and case mix index.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall CMI</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Denials due to Coding</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revenue Recovered</p>
