...
export default function AuditAnalyticsPage() {
  ...
  const columns = [
    ...
    { header: 'Audit Failure Rate', accessor: 'auditfailurerate', sortable: true },
    { header: 'Recurrent NC Area', accessor: 'recurrentncarea', sortable: true },
    { header: 'Root Cause', accessor: 'rootcause', sortable: true },
    { header: 'Improvement Plan', accessor: 'improvementplan', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Identifying departments or doctors with recurrent non-compliances.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Most Improved Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Emergency</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest NC Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>Orthopedics</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Audit Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>91%</p>
        </div>
      </div>
