...
export default function RecordReleaseApprovalPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Approval ID', accessor: 'approvalid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Requesting Party', accessor: 'requestingparty', sortable: true },
    { header: 'Documents Included', accessor: 'documentsincluded', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Final Medical Superintendent/Legal approval before handing any record to a third party.</p>
        </div>
