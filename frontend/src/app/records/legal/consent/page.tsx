...
export default function ConsentManagementPage() {
  ...
  const columns = [
    { header: 'Consent ID', accessor: 'consentid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Consent Type', accessor: 'consenttype', sortable: true },
    { header: 'Procedure', accessor: 'procedure', sortable: true },
    { header: 'Signed By', accessor: 'signedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Centralized repository of all signed informed consents (Surgical, Anesthesia, High-Risk).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Consents Signed (24H)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>124</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missing Consents</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Digital Consents</p>
