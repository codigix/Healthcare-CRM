...
export default function InfectionReportingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Report ID', accessor: 'reportid', sortable: true },
    { header: 'Disease Name', accessor: 'diseasename', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Mandatory reporting of notifiable diseases (e.g., TB, COVID, Dengue) to authorities.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Notifiable Diseases (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reports Filed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45/45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
