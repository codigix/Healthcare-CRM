...
export default function HAISurveillancePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'HAI ID', accessor: 'haiid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Infection Type', accessor: 'infectiontype', sortable: true },
    { header: 'Onset Date', accessor: 'onsetdate', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hospital-Acquired Infection tracking (VAP, CAUTI, CLABSI, SSI).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total HAI (Mo)</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Device Days</p>
