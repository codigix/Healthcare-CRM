...
export default function ComplianceRulesPage() {
  ...
  const columns = [
    ...
    { header: 'Alert Timing', accessor: 'alerttiming', sortable: true },
    { header: 'Escalation To', accessor: 'escalationto', sortable: true },
    { header: 'Auto-Locking', accessor: 'autolocking', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Setting up automated alerts and escalation matrices for missing signatures or documents.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Auto-escalations (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">System Locks</p>
