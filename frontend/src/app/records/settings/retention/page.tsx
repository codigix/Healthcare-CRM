...
export default function RecordRetentionPolicyPage() {
  ...
  const columns = [
    { header: 'Record Type', accessor: 'recordtype', sortable: true },
    { header: 'Retention Period (Adult)', accessor: 'retentionperiodadult', sortable: true },
    { header: 'Retention Period (Minor)', accessor: 'retentionperiodminor', sortable: true },
    { header: 'Action Post Retention', accessor: 'actionpostretention', sortable: true },
    { header: 'Legal Hold', accessor: 'legalhold', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configuring statutory timeframes for archiving and purging physical/digital records.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Retention Policies</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Files on Legal Hold</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Next Purge Cycle</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Dec 2026</p>
        </div>
      </div>
