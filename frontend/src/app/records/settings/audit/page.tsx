...
export default function AuditTemplatesPage() {
  ...
  const columns = [
    ...
    { header: 'Questions', accessor: 'questions', sortable: true },
    { header: 'Scoring Type', accessor: 'scoringtype', sortable: true },
    { header: 'Applicable Depts', accessor: 'applicabledepts', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Creating custom checklists and scoring logic for internal clinical audits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Configured Audits</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Automated Scoring</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Enabled</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Scheduled Audits</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8/Month</p>
        </div>
      </div>
