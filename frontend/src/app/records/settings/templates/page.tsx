...
export default function DocumentTemplatesSettingsPage() {
  ...
  const columns = [
    ...
    { header: 'Fields Count', accessor: 'fieldscount', sortable: true },
    { header: 'Last Edited By', accessor: 'lasteditedby', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Builder interface for creating dynamic clinical forms and discharge summaries.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Dynamic Forms</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>124</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Print Templates</p>
