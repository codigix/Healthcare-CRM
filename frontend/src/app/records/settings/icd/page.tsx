...
export default function ICDMasterPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'ICD Code', accessor: 'icdcode', sortable: true },
    { header: 'Description', accessor: 'description', sortable: true },
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Mapped CPT', accessor: 'mappedcpt', sortable: true },
    { header: 'Active Status', accessor: 'activestatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configuration and mapping of the International Classification of Diseases database.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total ICD-10 Codes</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>72,184</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Custom Mappings</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Last DB Update</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Jan 2026</p>
        </div>
      </div>
