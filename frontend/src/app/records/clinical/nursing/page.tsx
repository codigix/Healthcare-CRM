...
export default function NursingNotesPage() {
  ...
  const columns = [
    ...
    { header: 'Nurse on Duty', accessor: 'nurseonduty', sortable: true },
    { header: 'Shift', accessor: 'shift', sortable: true },
    { header: 'Entry Type', accessor: 'entrytype', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Nursing assessments, care plans, vital signs monitoring, and handover notes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Handover Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>98%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missed Vitals</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Care Plans Active</p>
