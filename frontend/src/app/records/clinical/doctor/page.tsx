...
export default function DoctorNotesPage() {
  ...
  const columns = [
    { header: 'Visit/IPD No', accessor: 'visitipdno', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Consultant', accessor: 'consultant', sortable: true },
    { header: 'Note Type', accessor: 'notetype', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed clinical evaluations, differential diagnosis, and treatment plans.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Consult Notes (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>340</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Addendums</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Peer Reviewed</p>
