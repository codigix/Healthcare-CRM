...
export default function DisasterRecoveryPage() {
  ...
  const columns = [
    { header: "Plan ID", accessor: "c0", sortable: true },
    { header: "Region", accessor: "c1", sortable: true },
    { header: "RTO", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage disaster recovery configurations globally</p>
        </div>
