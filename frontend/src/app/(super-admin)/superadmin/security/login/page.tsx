...
export default function LoginMonitoringPage() {
  ...
  const columns = [
    { header: "Username", accessor: "c0", sortable: true },
    { header: "IP", accessor: "c1", sortable: true },
    { header: "Time", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage login monitoring configurations globally</p>
        </div>
