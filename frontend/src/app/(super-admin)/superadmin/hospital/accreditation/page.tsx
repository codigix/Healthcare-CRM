  ...
  return (
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-dark-secondary rounded2 border border-gray-800 flex items-center gap-4">
        ...
        <div className="bg-dark-secondary rounded2 border border-amber-500/30 flex items-center gap-4 relative overflow-hidden">
            ...
            <div className="p-6 border-b border-gray-800 relative bg-dark-tertiary/20">
              <div className="flex justify-between items-start mb-4">
                <div className="flex items-center gap-2">
                  <div className={`w-12 h-12 roundedex items-center justify-center  text-xl shadow-lg ${acc.body === 'NABH' ? 'bg-blue-500/10 text-blue-400 border border-blue-500/20' :
