...
export default function APIManagementPage() {
  ...
  const [data] = useState([
    {
      "c0": "ID-1933",
      "c1": "Sample Auth Required 1",
      "c2": "Sample Rate Limit 1",
      "c3": "Active"
    },
    {
      "c0": "ID-1976",
      "c1": "Sample Auth Required 2",
      "c2": "Sample Rate Limit 2",
      "c3": "Active"
    },
    {
      "c0": "ID-2862",
      "c1": "Sample Auth Required 3",
      "c2": "Sample Rate Limit 3",
      "c3": "Active"
    },
    {
      "c0": "ID-1986",
      "c1": "Sample Auth Required 4",
      "c2": "Sample Rate Limit 4",
      "c3": "Active"
    },
    {
      "c0": "ID-9062",
      "c1": "Sample Auth Required 5",
      "c2": "Sample Rate Limit 5",
      "c3": "Pending"
    },
    {
      "c0": "ID-1951",
      "c1": "Sample Auth Required 6",
      "c2": "Sample Rate Limit 6",
      "c3": "Active"
    },
    {
      "c0": "ID-4607",
      "c1": "Sample Auth Required 7",
      "c2": "Sample Rate Limit 7",
      "c3": "Pending"
    },
    {
      "c0": "ID-8537",
      "c1": "Sample Auth Required 8",
      "c2": "Sample Rate Limit 8",
      "c3": "Inactive"
    },
    {
      "c0": "ID-3709",
      "c1": "Sample Auth Required 9",
      "c2": "Sample Rate Limit 9",
      "c3": "Pending"
    },
    {
      "c0": "ID-4857",
      "c1": "Sample Auth Required 10",
      "c2": "Sample Rate Limit 10",
      "c3": "Active"
    },
    {
      "c0": "ID-1756",
      "c1": "Sample Auth Required 11",
      "c2": "Sample Rate Limit 11",
      "c3": "Pending"
    },
    {
      "c0": "ID-6454",
      "c1": "Sample Auth Required 12",
      "c2": "Sample Rate Limit 12",
      "c3": "Active"
    }
  ]);
  ...
  const columns = [
    ...
    { header: "Auth Required", accessor: "c1", sortable: true },
    { header: "Rate Limit", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage api management configurations globally</p>
        </div>
