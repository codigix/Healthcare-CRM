...
export default function QueueManagerPage() {
  ...
  const [data] = useState([
    ...
    {
      "c0": "ID-3152",
      "c1": "Sample Pending 10",
      "c2": "Sample Failed 10",
      "c3": "Active"
    },
    {
      "c0": "ID-4618",
      "c1": "Sample Pending 11",
      "c2": "Sample Failed 11",
      "c3": "Active"
    },
    {
      "c0": "ID-1246",
      "c1": "Sample Pending 12",
      "c2": "Sample Failed 12",
      "c3": "Active"
    }
  ]);
  ...
  const columns = [
    { header: "Queue", accessor: "c0", sortable: true },
    { header: "Pending", accessor: "c1", sortable: true },
    { header: "Failed", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage queue manager configurations globally</p>
        </div>
