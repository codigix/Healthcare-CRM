    ...
    <div className="p-2 space-y-2 max-w-7xl mx-auto">
      ...
      <div className=" p-8 flex flex-col items-center justify-center min-h-[500px]">
        ...
        <div className="flex flex-col items-center">
          <div className="bg-blue-600/20 border border-blue-500 p-4 roundedxt-center w-64 shadow-[0_0_15px_rgba(59,130,246,0.2)]">
          ...
          <div className="bg-emerald-600/20 border border-emerald-500 p-4 roundedxt-center w-64 shadow-[0_0_15px_rgba(16,185,129,0.1)]">
          ...
          <div className="flex justify-between w-[800px] pt-8">
            <div className="bg-dark-tertiary border border-gray-700 p-4 roundedxt-center w-48 hover:border-blue-500 transition-colors">
