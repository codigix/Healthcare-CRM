...
export default function SubscriptionsPage() {
  ...
  const [data] = useState([
    {
      "c0": "ID-3787",
      "c1": "Sample Hospital 1",
      "c2": "Sample Plan 1",
      "c3": "Active"
    },
    {
      "c0": "ID-9452",
      "c1": "Sample Hospital 2",
      "c2": "Sample Plan 2",
      "c3": "Active"
    },
    {
      "c0": "ID-3486",
      "c1": "Sample Hospital 3",
      "c2": "Sample Plan 3",
      "c3": "Active"
    },
    {
      "c0": "ID-2432",
      "c1": "Sample Hospital 4",
      "c2": "Sample Plan 4",
      "c3": "Active"
    },
    {
      "c0": "ID-7368",
      "c1": "Sample Hospital 5",
      "c2": "Sample Plan 5",
      "c3": "Active"
    },
    {
      "c0": "ID-3561",
      "c1": "Sample Hospital 6",
      "c2": "Sample Plan 6",
      "c3": "Active"
    },
    {
      "c0": "ID-8655",
      "c1": "Sample Hospital 7",
      "c2": "Sample Plan 7",
      "c3": "Active"
    },
    {
      "c0": "ID-4155",
      "c1": "Sample Hospital 8",
      "c2": "Sample Plan 8",
      "c3": "Active"
    },
    {
      "c0": "ID-2957",
      "c1": "Sample Hospital 9",
      "c2": "Sample Plan 9",
      "c3": "Active"
    },
    {
      "c0": "ID-9657",
      "c1": "Sample Hospital 10",
      "c2": "Sample Plan 10",
      "c3": "Active"
    },
    {
      "c0": "ID-2460",
      "c1": "Sample Hospital 11",
      "c2": "Sample Plan 11",
      "c3": "Active"
    },
    {
      "c0": "ID-1756",
      "c1": "Sample Hospital 12",
      "c2": "Sample Plan 12",
      "c3": "Active"
    }
  ]);
  ...
  const columns = [
    { header: "Sub ID", accessor: "c0", sortable: true },
    { header: "Hospital", accessor: "c1", sortable: true },
    { header: "Plan", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage subscriptions configurations globally</p>
        </div>
