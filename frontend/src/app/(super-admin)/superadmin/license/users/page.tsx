...
export default function UserLimitsPage() {
  ...
  const columns = [
    ...
    { header: "Max Users", accessor: "c1", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage user limits configurations globally</p>
        </div>
