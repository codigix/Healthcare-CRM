...
export default function DomainManagementPage() {
  ...
  const [data] = useState([
    {
      "c0": "ID-8862",
      "c1": "Sample Registrar 1",
      "c2": "Sample Expiry 1",
      "c3": "Inactive"
    },
    {
      "c0": "ID-4086",
      "c1": "Sample Registrar 2",
      "c2": "Sample Expiry 2",
      "c3": "Inactive"
    },
    {
      "c0": "ID-3512",
      "c1": "Sample Registrar 3",
      "c2": "Sample Expiry 3",
      "c3": "Active"
    },
    {
      "c0": "ID-5276",
      "c1": "Sample Registrar 4",
      "c2": "Sample Expiry 4",
      "c3": "Active"
    },
    {
      "c0": "ID-1163",
      "c1": "Sample Registrar 5",
      "c2": "Sample Expiry 5",
      "c3": "Inactive"
    },
    {
      "c0": "ID-2882",
      "c1": "Sample Registrar 6",
      "c2": "Sample Expiry 6",
      "c3": "Inactive"
    },
    {
      "c0": "ID-6655",
      "c1": "Sample Registrar 7",
      "c2": "Sample Expiry 7",
      "c3": "Inactive"
    },
    {
      "c0": "ID-3085",
      "c1": "Sample Registrar 8",
      "c2": "Sample Expiry 8",
      "c3": "Active"
    },
    {
      "c0": "ID-1207",
      "c1": "Sample Registrar 9",
      "c2": "Sample Expiry 9",
      "c3": "Pending"
    },
    {
      "c0": "ID-1747",
      "c1": "Sample Registrar 10",
      "c2": "Sample Expiry 10",
      "c3": "Active"
    },
    {
      "c0": "ID-3070",
      "c1": "Sample Registrar 11",
      "c2": "Sample Expiry 11",
      "c3": "Inactive"
    },
    {
      "c0": "ID-7412",
      "c1": "Sample Registrar 12",
      "c2": "Sample Expiry 12",
      "c3": "Active"
    }
  ]);
  ...
  const columns = [
    { header: "Domain Name", accessor: "c0", sortable: true },
    { header: "Registrar", accessor: "c1", sortable: true },
    { header: "Expiry", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage domain management configurations globally</p>
        </div>
