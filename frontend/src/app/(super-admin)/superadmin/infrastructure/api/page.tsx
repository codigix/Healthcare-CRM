...
export default function APIServicesPage() {
  ...
  const columns = [
    { header: "Service", accessor: "c0", sortable: true },
    { header: "Endpoint", accessor: "c1", sortable: true },
    { header: "Method", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage api services configurations globally</p>
        </div>
