...
export default function ServersPage() {
  ...
  const [data] = useState([
    {
      "c0": "ID-8947",
      "c1": "Sample Hostname 1",
      "c2": "Sample IP Address 1",
      "c3": "Active"
    },
    {
      "c0": "ID-3465",
      "c1": "Sample Hostname 2",
      "c2": "Sample IP Address 2",
      "c3": "Inactive"
    },
    {
      "c0": "ID-6045",
      "c1": "Sample Hostname 3",
      "c2": "Sample IP Address 3",
      "c3": "Active"
    },
    {
      "c0": "ID-2032",
      "c1": "Sample Hostname 4",
      "c2": "Sample IP Address 4",
      "c3": "Active"
    },
    {
      "c0": "ID-5478",
      "c1": "Sample Hostname 5",
      "c2": "Sample IP Address 5",
      "c3": "Active"
    },
    {
      "c0": "ID-5276",
      "c1": "Sample Hostname 6",
      "c2": "Sample IP Address 6",
      "c3": "Inactive"
    },
    {
      "c0": "ID-8513",
      "c1": "Sample Hostname 7",
      "c2": "Sample IP Address 7",
      "c3": "Inactive"
    },
    {
      "c0": "ID-7213",
      "c1": "Sample Hostname 8",
      "c2": "Sample IP Address 8",
      "c3": "Pending"
    },
    {
      "c0": "ID-2905",
      "c1": "Sample Hostname 9",
      "c2": "Sample IP Address 9",
      "c3": "Active"
    },
    {
      "c0": "ID-2266",
      "c1": "Sample Hostname 10",
      "c2": "Sample IP Address 10",
      "c3": "Inactive"
    },
    {
      "c0": "ID-8184",
      "c1": "Sample Hostname 11",
      "c2": "Sample IP Address 11",
      "c3": "Pending"
    },
    {
      "c0": "ID-8130",
      "c1": "Sample Hostname 12",
      "c2": "Sample IP Address 12",
      "c3": "Active"
    }
  ]);

  const columns = [
    { header: "Server ID", accessor: "c0", sortable: true },
    { header: "Hostname", accessor: "c1", sortable: true },
    { header: "IP Address", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage servers configurations globally</p>
        </div>
