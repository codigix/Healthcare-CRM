...
export default function CloudStoragePage() {
  ...
  const columns = [
    { header: "Bucket", accessor: "c0", sortable: true },
    { header: "Provider", accessor: "c1", sortable: true },
    { header: "Usage", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage cloud storage configurations globally</p>
        </div>
