...
export default function ForecastingConfigPage() {
  const [searchTerm, setSearchTerm] = useState("");
  const [data] = useState([
    {
      "c0": "ID-2395",
      "c1": "Sample Algorithm 1",
      "c2": "Sample Confidence 1",
      "c3": "Active"
    },
    {
      "c0": "ID-6095",
      "c1": "Sample Algorithm 2",
      "c2": "Sample Confidence 2",
      "c3": "Active"
    },
    {
      "c0": "ID-5364",
      "c1": "Sample Algorithm 3",
      "c2": "Sample Confidence 3",
      "c3": "Active"
    },
    {
      "c0": "ID-2630",
      "c1": "Sample Algorithm 4",
      "c2": "Sample Confidence 4",
      "c3": "Pending"
    },
    {
      "c0": "ID-8783",
      "c1": "Sample Algorithm 5",
      "c2": "Sample Confidence 5",
      "c3": "Active"
    },
    {
      "c0": "ID-7580",
      "c1": "Sample Algorithm 6",
      "c2": "Sample Confidence 6",
      "c3": "Active"
    },
    {
      "c0": "ID-4533",
      "c1": "Sample Algorithm 7",
      "c2": "Sample Confidence 7",
      "c3": "Inactive"
    },
    {
      "c0": "ID-7353",
      "c1": "Sample Algorithm 8",
      "c2": "Sample Confidence 8",
      "c3": "Active"
    },
    {
      "c0": "ID-5219",
      "c1": "Sample Algorithm 9",
      "c2": "Sample Confidence 9",
      "c3": "Active"
    },
    {
      "c0": "ID-4497",
      "c1": "Sample Algorithm 10",
      "c2": "Sample Confidence 10",
      "c3": "Pending"
    },
    {
      "c0": "ID-8474",
      "c1": "Sample Algorithm 11",
      "c2": "Sample Confidence 11",
      "c3": "Active"
    },
    {
      "c0": "ID-8085",
      "c1": "Sample Algorithm 12",
      "c2": "Sample Confidence 12",
      "c3": "Pending"
    }
  ]);

  const columns = [
    { header: "Target Metric", accessor: "c0", sortable: true },
    { header: "Algorithm", accessor: "c1", sortable: true },
    { header: "Confidence", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage forecasting config configurations globally</p>
        </div>
