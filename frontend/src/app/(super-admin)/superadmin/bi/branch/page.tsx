...
export default function BranchComparisonPage() {
  ...
  const [data] = useState([
    {
      "c0": "ID-3904",
      "c1": "Sample Branch X 1",
      "c2": "Sample Branch Y 1",
      "c3": "Pending"
    },
    {
      "c0": "ID-7799",
      "c1": "Sample Branch X 2",
      "c2": "Sample Branch Y 2",
      "c3": "Active"
    },
    {
      "c0": "ID-5881",
      "c1": "Sample Branch X 3",
      "c2": "Sample Branch Y 3",
      "c3": "Active"
    },
    {
      "c0": "ID-3631",
      "c1": "Sample Branch X 4",
      "c2": "Sample Branch Y 4",
      "c3": "Active"
    },
    {
      "c0": "ID-5888",
      "c1": "Sample Branch X 5",
      "c2": "Sample Branch Y 5",
      "c3": "Pending"
    },
    {
      "c0": "ID-3591",
      "c1": "Sample Branch X 6",
      "c2": "Sample Branch Y 6",
      "c3": "Pending"
    },
    {
      "c0": "ID-9457",
      "c1": "Sample Branch X 7",
      "c2": "Sample Branch Y 7",
      "c3": "Active"
    },
    {
      "c0": "ID-5338",
      "c1": "Sample Branch X 8",
      "c2": "Sample Branch Y 8",
      "c3": "Inactive"
    },
    {
      "c0": "ID-9790",
      "c1": "Sample Branch X 9",
      "c2": "Sample Branch Y 9",
      "c3": "Active"
    },
    {
      "c0": "ID-4709",
      "c1": "Sample Branch X 10",
      "c2": "Sample Branch Y 10",
      "c3": "Active"
    },
    {
      "c0": "ID-3764",
      "c1": "Sample Branch X 11",
      "c2": "Sample Branch Y 11",
      "c3": "Pending"
    },
    {
      "c0": "ID-2971",
      "c1": "Sample Branch X 12",
      "c2": "Sample Branch Y 12",
      "c3": "Pending"
    }
  ]);
  ...
  const columns = [
    ...
    { header: "Branch X", accessor: "c1", sortable: true },
    { header: "Branch Y", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage branch comparison configurations globally</p>
        </div>
