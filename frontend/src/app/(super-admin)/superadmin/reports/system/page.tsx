...
export default function SystemReportsPage() {
  ...
  const [data] = useState([
    {
      "c0": "ID-2564",
      "c1": "Sample Category 1",
      "c2": "Sample Date 1",
      "c3": "Inactive"
    },
    {
      "c0": "ID-8028",
      "c1": "Sample Category 2",
      "c2": "Sample Date 2",
      "c3": "Inactive"
    },
    {
      "c0": "ID-5661",
      "c1": "Sample Category 3",
      "c2": "Sample Date 3",
      "c3": "Active"
    },
    {
      "c0": "ID-8646",
      "c1": "Sample Category 4",
      "c2": "Sample Date 4",
      "c3": "Active"
    },
    {
      "c0": "ID-5475",
      "c1": "Sample Category 5",
      "c2": "Sample Date 5",
      "c3": "Pending"
    },
    {
      "c0": "ID-3870",
      "c1": "Sample Category 6",
      "c2": "Sample Date 6",
      "c3": "Active"
    },
    {
      "c0": "ID-4663",
      "c1": "Sample Category 7",
      "c2": "Sample Date 7",
      "c3": "Inactive"
    },
    {
      "c0": "ID-3090",
      "c1": "Sample Category 8",
      "c2": "Sample Date 8",
      "c3": "Inactive"
    },
    {
      "c0": "ID-5246",
      "c1": "Sample Category 9",
      "c2": "Sample Date 9",
      "c3": "Active"
    },
    {
      "c0": "ID-2262",
      "c1": "Sample Category 10",
      "c2": "Sample Date 10",
      "c3": "Active"
    },
    {
      "c0": "ID-1501",
      "c1": "Sample Category 11",
      "c2": "Sample Date 11",
      "c3": "Pending"
    },
    {
      "c0": "ID-7644",
      "c1": "Sample Category 12",
      "c2": "Sample Date 12",
      "c3": "Active"
    }
  ]);
  ...
  const columns = [
    ...
    { header: "Category", accessor: "c1", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage system reports configurations globally</p>
        </div>
