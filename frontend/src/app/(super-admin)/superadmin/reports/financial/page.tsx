...
export default function FinancialReportsPage() {
  ...
  const [data] = useState([
    ...
    },
    {
      "c0": "ID-1706",
      "c1": "Sample Period 10",
      "c2": "Sample Revenue 10",
      "c3": "Pending"
    },
    {
      "c0": "ID-6900",
      "c1": "Sample Period 11",
      "c2": "Sample Revenue 11",
      "c3": "Active"
    },
    {
      "c0": "ID-8734",
      "c1": "Sample Period 12",
      "c2": "Sample Revenue 12",
      "c3": "Active"
    }
  ]);
  ...
  const columns = [
    ...
    { header: "Period", accessor: "c1", sortable: true },
    { header: "Revenue", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage financial reports configurations globally</p>
        </div>
