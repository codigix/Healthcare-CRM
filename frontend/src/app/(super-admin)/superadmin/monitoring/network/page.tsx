...
export default function NetworkMonitoringPage() {
  ...
  const [data] = useState([
    {
      "c0": "ID-8466",
      "c1": "Sample Bandwidth In 1",
      "c2": "Sample Bandwidth Out 1",
      "c3": "Pending"
    },
    {
      "c0": "ID-9997",
      "c1": "Sample Bandwidth In 2",
      "c2": "Sample Bandwidth Out 2",
      "c3": "Active"
    },
    {
      "c0": "ID-4837",
      "c1": "Sample Bandwidth In 3",
      "c2": "Sample Bandwidth Out 3",
      "c3": "Inactive"
    },
    {
      "c0": "ID-7302",
      "c1": "Sample Bandwidth In 4",
      "c2": "Sample Bandwidth Out 4",
      "c3": "Active"
    },
    {
      "c0": "ID-8031",
      "c1": "Sample Bandwidth In 5",
      "c2": "Sample Bandwidth Out 5",
      "c3": "Active"
    },
    {
      "c0": "ID-6075",
      "c1": "Sample Bandwidth In 6",
      "c2": "Sample Bandwidth Out 6",
      "c3": "Inactive"
    },
    {
      "c0": "ID-6761",
      "c1": "Sample Bandwidth In 7",
      "c2": "Sample Bandwidth Out 7",
      "c3": "Pending"
    },
    {
      "c0": "ID-9676",
      "c1": "Sample Bandwidth In 8",
      "c2": "Sample Bandwidth Out 8",
      "c3": "Active"
    },
    {
      "c0": "ID-9289",
      "c1": "Sample Bandwidth In 9",
      "c2": "Sample Bandwidth Out 9",
      "c3": "Pending"
    },
    {
      "c0": "ID-2501",
      "c1": "Sample Bandwidth In 10",
      "c2": "Sample Bandwidth Out 10",
      "c3": "Active"
    },
    {
      "c0": "ID-6665",
      "c1": "Sample Bandwidth In 11",
      "c2": "Sample Bandwidth Out 11",
      "c3": "Active"
    },
    {
      "c0": "ID-1176",
      "c1": "Sample Bandwidth In 12",
      "c2": "Sample Bandwidth Out 12",
      "c3": "Active"
    }
  ]);

  const columns = [
    { header: "Interface", accessor: "c0", sortable: true },
    { header: "Bandwidth In", accessor: "c1", sortable: true },
    { header: "Bandwidth Out", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage network monitoring configurations globally</p>
        </div>
