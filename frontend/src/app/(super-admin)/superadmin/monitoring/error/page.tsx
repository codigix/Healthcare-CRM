...
export default function ErrorMonitoringPage() {
  ...
  const [data] = useState([
    ...
    {
      "c0": "ID-5886",
      "c1": "Sample Service 10",
      "c2": "Sample Count 10",
      "c3": "Active"
    },
    {
      "c0": "ID-1474",
      "c1": "Sample Service 11",
      "c2": "Sample Count 11",
      "c3": "Active"
    },
    {
      "c0": "ID-2504",
      "c1": "Sample Service 12",
      "c2": "Sample Count 12",
      "c3": "Active"
    }
  ]);
  ...
  const columns = [
    { header: "Error ID", accessor: "c0", sortable: true },
    { header: "Service", accessor: "c1", sortable: true },
    { header: "Count", accessor: "c2", sortable: true },
    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-xs">Manage error monitoring configurations globally</p>
        </div>
