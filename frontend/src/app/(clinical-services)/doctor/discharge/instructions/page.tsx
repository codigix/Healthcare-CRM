...
export default function HomeCareInstructionsPage() {
  ...
  const columns = [
    { header: 'Instruction ID', accessor: 'instructionid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Provided By', accessor: 'providedby', sortable: true },
    { header: 'Acknowledged', accessor: 'acknowledged', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Specific nursing and lifestyle instructions for home care.</p>
        </div>
