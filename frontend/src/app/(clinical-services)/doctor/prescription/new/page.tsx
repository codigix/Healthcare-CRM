...
export default function NewPrescriptionPage() {
  ...
  const columns = [
    ...
    { header: 'Medications Count', accessor: 'medicationscount', sortable: true },
    { header: 'Duration', accessor: 'duration', sortable: true },
    { header: 'Pharmacy Route', accessor: 'pharmacyroute', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Create and issue a new medication prescription.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rx Issued Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>142</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">e-Rx Sent</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>130</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Printed</p>
