...
export default function ProceduralPerformancePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Metric ID', accessor: 'metricid', sortable: true },
    { header: 'Surgeon', accessor: 'surgeon', sortable: true },
    { header: 'Procedures Done', accessor: 'proceduresdone', sortable: true },
    { header: 'Success Rate', accessor: 'successrate', sortable: true },
    { header: 'Avg OR Time', accessor: 'avgortime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Metrics on surgical success rates, complications, and OR time.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Procedures</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>342</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Success</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>99%</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Target OR Util.</p>
