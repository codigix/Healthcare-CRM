...
export default function PatientMedicalHistoryPage() {
  ...
  const columns = [
    { header: 'History ID', accessor: 'historyid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Past Diagnosis', accessor: 'pastdiagnosis', sortable: true },
    { header: 'Resolution Date', accessor: 'resolutiondate', sortable: true },
    { header: 'Treated By', accessor: 'treatedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Complete historical view of a patient's past diagnoses.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">History Records</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12,450</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Updated Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Flagged Info</p>
