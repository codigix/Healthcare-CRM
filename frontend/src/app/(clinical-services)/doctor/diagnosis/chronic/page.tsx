...
export default function ChronicConditionsPage() {
  ...
  const columns = [
    ...
    { header: 'Diagnosed On', accessor: 'diagnosedon', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Track long-term and chronic conditions for regular patients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Patients w/ Chronic</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>450</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Severity</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>84</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Stable</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>312</p>
        </div>
      </div>
