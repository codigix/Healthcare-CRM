...
export default function PrescriptionAnalyticsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Report ID', accessor: 'reportid', sortable: true },
    { header: 'Medication Class', accessor: 'medicationclass', sortable: true },
    { header: 'Total Prescribed', accessor: 'totalprescribed', sortable: true },
    { header: 'Top Prescriber', accessor: 'topprescriber', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Reports on medication usage, trends, and pharmacy data.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Most Prescribed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Antibiotics</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">e-Rx Adoption</p>
