...
export default function TraumaCasesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Trauma ID', accessor: 'traumaid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Mechanism of Injury', accessor: 'mechanismofinjury', sortable: true },
    { header: 'Trauma Surgeon', accessor: 'traumasurgeon', sortable: true },
    { header: 'Imaging', accessor: 'imaging', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Specific log for trauma and surgical emergency cases.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Trauma Cases Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">In OR</p>
