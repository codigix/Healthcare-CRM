...
export default function DiagnosisListPage() {
  ...
  const columns = [
    { header: 'Dx ID', accessor: 'dxid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'ICD-10 Code', accessor: 'icd10code', sortable: true },
    { header: 'Diagnosis Description', accessor: 'diagnosisdescription', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">ICD-10 coded diagnosis tracker for patient encounters.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Primary Dx</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Secondary Dx</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unconfirmed</p>
