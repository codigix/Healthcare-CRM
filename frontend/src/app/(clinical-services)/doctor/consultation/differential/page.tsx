...
export default function DifferentialDiagnosisPage() {
  ...
  const columns = [
    ...
    { header: 'Presenting Symptoms', accessor: 'presentingsymptoms', sortable: true },
    { header: 'Differential Dx', accessor: 'differentialdx', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage and rule out potential diagnoses for complex cases.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Complexity</p>
