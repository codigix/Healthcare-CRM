...
export default function TodaysSchedulePage() {
  ...
  const columns = [
    ...
    { header: 'Room/Ward', accessor: 'roomward', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Live overview of all doctor appointments scheduled for today.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Appts Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>312</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
