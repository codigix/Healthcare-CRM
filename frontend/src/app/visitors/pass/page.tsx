...
export default function VisitorPassesPage() {
  ...
  const columns = [
    { header: 'Pass ID', accessor: 'passid', sortable: true },
    { header: 'Visitor Name', accessor: 'visitorname', sortable: true },
    { header: 'Pass Type', accessor: 'passtype', sortable: true },
    { header: 'Valid Until', accessor: 'validuntil', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Issue and manage digital or physical passes for registered visitors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Expired Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>54</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revoked</p>
