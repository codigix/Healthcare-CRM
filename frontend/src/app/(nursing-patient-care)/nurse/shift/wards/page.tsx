...
export default function WardOverviewPage() {
  ...
  const columns = [
    ...
    { header: 'Admission Reason', accessor: 'admissionreason', sortable: true },
    { header: 'Attending Dr', accessor: 'attendingdr', sortable: true },
    { header: 'Last Check', accessor: 'lastcheck', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">High-level view of all beds and patients in your current ward.</p>
        </div>
