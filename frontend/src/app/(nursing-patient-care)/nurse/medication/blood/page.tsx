...
export default function BloodTransfusionsPage() {
  ...
  const columns = [
    ...
    { header: 'Product/Group', accessor: 'productgroup', sortable: true },
    { header: 'Start Time', accessor: 'starttime', sortable: true },
    { header: 'Vitals Checked', accessor: 'vitalschecked', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Specialized log for monitoring blood product transfusions.</p>
        </div>
