...
export default function IVFluidsTrackingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'IV ID', accessor: 'ivid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Fluid Type', accessor: 'fluidtype', sortable: true },
    { header: 'Rate (ml/hr)', accessor: 'ratemlhr', sortable: true },
    { header: 'Vol Infused', accessor: 'volinfused', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage IV drips, flow rates, and volume infused.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Drips</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Completing Soon</p>
