...
export default function FallRiskAssessmentsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Eval ID', accessor: 'evalid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Scale Used', accessor: 'scaleused', sortable: true },
    { header: 'Score', accessor: 'score', sortable: true },
    { header: 'Precautions', accessor: 'precautions', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Evaluate and log patient fall risks (e.g., Morse Fall Scale).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Patients Assessed</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bed Alarms Active</p>
