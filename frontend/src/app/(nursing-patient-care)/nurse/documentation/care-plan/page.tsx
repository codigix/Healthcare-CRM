...
export default function CarePlanUpdatesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Update ID', accessor: 'updateid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Plan ID', accessor: 'planid', sortable: true },
    { header: 'Change Reason', accessor: 'changereason', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Documentation of revisions to nursing care plans.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Plans Updated</p>
