...
export default function IncidentReportsPage() {
  ...
  const columns = [
    ...
    { header: 'Patient/Staff Involved', accessor: 'patientstaffinvolved', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Documentation of adverse events, falls, or medication errors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Incidents Today</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>5 (Monthly)</p>
        </div>
      </div>
