...
export default function NursingCarePlansPage() {
  ...
  const columns = [
    ...
    { header: 'Nursing Diagnosis', accessor: 'nursingdiagnosis', sortable: true },
    { header: 'Interventions', accessor: 'interventions', sortable: true },
    { header: 'Last Reviewed', accessor: 'lastreviewed', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Structured, individualized plans of care and nursing diagnoses.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Due for Review</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Goals Met</p>
