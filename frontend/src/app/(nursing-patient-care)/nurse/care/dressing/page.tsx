...
export default function DressingChangesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Task ID', accessor: 'taskid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Wound Location', accessor: 'woundlocation', sortable: true },
    { header: 'Dressing Type', accessor: 'dressingtype', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Schedule and log surgical and wound dressing changes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Changes Today</p>
