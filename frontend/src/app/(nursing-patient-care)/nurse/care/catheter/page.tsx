...
export default function CatheterCarePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Log ID', accessor: 'logid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Catheter Type', accessor: 'cathetertype', sortable: true },
    { header: 'Inserted On', accessor: 'insertedon', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Log insertion, removal, and maintenance of urinary/IV catheters.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Catheters</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>22</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Due for Change</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Removed Today</p>
