...
export default function InfectionControlChecksPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Audit ID', accessor: 'auditid', sortable: true },
    { header: 'Ward/Room', accessor: 'wardroom', sortable: true },
    { header: 'Isolation Type', accessor: 'isolationtype', sortable: true },
    { header: 'Signage Posted', accessor: 'signageposted', sortable: true },
    { header: 'PPE Available', accessor: 'ppeavailable', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Isolation protocols, hygiene audits, and PPE compliance.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Isolation Rooms</p>
