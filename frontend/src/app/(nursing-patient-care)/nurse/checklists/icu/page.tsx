...
export default function ICUTransferChecklistPage() {
  ...
  const columns = [
    ...
    { header: 'Bed Prepared', accessor: 'bedprepared', sortable: true },
    { header: 'Ventilator Ready', accessor: 'ventilatorready', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Critical care transfer protocols and equipment readiness.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Transfers Pending</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Equipment Issues</p>
