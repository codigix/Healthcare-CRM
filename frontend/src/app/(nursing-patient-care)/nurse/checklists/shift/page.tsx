...
export default function ShiftChecklistPage() {
  ...
  const columns = [
    ...
    { header: 'Crash Cart Checked', accessor: 'crashcartchecked', sortable: true },
    { header: 'Narcotics Counted', accessor: 'narcoticscounted', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Start/End of shift responsibilities and equipment checks.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Shift Checks Done</p>
