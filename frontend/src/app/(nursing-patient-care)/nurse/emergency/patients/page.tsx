...
export default function ERPatientsNurseViewPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'ER ID', accessor: 'erid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Triage Priority', accessor: 'triagepriority', sortable: true },
    { header: 'Assigned Bed', accessor: 'assignedbed', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            ER Patients (Nurse View)
          </h1>
          <p className="text-sm text-gray-400 mt-1">Triage queue and active ER patients requiring nursing care.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">My ER Patients</p>
