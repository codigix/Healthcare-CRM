...
export default function ERCrashCartMedsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Check ID', accessor: 'checkid', sortable: true },
    { header: 'Cart Location', accessor: 'cartlocation', sortable: true },
    { header: 'Checked By', accessor: 'checkedby', sortable: true },
    { header: 'Missing/Used Items', accessor: 'missinguseditems', sortable: true },
    { header: 'Last Checked', accessor: 'lastchecked', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Usage logs and inventory checks for emergency medications.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Carts Checked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>5/5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Restock Required</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Expired Items</p>
