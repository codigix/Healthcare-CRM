...
export default function DischargeEducationPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Edu ID', accessor: 'eduid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Topic Covered', accessor: 'topiccovered', sortable: true },
    { header: 'Family Present', accessor: 'familypresent', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Final checklist of educational needs prior to patient discharge.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cleared</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>6</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Refusals</p>
