...
export default function HomeCareTrainingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Edu ID', accessor: 'eduid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Device/Skill', accessor: 'deviceskill', sortable: true },
    { header: 'Demonstration', accessor: 'demonstration', sortable: true },
    { header: 'Return Demo', accessor: 'returndemo', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Specialized training for devices (e.g. ostomies, catheters) at home.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Trainings Required</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Competent</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Needs Review</p>
