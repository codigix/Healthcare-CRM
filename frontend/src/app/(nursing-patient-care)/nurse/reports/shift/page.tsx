...
export default function ShiftSummaryReportsPage() {
  ...
  const columns = [
    ...
    { header: 'Nurses on Duty', accessor: 'nursesonduty', sortable: true },
    { header: 'Patient Ratio', accessor: 'patientratio', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Aggregated data on nurse workload, overtime, and staffing ratios.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Ratio</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1:5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overtime Hours</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Sick Calls</p>
