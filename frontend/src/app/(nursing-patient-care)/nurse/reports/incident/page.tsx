...
export default function IncidentAnalyticsPage() {
  ...
  const columns = [
    ...
    { header: 'Falls', accessor: 'falls', sortable: true },
    { header: 'Med Errors', accessor: 'mederrors', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Trends and analysis of nursing-related incident reports.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Incidents (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fall Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.2/1000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Action Plans</p>
