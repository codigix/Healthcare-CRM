...
export default function MedicationAdminReportPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Report ID', accessor: 'reportid', sortable: true },
    { header: 'Ward', accessor: 'ward', sortable: true },
    { header: 'Meds Given', accessor: 'medsgiven', sortable: true },
    { header: 'On-Time %', accessor: 'ontime', sortable: true },
    { header: 'Missed/Refused', accessor: 'missedrefused', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analytics on medication timings, errors, and PRN usage.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">On-Time Admin</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>96%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">PRN Doses</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Errors Reported</p>
