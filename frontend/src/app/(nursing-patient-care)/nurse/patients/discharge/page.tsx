...
export default function DischargeProcessingPage() {
  ...
  const columns = [
    ...
    { header: 'Checklist', accessor: 'checklist', sortable: true },
    { header: 'Cannula Removed', accessor: 'cannularemoved', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Finalize nursing checklist for departing patients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cleared to Leave</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Meds</p>
