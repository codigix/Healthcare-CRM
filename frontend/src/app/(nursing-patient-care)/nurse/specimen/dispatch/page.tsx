...
export default function SpecimenDispatchPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Dispatch ID', accessor: 'dispatchid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Specimen Type', accessor: 'specimentype', sortable: true },
    { header: 'Sent Via', accessor: 'sentvia', sortable: true },
    { header: 'Time Sent', accessor: 'timesent', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Log of specimens sent to the laboratory.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Dispatched Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>40</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">In Transit</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Received by Lab</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>35</p>
        </div>
      </div>
