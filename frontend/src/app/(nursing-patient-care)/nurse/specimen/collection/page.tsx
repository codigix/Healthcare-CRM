...
export default function SpecimenCollectionPage() {
  ...
  const columns = [
    ...
    { header: 'Test Ordered', accessor: 'testordered', sortable: true },
    { header: 'Due Time', accessor: 'duetime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tasks for collecting blood, urine, or swab samples.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Collections</p>
