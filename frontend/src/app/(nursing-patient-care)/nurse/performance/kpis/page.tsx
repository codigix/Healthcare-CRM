...
export default function NursingKPIsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'KPI ID', accessor: 'kpiid', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Overall department and individual key performance indicators.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">KPIs Met</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>15/18</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Grade</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>A-</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Focus Areas</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Documentation</p>
        </div>
      </div>
