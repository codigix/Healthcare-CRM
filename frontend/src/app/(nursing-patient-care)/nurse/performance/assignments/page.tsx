...
export default function AssignmentLoadPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Log ID', accessor: 'logid', sortable: true },
    { header: 'Nurse Name', accessor: 'nursename', sortable: true },
    { header: 'Avg Patients', accessor: 'avgpatients', sortable: true },
    { header: 'Acuity Score', accessor: 'acuityscore', sortable: true },
    { header: 'Overtime Hrs', accessor: 'overtimehrs', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analysis of patient acuity and workload distribution.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Acuity Load</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Medium-High</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Balanced Shifts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>85%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overburdened</p>
