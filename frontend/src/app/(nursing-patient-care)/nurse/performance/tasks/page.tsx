...
export default function TaskEfficiencyPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Metric ID', accessor: 'metricid', sortable: true },
    { header: 'Nurse Name', accessor: 'nursename', sortable: true },
    { header: 'Tasks Assigned', accessor: 'tasksassigned', sortable: true },
    { header: 'Completed On-Time', accessor: 'completedontime', sortable: true },
    { header: 'Efficiency %', accessor: 'efficiency', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Metrics tracking individual nurse task completion times.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Efficiency</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>94%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Performers</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Needs Support</p>
