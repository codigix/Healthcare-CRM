...
export default function EmployeeExitPage() {
  ...
  const columns = [
    ...
    { header: 'Resignation Date', accessor: 'resignationdate', sortable: true },
    { header: 'Notice Period', accessor: 'noticeperiod', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Offboarding process, clearances, and full & final settlement tracking.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Exits</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Clearances Pending</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Alumni</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>150</p>
        </div>
      </div>
