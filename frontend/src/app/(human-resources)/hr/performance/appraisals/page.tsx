...
export default function AppraisalsPage() {
  ...
  const columns = [
    { header: 'Appraisal ID', accessor: 'appraisalid', sortable: true },
    { header: 'Emp Name', accessor: 'empname', sortable: true },
    { header: 'Final Rating', accessor: 'finalrating', sortable: true },
    { header: 'Recommendation', accessor: 'recommendation', sortable: true },
    { header: 'HR Action', accessor: 'hraction', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Annual rating finalization leading to increments or promotions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Appraisal Cycle</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Closed</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Rating</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>3.8/5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
