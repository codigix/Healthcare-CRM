...
export default function PerformanceReviewPage() {
  ...
  const columns = [
    ...
    { header: 'Self Score', accessor: 'selfscore', sortable: true },
    { header: 'Mgr Score', accessor: 'mgrscore', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Periodic check-ins and scoring between employees and managers.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Current Cycle</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Mid-Year 2026</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reviews Completed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>75%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Manager</p>
