...
export default function PromotionsPage() {
  ...
  const columns = [
    ...
    { header: 'Old Designation', accessor: 'olddesignation', sortable: true },
    { header: 'New Designation', accessor: 'newdesignation', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking staff elevation to higher bands or designations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Promotions (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>34</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Final Auth</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fast Track</p>
