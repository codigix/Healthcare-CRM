...
export default function TrainingCalendarPage() {
  ...
  const columns = [
    { header: 'Training Date', accessor: 'trainingdate', sortable: true },
    { header: 'Program Name', accessor: 'programname', sortable: true },
    { header: 'Trainer', accessor: 'trainer', sortable: true },
    { header: 'Target Audience', accessor: 'targetaudience', sortable: true },
    { header: 'Location/Link', accessor: 'locationlink', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Schedules for all upcoming induction, compliance, and clinical training sessions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Upcoming Trainings</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Staff Enrolled</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Trainings (YTD)</p>
