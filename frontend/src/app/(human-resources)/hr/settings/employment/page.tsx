...
export default function EmploymentTypesPage() {
  ...
  const columns = [
    { header: 'Type Name', accessor: 'typename', sortable: true },
    { header: 'PF/ESI Applicability', accessor: 'pfesiapplicability', sortable: true },
    { header: 'Leave Accrual', accessor: 'leaveaccrual', sortable: true },
    { header: 'Notice Req.', accessor: 'noticereq', sortable: true },
    { header: 'Max Tenure', accessor: 'maxtenure', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Rules for Full-Time, Part-Time, Consultants, Locums, and Contract staff.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Emp Types Defined</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>6</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Contract Staff %</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>20%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Locum Doctors</p>
