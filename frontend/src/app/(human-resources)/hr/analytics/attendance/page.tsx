...
export default function AttendanceAnalyticsPage() {
  ...
  const columns = [
    { header: 'Pattern Identified', accessor: 'patternidentified', sortable: true },
    { header: 'Affected Staff', accessor: 'affectedstaff', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Identifying chronic absenteeism, frequent latecomers, and OT patterns.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Chronic Absentees</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Habitual Latecomers</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">OT Dependency</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>High in ER</p>
        </div>
      </div>
