...
export default function LeaveSummaryReportPage() {
  ...
  const columns = [
    ...
    { header: 'Leaves Taken (YTD)', accessor: 'leavestakenytd', sortable: true },
    { header: 'Average/Emp', accessor: 'averageemp', sortable: true },
    { header: 'Liability Value', accessor: 'liabilityvalue', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Trends on leave consumption and remaining organizational liability.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Leaves Taken</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>2,450</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Leave Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Nursing</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unplanned Leave %</p>
