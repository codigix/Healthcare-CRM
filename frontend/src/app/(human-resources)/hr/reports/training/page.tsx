...
export default function TrainingROIReportPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Program', accessor: 'program', sortable: true },
    { header: 'Batches', accessor: 'batches', sortable: true },
    { header: 'Staff Trained', accessor: 'stafftrained', sortable: true },
    { header: 'Total Hours', accessor: 'totalhours', sortable: true },
    { header: 'Avg Score', accessor: 'avgscore', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Data on training hours delivered, costs, and post-training assessment scores.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Training Hrs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Staff Covered</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>85%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Training Budget</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>65% Used</p>
        </div>
      </div>
