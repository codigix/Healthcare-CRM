...
export default function IncentivesPage() {
  ...
  const columns = [
    ...
    { header: 'Target Metric', accessor: 'targetmetric', sortable: true },
    { header: 'Achieved', accessor: 'achieved', sortable: true },
    { header: 'Incentive Amount', accessor: 'incentiveamount', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Variable pay for doctors, sales, or collections teams based on targets.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Incentives (Mo)</p>
