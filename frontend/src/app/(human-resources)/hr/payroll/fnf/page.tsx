...
export default function FullFinalSettlementPage() {
  ...
  const columns = [
    { header: 'Exit ID', accessor: 'exitid', sortable: true },
    { header: 'Emp Name', accessor: 'empname', sortable: true },
    { header: 'Last Working Day', accessor: 'lastworkingday', sortable: true },
    { header: 'FnF Amount', accessor: 'fnfamount', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Final financial clearance calculation for departing employees.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending FnF</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Settled (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Settlement Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>28 Days</p>
        </div>
      </div>
