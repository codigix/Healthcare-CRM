...
export default function SalaryStructurePage() {
  ...
  const columns = [
    { header: 'Band/Grade', accessor: 'bandgrade', sortable: true },
    { header: 'Basic %', accessor: 'basic', sortable: true },
    { header: 'HRA %', accessor: 'hra', sortable: true },
    { header: 'Special Allowance', accessor: 'specialallowance', sortable: true },
    { header: 'PF Rule', accessor: 'pfrule', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Defining CTC breakdowns: Basic, HRA, Allowances for different bands.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Bands</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Structures Defined</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>100%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Updates</p>
