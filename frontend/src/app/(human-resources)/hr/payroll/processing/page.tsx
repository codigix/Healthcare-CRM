...
export default function PayrollProcessingPage() {
  ...
  const columns = [
    ...
    { header: 'Processed By', accessor: 'processedby', sortable: true },
    { header: 'Total Emp Processed', accessor: 'totalempprocessed', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monthly calculation engine factoring attendance, OT, leaves, and deductions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Current Month</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>June 2026</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Processing Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Completed</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Errors Flagged</p>
