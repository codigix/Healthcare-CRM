...
export default function ReimbursementsPage() {
  ...
  const columns = [
    ...
    { header: 'Claim Type', accessor: 'claimtype', sortable: true },
    { header: 'Approved Amount', accessor: 'approvedamount', sortable: true },
    { header: 'Payout Month', accessor: 'payoutmonth', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Payout of approved employee expenses along with the salary.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Payout</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$8,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Paid (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$12,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Claim TAT</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>5 Days</p>
        </div>
      </div>
