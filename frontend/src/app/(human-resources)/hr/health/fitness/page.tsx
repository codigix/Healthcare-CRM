...
export default function FitnessCertificatesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Emp Name', accessor: 'empname', sortable: true },
    { header: 'Leave Type', accessor: 'leavetype', sortable: true },
    { header: 'Leave Duration', accessor: 'leaveduration', sortable: true },
    { header: 'Fitness Date', accessor: 'fitnessdate', sortable: true },
    { header: 'Cleared By', accessor: 'clearedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Return-to-work clearances after prolonged illness or maternity leave.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Maternity Returns</p>
