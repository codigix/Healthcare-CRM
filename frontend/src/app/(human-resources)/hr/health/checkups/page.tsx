...
export default function HealthCheckupsPage() {
  ...
  const columns = [
    ...
    { header: 'Checkup Type', accessor: 'checkuptype', sortable: true },
    { header: 'Date', accessor: 'date', sortable: true },
    { header: 'Fitness Status', accessor: 'fitnessstatus', sortable: true },
    { header: 'Reviewing Doctor', accessor: 'reviewingdoctor', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Annual or pre-employment health screening records for staff.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Checkups Done (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>450</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Annual</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unfit/Review</p>
