...
export default function VaccinationHistoryPage() {
  ...
  const columns = [
    ...
    { header: 'Dose No', accessor: 'doseno', sortable: true },
    { header: 'Date Administered', accessor: 'dateadministered', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed log of all vaccines administered to an employee by the hospital.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Vaccines Administered</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,240</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Adverse Reactions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Stock Availability</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Adequate</p>
        </div>
      </div>
