...
export default function ShiftSwapPage() {
  ...
  const columns = [
    ...
    { header: 'Initiator', accessor: 'initiator', sortable: true },
    { header: 'Requested Staff', accessor: 'requestedstaff', sortable: true },
    { header: 'Date', accessor: 'date', sortable: true },
    { header: 'Shift Exchanged', accessor: 'shiftexchanged', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Requests by employees to exchange shifts with colleagues.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Swaps</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Approved (Week)</p>
