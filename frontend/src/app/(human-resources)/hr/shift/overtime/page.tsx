...
export default function OvertimeManagementPage() {
  ...
  const columns = [
    ...
    { header: 'Extra Hours', accessor: 'extrahours', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking and approval of extra hours worked beyond the shift.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total OT Hours (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>345 Hrs</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Approved Value</p>
