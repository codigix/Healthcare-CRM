...
export default function ShiftMasterPage() {
  ...
  const columns = [
    { header: 'Shift Code', accessor: 'shiftcode', sortable: true },
    ...
    { header: 'Grace Period', accessor: 'graceperiod', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Defining hospital shifts (Morning, Evening, Night, General).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Shifts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>6</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Employees Mapped</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>824</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">24/7 Coverage</p>
