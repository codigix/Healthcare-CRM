...
export default function LeaveBalancePage() {
  ...
  const columns = [
    ...
    { header: 'Annual', accessor: 'annual', sortable: true },
    { header: 'Sick', accessor: 'sick', sortable: true },
    { header: 'Casual', accessor: 'casual', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking accrued, consumed, and remaining leave quotas per employee.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Liability (Days)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Encashment Due</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$12,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Negative Balances</p>
