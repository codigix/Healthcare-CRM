...
export default function LeaveApprovalPage() {
  ...
  const columns = [
    ...
    { header: 'Days Requested', accessor: 'daysrequested', sortable: true },
    { header: 'Coverage Plan', accessor: 'coverageplan', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manager dashboard for approving or rejecting leave based on roster impact.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Leaves to Approve</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Roster Conflicts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg TAT</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.5 Days</p>
        </div>
      </div>
