...
export default function LeaveRequestsPage() {
  ...
  const columns = [
    ...
    { header: 'From Date', accessor: 'fromdate', sortable: true },
    { header: 'To Date', accessor: 'todate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Incoming applications from staff for vacation, sick, or casual leave.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Staff on Leave</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>29</p>
        </div>
      </div>
