...
export default function ApprovalWorkflowPage() {
  ...
  const columns = [
    ...
    { header: 'Policy Limit', accessor: 'policylimit', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manager/HOD view to approve, reject, or request more info on team claims.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">My Approvals Due</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$3,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
