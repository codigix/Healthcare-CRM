...
export default function GeneralExpenseClaimsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Claim ID', accessor: 'claimid', sortable: true },
    { header: 'Emp Name', accessor: 'empname', sortable: true },
    { header: 'Expense Category', accessor: 'expensecategory', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Reimbursement for mobile bills, internet, or petty departmental purchases.</p>
        </div>
