...
export default function TravelClaimsPage() {
  ...
  const columns = [
    ...
    { header: 'Travel Purpose', accessor: 'travelpurpose', sortable: true },
    { header: 'Amount Claimed', accessor: 'amountclaimed', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Reimbursement for official travel, conferences, or camp duties.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Claims</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Claim Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$4,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Approved (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$12,000</p>
        </div>
      </div>
