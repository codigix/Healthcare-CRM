...
export default function HRAnnouncementsPage() {
  ...
  const columns = [
    { header: 'Announcement Title', accessor: 'announcementtitle', sortable: true },
    { header: 'Date Posted', accessor: 'dateposted', sortable: true },
    { header: 'Target Audience', accessor: 'targetaudience', sortable: true },
    { header: 'Read Count', accessor: 'readcount', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Broadcast messages for events, policy changes, or hospital news.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Announcements</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Read Rate</p>
