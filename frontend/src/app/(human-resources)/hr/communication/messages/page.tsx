...
export default function InternalMessagesPage() {
  ...
  const columns = [
    { header: 'Message Subject', accessor: 'messagesubject', sortable: true },
    { header: 'To/From', accessor: 'tofrom', sortable: true },
    { header: 'Date & Time', accessor: 'datetime', sortable: true },
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Attachments', accessor: 'attachments', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Direct secure messaging between HR and individual employees.</p>
        </div>
