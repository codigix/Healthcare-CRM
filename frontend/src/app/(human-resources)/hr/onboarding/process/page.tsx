...
export default function EmployeeOnboardingPage() {
  ...
  const columns = [
    ...
    { header: 'DOJ', accessor: 'doj', sortable: true },
    { header: 'Documents Check', accessor: 'documentscheck', sortable: true },
    { header: 'Asset Allocation', accessor: 'assetallocation', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Workflow tracking for new hires on their first week.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Onboardings</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Delayed Steps</p>
