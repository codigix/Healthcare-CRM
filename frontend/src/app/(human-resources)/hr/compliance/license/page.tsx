...
export default function LicenseVerificationPage() {
  ...
  const columns = [
    ...
    { header: 'License Type', accessor: 'licensetype', sortable: true },
    { header: 'License No', accessor: 'licenseno', sortable: true },
    { header: 'Council', accessor: 'council', sortable: true },
    { header: 'Verification Date', accessor: 'verificationdate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Primary Source Verification (PSV) of nursing and medical licenses.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Verified Licenses</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>450</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending PSV</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Flagged/Fake</p>
