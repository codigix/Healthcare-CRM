...
export default function StaffVaccinationPage() {
  ...
  const columns = [
    ...
    { header: 'Hep-B Status', accessor: 'hepbstatus', sortable: true },
    { header: 'COVID Status', accessor: 'covidstatus', sortable: true },
    { header: 'Next Dose Due', accessor: 'nextdosedue', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Mandatory tracking of Hep-B, COVID, and Flu shots for clinical staff.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fully Vaccinated</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>95%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Hep-B</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Doses Scheduled</p>
