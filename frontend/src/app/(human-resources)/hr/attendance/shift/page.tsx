...
export default function ShiftAttendancePage() {
  ...
  const columns = [
    ...
    { header: 'Assigned Shift', accessor: 'assignedshift', sortable: true },
    { header: 'Actual In', accessor: 'actualin', sortable: true },
    { header: 'Late By', accessor: 'lateby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Attendance view filtered specifically for mapping against assigned shifts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Shift Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>96%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Late Comers</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>32</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Shift Mismatches</p>
