...
export default function AttendancePage() {
  ...
  const fetchAttendance = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/attendance?date=${selectedDate}`,
        {
          headers: {
  ...
  const handleRecordTimeSubmit = async () => {
    ...
    try {
      const hours = calculateHours(
        recordFormData.checkIn,
        recordFormData.checkOut
      );
      const payload = {
        staffId: recordFormData.staffId,
        date: recordFormData.date,
        status: recordFormData.status,
        checkIn: recordFormData.checkIn
          ? `${recordFormData.date}T${recordFormData.checkIn}`
          : null,
        checkOut: recordFormData.checkOut
          ? `${recordFormData.date}T${recordFormData.checkOut}`
          : null,
        hours: hours,
      };
  ...
  const getWeeklyTimesheets = () => {
    ...
    const weeklySummary: Record<
      string,
      { staff: string; hours: number; status: string }[]
    > = {};
    ...
    <>
      <div className="space-y-6">
        <div className="flex justify-between items-center my-3 my-3">
          <div>
            <h1 className="text-3xl  mb-2">Staff Attendance</h1>
            <p className="text-gray-400">
              Track and manage staff attendance records
            </p>
          </div>
          <div className="flex gap-3">
            <button onClick={handleRecordTimeClick} className="btn-primary">
              Record Time
            </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="card">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-mdtext-gray-400">Present Today</div>
          ...
          <div className="card">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-mdtext-gray-400">Absent Today</div>
          ...
          <div className="card">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-2xl ">{onLeaveCount}</div>
          ...
          <div className="card">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-mdtext-gray-400">Late Arrivals</div>
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2 p-2 bg-dark-tertiary rounded">
          ...
          <div className="flex gap-4 mb-6 border-b border-dark-tertiary overflow-x-auto">
            <button
              ...
              className={`pb-3 px-1 font-medium whitespace-nowrap transition-colors ${activeTab === "daily"
            ...
            <button
              ...
              className={`pb-3 px-1 font-medium whitespace-nowrap transition-colors ${activeTab === "calendar"
                ? "text-emerald-500 border-b-2 border-emerald-500"
                : "text-gray-400 hover:text-gray-300"
                }`}
            >
            ...
            <button
              ...
              className={`pb-3 px-1 font-medium whitespace-nowrap transition-colors ${activeTab === "timesheets"
                ? "text-emerald-500 border-b-2 border-emerald-500"
                : "text-gray-400 hover:text-gray-300"
                }`}
            >
            ...
            <button
              ...
              className={`pb-3 px-1 font-medium whitespace-nowrap transition-colors ${activeTab === "leaves"
                ? "text-emerald-500 border-b-2 border-emerald-500"
                : "text-gray-400 hover:text-gray-300"
                }`}
            >
            ...
            <button
              ...
              className={`pb-3 px-1 font-medium whitespace-nowrap transition-colors ${activeTab === "reports"
                ? "text-emerald-500 border-b-2 border-emerald-500"
                : "text-gray-400 hover:text-gray-300"
                }`}
            >
              ...
              <div className="grid grid-cols-7 gap-2">
                ...
                {getMonthCalendarDays().map((day, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`aspect-square rounded p-2 ${statusColor} cursor-pointer hover:opacity-80 transition-opacity flex flex-col items-center justify-center text-center`}
                    >
                      <div className="text-mdfont-semibold text-white">
                        {day.getDate()}
                      </div>
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                <div className="bg-emerald-500/20 border border-emerald-500/30 rounded p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-mdtext-gray-400">All Present</p>
                      <p className="text-lg font-semibold text-emerald-400">
                        {
                          getMonthCalendarDays().filter(
                            (day) =>
                              getStatusColor(
                ...
                <div className="bg-blue-500/20 border border-blue-500/30 rounded p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-mdtext-gray-400">Partial</p>
                ...
                <div className="bg-red-500/20 border border-red-500/30 rounded p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-mdtext-gray-400">Absent</p>
            ...
            <>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    {Object.entries(getWeeklyTimesheets()).map(
                      ([date, staffList]) =>
                        staffList.length > 0 ? (
                          staffList.map((staff, idx) => (
                            ...
                            >
                              ...
                              <td className="py-4 px-4 text-gray-300 font-semibold">
                                {staff.hours.toFixed(2)}h
                              </td>
                              <td className="py-4 px-4">
                                <span
                                  className={`px-3 py-1 rounded-full text-xs font-medium ${staff.status === "Present"
                                    ? "bg-emerald-500/10 text-emerald-500 border border-emerald-500/20"
                                    : staff.status === "On Late"
                                      ? "bg-orange-500/10 text-orange-500 border border-orange-500/20"
                                      : staff.status === "Absent"
                                        ? "bg-red-500/10 text-red-500 border border-red-500/20"
                                        : "bg-blue-500/10 text-blue-500 border border-blue-500/20"
                          ...
                          <tr
                            key={date}
                            className="border-b border-dark-tertiary"
                          >
                            <td
                              colSpan={6}
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-emerald-500/20 border border-emerald-500/30 rounded p-4">
                  ...
                  <p className="text-2xl  text-emerald-400">
                    {Object.values(getWeeklyTimesheets())
                      .flat()
                ...
                <div className="bg-blue-500/20 border border-blue-500/30 rounded p-4">
                  <p className="text-mdtext-gray-400 mb-1">Average Hours/Day</p>
                ...
                <div className="bg-orange-500/20 border border-orange-500/30 rounded p-4">
                  <p className="text-mdtext-gray-400 mb-1">Days Worked</p>
                  <p className="text-2xl  text-orange-400">
                    {
                      Object.entries(getWeeklyTimesheets()).filter(
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-blue-500/10 border border-blue-500/20 rounded p-4">
                  <p className="text-mdtext-gray-400 mb-2">Pending Requests</p>
                  <p className="text-3xl  text-blue-400">0</p>
                </div>
                <div className="bg-emerald-500/10 border border-emerald-500/20 rounded p-4">
                  <p className="text-mdtext-gray-400 mb-2">Approved</p>
                  <p className="text-3xl  text-emerald-400">0</p>
                </div>
                <div className="bg-orange-500/10 border border-orange-500/20 rounded p-4">
                  <p className="text-mdtext-gray-400 mb-2">Rejected</p>
                  <p className="text-3xl  text-orange-400">0</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-dark-tertiary rounded p-6 border border-dark-tertiary">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-mdtext-gray-400 mb-3">
                        2025-01-15 to 2025-01-17 (3 days)
                      </p>
                ...
                <div className="bg-dark-tertiary rounded p-6 border border-dark-tertiary">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-mdtext-gray-400 mb-3">
                        2025-02-20 to 2025-02-28 (9 days)
                      </p>
                      <p className="text-mdtext-gray-300">
          ...
          {activeTab === "reports" && (
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                <div className="bg-emerald-500/10 border border-emerald-500/20 rounded p-4">
                  <p className="text-mdtext-gray-400">Month Attendance Rate</p>
                  <p className="text-2xl  text-emerald-400">95%</p>
                </div>
                <div className="bg-blue-500/10 border border-blue-500/20 rounded p-4">
                  <p className="text-mdtext-gray-400">Average Daily Hours</p>
                  <p className="text-2xl  text-blue-400">8.5h</p>
                </div>
                <div className="bg-orange-500/10 border border-orange-500/20 rounded p-4">
                  <p className="text-mdtext-gray-400">Late Arrivals</p>
                  <p className="text-2xl  text-orange-400">2</p>
                </div>
                <div className="bg-red-500/10 border border-red-500/20 rounded p-4">
                  <p className="text-mdtext-gray-400">Absences</p>
                  <p className="text-2xl  text-red-400">1</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-dark-tertiary rounded p-6">
                  <h3 className="text-lg font-semibold text-white mb-4">
                    Monthly Summary
                  </h3>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center my-3 my-3 pb-3 border-b border-dark-secondary">
      ...
      <ActionModal
        ...
        actions={
          <>
            ...
            <button onClick={handleRecordTimeSubmit} className="btn-primary">
              Record Time
            </button>
          </>
        }
      >
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-mdfont-medium mb-2">Date</label>
            <input
              type="date"
          ...
          {recordFormData.checkIn && recordFormData.checkOut && (
            <div className="bg-blue-500/10 border border-blue-500/20 rounded p-3">
              <p className="text-mdtext-blue-300">
                Total Hours:{" "}
                <strong>
                  {calculateHours(
                    recordFormData.checkIn,
