...
export default function BedAllocationsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Allocation ID', accessor: 'allocationid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Current Bed', accessor: 'currentbed', sortable: true },
    { header: 'New Bed (Transfer)', accessor: 'newbedtransfer', sortable: true },
    { header: 'Action By', accessor: 'actionby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage and update patient bed assignments within the ward.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Beds Managed</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Allocated Today</p>
