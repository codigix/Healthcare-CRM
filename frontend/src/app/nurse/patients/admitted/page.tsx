...
export default function AdmittedLogPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Admit ID', accessor: 'admitid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Time of Admit', accessor: 'timeofadmit', sortable: true },
    { header: 'From Dept', accessor: 'fromdept', sortable: true },
    { header: 'Initial Vitals', accessor: 'initialvitals', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Log of newly admitted patients requiring initial assessment.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Admitted Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Assessments Pending</p>
