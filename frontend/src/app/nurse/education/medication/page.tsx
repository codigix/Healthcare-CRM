...
export default function MedicationEducationPage() {
  ...
  const columns = [
    ...
    { header: 'Educated By', accessor: 'educatedby', sortable: true },
    { header: 'Handouts Given', accessor: 'handoutsgiven', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Counseling on new prescriptions and medication adherence.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inhaler Technique</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Completed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>16</p>
        </div>
      </div>
