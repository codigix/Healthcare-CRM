...
export default function CPRResusRecordsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Record ID', accessor: 'recordid', sortable: true },
    { header: 'Code ID', accessor: 'codeid', sortable: true },
    { header: 'Recorder', accessor: 'recorder', sortable: true },
    { header: 'Total Shocks', accessor: 'totalshocks', sortable: true },
    { header: 'Epinephrine Given', accessor: 'epinephrinegiven', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed logs of compressions, shocks, and meds during a code.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Records Pending Sign</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Audited</p>
