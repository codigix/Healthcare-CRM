...
export default function NursingCareNotesPage() {
  ...
  const columns = [
    ...
    { header: 'Note Category', accessor: 'notecategory', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Routine shift notes and general patient observations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>56</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>52</p>
        </div>
      </div>
