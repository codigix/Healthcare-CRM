...
export default function EarlyWarningScorePage() {
  ...
  const columns = [
    ...
    { header: 'EWS Score', accessor: 'ewsscore', sortable: true },
    { header: 'Clinical Response', accessor: 'clinicalresponse', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Track EWS parameters to identify clinical deterioration.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Scores</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Risk (Score >6)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-500"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Low Risk</p>
