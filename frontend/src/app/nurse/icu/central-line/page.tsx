...
export default function CentralLineCarePage() {
  ...
  const columns = [
    ...
    { header: 'Insertion Site', accessor: 'insertionsite', sortable: true },
    { header: 'Days In Situ', accessor: 'daysinsitu', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Central Venous Catheter (CVC) insertion logs and site care.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Lines</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">CLABSI Risk</p>
