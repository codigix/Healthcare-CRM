...
export default function NurseProfilePage() {
  ...
  const columns = [
    { header: 'Credential ID', accessor: 'credentialid', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage your personal details, credentials, and certifications.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">CEUs Earned</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24/30</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Expiring Soon</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>BLS (30 days)</p>
        </div>
      </div>
