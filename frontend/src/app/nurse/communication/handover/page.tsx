...
export default function InterDepartmentCommPage() {
  ...
  const columns = [
    ...
    { header: 'Resolution', accessor: 'resolution', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Inter-Department Comm
          </h1>
          <p className="text-sm text-gray-400 mt-1">Communication logs between nursing and pharmacy, lab, etc.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inter-Dept Comms</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pharmacy Issues</p>
