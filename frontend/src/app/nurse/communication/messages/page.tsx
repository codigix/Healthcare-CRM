...
export default function InternalMessagesPage() {
  ...
  const columns = [
    ...
    { header: 'To/Group', accessor: 'togroup', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Secure text and broadcast messages with other ward staff.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Broadcasts</p>
