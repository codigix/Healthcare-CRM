...
export default function DoctorCommLogPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Comm ID', accessor: 'commid', sortable: true },
    { header: 'Doctor Name', accessor: 'doctorname', sortable: true },
    { header: 'Regarding Patient', accessor: 'regardingpatient', sortable: true },
    { header: 'Reason for Call', accessor: 'reasonforcall', sortable: true },
    { header: 'Response Time', accessor: 'responsetime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking calls and pages made to physicians.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Calls Made</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Awaiting Call Back</p>
