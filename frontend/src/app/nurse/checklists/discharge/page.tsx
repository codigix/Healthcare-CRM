...
export default function DischargeChecklistPage() {
  ...
  const columns = [
    ...
    { header: 'Cannula Out', accessor: 'cannulaout', sortable: true },
    { header: 'Meds Given', accessor: 'medsgiven', sortable: true },
    { header: 'Belongings Returned', accessor: 'belongingsreturned', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Verification of meds, belongings, and follow-up plans.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Pharmacy</p>
