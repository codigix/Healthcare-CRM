...
export default function PreOpOTChecklistPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Checklist ID', accessor: 'checklistid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Surgery', accessor: 'surgery', sortable: true },
    { header: 'Consent Signed', accessor: 'consentsigned', sortable: true },
    { header: 'NPO Status', accessor: 'npostatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Preparation checklist before transferring patient to the OR.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Surgeries Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>6</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cleared for OT</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Prep Pending</p>
