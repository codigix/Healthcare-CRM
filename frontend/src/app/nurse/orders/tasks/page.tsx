...
export default function NursingTasksPage() {
  ...
  const columns = [
    ...
    { header: 'Task Description', accessor: 'taskdescription', sortable: true },
    { header: 'Due By', accessor: 'dueby', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Daily checklist and routine care tasks for assigned patients.</p>
        </div>
