...
export default function ShiftRosterPage() {
  ...
  const columns = [
    { header: 'Shift Date', accessor: 'shiftdate', sortable: true },
    { header: 'Day', accessor: 'day', sortable: true },
    { header: 'Shift Timing', accessor: 'shifttiming', sortable: true },
    { header: 'Ward/Unit', accessor: 'wardunit', sortable: true },
    { header: 'Charge Nurse', accessor: 'chargenurse', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monthly nursing schedule and upcoming shifts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Shifts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>22</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Night Shifts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Leave Days</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>4</p>
        </div>
      </div>
