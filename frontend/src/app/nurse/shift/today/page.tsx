...
export default function TodaysShiftPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Assignment ID', accessor: 'assignmentid', sortable: true },
    { header: 'Ward/Unit', accessor: 'wardunit', sortable: true },
    { header: 'Patients Assigned', accessor: 'patientsassigned', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Current shift overview and primary responsibilities.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">My Patients Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Tasks Pending</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Time Left</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4h 15m</p>
        </div>
      </div>
