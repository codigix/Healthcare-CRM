...
export default function CarePlanAuditsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Audit ID', accessor: 'auditid', sortable: true },
    { header: 'Ward', accessor: 'ward', sortable: true },
    { header: 'Charts Audited', accessor: 'chartsaudited', sortable: true },
    { header: 'Complete Plans', accessor: 'completeplans', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Audit reports measuring the completeness of nursing care plans.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Charts Audited</p>
