...
export default function AMCTrackingPage() {
  ...
  const columns = [
    ...
    { header: 'Equipment Covered', accessor: 'equipmentcovered', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Management of Annual Maintenance Contracts and warranty expirations.</p>
        </div>
