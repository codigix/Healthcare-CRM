    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Specific register for medical devices requiring clinical calibration.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Risk</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>810</p>
        </div>
      </div>
