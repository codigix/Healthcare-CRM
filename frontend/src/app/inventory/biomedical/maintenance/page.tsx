...
export default function PreventiveMaintenancePage() {
  ...
  const columns = [
    { header: 'PPM ID', accessor: 'ppmid', sortable: true },
    { header: 'Equipment Name', accessor: 'equipmentname', sortable: true },
    { header: 'Schedule Date', accessor: 'scheduledate', sortable: true },
    { header: 'Completed Date', accessor: 'completeddate', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Planned Preventive Maintenance (PPM) schedules for all medical devices.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">PPM Scheduled</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overdue PPM</p>
