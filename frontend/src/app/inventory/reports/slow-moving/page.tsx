...
export default function SlowMovingItemsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Item Name', accessor: 'itemname', sortable: true },
    { header: 'Avg Monthly Use', accessor: 'avgmonthlyuse', sortable: true },
    { header: 'Current Stock', accessor: 'currentstock', sortable: true },
    { header: 'Months of Stock', accessor: 'monthsofstock', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Items with very low turnover, tying up warehouse space and capital.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Slow Moving Value</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Optimized</p>
