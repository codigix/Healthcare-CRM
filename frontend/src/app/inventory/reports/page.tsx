        ...
        <>
            ...
            <div className="card border-l-4 border-[#1abc9c] hover:translate-y-[-2px] transition-transform">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-white mt-1">₹{totalValuation.toLocaleString("en-IN", { maximumFractionDigits: 2 })}</h3>
            ...
            <div className="card border-l-4 border-blue-500 hover:translate-y-[-2px] transition-transform">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-white mt-1">{totalSupplies.toLocaleString()} Units</h3>
            ...
            <div className="card border-l-4 border-amber-500 hover:translate-y-[-2px] transition-transform">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-white mt-1">12 Approved</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="card flex flex-col justify-between">
              <h3 className="text-lg font-bold text-white mb-4">Valuation by Category</h3>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                  ...
                  <div className="space-y-2 flex-1 w-full">
                    {categoryData.map((item, index) => (
                      <div key={item.name} className="flex justify-between items-center text-sm py-1 border-b border-white/5">
            ...
            <div className="card">
              <h3 className="text-lg font-bold text-white mb-4">Supply Burn Rate vs Procurement (Units)</h3>
