                ...
                <tbody>
                  {assets.map((a) => (
                    <tr key={a.id} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                      <td className="py-3.5 px-4 text-white font-semibold">{a.name}</td>
                      <td className="py-3.5 px-4 text-gray-300">{a.category}</td>
                      ...
                      <td className="py-3.5 px-4 text-gray-300">{a.location}</td>
                      <td className="py-3.5 px-4 text-center text-gray-300 font-bold">{a.quantity}</td>
                      <td className="py-3.5 px-4 text-gray-400">{a.lastMaintained}</td>
                      <td className="py-3.5 px-4 text-right text-white font-bold">₹{a.purchasePrice.toLocaleString()}</td>
                    </tr>
                  ))}
                  {assets.length === 0 && (
                    <tr>
                      <td colSpan={7} className="py-12 text-center text-gray-500">No operational durables registered in the asset log.</td>
                    </tr>
                  )}
                </tbody>
              </table>
