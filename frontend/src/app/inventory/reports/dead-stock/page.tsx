...
export default function DeadStockReportPage() {
  ...
  const columns = [
    ...
    { header: 'Last Moved Date', accessor: 'lastmoveddate', sortable: true },
    { header: 'Current Qty', accessor: 'currentqty', sortable: true },
    { header: 'Capital Locked', accessor: 'capitallocked', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Items with zero movement over the last 6 to 12 months.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Dead Stock Value</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Liquidated (YTD)</p>
