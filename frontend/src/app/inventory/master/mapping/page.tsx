...
export default function ItemMappingPage() {
  ...
  const columns = [
    { header: 'Mapping ID', accessor: 'mappingid', sortable: true },
    { header: 'Item Name', accessor: 'itemname', sortable: true },
    { header: 'Mapped Department', accessor: 'mappeddepartment', sortable: true },
    { header: 'Preferred Supplier', accessor: 'preferredsupplier', sortable: true },
    { header: 'Billing Code', accessor: 'billingcode', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Linking inventory items to specific departments, suppliers, or billing codes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unmapped Items</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fully Mapped</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>15,355</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Supplier Conflicts</p>
