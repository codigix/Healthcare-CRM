...
export default function SubCategoriesPage() {
  ...
  const columns = [
    { header: 'Sub ID', accessor: 'subid', sortable: true },
    { header: 'Sub Category Name', accessor: 'subcategoryname', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed sub-classifications under main inventory categories.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Sub-categories</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Empty Categories</p>
