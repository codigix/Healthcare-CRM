...
export default function StockReconciliationPage() {
  ...
  const columns = [
    ...
    { header: 'Count Ref', accessor: 'countref', sortable: true },
    { header: 'Total Variances', accessor: 'totalvariances', sortable: true },
    { header: 'Net Value Impact', accessor: 'netvalueimpact', sortable: true },
    { header: 'Approver', accessor: 'approver', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Approving adjustments to sync system stock with physically verified counts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reconciled (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>18</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Value Written Off</p>
