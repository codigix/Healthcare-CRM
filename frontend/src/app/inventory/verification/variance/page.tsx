    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analytical report highlighting frequently mismatched items or stores.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Variance Item</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>Syringes</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Best Store Accuracy</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>OT Store</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Shrinkage</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1.2%</p>
        </div>
      </div>
