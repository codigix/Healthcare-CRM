...
export default function ExpiredItemsPage() {
  ...
  const columns = [
    ...
    { header: 'Expired On', accessor: 'expiredon', sortable: true },
    { header: 'Qty', accessor: 'qty', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Log of fully expired items awaiting write-off or destruction.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Write-off</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Value Pending</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$350</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Destroyed (YTD)</p>
