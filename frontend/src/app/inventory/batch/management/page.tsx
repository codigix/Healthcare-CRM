...
export default function BatchManagementPage() {
  ...
  const columns = [
    ...
    { header: 'Mfg Date', accessor: 'mfgdate', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking multiple batches of items, particularly sterile consumables.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Quarantined</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Consumed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>120 (Mo)</p>
        </div>
      </div>
