...
export default function AssetMovementPage() {
  ...
  const columns = [
    { header: 'Movement ID', accessor: 'movementid', sortable: true },
    { header: 'Asset Name', accessor: 'assetname', sortable: true },
    { header: 'From Location', accessor: 'fromlocation', sortable: true },
    { header: 'To Location', accessor: 'tolocation', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Log of physical relocations for tracking and auditing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Moves This Month</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Disputed</p>
