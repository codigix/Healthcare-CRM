...
export default function PharmacyTransferPage() {
  ...
  const columns = [
    ...
    { header: 'Pharmacy Branch', accessor: 'pharmacybranch', sortable: true },
    { header: 'Drugs Transferred', accessor: 'drugstransferred', sortable: true },
    { header: 'Total Value', accessor: 'totalvalue', sortable: true },
    { header: 'Dispatched By', accessor: 'dispatchedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Transferring drugs and surgicals to the pharmacy stock.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$5,400</p>
        </div>
      </div>
