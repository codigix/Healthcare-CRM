...
export default function StoreLocationsPage() {
  ...
  const columns = [
    { header: 'Location ID', accessor: 'locationid', sortable: true },
    { header: 'Warehouse', accessor: 'warehouse', sortable: true },
    { header: 'Zone/Aisle', accessor: 'zoneaisle', sortable: true },
    { header: 'Category Restricted', accessor: 'categoryrestricted', sortable: true },
    { header: 'Current Items', accessor: 'currentitems', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed mapping of aisles and zones within a warehouse.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Zones</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cold Storage Zones</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Audit Required</p>
