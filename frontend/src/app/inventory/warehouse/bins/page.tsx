...
export default function BinManagementPage() {
  ...
  const columns = [
    { header: 'Bin ID', accessor: 'binid', sortable: true },
    { header: 'Rack ID', accessor: 'rackid', sortable: true },
    { header: 'Assigned Item', accessor: 'assigneditem', sortable: true },
    { header: 'Current Qty', accessor: 'currentqty', sortable: true },
    { header: 'Bin Capacity', accessor: 'bincapacity', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Granular tracking of specific bins/boxes on racks for fast picking.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Bins</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>2,400</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Empty Bins</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overfilled Bins</p>
