...
export default function RackManagementPage() {
  ...
  const columns = [
    ...
    { header: 'Rack Type', accessor: 'racktype', sortable: true },
    { header: 'Max Weight', accessor: 'maxweight', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configuration and capacity tracking of physical storage racks.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Racks</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>320</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overloaded</p>
