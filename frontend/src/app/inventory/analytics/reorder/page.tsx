...
export default function ReorderAnalysisPage() {
  ...
  const columns = [
    ...
    { header: 'Current ROL', accessor: 'currentrol', sortable: true },
    { header: 'Suggested ROL', accessor: 'suggestedrol', sortable: true },
    { header: 'Current Safety Stock', accessor: 'currentsafetystock', sortable: true },
    { header: 'Suggested Safety Stock', accessor: 'suggestedsafetystock', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">AI/Statistical analysis to optimize reorder points and safety stock levels.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Optimization Opps</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>450 Items</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Capital Savings Est.</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$24,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Stockout Risks Addressed</p>
