...
export default function InventoryCostAnalysisPage() {
  ...
  const columns = [
    { header: 'Cost Component', accessor: 'costcomponent', sortable: true },
    { header: 'Current Month', accessor: 'currentmonth', sortable: true },
    { header: 'Previous Month', accessor: 'previousmonth', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Breakdown of holding costs, ordering costs, and shortage costs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Holding Cost</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$45,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cost per Order</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Shrinkage Cost</p>
