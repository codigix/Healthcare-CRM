...
export default function DepartmentAnalyticsPage() {
  ...
  const columns = [
    ...
    { header: 'Budget Allocated', accessor: 'budgetallocated', sortable: true },
    { header: 'Consumed (YTD)', accessor: 'consumedytd', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Visual insights into which departments are consuming the most budget.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Consumer</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>OT</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Budget Variance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>-2.4%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical Depts</p>
