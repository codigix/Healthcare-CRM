...
export default function ReturnApprovalPage() {
  ...
  const columns = [
    ...
    { header: 'Est. Value', accessor: 'estvalue', sortable: true },
    { header: 'QA Required', accessor: 'qarequired', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Inventory manager authorization for department returns and stock crediting.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">QA Pending</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Stock Credited</p>
