...
export default function ICUConsumablesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Item Name', accessor: 'itemname', sortable: true },
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Min Level', accessor: 'minlevel', sortable: true },
    { header: 'Current Stock', accessor: 'currentstock', sortable: true },
    { header: 'Last Reordered', accessor: 'lastreordered', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Critical care lines, catheters, and emergency kits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Value Stocked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$24,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical Items</p>
