...
export default function RadiologyConsumablesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Item Name', accessor: 'itemname', sortable: true },
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Usage (MTD)', accessor: 'usagemtd', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Films, contrast media, and protective gear.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Consumed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>450 Units</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Contrast Stock</p>
