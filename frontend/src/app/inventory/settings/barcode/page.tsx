...
export default function BarcodeSettingsPage() {
  ...
  const columns = [
    { header: 'Setting Name', accessor: 'settingname', sortable: true },
    { header: 'Configuration', accessor: 'configuration', sortable: true },
    { header: 'Format', accessor: 'format', sortable: true },
    { header: 'Printer Mapped', accessor: 'printermapped', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configure barcode formats, label sizes, and printer integrations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Default Format</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Code 128</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Printers Online</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4/4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Labels Printed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>1.2M</p>
        </div>
      </div>
