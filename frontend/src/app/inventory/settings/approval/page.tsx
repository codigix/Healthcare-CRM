...
export default function ApprovalRulesPage() {
  ...
  const columns = [
    ...
    { header: 'Approver 1', accessor: 'approver1', sortable: true },
    { header: 'Approver 2', accessor: 'approver2', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Workflow routing for stock issues, adjustments, and returns based on value.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Approval Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4.5 Hrs</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bottlenecks</p>
