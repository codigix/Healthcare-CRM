...
export default function PatientSafetyPage() {
  ...
  const columns = [
    { header: 'Safety Area', accessor: 'safetyarea', sortable: true },
    { header: 'Metric', accessor: 'metric', sortable: true },
    { header: 'Occurrences (Mo)', accessor: 'occurrencesmo', sortable: true },
    { header: 'Severity Level', accessor: 'severitylevel', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Specific indicators tracking falls, bedsores, and medication safety.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Patient Falls (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">HAPU (Bedsores)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Safety Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>98/100</p>
        </div>
      </div>
