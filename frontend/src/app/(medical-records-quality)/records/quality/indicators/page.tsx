...
export default function QualityIndicatorsPage() {
  ...
  const columns = [
    { header: 'Indicator ID', accessor: 'indicatorid', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hospital-wide clinical and managerial quality metrics (NABH/JCI based).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Indicators</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>64</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Meeting Targets</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>58</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Falling Short</p>
