...
export default function RootCauseAnalysisRCAPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'RCA ID', accessor: 'rcaid', sortable: true },
    { header: 'Linked Event', accessor: 'linkedevent', sortable: true },
    { header: 'Methodology', accessor: 'methodology', sortable: true },
    { header: 'Lead Investigator', accessor: 'leadinvestigator', sortable: true },
    { header: 'Target Date', accessor: 'targetdate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Structured problem-solving (Fishbone/5 Whys) for identified quality failures.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Open RCAs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Completion Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>14 Days</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Corrective Actions Formed</p>
