...
export default function PatientDocumentsPage() {
  ...
  const columns = [
    ...
    { header: 'Document Category', accessor: 'documentcategory', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">General uploaded documents like ID proofs, external lab reports, and old records.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Uploads</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1.4M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Storage Used</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2.4 TB</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
