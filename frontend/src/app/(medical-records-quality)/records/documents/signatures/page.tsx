...
export default function DigitalSignaturesPage() {
  ...
  const columns = [
    { header: 'Sign ID', accessor: 'signid', sortable: true },
    { header: 'Doctor/Staff Name', accessor: 'doctorstaffname', sortable: true },
    { header: 'Auth Method', accessor: 'authmethod', sortable: true },
    { header: 'Signature Image', accessor: 'signatureimage', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Managing e-signatures, DSC tokens, and biometric validations for doctors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active DSCs</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">PIN Resets Req</p>
