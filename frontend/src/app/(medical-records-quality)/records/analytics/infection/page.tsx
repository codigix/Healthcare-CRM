...
export default function InfectionAnalyticsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Ward/ICU', accessor: 'wardicu', sortable: true },
    { header: 'Infection Rate', accessor: 'infectionrate', sortable: true },
    { header: 'Predominant Bug', accessor: 'predominantbug', sortable: true },
    { header: 'Outbreak Risk', accessor: 'outbreakrisk', sortable: true },
    { header: 'Action Required', accessor: 'actionrequired', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Heatmaps and predictive modeling of infection outbreaks within wards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Risk Zones</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Outbreak Alerts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>None</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Antibiotic Usage</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Optimized</p>
        </div>
      </div>
