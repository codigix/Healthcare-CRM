...
export default function QualityAnalyticsPage() {
  ...
  const columns = [
    { header: 'Quality Domain', accessor: 'qualitydomain', sortable: true },
    { header: 'Trend Direction', accessor: 'trenddirection', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Trending analysis of quality indicators to predict potential safety risks.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Quality Index</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>9.2/10</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Predictive Risks</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4.6/5</p>
        </div>
      </div>
