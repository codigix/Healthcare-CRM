...
export default function ApprovalWorkflowPage() {
  ...
  const columns = [
    { header: 'Auth ID', accessor: 'authid', sortable: true },
    { header: 'Request Source', accessor: 'requestsource', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Information Type', accessor: 'informationtype', sortable: true },
    { header: 'Fee Collected', accessor: 'feecollected', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Internal queue for Medical Records Dept head to authorize outgoing information.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending My Auth</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revenue from ROI</p>
