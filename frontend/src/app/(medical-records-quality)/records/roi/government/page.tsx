...
export default function GovernmentRequestsPage() {
  ...
  const columns = [
    ...
    { header: 'Govt Department', accessor: 'govtdepartment', sortable: true },
    { header: 'Data Requested', accessor: 'datarequested', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Requests from health ministries or municipal bodies (e.g., birth/death stats).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Statutory Reports</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4 Due</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>100%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Last Submitted</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Today</p>
        </div>
      </div>
