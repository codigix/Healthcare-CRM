...
export default function LegalRequestsPage() {
  ...
  const columns = [
    ...
    { header: 'Documents Prepared', accessor: 'documentsprepared', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Subpoenas and court orders for medical records (overlaps with Legal but focused on fulfillment).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Prep</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Dispatched (YTD)</p>
