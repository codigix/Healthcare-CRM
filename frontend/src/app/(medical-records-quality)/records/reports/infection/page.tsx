...
export default function InfectionReportsPage() {
  ...
  const columns = [
    { header: 'Report Focus', accessor: 'reportfocus', sortable: true },
    { header: 'Date Range', accessor: 'daterange', sortable: true },
    { header: 'Key Finding', accessor: 'keyfinding', sortable: true },
    { header: 'Reported To', accessor: 'reportedto', sortable: true },
    { header: 'Format', accessor: 'format', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Epidemiological data, HAI rates, and antibiograms for the Infection Control Committee.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">HAI Rate (Overall)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.2%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SSI Rate (Surgeries)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0.4%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Committee Meetings</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Monthly</p>
        </div>
      </div>
