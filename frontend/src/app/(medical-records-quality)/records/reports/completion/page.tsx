...
export default function RecordCompletionReportsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Doctor Name', accessor: 'doctorname', sortable: true },
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Incomplete Files', accessor: 'incompletefiles', sortable: true },
    { header: 'Avg Delay', accessor: 'avgdelay', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Record Completion Reports
          </h1>
          <p className="text-sm text-gray-400 mt-1">Tracking which doctors have the highest number of incomplete patient files.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Deficient Files</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Delay</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>3 Days</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Privileges Suspended</p>
