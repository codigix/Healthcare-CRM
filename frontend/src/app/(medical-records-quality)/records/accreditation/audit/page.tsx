...
export default function AccreditationAuditPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Audit Date', accessor: 'auditdate', sortable: true },
    { header: 'Auditor/Assessor', accessor: 'auditorassessor', sortable: true },
    { header: 'Chapters Covered', accessor: 'chapterscovered', sortable: true },
    { header: 'Score Achieved', accessor: 'scoreachieved', sortable: true },
    { header: 'NCs Raised', accessor: 'ncsraised', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Internal mock audits simulating external assessor visits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Mock Audits (YTD)</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Open NCs</p>
