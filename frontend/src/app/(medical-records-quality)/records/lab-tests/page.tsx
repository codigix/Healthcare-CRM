            ...
            {whatsappRecord && (() => {
               ...
               if (whatsappStatus !== "ready" && whatsappStatus !== "loading") {
                  return (
                     <div className="space-y-6 text-gray-300 py-2">
                        <div className="bg-amber-500/10 border border-amber-500/20 p-4 roundedex items-start gap-3">
                        ...
                        <div className="flex flex-col items-center justify-center p-6 bg-dark-secondary/50 rounded-2xl border border-dark-tertiary/20 shadow-2xl relative overflow-hidden">
                           ...
                           {qrCodeUrl ? (
                              <div className="relative p-3 bg-card roundedadow-lg border-2 border-emerald-500/30">
                                 <img
                                    src={qrCodeUrl}
                              ...
                              <div className="w-[200px] h-[200px] bg-dark-tertiary/20 roundedex items-center justify-center border border-dark-tertiary/40">
               ...
               return (
                  <div className="space-y-5 text-gray-300">
                     <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 roundedex items-start gap-3">
