...
export default function MortalityAuditPage() {
  ...
  const columns = [
    { header: 'Death Record', accessor: 'deathrecord', sortable: true },
    { header: 'Date of Death', accessor: 'dateofdeath', sortable: true },
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Review Committee', accessor: 'reviewcommittee', sortable: true },
    { header: 'Preventability', accessor: 'preventability', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Clinical review of all hospital deaths to identify preventable causes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Preventable (YTD)</p>
