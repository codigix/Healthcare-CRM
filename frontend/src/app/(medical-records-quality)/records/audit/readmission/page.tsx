...
export default function ReadmissionAuditPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'UHID', accessor: 'uhid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Previous Discharge', accessor: 'previousdischarge', sortable: true },
    { header: 'Readmission Date', accessor: 'readmissiondate', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking patients readmitted within 30 days for the same diagnosis.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">30-Day Readmit Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>2.4%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Risk Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Pulmonology</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cases Analyzed</p>
