...
export default function EmergencyRecordsPage() {
  ...
  const columns = [
    { header: 'ER No', accessor: 'erno', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Rapid documentation and triage logs for emergency department cases.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ER Cases (24H)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>85</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Admitted from ER</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">MLC Cases</p>
