...
export default function ArchivedRecordsPage() {
  ...
  const columns = [
    { header: 'Archive ID', accessor: 'archiveid', sortable: true },
    { header: 'UHID', accessor: 'uhid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Archived Date', accessor: 'archiveddate', sortable: true },
    { header: 'Retention Till', accessor: 'retentiontill', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Historical patient files securely stored as per statutory retention policies.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Archived</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Due for Destruction</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Digitized %</p>
