...
export default function InfectionAuditPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Audit Area', accessor: 'auditarea', sortable: true },
    ...
    { header: 'Deficiencies', accessor: 'deficiencies', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hand hygiene compliance and environmental cleaning audits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Hand Hygiene Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>88%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">OT Swab Cultures</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>100% Sterile</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Audits (Mo)</p>
