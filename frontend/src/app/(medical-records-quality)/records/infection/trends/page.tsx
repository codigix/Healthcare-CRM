...
export default function InfectionTrendsPage() {
  ...
  const columns = [
    { header: 'Organism', accessor: 'organism', sortable: true },
    { header: 'Sample Source', accessor: 'samplesource', sortable: true },
    { header: 'Resistant Drug 1', accessor: 'resistantdrug1', sortable: true },
    { header: 'Resistant Drug 2', accessor: 'resistantdrug2', sortable: true },
    { header: 'Sensitivity Trend', accessor: 'sensitivitytrend', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Antibiogram data showing local antibiotic resistance patterns.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Cultures Done</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">MDR Organisms</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>12%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Data Updated</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Last Month</p>
        </div>
      </div>
