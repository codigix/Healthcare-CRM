...
export default function AntibioticStewardshipPage() {
  ...
  const columns = [
    ...
    { header: 'Restricted Drug', accessor: 'restricteddrug', sortable: true },
    { header: 'Prescriber', accessor: 'prescriber', sortable: true },
    { header: 'Days on Drug', accessor: 'daysondrug', sortable: true },
    { header: 'Approval Code', accessor: 'approvalcode', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking usage of restricted antibiotics and adherence to hospital formulary.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Restricted Rx (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unapproved Uses</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Stewardship Compliance</p>
