...
export default function IncompleteRecordsPage() {
  ...
  const columns = [
    ...
    { header: 'Document Name', accessor: 'documentname', sortable: true },
    { header: 'Author', accessor: 'author', sortable: true },
    { header: 'Deficiency Details', accessor: 'deficiencydetails', sortable: true },
    { header: 'Date Flagged', accessor: 'dateflagged', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Dashboard of partially filled forms or notes lacking critical clinical data.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Incomplete Forms</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>28</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Doctors Notified</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Average Age</p>
