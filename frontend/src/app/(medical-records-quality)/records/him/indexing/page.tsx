...
export default function RecordIndexingPage() {
  ...
  const columns = [
    ...
    { header: 'Indexed By', accessor: 'indexedby', sortable: true },
    { header: 'Tags', accessor: 'tags', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Categorization and tagging of medical records for easy search and retrieval.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Backlog to Index</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Indexed Today</p>
