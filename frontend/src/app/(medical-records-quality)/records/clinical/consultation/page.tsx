...
export default function ConsultationNotesPage() {
  ...
  const columns = [
    { header: 'Ref ID', accessor: 'refid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Referring Dept', accessor: 'referringdept', sortable: true },
    { header: 'Consulting Dept', accessor: 'consultingdept', sortable: true },
    { header: 'Opinion Status', accessor: 'opinionstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Cross-departmental referral notes and specialist opinions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Referrals</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overdue Consults</p>
