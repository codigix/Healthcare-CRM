...
export default function ProcedureNotesPage() {
  ...
  const columns = [
    { header: 'Proc ID', accessor: 'procid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Performing Doctor', accessor: 'performingdoctor', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Documentation for minor procedures (endoscopy, cath lab, dialysis).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Complications Logged</p>
