...
export default function MedicoLegalCasesMLCPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'MLC No', accessor: 'mlcno', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Incident Type', accessor: 'incidenttype', sortable: true },
    { header: 'Intimation Sent', accessor: 'intimationsent', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Specialized registry for accidents, assaults, or poisonings requiring police intimation.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Intimations Pending</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Closed MLCs</p>
