...
export default function PoliceRequestsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Req ID', accessor: 'reqid', sortable: true },
    { header: 'Police Station', accessor: 'policestation', sortable: true },
    { header: 'IO Name', accessor: 'ioname', sortable: true },
    { header: 'Information Requested', accessor: 'informationrequested', sortable: true },
    { header: 'Date Received', accessor: 'datereceived', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Responses to police inquiries, requisition of clinical notes or CCTV footage.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Inquiries</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Replies Sent</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Response Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>48 Hrs</p>
        </div>
      </div>
