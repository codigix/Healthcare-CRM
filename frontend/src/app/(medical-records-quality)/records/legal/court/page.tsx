...
export default function CourtCasesPage() {
  ...
  const columns = [
    { header: 'Case No', accessor: 'caseno', sortable: true },
    { header: 'Court Name', accessor: 'courtname', sortable: true },
    { header: 'Hearing Date', accessor: 'hearingdate', sortable: true },
    { header: 'Hospital Rep.', accessor: 'hospitalrep', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking ongoing litigation, hearings, and required hospital representations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Litigation</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Upcoming Hearings</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Favorable Judgments</p>
