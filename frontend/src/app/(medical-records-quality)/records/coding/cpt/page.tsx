...
export default function CPTCodingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Procedure ID', accessor: 'procedureid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'Procedure Name', accessor: 'procedurename', sortable: true },
    { header: 'CPT Code', accessor: 'cptcode', sortable: true },
    { header: 'Modifier', accessor: 'modifier', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Current Procedural Terminology coding for outpatient and surgical procedures.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Procedures Coded</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>85</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending CPT</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Claim Ready %</p>
