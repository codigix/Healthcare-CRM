...
export default function ICD11CodingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Encounter ID', accessor: 'encounterid', sortable: true },
    { header: 'Patient', accessor: 'patient', sortable: true },
    { header: 'ICD-10 Code', accessor: 'icd10code', sortable: true },
    { header: 'ICD-11 Mapping', accessor: 'icd11mapping', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Transition and mapping to the latest ICD-11 coding standards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Transition Progress</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>85%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Mapping Errors</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Verified Codes</p>
