...
export default function CodingAuditPage() {
  ...
  const columns = [
    ...
    { header: 'Encounter', accessor: 'encounter', sortable: true },
    { header: 'Original Coder', accessor: 'originalcoder', sortable: true },
    { header: 'Auditor', accessor: 'auditor', sortable: true },
    { header: 'Variance Found', accessor: 'variancefound', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Quality checks on assigned codes to prevent upcoding, downcoding, or rejections.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Files Audited (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>350</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Major Errors</p>
