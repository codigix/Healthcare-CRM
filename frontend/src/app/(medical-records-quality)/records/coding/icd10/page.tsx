...
export default function ICD10CodingPage() {
  ...
  const columns = [
    ...
    { header: 'Primary Diagnosis', accessor: 'primarydiagnosis', sortable: true },
    { header: 'ICD-10 Code', accessor: 'icd10code', sortable: true },
    { header: 'Coder', accessor: 'coder', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Assigning International Classification of Diseases (10th Rev) codes to diagnoses.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Files Coded (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Coding</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>34</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Auto-Coded %</p>
