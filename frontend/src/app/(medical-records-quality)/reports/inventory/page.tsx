...
export default function InventoryReportsPage() {
  ...
  const inventoryStats = [
    {
      label: "Total Items",
      value: "1,245",
      change: "+28 items stock last month",
      color: "text-blue-500",
    ...
    },
    {
      ...
      value: "2.6%",
      change: "+0.6% from previous period",
      color: "text-red-500",
  ...
  const stockStatusDistribution = [
    { name: "In Stock", value: 85, fill: "rgb(26, 188, 156)" },
    { name: "Low Stock", value: 10, fill: "rgb(241, 92, 108)" },
    { name: "Out of Stock", value: 5, fill: "rgb(132, 149, 171)" },
  ];
  ...
  const topLowStockItems: InventoryItem[] = [
    ...
    },
    {
      ...
      category: "Medical Supplies",
      currentStock: "15 cases",
      reorderLevel: "30 cases",
      supplier: "BD Medical",
      status: "low-stock",
    },
    {
    ...
    <>
      <div className="space-y-6">
        <div className="flex justify-between items-center my-3 my-3">
          <div>
            <h1 className="text-3xl  mb-2">Inventory Report</h1>
