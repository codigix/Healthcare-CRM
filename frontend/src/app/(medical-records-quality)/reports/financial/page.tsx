...
export default function FinancialReportsPage() {
  ...
  const revenueByDepartment = [
    { name: "Cardiology", value: 28, fill: "rgb(132, 149, 171)" },
    { name: "Orthopedics", value: 22, fill: "rgb(26, 188, 156)" },
    { name: "Neurology", value: 18, fill: "rgb(241, 92, 108)" },
    { name: "Pediatrics", value: 14, fill: "rgb(176, 206, 228)" },
    { name: "Dermatology", value: 10, fill: "rgb(132, 149, 171)" },
    { name: "Other", value: 8, fill: "rgb(42, 46, 51)" },
  ];
  ...
  const columns_0: Column<any>[] = [
    ...
    { header: "Revenue", accessor: (row) => (<>\n{row.revenue}\n</>) },
    { header: "Expenses", accessor: (row) => (<>\n{row.expenses}\n</>) },
    { header: "Profit", accessor: (row) => (<>\n{row.profit}\n</>) },
    { header: "Margin", accessor: "margin" },
    { header: "Growth", accessor: (row) => (<>\n{row.growth}\n</>) },
  ];
    ...
    <>
      <div className="space-y-6">
        <div className="flex justify-between items-center my-3 my-3">
          <div>
            <h1 className="text-3xl  mb-2">Financial Reports</h1>
          ...
          <>
            ...
            <div className="card">
              ...
              <div className="overflow-x-auto">
                <DataTable columns={columns_0} data={financialSummary} enableLocalSearch enableLocalPagination />
              </div>
            </div>
          </>
        )}
