...
export default function QueueWaitTimeReportsPage() {
  ...
  const columns = [
    ...
    { header: 'Max Wait Time', accessor: 'maxwaittime', sortable: true },
    { header: 'Service Time', accessor: 'servicetime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analysis of patient waiting times across departments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global Avg Wait</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>14 mins</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Longest Queue</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Orthopedics</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SLA Breaches</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>1.2%</p>
        </div>
      </div>
