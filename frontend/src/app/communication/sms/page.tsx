...
export default function SMSGatewayPage() {
  ...
  const columns = [
    ...
    { header: 'Gateway Status', accessor: 'gatewaystatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monitor and send automated SMS alerts and broadcasts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>1.5%</p>
        </div>
      </div>
