...
export default function ContactsPage() {
 ...
 className="flex items-center gap-3 text-mdtext-gray-300 hover:text-emerald-400 transition-colors"
 >
 ...
 <div className="flex items-center gap-3 text-mdtext-gray-300">
 ...
 <button className="flex-1 py-2 rounded-lg bg-emerald-500/10 text-emerald-400 text-mdfont-medium hover:bg-emerald-500/20 transition-colors">
 Message
 </button>
 <button className="flex-1 py-2 rounded-lg bg-dark-tertiary text-gray-300 text-mdfont-medium hover:bg-dark-secondary transition-colors">
 Call
 </button>
 </div>
 </div>
