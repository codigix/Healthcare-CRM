            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <button className="flex items-center gap-2 p-2 bg-dark-secondary rounded hover:bg-dark-tertiary transition-colors">
                            <CalendarIcon size={15} />
                            <span className="text-sm">Nov 11, 2025 - Nov 11, 2025</span>
                        </button>
                        <button className="p-2 bg-emerald-500 text-white rounded hover:bg-emerald-600 transition-colors">
                            Export
                        </button>
                    </div>
                </div>
                        ...
                        <div className="card">
                                ...
                                {["overview", "analytics", "reports", "notifications"].map(
                                    (tab) => (
                                        <button
                                            ...
                                            className={`p-2 text-mdfont-medium capitalize transition-colors relative ${activeTab === tab
                                                ? "text-white"
                                        ...
                                        <div className="space-y-3 max-h-[300px] overflow-y-auto pr-2">
                                            {appointments.length > 0 ? (
                                                appointments.map((apt) => (
                                                    <div
                                                        key={apt.id}
                                                        className="flex items-center justify-between p-3 bg-dark-secondary rounded hover:bg-dark-tertiary transition-colors"
                                                    >
                                                        <div className="flex items-center gap-2">
                            ...
                            {activeTab === "analytics" && (
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        <div className="bg-dark-secondary rounded p-4 border border-dark-tertiary">
                            ...
                            {activeTab === "reports" && (
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center justify-between p-4 bg-dark-secondary rounded border border-dark-tertiary hover:bg-dark-tertiary transition-colors cursor-pointer">
                                            <div className="flex items-center gap-2">
                                            ...
                                            <button className="p-2 bg-emerald-500/20 text-emerald-500 rounded hover:bg-emerald-500/30 transition-colors text-sm">
                                                Generate
                                            </button>
                                        </div>
                                        <div className="flex items-center justify-between p-4 bg-dark-secondary rounded border border-dark-tertiary hover:bg-dark-tertiary transition-colors cursor-pointer">
                            ...
                            {activeTab === "notifications" && (
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                    ...
                                    <div className="lg:col-span-1 bg-dark-secondary border border-dark-tertiary p-5 roundedace-y-4">
                                        <div className="border-b border-dark-tertiary pb-3">
                                            <h3 className="text-md  text-white">Dispatch Notification</h3>
                                        ...
                                        <form onSubmit={handleSendTestNotification} className="space-y-4">
                                                ...
                                                <div className="grid grid-cols-4 gap-2">
                                                    {[
                                                        ...
                                                        <button
                                                            ...
                                                            className={`py-1.5 px-1 text-[11px]  rounded border text-center transition-all ${testNotifType === t.value
                                                                ? 'border-emerald-500 bg-emerald-500/20 text-white scale-105 shadow-sm '
                                            ...
                                            <button
                                                ...
                                                className="w-full py-2.5 text-xs  bg-emerald-500 hover:bg-emerald-600 text-white rounded transition-all shadow-md active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1.5 border border-emerald-500/20 hover:shadow-emerald-500/20"
                                            >
                                                {dispatchingNotif ? (
                                                    <>
                                    ...
                                    <div className="lg:col-span-2 bg-dark-secondary border border-dark-tertiary p-5 roundedace-y-4">
                                        <div className="flex items-center justify-between border-b border-dark-tertiary pb-3">
                                            <div>
                                                <h3 className="text-md  text-white">Live Dispatched Log</h3>
                                                <p className="text-xs text-gray-400 mt-1">
                                        ...
                                        <div className="space-y-3 max-h-[360px] overflow-y-auto pr-1">
                                            {liveNotifications.length === 0 ? (
                                                <div className="text-center py-12 text-xs text-gray-500 italic border border-dashed border-dark-tertiary/40 rounded">
                                                ...
                                                liveNotifications.map((notif: any) => (
                                                    <div
                                                        key={notif.id}
                                                        className={`flex items-start gap-4 p-3.5 rounded border transition-colors ${notif.type === 'danger' || notif.type === 'error' ? 'bg-red-500/5 border-red-500/10' :
                                                    ...
                                                    >
                                                        <div className="flex-1">
                                                            <div className="flex justify-between items-center my-3 my-3 gap-2">
                                                                <p className={` text-xs ${notif.type === 'danger' || notif.type === 'error' ? 'text-red-400' :
                                                                ...
                                                                <div className="flex items-center gap-1.5">
                                                                    <span className="text-[9px] bg-dark-tertiary border border-dark-tertiary/80 text-gray-400 px-1.5 py-0.5 rounded uppercase  tracking-wider font-mono">
