...
export default function OutstandingReceivablesPage() {
  ...
  const columns = [
    { header: 'Debtor Category', accessor: 'debtorcategory', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Account Receivables (AR) aging analysis (Corporate, TPA, Patients).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total AR</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$4.2M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">AR > 90 Days</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$850K</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bad Debt Prov.</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>$120K</p>
        </div>
      </div>
