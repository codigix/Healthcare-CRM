...
export default function DailyCollectionsPage() {
  ...
  const columns = [
    ...
    { header: 'Credit/Debit', accessor: 'creditdebit', sortable: true },
    { header: 'Insurance Transfers', accessor: 'insurancetransfers', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Cash flow tracking, mode of payment analysis, and daily banking reconciliations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Collections Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$125K</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Deficit vs Billed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>3%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bank Reconciled</p>
