...
export default function GovernmentSchemeRevenuePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Scheme Name', accessor: 'schemename', sortable: true },
    { header: 'Patients Treated', accessor: 'patientstreated', sortable: true },
    { header: 'Claimed Value', accessor: 'claimedvalue', sortable: true },
    { header: 'Realized Value', accessor: 'realizedvalue', sortable: true },
    { header: 'Pending Grants', accessor: 'pendinggrants', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Government Scheme Revenue
          </h1>
          <p className="text-sm text-gray-400 mt-1">Revenue analytics for subsidized government health schemes (e.g., Ayushman Bharat).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Govt Revenue Share</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Realization Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>85%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Grants Delayed > 90d</p>
