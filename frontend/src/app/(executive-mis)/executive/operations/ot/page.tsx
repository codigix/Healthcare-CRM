...
export default function OTUtilizationPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'OT Number', accessor: 'otnumber', sortable: true },
    { header: 'Scheduled Hours', accessor: 'scheduledhours', sortable: true },
    { header: 'Actual Utilization', accessor: 'actualutilization', sortable: true },
    { header: 'Turnaround Time', accessor: 'turnaroundtime', sortable: true },
    { header: 'First Case On-Time', accessor: 'firstcaseontime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Operation theater efficiency, turnaround times, and scheduling gaps.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global OT Utilization</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>78%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Turnaround</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>35 Mins</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
