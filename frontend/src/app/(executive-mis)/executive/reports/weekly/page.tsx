...
export default function WeeklyMISPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Week', accessor: 'week', sortable: true },
    { header: 'Revenue YoY', accessor: 'revenueyoy', sortable: true },
    { header: 'Volume YoY', accessor: 'volumeyoy', sortable: true },
    { header: 'Key Highlight', accessor: 'keyhighlight', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Week-over-Week comparisons of hospital performance.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Current Week Rev</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$310K</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Week-on-Week</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>+2%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Target Achieved</p>
