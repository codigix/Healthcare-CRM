...
export default function AnnualMISPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Financial Year', accessor: 'financialyear', sortable: true },
    { header: 'Audited Revenue', accessor: 'auditedrevenue', sortable: true },
    { header: 'Net Income', accessor: 'netincome', sortable: true },
    { header: 'Auditor Sign-off', accessor: 'auditorsignoff', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Year-end financial audits, annual growth reports, and shareholder letters.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">FY 25-26 Rev Est</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$140M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">YoY Growth</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>+12%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Audit Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Clear</p>
        </div>
      </div>
