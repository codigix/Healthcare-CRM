...
export default function MonthlyMISPage() {
  ...
  const columns = [
    ...
    { header: 'Net Profit Margin', accessor: 'netprofitmargin', sortable: true },
    { header: 'EBITDA', accessor: 'ebitda', sortable: true },
    { header: 'Significant Event', accessor: 'significantevent', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Comprehensive month-end closing reports, P&L, and balance sheets.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">YTD Margin</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>14%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Best Month</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>March ($1.2M Profit)</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Closure</p>
