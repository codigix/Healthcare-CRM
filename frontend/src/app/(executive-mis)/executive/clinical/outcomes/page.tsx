...
export default function ClinicalOutcomesPage() {
  ...
  const columns = [
    { header: 'Condition / Pathway', accessor: 'conditionpathway', sortable: true },
    { header: 'Total Treated', accessor: 'totaltreated', sortable: true },
    { header: 'Success Rate', accessor: 'successrate', sortable: true },
    { header: 'Complication Rate', accessor: 'complicationrate', sortable: true },
    { header: 'PROM Score', accessor: 'promscore', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Patient Reported Outcome Measures (PROMs) and clinical success rates.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg PROM Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>8.5/10</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pathways Tracked</p>
