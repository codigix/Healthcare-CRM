...
export default function DepartmentPerformancePage() {
  ...
  const columns = [
    ...
    { header: 'Patient Volume', accessor: 'patientvolume', sortable: true },
    { header: 'Clinical Errors', accessor: 'clinicalerrors', sortable: true },
    { header: 'Patient Sat.', accessor: 'patientsat', sortable: true },
    { header: 'Revenue Contrib.', accessor: 'revenuecontrib', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Comparative analysis of clinical departments on quality and volume metrics.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Volume Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Internal Med</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Revenue Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Cardiology</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lowest Sat. Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>Emergency</p>
        </div>
      </div>
