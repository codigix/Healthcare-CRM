...
export default function SurgeryAnalyticsPage() {
  ...
  const columns = [
    { header: 'Surgery Category', accessor: 'surgerycategory', sortable: true },
    { header: 'Total Volume', accessor: 'totalvolume', sortable: true },
    { header: 'Avg OT Time', accessor: 'avgottime', sortable: true },
    { header: 'Cancel Rate', accessor: 'cancelrate', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Operation theater metrics: volumes, utilization, and post-op outcomes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Surgeries (MTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">OT Utilization</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>78%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cancel Rate</p>
