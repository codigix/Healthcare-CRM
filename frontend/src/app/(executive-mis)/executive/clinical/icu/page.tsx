...
export default function ICUAnalyticsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'ICU Unit', accessor: 'icuunit', sortable: true },
    { header: 'Admissions', accessor: 'admissions', sortable: true },
    { header: 'Avg APACHE Score', accessor: 'avgapachescore', sortable: true },
    { header: 'Survival Rate', accessor: 'survivalrate', sortable: true },
    { header: 'VAP Rate', accessor: 'vaprate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Intensive care outcomes, survival rates, and resource utilization.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ICU Survival Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>92%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Stay</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>5.5 Days</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bed Turnaround</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4 Hrs</p>
        </div>
      </div>
