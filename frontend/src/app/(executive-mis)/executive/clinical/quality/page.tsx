...
export default function QualityIndicatorsPage() {
  ...
  const columns = [
    ...
    { header: 'Responsible Dept', accessor: 'responsibledept', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Aggregate dashboard for clinical quality indicators and patient safety metrics.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Indicators Met</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>28/32</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Indicators At Risk</p>
