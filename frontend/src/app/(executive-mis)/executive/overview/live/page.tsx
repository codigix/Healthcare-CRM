...
export default function LiveDashboardPage() {
  ...
  const columns = [
    ...
    { header: 'Active Patients', accessor: 'activepatients', sortable: true },
    { header: 'Staff on Duty', accessor: 'staffonduty', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Real-time telemetry of critical hospital operations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Live Patients</p>
