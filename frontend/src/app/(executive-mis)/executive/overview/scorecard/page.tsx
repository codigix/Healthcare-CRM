...
export default function HospitalScorecardPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Perspective', accessor: 'perspective', sortable: true },
    { header: 'Objective', accessor: 'objective', sortable: true },
    { header: 'Measure', accessor: 'measure', sortable: true },
    { header: 'Current Performance', accessor: 'currentperformance', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Balanced scorecard evaluating Financial, Customer, Internal Process, and Learning & Growth perspectives.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Grade</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>A-</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Objectives Met</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>18/24</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Needs Improvement</p>
