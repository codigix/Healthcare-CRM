...
export default function CapacityPlanningPage() {
  ...
  const columns = [
    { header: 'Expansion Area', accessor: 'expansionarea', sortable: true },
    { header: 'Current Utilization', accessor: 'currentutilization', sortable: true },
    { header: 'Projected Limit Date', accessor: 'projectedlimitdate', sortable: true },
    { header: 'Proposed Addition', accessor: 'proposedaddition', sortable: true },
    { header: 'Est. CAPEX', accessor: 'estcapex', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Decisions on adding new beds, expanding ICUs, or opening new modular OTs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Current Bed Capacity</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>85%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Expansion Budget</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$5.5M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
