...
export default function DepartmentBenchmarkingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Metric / Department', accessor: 'metricdepartment', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Comparing internal departments against national or industry standards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Quartile Metrics</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Below Average</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global Rank Est.</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Top 10%</p>
        </div>
      </div>
