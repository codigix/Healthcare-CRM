...
export default function BudgetPlanningPage() {
  ...
  const columns = [
    { header: 'Department/Cost Center', accessor: 'departmentcostcenter', sortable: true },
    { header: 'Annual Budget', accessor: 'annualbudget', sortable: true },
    { header: 'YTD Spend', accessor: 'ytdspend', sortable: true },
    { header: 'Variance', accessor: 'variance', sortable: true },
    { header: 'Forecast End-Year', accessor: 'forecastendyear', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Annual budget vs actual tracking across departments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Hospital Budget</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$120M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Variance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>-1.5%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Capex Utilized</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>65%</p>
        </div>
      </div>
