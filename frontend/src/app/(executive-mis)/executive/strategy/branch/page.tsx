...
export default function BranchComparisonPage() {
  ...
  const columns = [
    { header: 'Branch Location', accessor: 'branchlocation', sortable: true },
    { header: 'Revenue Target Met', accessor: 'revenuetargetmet', sortable: true },
    { header: 'Quality Score', accessor: 'qualityscore', sortable: true },
    { header: 'Patient Sat.', accessor: 'patientsat', sortable: true },
    { header: 'Profit Margin', accessor: 'profitmargin', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">If a group hospital, comparing KPIs across different geographical branches.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Performing Branch</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>City Center</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Underperforming</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>North Wing</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
