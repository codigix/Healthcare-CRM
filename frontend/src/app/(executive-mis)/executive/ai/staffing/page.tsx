...
export default function StaffingPredictionPage() {
  ...
  const columns = [
    ...
    { header: 'Recommended Staffing', accessor: 'recommendedstaffing', sortable: true },
    { header: 'Scheduled Staff', accessor: 'scheduledstaff', sortable: true },
    { header: 'Shortfall Risk', accessor: 'shortfallrisk', sortable: true },
    { header: 'Cost of Overtime', accessor: 'costofovertime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">AI-driven roster suggestions based on historical absenteeism and patient loads.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Predicted Shortfalls</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2 Depts</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overtime Est.</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$12K</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Roster Efficiency</p>
