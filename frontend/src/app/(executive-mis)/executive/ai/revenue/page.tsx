...
export default function RevenuePredictionPage() {
  ...
  const columns = [
    { header: 'Prediction Window', accessor: 'predictionwindow', sortable: true },
    { header: 'Forecasted Revenue', accessor: 'forecastedrevenue', sortable: true },
    { header: 'Confidence Interval', accessor: 'confidenceinterval', sortable: true },
    { header: 'Key Driver', accessor: 'keydriver', sortable: true },
    { header: 'AI Suggestion', accessor: 'aisuggestion', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Machine Learning models predicting cash flow based on seasonality and billing trends.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Next Month Forecast</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$12.8M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Model Confidence</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>94%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Seasonal Trend</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Upward (Winter)</p>
        </div>
      </div>
