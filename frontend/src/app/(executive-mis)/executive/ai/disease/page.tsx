...
export default function DiseaseTrendsPage() {
  ...
  const columns = [
    { header: 'Disease / Condition', accessor: 'diseasecondition', sortable: true },
    { header: 'Current Cases', accessor: 'currentcases', sortable: true },
    { header: 'Expected vs Baseline', accessor: 'expectedvsbaseline', sortable: true },
    { header: 'Geographic Hotspot', accessor: 'geographichotspot', sortable: true },
    { header: 'Severity Index', accessor: 'severityindex', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Epidemiological trends identifying outbreaks (e.g., Dengue spike in August).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Outbreaks</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>1 (Dengue)</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bed Impact</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>+15%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inventory Alert</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>IV Fluids, Platelets</p>
        </div>
      </div>
