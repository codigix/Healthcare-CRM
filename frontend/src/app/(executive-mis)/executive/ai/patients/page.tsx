...
export default function PatientVolumeForecastPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Specialty', accessor: 'specialty', sortable: true },
    { header: 'Predicted Volume (Next 7d)', accessor: 'predictedvolumenext7d', sortable: true },
    { header: 'Historical Avg', accessor: 'historicalavg', sortable: true },
    { header: 'Surge Probability', accessor: 'surgeprobability', sortable: true },
    { header: 'Action Req.', accessor: 'actionreq', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Predicting OPD footfall and IPD admissions to optimize doctor scheduling.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Expected Surge</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Pulmonology</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Volume Est.</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,800</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Staff Adequacy</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>85%</p>
        </div>
      </div>
