...
export default function InfectionControlHICPage() {
  ...
  const columns = [
    ...
    { header: 'Cost Impact (Est)', accessor: 'costimpactest', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Executive view of hospital-acquired infections and antibiotic stewardship.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">HAI Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.8%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Hand Hygiene</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>88%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Abx Resistance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Monitored</p>
        </div>
      </div>
