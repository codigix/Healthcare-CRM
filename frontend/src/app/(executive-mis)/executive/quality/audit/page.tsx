...
export default function ClinicalAuditPage() {
  ...
  const columns = [
    ...
    { header: 'Deficiency Rate', accessor: 'deficiencyrate', sortable: true },
    { header: 'Critical Errors', accessor: 'criticalerrors', sortable: true },
    { header: 'Lead Auditor', accessor: 'leadauditor', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Results of internal peer reviews, prescription audits, and record completeness.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Audits Conducted</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12 (MTD)</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Completeness</p>
