...
export default function DashboardPreferencesPage() {
  ...
  const columns = [
    ...
    { header: 'Current Configuration', accessor: 'currentconfiguration', sortable: true },
    { header: 'Scope', accessor: 'scope', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Customizing default views, widgets, and themes for the executive dashboard.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Default Widgets</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>6 Enabled</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Theme</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Dark Mode</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Auto-Refresh</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>5 Mins</p>
        </div>
      </div>
