...
export default function NotificationSettingsPage() {
  ...
  const columns = [
    { header: 'Alert Event', accessor: 'alertevent', sortable: true },
    { header: 'Trigger Condition', accessor: 'triggercondition', sortable: true },
    { header: 'Notify Via', accessor: 'notifyvia', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">SMS/Email alert thresholds for critical executive warnings.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical Triggers</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SMS Enabled</p>
