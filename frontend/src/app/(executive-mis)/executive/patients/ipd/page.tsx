...
export default function IPDAnalyticsPage() {
  ...
  const columns = [
    { header: 'Ward Type', accessor: 'wardtype', sortable: true },
    { header: 'Admissions', accessor: 'admissions', sortable: true },
    { header: 'Discharges', accessor: 'discharges', sortable: true },
    { header: 'Current Occupancy', accessor: 'currentoccupancy', sortable: true },
    { header: 'Avg ALOS', accessor: 'avgalos', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Inpatient metrics, length of stay, and bed utilization insights.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total IPD (MTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,450</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Occupancy</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>82%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global ALOS</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4.2 Days</p>
        </div>
      </div>
