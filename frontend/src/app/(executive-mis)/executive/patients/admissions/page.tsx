...
export default function AdmissionTrendsPage() {
  ...
  const columns = [
    { header: 'Month/Period', accessor: 'monthperiod', sortable: true },
    { header: 'Total Admissions', accessor: 'totaladmissions', sortable: true },
    { header: 'Elective', accessor: 'elective', sortable: true },
    { header: 'Emergency', accessor: 'emergency', sortable: true },
    { header: 'Growth Trend', accessor: 'growthtrend', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Historical trends and forecasts for hospital admissions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">YTD Admissions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>14,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Elective Rate</p>
