...
export default function BedOccupancyPage() {
  ...
  const columns = [
    ...
    { header: 'Total Beds', accessor: 'totalbeds', sortable: true },
    { header: 'Occupied', accessor: 'occupied', sortable: true },
    { header: 'Occupancy Rate', accessor: 'occupancyrate', sortable: true },
    { header: 'Turnover Interval', accessor: 'turnoverinterval', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed occupancy rates across all wards and intensive care units.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global Occupancy</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>82%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ICU Occupancy</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>95%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Available Beds</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>124</p>
        </div>
      </div>
