...
export default function EquipmentDowntimePage() {
  ...
  const columns = [
    ...
    { header: 'Total Lost Hours', accessor: 'totallosthours', sortable: true },
    { header: 'Est. Revenue Loss', accessor: 'estrevenueloss', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Impact of biomedical equipment breakdowns on operations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global Uptime</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>98.5%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Revenue Lost</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$45K (MTD)</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Repair Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12 Hrs</p>
        </div>
      </div>
