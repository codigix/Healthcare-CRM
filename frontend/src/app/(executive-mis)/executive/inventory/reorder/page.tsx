...
export default function ReorderStatusPage() {
  ...
  const columns = [
    { header: 'Item Class', accessor: 'itemclass', sortable: true },
    { header: 'Items < Reorder Level', accessor: 'itemsreorderlevel', sortable: true },
    { header: 'Critical Stockouts', accessor: 'criticalstockouts', sortable: true },
    { header: 'Avg Procure Time', accessor: 'avgprocuretime', sortable: true },
    { header: 'Pending PO Value', accessor: 'pendingpovalue', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Insights into items hitting reorder levels and stockout risks.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Items Below Reorder</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical Stockouts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Pending POs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$450K</p>
        </div>
      </div>
