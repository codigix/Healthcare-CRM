...
export default function AssetUtilizationPage() {
  ...
  const columns = [
    { header: 'Equipment Group', accessor: 'equipmentgroup', sortable: true },
    { header: 'Total Assets', accessor: 'totalassets', sortable: true },
    { header: 'Avg Daily Usage', accessor: 'avgdailyusage', sortable: true },
    { header: 'Maintenance Cost', accessor: 'maintenancecost', sortable: true },
    { header: 'Est. ROI Time', accessor: 'estroitime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking utilization and ROI of expensive medical equipment.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Capital Asset Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$24.5M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Utilization</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>68%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Assets Under Maint.</p>
