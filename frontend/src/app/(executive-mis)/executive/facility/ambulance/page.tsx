...
export default function AmbulanceUtilizationPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Vehicle Type', accessor: 'vehicletype', sortable: true },
    { header: 'Total Trips', accessor: 'totaltrips', sortable: true },
    { header: 'Avg Response Time', accessor: 'avgresponsetime', sortable: true },
    { header: 'Fuel Cost/Km', accessor: 'fuelcostkm', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Fleet tracking, response times, and revenue generation from transport services.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Trips (MTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>450</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Response</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12 Mins</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fleet Uptime</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>95%</p>
        </div>
      </div>
