...
export default function BiomedicalEquipmentPage() {
  ...
  const columns = [
    { header: 'Equipment Class', accessor: 'equipmentclass', sortable: true },
    { header: 'Total Units', accessor: 'totalunits', sortable: true },
    { header: 'Units Under Repair', accessor: 'unitsunderrepair', sortable: true },
    { header: 'Uptime %', accessor: 'uptime', sortable: true },
    { header: 'AMC Status', accessor: 'amcstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Uptime of critical life-saving devices (Ventilators, Defibrillators).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical Uptime</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>99.5%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Breakdown</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">AMC Renewals Due</p>
