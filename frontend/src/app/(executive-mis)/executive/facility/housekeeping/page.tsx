...
export default function HousekeepingKPIsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Area/Ward', accessor: 'areaward', sortable: true },
    { header: 'Avg Cleaning Time', accessor: 'avgcleaningtime', sortable: true },
    { header: 'Inspection Score', accessor: 'inspectionscore', sortable: true },
    { header: 'Patient Complaints', accessor: 'patientcomplaints', sortable: true },
    { header: 'Staff Deployed', accessor: 'staffdeployed', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Cleanliness scores, turnaround times, and infection control compliance.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cleanliness Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>9.2/10</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Complaints Today</p>
