...
export default function UtilityConsumptionPage() {
  ...
  const columns = [
    { header: 'Utility Type', accessor: 'utilitytype', sortable: true },
    { header: 'Monthly Usage', accessor: 'monthlyusage', sortable: true },
    { header: 'Budget Variance', accessor: 'budgetvariance', sortable: true },
    { header: 'Cost/Unit', accessor: 'costunit', sortable: true },
    { header: 'Green Initiative', accessor: 'greeninitiative', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Water, electricity, and medical gas consumption vs budget.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Utility Bill</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$45K</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Power Savings</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Water Consumption</p>
