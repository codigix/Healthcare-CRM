...
export default function CRMPerformancePage() {
  ...
  const columns = [
    { header: 'Campaign / Program', accessor: 'campaignprogram', sortable: true },
    { header: 'Reach', accessor: 'reach', sortable: true },
    { header: 'Engagement Rate', accessor: 'engagementrate', sortable: true },
    { header: 'Conversion/Follow-up', accessor: 'conversionfollowup', sortable: true },
    { header: 'ROI Est.', accessor: 'roiest', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Effectiveness of patient engagement, outreach, and loyalty programs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Patients in CRM</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>125K</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Follow-up Success</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Health Check Conversions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>320</p>
        </div>
      </div>
