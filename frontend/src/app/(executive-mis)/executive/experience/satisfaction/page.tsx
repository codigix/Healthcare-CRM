...
export default function PatientSatisfactionPage() {
  ...
  const columns = [
    ...
    { header: 'CSAT Score (Out of 5)', accessor: 'csatscoreoutof5', sortable: true },
    { header: 'Surveys Sent', accessor: 'surveyssent', sortable: true },
    { header: 'Response Rate', accessor: 'responserate', sortable: true },
    { header: 'Top Complaint', accessor: 'topcomplaint', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">CSAT scores broken down by department, doctor, and facility touchpoints.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global CSAT</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4.2/5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Response Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>22%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Surveys Collected</p>
