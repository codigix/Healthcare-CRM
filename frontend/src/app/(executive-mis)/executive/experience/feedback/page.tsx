...
export default function FeedbackAnalysisPage() {
  ...
  const columns = [
    { header: 'Topic Category', accessor: 'topiccategory', sortable: true },
    { header: 'Mentions', accessor: 'mentions', sortable: true },
    { header: 'Positive Sentiment', accessor: 'positivesentiment', sortable: true },
    { header: 'Negative Sentiment', accessor: 'negativesentiment', sortable: true },
    { header: 'Key Keyword', accessor: 'keykeyword', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">AI-driven sentiment analysis of open-text patient feedback.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Reviews Analyzed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Sentiment</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Positive (72%)</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Brand Reputation</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Strong</p>
        </div>
      </div>
