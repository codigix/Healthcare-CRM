...
export default function PayrollAnalyticsPage() {
  ...
  const columns = [
    { header: 'Staff Level', accessor: 'stafflevel', sortable: true },
    { header: 'Total Payroll (Mo)', accessor: 'totalpayrollmo', sortable: true },
    { header: 'Benefits %', accessor: 'benefits', sortable: true },
    { header: 'Avg CTC', accessor: 'avgctc', sortable: true },
    { header: 'Budget Variance', accessor: 'budgetvariance', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Salary distributions, benefits costs, and HR budget vs actuals.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Monthly Payroll</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$1.8M</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cost Per Bed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$4,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Budget Variance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>+1.5%</p>
        </div>
      </div>
