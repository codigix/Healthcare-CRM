...
export default function AttendanceAnalyticsPage() {
  ...
  const columns = [
    ...
    { header: 'Absenteeism %', accessor: 'absenteeism', sortable: true },
    { header: 'Avg Overtime/Emp', accessor: 'avgovertimeemp', sortable: true },
    { header: 'Late Arrivals', accessor: 'latearrivals', sortable: true },
    { header: 'Shift Compliance', accessor: 'shiftcompliance', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Absenteeism trends, overtime hours, and shift adherence.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global Absenteeism</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4.2%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Overtime</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1,200 Hrs</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Leave Liability</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>$150K</p>
        </div>
      </div>
