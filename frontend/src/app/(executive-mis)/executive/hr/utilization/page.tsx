...
export default function StaffUtilizationPage() {
  ...
  const columns = [
    ...
    { header: 'Required FTEs', accessor: 'requiredftes', sortable: true },
    { header: 'Actual FTEs', accessor: 'actualftes', sortable: true },
    { header: 'Utilization %', accessor: 'utilization', sortable: true },
    { header: 'Fatigue Risk', accessor: 'fatiguerisk', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Identifying over-staffed or under-staffed departments based on patient volume.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Understaffed Depts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Burnout Risk Cases</p>
