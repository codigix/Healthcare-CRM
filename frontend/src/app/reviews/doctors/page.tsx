...
export default function DoctorReviewsPage() {
    ...
    const reviews: DoctorReview[] = [
        ...
        },
        {
            ...
            status: "Pending",
            comment:
                "Dr. Wong explained everything clearly and was very patient. Great experience!",
            helpful: 0,
        },
        {
            id: "DR004",
    ...
    const filteredReviews = reviews.filter((review) => {
        ...
        const matchesDepartment =
            departmentFilter === "all" || review.department === departmentFilter;

        if (activeTab === "approved")
            return matchesSearch && matchesDepartment && review.status === "Approved";
        if (activeTab === "pending")
            return matchesSearch && matchesDepartment && review.status === "Pending";
        ...
        <>
            <div className="space-y-6">
                <div className="flex justify-between items-start md:items-center">
                    <div>
                        <h1 className="text-3xl  text-white">Doctor Reviews</h1>
                    ...
                    <div className="bg-dark-secondary border border-dark-tertiary rounded p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl  text-blue-400 mt-1">54</p>
                            </div>
                ...
                <div className="bg-dark-secondary border border-dark-tertiary rounded p-6">
                    ...
                    <div className="flex gap-2 mb-6 border-b border-dark-tertiary">
                        ...
                        <button
                            ...
                            className={`p-2 font-medium transition-colors ${activeTab === "approved"
                                ? "text-emerald-400 border-b-2 border-emerald-400"
                                : "text-gray-400 hover:text-gray-300"
                                }`}
                        >
                    ...
                    <div className="space-y-4">
                        {filteredReviews.map((review) => (
                            <div
                                key={review.id}
                                className="bg-dark-tertiary rounded p-4 border border-dark-tertiary hover:border-emerald-500/50 transition-colors"
                            >
