                        ...
                        <div className="grid grid-cols-7 gap-2">
                            {days.map((day, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className={`aspect-square p-2 rounded border transition-colors cursor-pointer ${day === null
                                    ...
                                    >
                                        {day && (
                                            <div className="h-full flex flex-col">
                                                <span
                                                    className={`text-mdfont-semibold ${today ? "text-emerald-400" : "text-white"
                                                        }`}
                                                >
                                                    {day}
                                                </span>
                        ...
                        <div className="space-y-3">
                            {events.map((event) => {
                                ...
                                return (
                                    <div
                                        key={event.id}
                                        className="p-3 bg-dark-tertiary rounded border border-dark-secondary hover:border-emerald-500 transition-colors cursor-pointer"
                                    >
