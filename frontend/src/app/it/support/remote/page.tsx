...
export default function RemoteSupportPage() {
  ...
  const columns = [
    ...
    { header: 'IT Tech', accessor: 'ittech', sortable: true },
    { header: 'Target Hostname', accessor: 'targethostname', sortable: true },
    { header: 'Duration', accessor: 'duration', sortable: true },
    { header: 'Issue Fixed', accessor: 'issuefixed', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logs of AnyDesk/TeamViewer sessions initiated by IT to fix end-user PCs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">First Contact Res.</p>
