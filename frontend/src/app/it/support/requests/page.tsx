...
export default function ServiceRequestsPage() {
  ...
  const columns = [
    ...
    { header: 'Item Requested', accessor: 'itemrequested', sortable: true },
    { header: 'Justification', accessor: 'justification', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Requests for new hardware (e.g., new mouse) or software installations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fulfilled (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>85</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Hardware Budget</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$4.5k Left</p>
        </div>
      </div>
