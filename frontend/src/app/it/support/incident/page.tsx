...
export default function IncidentManagementPage() {
  ...
  const columns = [
    { header: 'Incident ID', accessor: 'incidentid', sortable: true },
    { header: 'Description', accessor: 'description', sortable: true },
    { header: 'Affected Area', accessor: 'affectedarea', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Major P1 incidents (e.g., HIS down) tracking and post-mortem logs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Major Incidents (Mo)</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Post-Mortems Pending</p>
