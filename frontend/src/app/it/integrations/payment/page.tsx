...
export default function PaymentGatewayPage() {
  ...
  const columns = [
    ...
    { header: 'Txn Count (24h)', accessor: 'txncount24h', sortable: true },
    { header: 'Success Rate', accessor: 'successrate', sortable: true },
    { header: 'Refunds Processing', accessor: 'refundsprocessing', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Stripe, Razorpay, or local banking integrations for online billing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Online Txn</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Failed Txn</p>
