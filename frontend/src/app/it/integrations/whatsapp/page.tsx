...
export default function WhatsAppAPIPage() {
  ...
  const columns = [
    { header: 'WABA Account', accessor: 'wabaaccount', sortable: true },
    { header: 'Messages Sent', accessor: 'messagessent', sortable: true },
    { header: 'Read Rate', accessor: 'readrate', sortable: true },
    { header: 'Template Approvals', accessor: 'templateapprovals', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">WhatsApp Business API integration for automated reports and reminders.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Opt-out Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Quality Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>High</p>
        </div>
      </div>
