...
export default function APIKeysPage() {
  ...
  const columns = [
    { header: 'Key Name', accessor: 'keyname', sortable: true },
    { header: 'Assigned To', accessor: 'assignedto', sortable: true },
    { header: 'Permissions', accessor: 'permissions', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Secure management and rotation of API keys used by external vendors or internal apps.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revoked Keys</p>
