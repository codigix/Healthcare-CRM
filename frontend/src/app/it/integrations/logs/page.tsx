...
export default function APILogsPage() {
  ...
  const columns = [
    ...
    { header: 'Endpoint', accessor: 'endpoint', sortable: true },
    { header: 'Method', accessor: 'method', sortable: true },
    { header: 'Response Code', accessor: 'responsecode', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed request/response payloads for debugging integration failures.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Logs (24h)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1.2M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">4xx Errors</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1,200</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">5xx Errors</p>
