...
export default function APIDashboardPage() {
  ...
  const columns = [
    ...
    { header: 'Uptime (30d)', accessor: 'uptime30d', sortable: true },
    { header: 'Requests (24h)', accessor: 'requests24h', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Overview of all third-party integrations, uptime, and request volumes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Integrations</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">API Requests (24h)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.2M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Failed Requests</p>
