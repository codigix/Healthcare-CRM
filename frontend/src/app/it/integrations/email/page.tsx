...
export default function EmailServerPage() {
  ...
  const columns = [
    { header: 'SMTP Server', accessor: 'smtpserver', sortable: true },
    { header: 'Emails Sent (Mo)', accessor: 'emailssentmo', sortable: true },
    { header: 'Bounce Rate', accessor: 'bouncerate', sortable: true },
    { header: 'Spam Complaints', accessor: 'spamcomplaints', sortable: true },
    { header: 'Domain Rep.', accessor: 'domainrep', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">SMTP (SendGrid, AWS SES) configuration for mass emails and transactional receipts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Emails Sent</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>85,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bounce Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.2%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Spam Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0.01%</p>
        </div>
      </div>
