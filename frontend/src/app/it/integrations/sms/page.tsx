...
export default function SMSGatewayPage() {
  ...
  const columns = [
    ...
    { header: 'SMS Sent (Mo)', accessor: 'smssentmo', sortable: true },
    { header: 'Delivery Rate', accessor: 'deliveryrate', sortable: true },
    { header: 'Credits Left', accessor: 'creditsleft', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Transactional SMS routes (Twilio, Gupshup) for patient appointments and OTPs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SMS Sent (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>125,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Delivery Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>96%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Credits Exhausting</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1 Route</p>
        </div>
      </div>
