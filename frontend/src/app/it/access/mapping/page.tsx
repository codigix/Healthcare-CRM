...
export default function RoleMappingPage() {
  ...
  const columns = [
    ...
    { header: 'Module Mapped', accessor: 'modulemapped', sortable: true },
    { header: 'Default Role', accessor: 'defaultrole', sortable: true },
    { header: 'Data Segregation', accessor: 'datasegregation', sortable: true },
    { header: 'Override Permitted', accessor: 'overridepermitted', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Mapping physical departments to software modules (e.g., Radiology Dept -> RIS Module).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Departments Mapped</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>34/34</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cross-dept Access</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12 Users</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Maps</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>0</p>
        </div>
      </div>
