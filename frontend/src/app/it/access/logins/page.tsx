...
export default function DepartmentLoginsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Total Users', accessor: 'totalusers', sortable: true },
    { header: 'Active Now', accessor: 'activenow', sortable: true },
    { header: 'Peak Login Time', accessor: 'peaklogintime', sortable: true },
    { header: 'Failed Logins (24h)', accessor: 'failedlogins24h', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monitoring logins filtered by specific clinical or support departments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Activity</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Billing</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lowest Activity</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>Mortuary</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Access Anomalies</p>
