...
export default function BackgroundServicesPage() {
  ...
  const columns = [
    ...
    { header: 'PID', accessor: 'pid', sortable: true },
    { header: 'Memory Used', accessor: 'memoryused', sortable: true },
    { header: 'Uptime', accessor: 'uptime', sortable: true },
    { header: 'Restart Count', accessor: 'restartcount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Systemd or Windows services running critical background modules.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Services Stopped</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Frequent Restarts</p>
