...
export default function QueueServicesPage() {
  ...
  const columns = [
    ...
    { header: 'Pending Msgs', accessor: 'pendingmsgs', sortable: true },
    { header: 'Processing Rate', accessor: 'processingrate', sortable: true },
    { header: 'Failed Msgs', accessor: 'failedmsgs', sortable: true },
    { header: 'Consumers', accessor: 'consumers', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Redis/RabbitMQ message queues for async tasks (e.g., sending SMS, PDF generation).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Queued</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,200</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Processing Speed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>450/s</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Dead Letter Queue</p>
