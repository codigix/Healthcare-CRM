...
export default function SMSNotificationsPage() {
  ...
  const columns = [
    { header: 'SMS ID', accessor: 'smsid', sortable: true },
    { header: 'Phone Number', accessor: 'phonenumber', sortable: true },
    { header: 'Message Template', accessor: 'messagetemplate', sortable: true },
    { header: 'Sent Time', accessor: 'senttime', sortable: true },
    { header: 'DLR Status', accessor: 'dlrstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking outbound transactional SMS messages.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SMS Sent (24h)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">DLR Received</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>95%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Failed Delivery</p>
