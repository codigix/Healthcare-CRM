...
export default function AlertRulesPage() {
  ...
  const columns = [
    ...
    { header: 'Channels', accessor: 'channels', sortable: true },
    { header: 'Escalation Level', accessor: 'escalationlevel', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logic defining when system admins receive critical alerts (e.g., DB Down -> SMS + Call).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Alerts Fired (24h)</p>
