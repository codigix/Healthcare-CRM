...
export default function WhatsAppNotificationsPage() {
  ...
  const columns = [
    { header: 'WA Message ID', accessor: 'wamessageid', sortable: true },
    ...
    { header: 'Read Receipt', accessor: 'readreceipt', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">WhatsApp API message logs for reports and telemedicine links.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">WA Sent (24h)</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Template Rejects</p>
