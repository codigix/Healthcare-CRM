...
export default function DataCenterHealthPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Sensor Location', accessor: 'sensorlocation', sortable: true },
    { header: 'Temperature', accessor: 'temperature', sortable: true },
    { header: 'Humidity', accessor: 'humidity', sortable: true },
    { header: 'Water Leak', accessor: 'waterleak', sortable: true },
    { header: 'Door Access', accessor: 'dooraccess', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Environment variables like temperature and humidity in server rooms.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Temp</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>21°C</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cooling Units</p>
