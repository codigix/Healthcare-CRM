...
export default function NetworkMonitoringPage() {
  ...
  const columns = [
    { header: 'Device Name', accessor: 'devicename', sortable: true },
    { header: 'IP/Subnet', accessor: 'ipsubnet', sortable: true },
    { header: 'Throughput', accessor: 'throughput', sortable: true },
    { header: 'Packet Loss', accessor: 'packetloss', sortable: true },
    { header: 'Active Conns', accessor: 'activeconns', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Switch, router, and firewall throughput and latency tracking.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Network Health</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>99.9%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Latency</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>2ms</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Packet Drops</p>
