...
export default function DiskUsagePage() {
  ...
  const columns = [
    { header: 'Drive/Mount', accessor: 'drivemount', sortable: true },
    { header: 'Server', accessor: 'server', sortable: true },
    { header: 'Total Space', accessor: 'totalspace', sortable: true },
    { header: 'Used Space', accessor: 'usedspace', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Storage capacity planning and alerts for almost-full drives.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>150 TB</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Used Storage</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>110 TB</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical Drives</p>
