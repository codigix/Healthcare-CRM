...
export default function MobileDevicesPage() {
  ...
  const columns = [
    { header: 'Device IMEI', accessor: 'deviceimei', sortable: true },
    { header: 'Assigned To', accessor: 'assignedto', sortable: true },
    { header: 'Model', accessor: 'model', sortable: true },
    { header: 'MDM Enrolled', accessor: 'mdmenrolled', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Mobile Device Management (MDM) for corporate-issued phones to doctors/staff.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Managed Devices</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Remote Wipes (YTD)</p>
