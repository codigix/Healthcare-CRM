...
export default function PrintersPage() {
  ...
  const columns = [
    { header: 'Printer IP', accessor: 'printerip', sortable: true },
    { header: 'Location', accessor: 'location', sortable: true },
    { header: 'Type', accessor: 'type', sortable: true },
    { header: 'Pages Printed', accessor: 'pagesprinted', sortable: true },
    { header: 'Toner Level', accessor: 'tonerlevel', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Network printers, label printers (Lab/Pharmacy), and toner level monitoring.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Printers</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Low Toner</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Paper Jam Errors</p>
