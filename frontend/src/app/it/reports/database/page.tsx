...
export default function DatabaseReportPage() {
  ...
  const columns = [
    { header: 'Database Name', accessor: 'databasename', sortable: true },
    { header: 'Size (GB)', accessor: 'sizegb', sortable: true },
    { header: 'MoM Growth', accessor: 'momgrowth', sortable: true },
    { header: 'Long TX Count', accessor: 'longtxcount', sortable: true },
    { header: 'Recommendation', accessor: 'recommendation', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Storage growth trends and index fragmentation reporting.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total DB Size</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4.5 TB</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Growth Rate (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>+2.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Index Health</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Good</p>
        </div>
      </div>
