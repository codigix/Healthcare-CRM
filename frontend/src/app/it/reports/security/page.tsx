...
export default function SecurityReportPage() {
  ...
  const columns = [
    ...
    { header: 'Threats Blocked', accessor: 'threatsblocked', sortable: true },
    { header: 'Unpatched PCs', accessor: 'unpatchedpcs', sortable: true },
    { header: 'Phishing Clicks', accessor: 'phishingclicks', sortable: true },
    { header: 'Risk Score', accessor: 'riskscore', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Summary of blocked threats, phishing tests, and patching compliance.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Threats Blocked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,240</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Phishing Fails</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Security Posture</p>
