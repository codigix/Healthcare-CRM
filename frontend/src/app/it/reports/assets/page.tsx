...
export default function ITAssetReportPage() {
  ...
  const columns = [
    ...
    { header: 'In Warranty', accessor: 'inwarranty', sortable: true },
    { header: 'End of Life (EOL)', accessor: 'endoflifeeol', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hardware inventory, depreciation value, and replacement forecasting.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Assets EOL (This Yr)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">New Procurements</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$24K</p>
        </div>
      </div>
