...
export default function APIReportPage() {
  ...
  const columns = [
    { header: 'Integration', accessor: 'integration', sortable: true },
    { header: 'Total Calls', accessor: 'totalcalls', sortable: true },
    { header: 'Avg Response', accessor: 'avgresponse', sortable: true },
    { header: 'Data Transferred', accessor: 'datatransferred', sortable: true },
    { header: 'Est Cost', accessor: 'estcost', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Integration volumes for billing vendors (e.g., SMS cost calculation).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">API Costs (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$2,400</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Most Used API</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>WhatsApp</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Failed API %</p>
