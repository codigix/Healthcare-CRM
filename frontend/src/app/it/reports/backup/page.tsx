...
export default function BackupReportPage() {
  ...
  const columns = [
    { header: 'Week Ending', accessor: 'weekending', sortable: true },
    { header: 'Total Backups', accessor: 'totalbackups', sortable: true },
    { header: 'Success Rate', accessor: 'successrate', sortable: true },
    { header: 'Verified Mounts', accessor: 'verifiedmounts', sortable: true },
    { header: 'Storage Consumed', accessor: 'storageconsumed', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Compliance report proving backups were taken and verified daily.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Success</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>100%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cloud Sync</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Completed</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Audit Ready</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Yes</p>
        </div>
      </div>
