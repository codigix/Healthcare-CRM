...
export default function FeatureFlagsPage() {
  ...
  const columns = [
    { header: 'Feature Name', accessor: 'featurename', sortable: true },
    { header: 'Target Group', accessor: 'targetgroup', sortable: true },
    { header: 'Rollout %', accessor: 'rollout', sortable: true },
    { header: 'Last Toggled By', accessor: 'lasttoggledby', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Toggle features on/off for specific user groups without deploying code.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Flags</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Beta Features</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Deprecated</p>
