...
export default function PatchManagementPage() {
  ...
  const columns = [
    { header: 'Patch Name', accessor: 'patchname', sortable: true },
    { header: 'Severity', accessor: 'severity', sortable: true },
    { header: 'Applicable PCs', accessor: 'applicablepcs', sortable: true },
    { header: 'Patched PCs', accessor: 'patchedpcs', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">OS and 3rd party software (Java, Chrome) patching on user PCs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical Patches</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fleet Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>92%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Failed Installs</p>
