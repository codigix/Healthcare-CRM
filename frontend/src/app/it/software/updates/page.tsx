...
export default function SoftwareUpdatesPage() {
  ...
  const columns = [
    { header: 'Update Schedule', accessor: 'updateschedule', sortable: true },
    { header: 'System Affected', accessor: 'systemaffected', sortable: true },
    { header: 'Expected Downtime', accessor: 'expecteddowntime', sortable: true },
    { header: 'Approved By', accessor: 'approvedby', sortable: true },
    { header: 'Communication', accessor: 'communication', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Scheduled maintenance windows and downtime announcements for updates.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Upcoming Windows</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1 (Sat Night)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Downtime</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45 Mins</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missed Windows</p>
