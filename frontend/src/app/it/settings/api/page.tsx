...
export default function APIConfigurationPage() {
  ...
  const columns = [
    { header: 'Endpoint Group', accessor: 'endpointgroup', sortable: true },
    { header: 'Rate Limit', accessor: 'ratelimit', sortable: true },
    { header: 'CORS Origins', accessor: 'corsorigins', sortable: true },
    { header: 'Authentication', accessor: 'authentication', sortable: true },
    { header: 'Cache TTL', accessor: 'cachettl', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Rate limiting thresholds and CORS settings for the hospital APIs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global Rate Limit</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>100 req/sec</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Blocked IPs (Limit)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">CORS Restrictive</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Yes</p>
        </div>
      </div>
