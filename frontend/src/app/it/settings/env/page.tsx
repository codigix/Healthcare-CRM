...
export default function EnvironmentVariablesPage() {
  ...
  const columns = [
    { header: 'Variable Name', accessor: 'variablename', sortable: true },
    { header: 'Value (Masked)', accessor: 'valuemasked', sortable: true },
    { header: 'Environment', accessor: 'environment', sortable: true },
    { header: 'Service', accessor: 'service', sortable: true },
    { header: 'Last Rotated', accessor: 'lastrotated', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Secure management of DB connection strings and API secrets (Encrypted).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Variables</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>124</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Secrets Expiring</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Encryption Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>AES-256</p>
        </div>
      </div>
