...
export default function MailConfigurationPage() {
  ...
  const columns = [
    ...
    { header: 'Test Connection', accessor: 'testconnection', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">SMTP credentials, ports, and default sender addresses.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SMTP Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Connected</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Daily Limit</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>50,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Queue Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-green-500"}>Empty</p>
        </div>
      </div>
