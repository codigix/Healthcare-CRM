...
export default function DatabaseBackupPage() {
  ...
  const columns = [
    { header: 'Backup ID', accessor: 'backupid', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logs of automated and manual database dumps to secure storage.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Last Full Backup</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Today 02:00</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Storage Consumed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4.5 TB</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Failed Backups</p>
