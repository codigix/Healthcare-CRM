...
export default function QueryMonitorPage() {
  ...
  const columns = [
    { header: 'Query Hash', accessor: 'queryhash', sortable: true },
    { header: 'Avg Execution', accessor: 'avgexecution', sortable: true },
    { header: 'Calls/Hr', accessor: 'callshr', sortable: true },
    { header: 'Rows Returned', accessor: 'rowsreturned', sortable: true },
    { header: 'Module Affected', accessor: 'moduleaffected', sortable: true },
    {
      header: 'Action',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Identifying slow queries and missing indexes impacting application speed.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Queries > 1s</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">New Slow Queries</p>
