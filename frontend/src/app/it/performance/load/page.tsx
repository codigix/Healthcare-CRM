...
export default function LoadAnalysisPage() {
  ...
  const columns = [
    { header: 'Time Window', accessor: 'timewindow', sortable: true },
    { header: 'Peak Concurrency', accessor: 'peakconcurrency', sortable: true },
    { header: 'Servers Spun Up', accessor: 'serversspunup', sortable: true },
    { header: 'Max CPU Hit', accessor: 'maxcpuhit', sortable: true },
    { header: 'Bandwidth Peak', accessor: 'bandwidthpeak', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Capacity planning, tracking concurrent user peaks, and autoscale events.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Peak Users Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,150 (11 AM)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Autoscale Events</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Capacity Margin</p>
