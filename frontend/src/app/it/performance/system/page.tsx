...
export default function SystemPerformancePage() {
  ...
  const columns = [
    { header: 'Apdex Score', accessor: 'apdexscore', sortable: true },
    { header: 'Service', accessor: 'service', sortable: true },
    { header: 'Avg Latency', accessor: 'avglatency', sortable: true },
    { header: 'P99 Latency', accessor: 'p99latency', sortable: true },
    { header: 'Error Rate', accessor: 'errorrate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Overall APM (Application Performance Monitoring) metrics (e.g., Datadog, NewRelic).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global Apdex</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0.95</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Web Transaction</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>120ms</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Service Degraded</p>
