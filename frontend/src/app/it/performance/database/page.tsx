...
export default function DatabasePerformancePage() {
  ...
  const columns = [
    { header: 'Query Type', accessor: 'querytype', sortable: true },
    { header: 'Avg Exec Time', accessor: 'avgexectime', sortable: true },
    { header: 'CPU Bound', accessor: 'cpubound', sortable: true },
    { header: 'I/O Bound', accessor: 'iobound', sortable: true },
    { header: 'Lock Waits', accessor: 'lockwaits', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Specific deep dives into database query speeds and wait states.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg DB Latency</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12ms</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lock Wait Ratio</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Long Transactions</p>
