...
export default function ResponseTimePage() {
  ...
  const columns = [
    { header: 'Page / Route', accessor: 'pageroute', sortable: true },
    { header: 'Avg Load Time', accessor: 'avgloadtime', sortable: true },
    { header: 'First Contentful Paint', accessor: 'firstcontentfulpaint', sortable: true },
    { header: 'Time to Interactive', accessor: 'timetointeractive', sortable: true },
    { header: 'DOM Size', accessor: 'domsize', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">End-user browser load times (RUM - Real User Monitoring).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Page Load</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.2s</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Slow Pages (>3s)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bounce Rate (UI)</p>
