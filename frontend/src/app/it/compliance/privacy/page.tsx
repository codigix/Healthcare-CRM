...
export default function DataPrivacyPage() {
  ...
  const columns = [
    { header: 'Privacy Request', accessor: 'privacyrequest', sortable: true },
    ...
    { header: 'SLA (Days)', accessor: 'sladays', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">GDPR / DPDP (India) compliance for patient data anonymization and consent management.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Data Deletion Req</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Consent Revoked</p>
