...
export default function NABHITCompliancePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'NABH Standard', accessor: 'nabhstandard', sortable: true },
    { header: 'Clause', accessor: 'clause', sortable: true },
    { header: 'IT Mapping', accessor: 'itmapping', sortable: true },
    { header: 'Document Proof', accessor: 'documentproof', sortable: true },
    { header: 'Internal Score', accessor: 'internalscore', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hospital accreditation board IT standards mapping (India).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Standard Met</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>95%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Gaps Identified</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Assessment Date</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Nov 2026</p>
        </div>
      </div>
