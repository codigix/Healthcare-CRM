...
export default function AccessAuditPage() {
  ...
  const columns = [
    { header: 'Review Cycle', accessor: 'reviewcycle', sortable: true },
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Accounts Reviewed', accessor: 'accountsreviewed', sortable: true },
    { header: 'Stale Found', accessor: 'stalefound', sortable: true },
    { header: 'Action Taken', accessor: 'actiontaken', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Periodic review of user permissions (e.g., Do terminated employees still have access?).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Access Reviews</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Quarterly</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Stale Accounts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">100% Compliant</p>
