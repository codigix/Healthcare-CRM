...
export default function HIPAACompliancePage() {
  ...
  const columns = [
    { header: 'Control Requirement', accessor: 'controlrequirement', sortable: true },
    { header: 'Implementation', accessor: 'implementation', sortable: true },
    { header: 'Last Audited', accessor: 'lastaudited', sortable: true },
    { header: 'Findings', accessor: 'findings', sortable: true },
    { header: 'Evidence Links', accessor: 'evidencelinks', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Checklists ensuring ePHI is encrypted at rest and in transit.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Open Findings</p>
          <p className={"text-2xl font-bold mt-2 " + "text-green-500"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Next Audit Due</p>
