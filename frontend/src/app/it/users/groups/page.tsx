...
export default function UserGroupsPage() {
  ...
  const columns = [
    ...
    { header: 'Assigned Roles', accessor: 'assignedroles', sortable: true },
    { header: 'Created Date', accessor: 'createddate', sortable: true },
    { header: 'Managed By', accessor: 'managedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logical grouping of users for bulk permission assignment (e.g., Ward Nurses).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Users Assigned</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1,100</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Empty Groups</p>
