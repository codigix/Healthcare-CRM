...
export default function SystemHealthScorePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Component', accessor: 'component', sortable: true },
    { header: 'Health Score', accessor: 'healthscore', sortable: true },
    { header: 'Weightage', accessor: 'weightage', sortable: true },
    { header: 'Primary Degrader', accessor: 'primarydegrader', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">An aggregated score (0-100) combining uptime, bugs, and performance.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Hospital IT Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>94/100</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Weakest Link</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Legacy LIS</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Trend (30d)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Improving</p>
        </div>
      </div>
