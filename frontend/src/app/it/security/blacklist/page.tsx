...
export default function IPBlacklistPage() {
  ...
  const columns = [
    { header: 'IP / Subnet', accessor: 'ipsubnet', sortable: true },
    { header: 'Source of Threat', accessor: 'sourceofthreat', sortable: true },
    { header: 'Block Reason', accessor: 'blockreason', sortable: true },
    { header: 'Added Date', accessor: 'addeddate', sortable: true },
    { header: 'Hit Count', accessor: 'hitcount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Known malicious IPs or subnets permanently blocked at the edge router.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Blocked IPs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1,240</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Auto-Blocked (IDS)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>450</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Hits on Blocklist</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>14.5k (24h)</p>
        </div>
      </div>
