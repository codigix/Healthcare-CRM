...
export default function IPWhitelistPage() {
  ...
  const columns = [
    ...
    { header: 'Assigned To/Vendor', accessor: 'assignedtovendor', sortable: true },
    { header: 'Purpose', accessor: 'purpose', sortable: true },
    { header: 'Added By', accessor: 'addedby', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Approved external IPs (e.g., specific vendors, remote doctors) allowed to bypass firewall.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Whitelisted IPs</p>
