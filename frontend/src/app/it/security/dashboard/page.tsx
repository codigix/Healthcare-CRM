...
export default function SecurityDashboardPage() {
  ...
  const columns = [
    { header: 'Security Metric', accessor: 'securitymetric', sortable: true },
    { header: 'Current Status', accessor: 'currentstatus', sortable: true },
    { header: 'Last Scan', accessor: 'lastscan', sortable: true },
    { header: 'Vulnerabilities', accessor: 'vulnerabilities', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Central view of threat alerts, firewall drops, and overall system security posture.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Security Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>92/100</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Threats</p>
          <p className={"text-2xl font-bold mt-2 " + "text-green-500"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Patches Pending</p>
