...
export default function FirewallRulesPage() {
  ...
  const columns = [
    { header: 'Rule ID', accessor: 'ruleid', sortable: true },
    { header: 'Source IP', accessor: 'sourceip', sortable: true },
    { header: 'Destination IP', accessor: 'destinationip', sortable: true },
    { header: 'Port', accessor: 'port', sortable: true },
    { header: 'Action (Allow/Deny)', accessor: 'actionallowdeny', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Managing inbound/outbound traffic rules, port forwarding, and VPN access.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Blocked Connections</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.2k (24h)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">VPN Users Active</p>
