...
export default function DrugRecallManagementPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Recall ID', accessor: 'recallid', sortable: true },
    { header: 'Medicine Name', accessor: 'medicinename', sortable: true },
    { header: 'Batch No', accessor: 'batchno', sortable: true },
    { header: 'Affected Qty Located', accessor: 'affectedqtylocated', sortable: true },
    { header: 'Vendor Notified', accessor: 'vendornotified', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Managing manufacturer alerts and pulling affected batches from all locations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Recalls</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>1</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Quarantined Qty</p>
