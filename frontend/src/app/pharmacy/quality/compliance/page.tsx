...
export default function RegulatoryCompliancePage() {
  ...
  const columns = [
    ...
    { header: 'Issuing Authority', accessor: 'issuingauthority', sortable: true },
    { header: 'Valid From', accessor: 'validfrom', sortable: true },
    { header: 'Expiry Date', accessor: 'expirydate', sortable: true },
    { header: 'Days to Expire', accessor: 'daystoexpire', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking pharmacy licenses, pharmacist registrations, and regulatory filings.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inspections Passed</p>
