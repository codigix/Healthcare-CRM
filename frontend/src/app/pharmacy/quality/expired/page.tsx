...
export default function ExpiredDrugsDisposalPage() {
  ...
  const columns = [
    ...
    { header: 'Witnessed By', accessor: 'witnessedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Regulatory tracking and documentation of the destruction of expired medicines.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Disposal</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>120 Items</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Disposed (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>$4,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Compliance Logs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Up to Date</p>
        </div>
      </div>
