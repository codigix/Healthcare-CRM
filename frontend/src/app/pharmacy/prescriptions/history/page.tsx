            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-dark-tertiary">
                  ...
                  <th className="text-left py-4 px-4 text-gray-400 font-medium text-sm">Attending Doctor</th>
            ...
            <div className="space-y-4 text-sm max-h-[400px] overflow-y-auto">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <span className="text-white font-bold">{viewDetails.patient?.name}</span>
                </div>
                <div>
              ...
              <div>
                ...
                <p className="text-white italic bg-white/5 p-2.5 rounded mt-1">"{viewDetails.diagnosis || "No specific diagnosis provided"}"</p>
              </div>
                ...
                <div className="space-y-2">
                  {parseMedications(viewDetails.medications).map((med: any, idx: number) => (
                    <div key={idx} className="p-3 bg-white/5 rounded border border-white/5 flex justify-between items-center">
                      ...
                      <span className="text-[#1abc9c] font-bold text-xs">{med.qty || med.dosage || "1 Unit"}</span>
                    </div>
                  ))}
                </div>
              </div>
