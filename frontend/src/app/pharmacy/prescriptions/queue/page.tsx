...
export default function PrescriptionQueuePage() {
  ...
  const columns = [
    ...
    { header: 'Time Received', accessor: 'timereceived', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Central queue of all electronic prescriptions sent from OPD and IPD.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Prescriptions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Processed Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>320</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Wait Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8 mins</p>
        </div>
      </div>
