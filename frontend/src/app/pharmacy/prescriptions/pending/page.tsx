...
export default function PendingPrescriptionsPage() {
 ...
 className="p-1.5 bg-card/5 hover:bg-card/10 disabled:hover:bg-card/5 text-gray-300 disabled:text-gray-600 disabled:opacity-50 rounded-lg border border-white/5 disabled:border-transparent transition-all cursor-pointer disabled:cursor-not-allowed"
 title="Previous Page"
 >
 <ChevronLeft size={16} />
 </button>
 ...
 className="p-2 hover:bg-card/5 rounded-lg text-gray-400 hover:text-white transition-colors"
 >
 <X size={20} />
 </button>
 </div>
