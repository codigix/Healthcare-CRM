...
export default function NewPrescriptionEntryPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Entry ID', accessor: 'entryid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Doctor/Clinic', accessor: 'doctorclinic', sortable: true },
    { header: 'Date', accessor: 'date', sortable: true },
    { header: 'Items Entered', accessor: 'itemsentered', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manual entry for physical (paper) prescriptions brought by patients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Manual Entries Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>42</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>39</p>
        </div>
      </div>
