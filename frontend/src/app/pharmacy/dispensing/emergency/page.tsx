...
export default function EmergencyDispensingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Emergency ID', accessor: 'emergencyid', sortable: true },
    { header: 'Location', accessor: 'location', sortable: true },
    { header: 'Requested Meds', accessor: 'requestedmeds', sortable: true },
    { header: 'Time Requested', accessor: 'timerequested', sortable: true },
    { header: 'Dispatch Time', accessor: 'dispatchtime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Zero-delay dispensing for ER / Trauma / Code Blue requirements.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ER Requests Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Dispatch TAT</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>2 mins</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Stock Replaced</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>20</p>
        </div>
      </div>
