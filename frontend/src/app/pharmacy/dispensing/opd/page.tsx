...
export default function OPDDispensingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Token No', accessor: 'tokenno', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Prescription ID', accessor: 'prescriptionid', sortable: true },
    { header: 'Items Dispensed', accessor: 'itemsdispensed', sortable: true },
    { header: 'Billed Amount', accessor: 'billedamount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Fast-track dispensing for outpatients and walk-in pharmacy customers.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">OPD Patients Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>210</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Service Time</p>
