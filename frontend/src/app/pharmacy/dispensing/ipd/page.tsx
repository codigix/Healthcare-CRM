...
export default function IPDDispensingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Ward/Bed', accessor: 'wardbed', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Order Type', accessor: 'ordertype', sortable: true },
    { header: 'Indent ID', accessor: 'indentid', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Ward orders, stat doses, and daily medication cart fills for admitted patients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Indents</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>18</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">STAT Orders</p>
