            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-dark-tertiary">
                  ...
                  <th className="text-left py-4 px-4 text-gray-400 font-medium text-sm">Prescription Ref</th>
                  ...
                  <th className="text-right py-4 px-4 text-gray-400 font-medium text-sm">Paid Amount</th>
                  <th className="text-right py-4 px-4 text-gray-400 font-medium text-sm">Remaining</th>
              ...
              <tbody>
                {filteredBills.map((bill) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-4 text-[#1abc9c] font-semibold font-mono">{bill.prescriptionId}</td>
                    ...
                    <td className="py-4 px-4 text-right text-emerald-400 font-bold">₹{bill.paidAmount.toFixed(2)}</td>
                    <td className="py-4 px-4 text-right text-amber-500 font-bold">₹{bill.remainingAmount.toFixed(2)}</td>
                    ...
                    <td className="py-4 px-4 text-center">
                      <div className="flex justify-center gap-2">
                        ...
                        <button
                          ...
                          className="p-2 bg-white/5 border border-white/5 rounded hover:bg-emerald-500/20 hover:text-emerald-500 transition-colors"
                        >
                          <Download size={16} />
                        </button>
                      </div>
          ...
          <div className="bg-[#1e1f27] border border-white/10 rounded-2xl p-6 w-full max-w-2xl relative animate-scaleUp max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm mb-4">
              ...
              <div className="flex justify-between items-center p-3 bg-white/5 border border-white/5 rounded-xl">
                ...
                <span className="text-[#1abc9c] font-bold font-mono">{selectedBill.prescriptionId}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-white/5 border border-white/5 rounded-xl">
              ...
              <div className="flex justify-between items-center p-3 bg-white/5 border border-white/5 rounded-xl">
                ...
                <span className="text-[#1abc9c] font-bold">₹{selectedBill.totalAmount.toFixed(2)}</span>
              </div>
              ...
              <div className="md:col-span-2 p-3 bg-white/5 border border-white/5 rounded-xl">
                <span className="text-gray-400 block mb-1 text-xs font-bold uppercase tracking-wider">Billing Notes</span>
            ...
            {selectedBill.paymentStatus !== "Paid" && (
              <div className="mt-4 p-4 bg-white/5 rounded-xl border border-white/5 space-y-3">
                ...
                <button
                  ...
                  className="btn-primary w-full py-2.5 px-4 text-xs font-bold flex items-center justify-center gap-2 rounded-xl transition-all shadow-lg"
                >
