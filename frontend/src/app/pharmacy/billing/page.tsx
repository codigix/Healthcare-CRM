...
export default function PharmacyBillingPage() {
 ...
 className="p-1 hover:bg-card/5 rounded-lg text-gray-400 hover:text-white transition-colors"
 title="Close Receipt"
 >
 <X size={20} />
 </button>
 ...
 <div className="flex justify-between items-center p-3 bg-card/5 border border-white/5 rounded-xl">
