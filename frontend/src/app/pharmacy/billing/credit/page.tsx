...
export default function CreditManagementPage() {
  ...
  const columns = [
    { header: 'Patient/Staff Name', accessor: 'patientstaffname', sortable: true },
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Credit Limit', accessor: 'creditlimit', sortable: true },
    { header: 'Outstanding Dues', accessor: 'outstandingdues', sortable: true },
    { header: 'Last Paid Date', accessor: 'lastpaiddate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monitoring partial payments, pending dues, and staff credit limits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Staff Credit</p>
