...
export default function DirectPharmacyBillingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Bill ID', accessor: 'billid', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Point of sale billing for cash/card paying OPD and walk-in patients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bills Today</p>
