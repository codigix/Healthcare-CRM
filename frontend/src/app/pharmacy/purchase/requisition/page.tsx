...
export default function PurchaseRequisitionPage() {
  ...
  const columns = [
    { header: 'PR ID', accessor: 'prid', sortable: true },
    { header: 'Item Name', accessor: 'itemname', sortable: true },
    { header: 'Requested Qty', accessor: 'requestedqty', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Internal requests generated based on reorder levels or special demands.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending PRs</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Converted to PO</p>
