...
export default function DiscountRulesPage() {
  ...
  const columns = [
    ...
    { header: 'Discount %', accessor: 'discount', sortable: true },
    { header: 'Max Limit', accessor: 'maxlimit', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configure automatic discounts for staff, senior citizens, or specific item categories.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Discount Given</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Discount (MTD)</p>
