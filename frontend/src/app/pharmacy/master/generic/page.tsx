...
export default function GenericMedicinesPage() {
  ...
  const columns = [
    { header: 'Generic ID', accessor: 'genericid', sortable: true },
    { header: 'Salt Name', accessor: 'saltname', sortable: true },
    { header: 'Therapeutic Class', accessor: 'therapeuticclass', sortable: true },
    { header: 'Pregnancy Category', accessor: 'pregnancycategory', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Directory of active pharmaceutical ingredients (APIs) and salts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Generics</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,450</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Schedule H1</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">OTC Generics</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>300</p>
        </div>
      </div>
