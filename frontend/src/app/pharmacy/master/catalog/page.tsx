...
export default function MedicineCatalogPage() {
  ...
  const columns = [
    ...
    { header: 'Generic Group', accessor: 'genericgroup', sortable: true },
    { header: 'Formulation', accessor: 'formulation', sortable: true },
    { header: 'MRP', accessor: 'mrp', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Master database of all drugs, consumables, and surgical items.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Items</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>11,800</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inactive</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>700</p>
        </div>
      </div>
