...
export default function ControlledDrugReturnsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Return ID', accessor: 'returnid', sortable: true },
    { header: 'Drug Name', accessor: 'drugname', sortable: true },
    { header: 'Empty Ampoules', accessor: 'emptyampoules', sortable: true },
    { header: 'Unused Qty', accessor: 'unusedqty', sortable: true },
    { header: 'Returned By', accessor: 'returnedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Controlled Drug Returns
          </h1>
          <p className="text-sm text-gray-400 mt-1">Logging empty ampoules or unused partial doses returned from wards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Returns Pending Verification</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Verified & Destroyed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missing Ampoules</p>
