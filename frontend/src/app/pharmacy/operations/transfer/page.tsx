...
export default function InterstoreTransfersPage() {
  ...
  const columns = [
    ...
    { header: 'From Store', accessor: 'fromstore', sortable: true },
    { header: 'To Store', accessor: 'tostore', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Moving stock from the main pharmacy store to sub-stores or ward stocks.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Transit Discrepancy</p>
