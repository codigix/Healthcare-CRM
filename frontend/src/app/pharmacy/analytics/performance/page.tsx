...
export default function PharmacyPerformancePage() {
  ...
  const columns = [
    ...
    { header: 'YTD Average', accessor: 'ytdaverage', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Executive dashboard tracking revenue, profit margins, and operational KPIs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revenue Target</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Achieved</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inventory Turnover</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12x</p>
        </div>
      </div>
