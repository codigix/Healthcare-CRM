...
export default function FastMovingGoodsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Medicine Name', accessor: 'medicinename', sortable: true },
    { header: 'Daily Avg Consumption', accessor: 'dailyavgconsumption', sortable: true },
    { header: 'Current Stock', accessor: 'currentstock', sortable: true },
    { header: 'Days of Stock Left', accessor: 'daysofstockleft', sortable: true },
    { header: 'Reorder Suggestion', accessor: 'reordersuggestion', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analysis of high-turnover medicines to optimize reorder levels and prevent stockouts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fast Moving Items</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Stockouts Averted</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Urgent Reorders</p>
