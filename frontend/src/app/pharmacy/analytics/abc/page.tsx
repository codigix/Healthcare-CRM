...
export default function ABCAnalysisPage() {
  ...
  const columns = [
    ...
    { header: '% of Total Items', accessor: 'oftotalitems', sortable: true },
    { header: 'Consumption Value', accessor: 'consumptionvalue', sortable: true },
    { header: '% of Total Value', accessor: 'oftotalvalue', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Categorizing inventory by consumption value (A=High, B=Medium, C=Low Value).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">A-Class Items</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>15%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">A-Class Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>70%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">C-Class Items</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>55%</p>
        </div>
      </div>
