...
export default function CurrentStockPage() {
  ...
  const columns = [
    ...
    { header: 'Stock Qty', accessor: 'stockqty', sortable: true },
    { header: 'Unit Location', accessor: 'unitlocation', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Real-time master view of all medicines available in the main pharmacy.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Value of Stock</p>
