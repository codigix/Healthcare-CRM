    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl ">IPD Medicine Supply</h1>
      ...
      <div className="card space-y-6">
        <div className="flex justify-between items-center my-3 my-3 pb-4 border-b border-white/5">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl  text-white">Inpatient (IPD) Medicine Supply Logs</h2>
          </div>
          <button
        ...
        {historyLoading ? (
          ...
          <div className="overflow-x-auto">
            <DataTable columns={columns_0} data={completedSupplies} enableLocalSearch enableLocalPagination />
          </div>
        )}
      </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-card/5 p-4 rounded-xl border border-white/5">
                <div>
                  ...
                  <span className="text-white  text-sm block mt-1">{selectedSupply.patient?.name || "Admitted Patient"}</span>
                ...
                <div>
                  ...
                  <span className="text-blue-400  text-sm block mt-1">IPD Admission</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-[#181920]/50 p-4 rounded-xl border border-white/5">
                  <span className="text-amber-400  text-xs uppercase tracking-wider block">Special Instructions</span>
              ...
              <div className="space-y-2">
                ...
                <div className="border border-white/5 rounded-xl overflow-hidden bg-card/[0.01]">
                  <DataTable columns={columns_1} data={getMedicationsList(selectedSupply.medications)} enableLocalSearch enableLocalPagination />
                </div>
              </div>
            </div>
