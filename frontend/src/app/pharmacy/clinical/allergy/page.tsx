...
export default function AllergyAlertsPage() {
  ...
  const columns = [
    ...
    { header: 'Allergen', accessor: 'allergen', sortable: true },
    { header: 'Prescribed Drug', accessor: 'prescribeddrug', sortable: true },
    { header: 'Reaction Type', accessor: 'reactiontype', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Alerts when a prescribed drug conflicts with a patient's known allergies.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Allergy Alerts (Month)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Prescriptions Stopped</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>40</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Anaphylaxis Risk</p>
