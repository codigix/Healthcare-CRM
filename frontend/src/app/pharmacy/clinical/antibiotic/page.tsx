...
export default function AntibioticStewardshipPage() {
  ...
  const columns = [
    ...
    { header: 'Restricted Antibiotic', accessor: 'restrictedantibiotic', sortable: true },
    { header: 'Days on Drug', accessor: 'daysondrug', sortable: true },
    { header: 'Culture Result', accessor: 'cultureresult', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monitoring restricted antibiotics, culture sensitivities, and de-escalation.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Patients on Reserve Abx</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>18</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">De-escalated Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Culture</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>6</p>
        </div>
      </div>
