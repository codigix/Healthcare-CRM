    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Medicine Usage Reports</h1>
        ...
        >
          <RefreshCw size={18} /> Refresh Reports
        </button>
      </div>
      ...
      {loading ? (
        ...
        <>
            ...
            <div className="card border-l-4 border-teal-500 hover:translate-y-[-2px] transition-transform">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-white mt-1">{totalDispensed.toLocaleString()} Units</h3>
            ...
            <div className="card border-l-4 border-blue-500 hover:translate-y-[-2px] transition-transform">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-white mt-1">{activePrescriptions} Prescriptions</h3>
            ...
            <div className="card border-l-4 border-purple-500 hover:translate-y-[-2px] transition-transform">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-white mt-1">{usageItems.length} Registered</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="card">
              <h3 className="text-lg font-bold text-white mb-4">Dispensation Volume Trends</h3>
            ...
            <div className="card">
              <h3 className="text-lg font-bold text-white mb-4">Top 5 Dispensed Medicine Categories</h3>
              <div className="h-[240px]">
                <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="card">
            <h3 className="text-lg font-bold text-white mb-6">Medication Usage Audit Log</h3>
                ...
                <tbody>
                  {usageItems.map((u) => (
                    <tr key={u.name} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                      ...
                      <td className="py-3.5 px-4 text-gray-300 italic">{u.genericName}</td>
                      <td className="py-3.5 px-4 text-gray-300">{u.category}</td>
                      <td className="py-3.5 px-4 text-center text-teal-400 font-bold">{u.dispensedCount} Units</td>
                      <td className="py-3.5 px-4 text-center text-gray-300 font-semibold">{u.remainingStock} Units</td>
                  ...
                  {usageItems.length === 0 && (
                    <tr>
                      <td colSpan={6} className="py-12 text-center text-gray-500">No clinically dispensed drug audits found in the usage ledger.</td>
                    </tr>
                  )}
                </tbody>
              </table>
