...
export default function DispensingEfficiencyReportPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Pharmacist', accessor: 'pharmacist', sortable: true },
    { header: 'Prescriptions Dispensed', accessor: 'prescriptionsdispensed', sortable: true },
    { header: 'Avg Turnaround', accessor: 'avgturnaround', sortable: true },
    { header: 'Errors Caught', accessor: 'errorscaught', sortable: true },
    { header: 'Patient Rating', accessor: 'patientrating', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Dispensing Efficiency Report
          </h1>
          <p className="text-sm text-gray-400 mt-1">Metrics on prescription wait times, pharmacist workload, and dispensing errors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>6.5 mins</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Prescriptions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12,450</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Near-miss Errors</p>
