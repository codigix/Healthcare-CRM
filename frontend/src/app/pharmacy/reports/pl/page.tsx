...
export default function PharmacyPLStatementPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Month', accessor: 'month', sortable: true },
    { header: 'Gross Revenue', accessor: 'grossrevenue', sortable: true },
    { header: 'Cost of Goods Sold (COGS)', accessor: 'costofgoodssoldcogs', sortable: true },
    { header: 'Operating Expenses', accessor: 'operatingexpenses', sortable: true },
    { header: 'Net Profit', accessor: 'netprofit', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Pharmacy P&L Statement
          </h1>
          <p className="text-sm text-gray-400 mt-1">Overall Profit and Loss statement for the pharmacy department.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Net Profit Margin</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>28.4%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revenue Growth</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>+4.2%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">OpEx Ratio</p>
