...
export default function StockValuationReportPage() {
  ...
  const columns = [
    ...
    { header: 'Current Qty', accessor: 'currentqty', sortable: true },
    { header: 'Purchase Value', accessor: 'purchasevalue', sortable: true },
    { header: 'MRP Value', accessor: 'mrpvalue', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Financial valuation of current inventory based on purchase price and MRP.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Purchase Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$450,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total MRP Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$680,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Projected Profit</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$230,000</p>
        </div>
      </div>
