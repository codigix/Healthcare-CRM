      ...
      <>
         <div className="space-y-6">
            <div className="flex items-center gap-4">
               ...
               <div>
                  <h1 className="text-3xl  mb-2">Create Prescription</h1>
            ...
            <form onSubmit={handleSubmit} className="w-full">
               <div className="card p-6 md:p-8 space-y-8">
                  ...
                  <div className="space-y-6">
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="relative" ref={patientDropdownRef}>
                           ...
                           {showPatientDropdown && (
                              <div className="absolute z-20 w-full left-0 mt-1 bg-dark-secondary border border-dark-tertiary rounded shadow-lg max-h-60 overflow-y-auto">
                                 {filteredPatients.length > 0 ? (
                                    filteredPatients.map((patient) => (
                                       <div
                                          key={patient.id}
                                          onClick={() => handlePatientSelect(patient)}
                                          className={`p-2 hover:bg-dark-tertiary cursor-pointer border-b border-dark-tertiary last:border-0 transition-colors flex items-center justify-between ${formData.patientId === patient.id ? "bg-emerald-500/10 text-emerald-400" : ""
                                             }`}
                                       >
                                          <div>
                                          ...
                                          {formData.patientId === patient.id && (
                                             <div className="text-emerald-500  text-sm">Selected</div>
                                          )}
                                       </div>
                                    ))
                                 ) : (
                                 ...
                                 {filteredDoctors.length > 0 ? (
                                    filteredDoctors.map((doctor) => (
                                       <div
                                          ...
                                          className={`p-2 hover:bg-dark-tertiary cursor-pointer border-b border-dark-tertiary last:border-0 transition-colors flex items-center justify-between ${selectedDoctor?.id === doctor.id ? "bg-emerald-500/10 text-emerald-400" : ""
                                             }`}
                                       >
                                          <div>
                     ...
                     {selectedPatient && (
                        <div className="p-4 bg-dark-secondary rounded border border-dark-tertiary">
                           <div className="flex items-center gap-2 mb-3 pb-2 border-b border-dark-tertiary">
                              {((selectedPatient.allergies && selectedPatient.allergies.length > 0) ||
                                 ...
                                 <>
                                    <ShieldAlert className="text-red-400 animate-pulse" size={15} />
                  ...
                  <div className="space-y-6">
                     ...
                     <div className="bg-dark-secondary p-5 rounded border border-dark-tertiary space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                           ...
                           {/* Allow Refills */}
                           <div className="flex items-center gap-4 bg-dark-tertiary/20 p-3 rounded border border-dark-tertiary">
                     ...
                     <div className="mt-6 border border-dark-tertiary rounded overflow-hidden bg-dark-secondary">
                        <div className="p-2 bg-dark-tertiary/30 border-b border-dark-tertiary flex items-center justify-between">
                  ...
                  <div className="space-y-6">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* Format Options */}
                        <div className="p-4 bg-dark-secondary rounded border border-dark-tertiary space-y-4">
