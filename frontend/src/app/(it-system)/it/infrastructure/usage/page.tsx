...
export default function CPURAMUsagePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Server Name', accessor: 'servername', sortable: true },
    { header: 'CPU Load', accessor: 'cpuload', sortable: true },
    { header: 'RAM Usage', accessor: 'ramusage', sortable: true },
    { header: 'Top Process', accessor: 'topprocess', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Real-time and historical resource utilization across infrastructure.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg CPU Load</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Servers >80% RAM</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Process Bottlenecks</p>
