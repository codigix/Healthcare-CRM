...
export default function InternetStatusPage() {
  ...
  const columns = [
    { header: 'ISP Link', accessor: 'isplink', sortable: true },
    { header: 'Bandwidth', accessor: 'bandwidth', sortable: true },
    { header: 'Current Load', accessor: 'currentload', sortable: true },
    { header: 'Latency', accessor: 'latency', sortable: true },
    { header: 'Failover Status', accessor: 'failoverstatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">ISP link monitoring, failover status, and bandwidth utilization.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Primary Link</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Active</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Bandwidth</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1 Gbps</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Uptime (Mo)</p>
