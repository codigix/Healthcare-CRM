...
export default function WebServerStatusPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Server', accessor: 'server', sortable: true },
    { header: 'Active Conns', accessor: 'activeconns', sortable: true },
    { header: 'Requests/Sec', accessor: 'requestssec', sortable: true },
    { header: '5xx Errors', accessor: '5xxerrors', sortable: true },
    { header: 'SSL Expiry', accessor: 'sslexpiry', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">NGINX/Apache metrics, active connections, and SSL validity.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Global Requests/s</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SSL Expiring</p>
