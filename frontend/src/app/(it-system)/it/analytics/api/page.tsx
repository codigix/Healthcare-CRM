...
export default function APIAnalyticsPage() {
  ...
  const columns = [
    { header: 'API Service', accessor: 'apiservice', sortable: true },
    { header: 'Cost (Mo)', accessor: 'costmo', sortable: true },
    { header: 'Value Generated', accessor: 'valuegenerated', sortable: true },
    { header: 'Cost/Call', accessor: 'costcall', sortable: true },
    { header: 'Optimization', accessor: 'optimization', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Cost analysis of external API usage (e.g., SMS costs vs Patient show rates).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total API Spend</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$4,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ROI Metrics</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Positive</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inefficient APIs</p>
