...
export default function InfrastructureDashboardPage() {
  ...
  const columns = [
    { header: 'Node/Server', accessor: 'nodeserver', sortable: true },
    { header: 'Avg CPU (7d)', accessor: 'avgcpu7d', sortable: true },
    { header: 'Peak CPU', accessor: 'peakcpu', sortable: true },
    { header: 'Memory Trend', accessor: 'memorytrend', sortable: true },
    { header: 'Disk I/O', accessor: 'diskio', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Visual graphs of CPU, RAM, and Disk trends over time.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Infra Utilization</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>65%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cost Optimization</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Good</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Nodes Overloaded</p>
