...
export default function SecurityAnalyticsPage() {
  ...
  const columns = [
    { header: 'Threat Source', accessor: 'threatsource', sortable: true },
    { header: 'Attack Vector', accessor: 'attackvector', sortable: true },
    { header: 'Events (7d)', accessor: 'events7d', sortable: true },
    { header: 'Severity Trend', accessor: 'severitytrend', sortable: true },
    { header: 'Mitigation', accessor: 'mitigation', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Geographic map of blocked IPs and vulnerability trend lines.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Attacks Blocked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12.4k</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Source Country</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Russia/China</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Malware Found</p>
