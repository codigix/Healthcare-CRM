...
export default function UserAnalyticsPage() {
  ...
  const columns = [
    ...
    { header: 'Active Users', accessor: 'activeusers', sortable: true },
    { header: 'Transactions/Sec', accessor: 'transactionssec', sortable: true },
    { header: 'Most Active Dept', accessor: 'mostactivedept', sortable: true },
    { header: 'Concurrent Max', accessor: 'concurrentmax', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Identifying peak usage hours to schedule maintenance windows.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>10:00 - 11:00 AM</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Max Concurrent</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1,250</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Night Shift Users</p>
