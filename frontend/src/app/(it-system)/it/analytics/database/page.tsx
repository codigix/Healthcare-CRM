...
export default function DatabaseAnalyticsPage() {
  ...
  const columns = [
    { header: 'Data Entity', accessor: 'dataentity', sortable: true },
    { header: 'Current Size', accessor: 'currentsize', sortable: true },
    { header: 'Growth Rate (Mo)', accessor: 'growthratemo', sortable: true },
    { header: '1 Year Forecast', accessor: '1yearforecast', sortable: true },
    { header: 'Archive Strategy', accessor: 'archivestrategy', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Data growth forecasting to plan storage procurement.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">DB Size Forecast (1y)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>6.5 TB</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Storage Needed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>+2 TB</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Budget Impact</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$2,400</p>
        </div>
      </div>
