...
export default function BackupVerificationPage() {
  ...
  const columns = [
    { header: 'Verification ID', accessor: 'verificationid', sortable: true },
    { header: 'Backup File', accessor: 'backupfile', sortable: true },
    { header: 'Checksum Status', accessor: 'checksumstatus', sortable: true },
    { header: 'Mount Test', accessor: 'mounttest', sortable: true },
    { header: 'Tested On', accessor: 'testedon', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Automated checks to ensure backup files are not corrupt and can be mounted.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Backups Verified</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>120/120</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Corrupt Files</p>
          <p className={"text-2xl font-bold mt-2 " + "text-green-500"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Verification Coverage</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>100%</p>
        </div>
      </div>
