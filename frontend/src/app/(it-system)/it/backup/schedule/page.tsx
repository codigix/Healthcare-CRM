...
export default function BackupSchedulePage() {
  ...
  const columns = [
    ...
    { header: 'Retention (Days)', accessor: 'retentiondays', sortable: true },
    { header: 'Storage Tier', accessor: 'storagetier', sortable: true },
    { header: 'Associated Jobs', accessor: 'associatedjobs', sortable: true },
    { header: 'Cost Est.', accessor: 'costest', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configuration matrix for GFS (Grandfather-Father-Son) backup retention policies.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Policies</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Storage Cost (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$1,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cold Storage Data</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45 TB</p>
        </div>
      </div>
