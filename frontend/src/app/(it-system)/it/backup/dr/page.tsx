...
export default function DisasterRecoveryPage() {
  ...
  const columns = [
    { header: 'DR Site', accessor: 'drsite', sortable: true },
    { header: 'Sync Status', accessor: 'syncstatus', sortable: true },
    { header: 'RPO Lag', accessor: 'rpolag', sortable: true },
    { header: 'Last Failover Test', accessor: 'lastfailovertest', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">DR drill logs, RTO/RPO metrics, and failover site status.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Current RPO</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>15 Mins</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Target RPO</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>30 Mins</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">DR Drills (YTD)</p>
