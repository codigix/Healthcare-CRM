...
export default function RestoreBackupPage() {
  ...
  const columns = [
    ...
    { header: 'Target Server', accessor: 'targetserver', sortable: true },
    { header: 'Backup Date', accessor: 'backupdate', sortable: true },
    { header: 'Requested By', accessor: 'requestedby', sortable: true },
    { header: 'Completion', accessor: 'completion', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logs and test workflows for file or server restorations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Files Restored (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Full Server Restore</p>
