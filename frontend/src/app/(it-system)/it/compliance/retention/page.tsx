...
export default function DataRetentionPage() {
  ...
  const columns = [
    { header: 'Data Category', accessor: 'datacategory', sortable: true },
    { header: 'Retention Policy', accessor: 'retentionpolicy', sortable: true },
    { header: 'Storage Tier', accessor: 'storagetier', sortable: true },
    { header: 'Last Purge Date', accessor: 'lastpurgedate', sortable: true },
    { header: 'Bytes Purged', accessor: 'bytespurged', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Rules for archiving EMR > 7 years and purging logs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Archived Data</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45 TB</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Purged (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>2.5 TB</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Storage Saved</p>
