...
export default function FailedLoginAttemptsPage() {
  ...
  const columns = [
    ...
    { header: 'Target System', accessor: 'targetsystem', sortable: true },
    { header: 'Attempt Count', accessor: 'attemptcount', sortable: true },
    { header: 'Lockout Triggered', accessor: 'lockouttriggered', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Audit trail of brute-force attempts on ERP, VPN, or Web portals.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Failed Logins (24h)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>124</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Accounts Locked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unique Attack IPs</p>
