...
export default function SecurityPoliciesPage() {
  ...
  const columns = [
    ...
    { header: 'Staff Acknowledged', accessor: 'staffacknowledged', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Documented ISO 27001 / HIPAA IT policies and staff acknowledgement tracking.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Policies</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Staff Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>85%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reviews Pending</p>
