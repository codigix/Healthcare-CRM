...
export default function AntivirusStatusPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Hostname', accessor: 'hostname', sortable: true },
    { header: 'Agent Version', accessor: 'agentversion', sortable: true },
    { header: 'Last Scan', accessor: 'lastscan', sortable: true },
    { header: 'Threats Found', accessor: 'threatsfound', sortable: true },
    { header: 'Defs Updated', accessor: 'defsupdated', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Centralized view of Endpoint Detection & Response (EDR) across all hospital PCs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Endpoints Protected</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Outdated Definitions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Threats Blocked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4 (Mo)</p>
        </div>
      </div>
