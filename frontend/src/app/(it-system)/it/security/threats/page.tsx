...
export default function ThreatDetectionPage() {
  ...
  const columns = [
    ...
    { header: 'Threat Type', accessor: 'threattype', sortable: true },
    { header: 'Severity', accessor: 'severity', sortable: true },
    { header: 'Target Asset', accessor: 'targetasset', sortable: true },
    { header: 'Detected Time', accessor: 'detectedtime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Intrusion Detection System (IDS) alerts for malware, ransomware, or phishing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Severity Alerts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-green-500"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Medium Severity</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Phishing Emails Blocked</p>
