...
export default function LISIntegrationPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Sync Type', accessor: 'synctype', sortable: true },
    { header: 'Orders Sent', accessor: 'orderssent', sortable: true },
    { header: 'Results Received', accessor: 'resultsreceived', sortable: true },
    { header: 'Pending Sync', accessor: 'pendingsync', sortable: true },
    { header: 'Last Error', accessor: 'lasterror', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Laboratory Information System (LIS) two-way sync for orders and results.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Orders Synced</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Results Synced</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Results</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>300</p>
        </div>
      </div>
