...
export default function ABDMABHAPage() {
  ...
  const columns = [
    ...
    { header: 'Total Calls', accessor: 'totalcalls', sortable: true },
    { header: 'Success Rate', accessor: 'successrate', sortable: true },
    { header: 'Avg Latency', accessor: 'avglatency', sortable: true },
    { header: 'Last Sync', accessor: 'lastsync', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Integration with India's Ayushman Bharat Digital Mission (ABDM) for health IDs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ABHA IDs Created</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>120 (Today)</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Records Linked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>450</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">API Gateway</p>
