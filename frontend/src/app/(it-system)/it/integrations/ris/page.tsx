...
export default function RISIntegrationPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Modality', accessor: 'modality', sortable: true },
    { header: 'Orders Sent', accessor: 'orderssent', sortable: true },
    { header: 'Reports Received', accessor: 'reportsreceived', sortable: true },
    { header: 'Queue Size', accessor: 'queuesize', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Radiology Information System (RIS) integration for imaging orders.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reports Finalized</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>400</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Turnaround Time</p>
