...
export default function PACSIntegrationPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Modality Node', accessor: 'modalitynode', sortable: true },
    { header: 'Studies Pushed', accessor: 'studiespushed', sortable: true },
    { header: 'Storage Used', accessor: 'storageused', sortable: true },
    { header: 'Viewer Active Conns', accessor: 'vieweractiveconns', sortable: true },
    { header: 'Last Ping', accessor: 'lastping', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Picture Archiving and Communication System (PACS) DICOM viewer links.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Studies (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>450</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Storage Growth</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>+12GB</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">PACS Gateway</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Online</p>
        </div>
      </div>
