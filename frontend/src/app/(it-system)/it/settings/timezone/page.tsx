...
export default function TimeZonePage() {
  ...
  const columns = [
    ...
    { header: 'Selected Value', accessor: 'selectedvalue', sortable: true },
    { header: 'System Default', accessor: 'systemdefault', sortable: true },
    { header: 'User Override', accessor: 'useroverride', sortable: true },
    { header: 'Impacts', accessor: 'impacts', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configuring server timezones and date formats for the HIS.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Default Timezone</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>UTC+5:30 (IST)</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Date Format</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>DD/MM/YYYY</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">NTP Sync Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Synced</p>
        </div>
      </div>
