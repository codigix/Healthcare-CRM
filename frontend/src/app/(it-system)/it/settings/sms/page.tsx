...
export default function SMSConfigurationPage() {
  ...
  const columns = [
    ...
    { header: 'Sender ID', accessor: 'senderid', sortable: true },
    { header: 'Route Type', accessor: 'routetype', sortable: true },
    { header: 'API Key Status', accessor: 'apikeystatus', sortable: true },
    { header: 'Test Message', accessor: 'testmessage', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">API endpoint, headers, and sender ID configurations for SMS vendors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Default Route</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Twilio</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fallback Route</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Gupshup</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">DLT Registered</p>
