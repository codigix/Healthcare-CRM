...
export default function GeneralSettingsPage() {
  ...
  const columns = [
    { header: 'Setting Key', accessor: 'settingkey', sortable: true },
    { header: 'Value', accessor: 'value', sortable: true },
    { header: 'Group', accessor: 'group', sortable: true },
    { header: 'Last Updated By', accessor: 'lastupdatedby', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Global configurations like Hospital Name, Logo, and default language.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">System Maintenance Mode</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>OFF</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unsaved Changes</p>
