...
export default function ModuleManagementPage() {
  ...
  const columns = [
    { header: 'Module Name', accessor: 'modulename', sortable: true },
    { header: 'License Type', accessor: 'licensetype', sortable: true },
    { header: 'Subscribed Users', accessor: 'subscribedusers', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Enabling/Disabling specific ERP modules (e.g., Telemedicine add-on).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SaaS Spend (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$4,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unused Modules</p>
