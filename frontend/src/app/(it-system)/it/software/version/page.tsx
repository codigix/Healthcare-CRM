...
export default function ERPVersionPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Module', accessor: 'module', sortable: true },
    { header: 'Current Version', accessor: 'currentversion', sortable: true },
    { header: 'Release Date', accessor: 'releasedate', sortable: true },
    { header: 'Critical Patch', accessor: 'criticalpatch', sortable: true },
    { header: 'Rollback Available', accessor: 'rollbackavailable', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking current software builds, release notes, and version history.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Core ERP Version</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>v4.5.1</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Last Update</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>15 Days Ago</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Updates Pending</p>
