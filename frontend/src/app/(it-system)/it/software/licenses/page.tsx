...
export default function LicenseManagementPage() {
  ...
  const columns = [
    { header: 'Software/Vendor', accessor: 'softwarevendor', sortable: true },
    { header: 'Total Licenses', accessor: 'totallicenses', sortable: true },
    { header: 'Allocated', accessor: 'allocated', sortable: true },
    { header: 'Cost/User', accessor: 'costuser', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking Microsoft, Antivirus, and specialized clinical software licenses.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Licenses</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Available Pool</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Renewal (30D)</p>
