...
export default function MultiFactorAuthenticationPage() {
  ...
  const columns = [
    ...
    { header: 'MFA Method', accessor: 'mfamethod', sortable: true },
    { header: 'Enrolled Date', accessor: 'enrolleddate', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Status of MFA adoption across the organization for secure access.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">MFA Enrolled</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>95%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Setup</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>45 Users</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">MFA Bypassed</p>
