...
export default function PasswordPolicyPage() {
  ...
  const columns = [
    { header: 'Policy Setting', accessor: 'policysetting', sortable: true },
    { header: 'Configured Value', accessor: 'configuredvalue', sortable: true },
    { header: 'Enforced Across', accessor: 'enforcedacross', sortable: true },
    { header: 'Exceptions', accessor: 'exceptions', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Enforcement of complex passwords, expiry cycles, and reset workflows.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Users Needs Reset</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Policy Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>98%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Self-Resets (Mo)</p>
