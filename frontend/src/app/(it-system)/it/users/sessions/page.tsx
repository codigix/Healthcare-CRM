...
export default function SessionManagementPage() {
  ...
  const columns = [
    ...
    { header: 'Idle Timeout', accessor: 'idletimeout', sortable: true },
    { header: 'Max Concurrent', accessor: 'maxconcurrent', sortable: true },
    { header: 'Token Expiry', accessor: 'tokenexpiry', sortable: true },
    { header: 'Last Audited', accessor: 'lastaudited', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Timeout configurations and concurrent login limits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Session Length</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4 Hrs</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Terminated (Timeout)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>120/day</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Concurrent Blocks</p>
