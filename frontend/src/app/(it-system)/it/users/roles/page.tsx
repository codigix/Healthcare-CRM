...
export default function RolesPermissionsPage() {
  ...
  const columns = [
    { header: 'Role Name', accessor: 'rolename', sortable: true },
    { header: 'Modules Accessible', accessor: 'modulesaccessible', sortable: true },
    { header: 'Total Permissions', accessor: 'totalpermissions', sortable: true },
    { header: 'Users Assigned', accessor: 'usersassigned', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Granular access control matrices defining what modules users can view or edit.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Configured Roles</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>34</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Admin Roles</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Last Audited</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>10 Days Ago</p>
        </div>
      </div>
