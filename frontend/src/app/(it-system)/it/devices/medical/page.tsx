...
export default function MedicalDevicesIoTPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Device MAC', accessor: 'devicemac', sortable: true },
    { header: 'Modality/Type', accessor: 'modalitytype', sortable: true },
    { header: 'Ward', accessor: 'ward', sortable: true },
    { header: 'Integration Status', accessor: 'integrationstatus', sortable: true },
    { header: 'Data Packets', accessor: 'datapackets', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Network-connected clinical devices (Monitors, Ventilators) sending data to HIS.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Connected Devices</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>450</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Data Syncing</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>445</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
