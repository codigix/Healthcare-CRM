...
export default function DesktopManagementPage() {
  ...
  const columns = [
    ...
    { header: 'OS Version', accessor: 'osversion', sortable: true },
    { header: 'Last Seen', accessor: 'lastseen', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Inventory of PCs, MAC addresses, OS versions, and assigned departments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Desktops</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Online Now</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>720</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Needs OS Update</p>
