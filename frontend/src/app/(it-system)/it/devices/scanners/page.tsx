...
export default function BarcodeScannersPage() {
  ...
  const columns = [
    { header: 'Scanner ID', accessor: 'scannerid', sortable: true },
    { header: 'Type (Wired/BT)', accessor: 'typewiredbt', sortable: true },
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Associated PC', accessor: 'associatedpc', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Pharmacy and lab barcode scanners tracking.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Scanners</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>240</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Faulty</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Battery Low (BT)</p>
