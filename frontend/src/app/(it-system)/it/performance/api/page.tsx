...
export default function APIPerformancePage() {
  ...
  const columns = [
    { header: 'External API', accessor: 'externalapi', sortable: true },
    { header: 'P90 Latency', accessor: 'p90latency', sortable: true },
    { header: 'Timeout Ratio', accessor: 'timeoutratio', sortable: true },
    { header: 'Circuit Breaker', accessor: 'circuitbreaker', sortable: true },
    { header: 'Last Incident', accessor: 'lastincident', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Latency tracking for external integrations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">External Avg</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>240ms</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Timeouts (1h)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Breakers Open</p>
