...
export default function UserSessionsPage() {
  ...
  const columns = [
    { header: 'User Session', accessor: 'usersession', sortable: true },
    { header: 'Browser', accessor: 'browser', sortable: true },
    { header: 'Client Memory', accessor: 'clientmemory', sortable: true },
    { header: 'DOM Nodes', accessor: 'domnodes', sortable: true },
    { header: 'JS Heap Size', accessor: 'jsheapsize', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Resource utilization per active user session (Memory leaks in browser apps).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Client Mem</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>120 MB</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Crashes Reported</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Clients</p>
