...
export default function EmailNotificationsPage() {
  ...
  const columns = [
    ...
    { header: 'Provider Response', accessor: 'providerresponse', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monitoring outbound system emails (e.g., Reports, Resets).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Emails Sent (24h)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>14.5k</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bounced</p>
