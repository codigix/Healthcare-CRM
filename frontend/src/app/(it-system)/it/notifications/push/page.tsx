...
export default function PushNotificationsPage() {
  ...
  const columns = [
    { header: 'Push ID', accessor: 'pushid', sortable: true },
    { header: 'Target Device', accessor: 'targetdevice', sortable: true },
    { header: 'Payload Title', accessor: 'payloadtitle', sortable: true },
    { header: 'Sent Time', accessor: 'senttime', sortable: true },
    { header: 'Interaction', accessor: 'interaction', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">FCM/APNS logs for hospital mobile app push alerts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Push Sent (24h)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45k</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Open Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unsubscribed</p>
