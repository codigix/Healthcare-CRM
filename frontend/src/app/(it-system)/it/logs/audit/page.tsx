    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Immutable trails of who changed what data (e.g., deleted a bill, edited an EMR).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Logs (24h)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>145k</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical Actions</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Storage Size</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45 GB</p>
        </div>
      </div>
