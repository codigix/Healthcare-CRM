...
export default function ActivityLogsPage() {
  ...
  const columns = [
    ...
    { header: 'Page Visited', accessor: 'pagevisited', sortable: true },
    { header: 'Time Spent', accessor: 'timespent', sortable: true },
    { header: 'Action Flow', accessor: 'actionflow', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">General usage telemetry (clicks, page views) for UX analytics.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Page Views (24h)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45k</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Most Used Module</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>OPD Queue</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Session</p>
