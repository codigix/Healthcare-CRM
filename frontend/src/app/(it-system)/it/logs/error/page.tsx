...
export default function ErrorLogsPage() {
  ...
  const columns = [
    ...
    { header: 'Error Level', accessor: 'errorlevel', sortable: true },
    { header: 'Service', accessor: 'service', sortable: true },
    { header: 'Error Message', accessor: 'errormessage', sortable: true },
    { header: 'Occurrence', accessor: 'occurrence', sortable: true },
    {
      header: 'Action',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Application crashes, unhandled exceptions, and stack traces.</p>
        </div>
