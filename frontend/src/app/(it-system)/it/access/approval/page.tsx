...
export default function ApprovalMatrixPage() {
  ...
  const columns = [
    ...
    { header: 'L1 Approver', accessor: 'l1approver', sortable: true },
    { header: 'L2 Approver', accessor: 'l2approver', sortable: true },
    { header: 'SLA', accessor: 'sla', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Defining who can approve access requests for sensitive modules (e.g., EMR).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Configured Workflows</p>
