...
export default function AccessRequestsPage() {
  ...
  const columns = [
    ...
    { header: 'Requested Access', accessor: 'requestedaccess', sortable: true },
    { header: 'Justification', accessor: 'justification', sortable: true },
    { header: 'Pending With', accessor: 'pendingwith', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Ticketing system for users requesting new software permissions or module access.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Open Requests</p>
