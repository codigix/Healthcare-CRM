    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">System availability and response time reporting for management.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Performance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Excellent</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Downtime (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12 Mins</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">User Complaints</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Down 15%</p>
        </div>
      </div>
