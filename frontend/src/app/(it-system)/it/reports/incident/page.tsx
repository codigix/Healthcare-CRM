...
export default function IncidentReportPage() {
  ...
  const columns = [
    ...
    { header: 'Tickets Raised', accessor: 'ticketsraised', sortable: true },
    { header: 'Resolved', accessor: 'resolved', sortable: true },
    { header: 'SLA Breaches', accessor: 'slabreaches', sortable: true },
    { header: 'Avg Resolution', accessor: 'avgresolution', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">SLA reporting for helpdesk ticket resolution times.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Escalations</p>
