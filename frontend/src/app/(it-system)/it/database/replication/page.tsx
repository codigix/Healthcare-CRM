...
export default function ReplicationStatusPage() {
  ...
  const columns = [
    { header: 'Replica Node', accessor: 'replicanode', sortable: true },
    { header: 'Sync Type', accessor: 'synctype', sortable: true },
    { header: 'Replication Lag', accessor: 'replicationlag', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monitoring sync lag between Master and High Availability (HA) read-replicas.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Max Lag</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0.2s</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Replicas</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Replication Errors</p>
