...
export default function DatabaseRestorePage() {
  ...
  const columns = [
    { header: 'Restore ID', accessor: 'restoreid', sortable: true },
    { header: 'Target Env', accessor: 'targetenv', sortable: true },
    { header: 'Source Backup', accessor: 'sourcebackup', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Audited workflows for restoring databases to sandbox/staging or production rollback.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Restores (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Restore Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>2.5 Hrs</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Prod Rollbacks</p>
