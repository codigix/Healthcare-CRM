...
export default function DatabaseLogsPage() {
  ...
  const columns = [
    ...
    { header: 'Log Level', accessor: 'loglevel', sortable: true },
    { header: 'Message', accessor: 'message', sortable: true },
    { header: 'User/Process', accessor: 'userprocess', sortable: true },
    { header: 'Database', accessor: 'database', sortable: true },
    {
      header: 'Action',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Error logs, slow query logs, and audit logs of database configuration changes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Errors (24h)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fatal Errors</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Log Size (Day)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1.2 GB</p>
        </div>
      </div>
