...
export default function DatabaseDashboardPage() {
  ...
  const columns = [
    { header: 'Cluster', accessor: 'cluster', sortable: true },
    { header: 'Role', accessor: 'role', sortable: true },
    { header: 'QPS', accessor: 'qps', sortable: true },
    { header: 'Connections', accessor: 'connections', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">High-level metrics of database clusters, queries/sec, and storage.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Queries/s</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Conns</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Slow Queries</p>
