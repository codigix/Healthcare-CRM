...
export default function ProblemManagementPage() {
  ...
  const columns = [
    { header: 'Problem ID', accessor: 'problemid', sortable: true },
    { header: 'Linked Tickets', accessor: 'linkedtickets', sortable: true },
    { header: 'Description', accessor: 'description', sortable: true },
    { header: 'Workaround', accessor: 'workaround', sortable: true },
    { header: 'Target Fix Date', accessor: 'targetfixdate', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Identifying underlying problems behind recurring tickets (e.g., Network drop in Ward A).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Open Problems</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Tickets Linked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Known Errors</p>
