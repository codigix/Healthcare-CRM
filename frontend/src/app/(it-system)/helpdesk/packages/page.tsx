...
export default function HealthPackagesPage() {
  ...
  const columns = [
    { header: 'Package ID', accessor: 'packageid', sortable: true },
    { header: 'Package Name', accessor: 'packagename', sortable: true },
    { header: 'Target Demo', accessor: 'targetdemo', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage health checkup packages and promotional offers.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bookings Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Revenue Generated</p>
