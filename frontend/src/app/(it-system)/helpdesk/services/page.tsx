...
export default function HospitalServicesInfoPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Service ID', accessor: 'serviceid', sortable: true },
    { header: 'Service Name', accessor: 'servicename', sortable: true },
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Operating Hours', accessor: 'operatinghours', sortable: true },
    { header: 'Contact Ext', accessor: 'contactext', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Directory of available services for helpdesk reference.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">24/7 Services</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Temporarily Closed</p>
