...
export default function FollowupInstructionsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Procedure/ICU', accessor: 'procedureicu', sortable: true },
    { header: 'Medications Prescribed', accessor: 'medicationsprescribed', sortable: true },
    { header: 'Follow-up Date', accessor: 'followupdate', sortable: true },
    { header: 'Dietary Advice', accessor: 'dietaryadvice', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Post-op wound care, medications, and follow-up appointment schedules.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Instructions Issued</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Appointments Booked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Translations Used</p>
