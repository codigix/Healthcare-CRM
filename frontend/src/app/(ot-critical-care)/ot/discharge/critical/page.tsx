...
export default function CriticalCareSummaryPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Summary ID', accessor: 'summaryid', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Comprehensive medical summary detailing ICU stay, interventions, and outcomes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Summaries Generated</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Sent to Records</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>41</p>
        </div>
      </div>
