...
export default function ICUDischargePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Discharge ID', accessor: 'dischargeid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'LOS (Days)', accessor: 'losdays', sortable: true },
    { header: 'Discharging Doctor', accessor: 'dischargingdoctor', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Medical clearance and final summaries for leaving the intensive care unit.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Summaries</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Mortality (Month)</p>
