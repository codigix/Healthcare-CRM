...
export default function DayCareSurgeryDischargePage() {
  ...
  const columns = [
    ...
    { header: 'Recovery Score', accessor: 'recoveryscore', sortable: true },
    { header: 'Companion Verified', accessor: 'companionverified', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Day Care Surgery Discharge
          </h1>
          <p className="text-sm text-gray-400 mt-1">Discharge summaries for ambulatory/day care surgical patients.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Day Care Surgeries</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Discharged</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>10</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Admitted (Complication)</p>
