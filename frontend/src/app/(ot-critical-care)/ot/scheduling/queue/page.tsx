...
export default function SurgeryQueuePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Queue ID', accessor: 'queueid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Procedure', accessor: 'procedure', sortable: true },
    { header: 'Wait Time (Days)', accessor: 'waittimedays', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Waitlist and queue management for elective and semi-urgent procedures.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total in Queue</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cleared This Week</p>
