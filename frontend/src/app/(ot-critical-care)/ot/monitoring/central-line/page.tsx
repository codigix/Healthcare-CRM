...
export default function CentralLineInvasiveMonitoringPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Line ID', accessor: 'lineid', sortable: true },
    { header: 'Bed ID', accessor: 'bedid', sortable: true },
    { header: 'Line Type', accessor: 'linetype', sortable: true },
    { header: 'Insertion Date', accessor: 'insertiondate', sortable: true },
    { header: 'CVP Reading', accessor: 'cvpreading', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking CVP, Arterial Lines, PICC lines, and CLABSI bundles.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Central Lines</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>32</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Arterial Lines</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>18</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Dressing Due</p>
