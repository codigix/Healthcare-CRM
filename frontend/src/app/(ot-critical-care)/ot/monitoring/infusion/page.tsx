...
export default function InfusionPumpsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Pump ID', accessor: 'pumpid', sortable: true },
    { header: 'Bed ID', accessor: 'bedid', sortable: true },
    { header: 'Medication', accessor: 'medication', sortable: true },
    { header: 'Dose Rate', accessor: 'doserate', sortable: true },
    { header: 'Time Remaining', accessor: 'timeremaining', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Centralized tracking of syringe pumps, IV fluids, and vasoactive drugs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Pumps</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inotropes/Vasopressors</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Near Empty Alarms</p>
