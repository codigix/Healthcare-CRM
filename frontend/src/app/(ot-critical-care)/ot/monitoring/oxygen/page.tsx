...
export default function OxygenTherapyPage() {
  ...
  const columns = [
    ...
    { header: 'Delivery Device', accessor: 'deliverydevice', sortable: true },
    { header: 'Flow Rate', accessor: 'flowrate', sortable: true },
    { header: 'Target SpO2', accessor: 'targetspo2', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monitoring oxygen delivery devices, flow rates, and cylinder statuses.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">O2 Therapy Patients</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">High Flow (HFNC)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Central O2 Pressure</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Normal</p>
        </div>
      </div>
