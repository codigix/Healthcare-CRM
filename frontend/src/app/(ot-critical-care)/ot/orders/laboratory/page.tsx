...
export default function LaboratoryOrdersPage() {
  ...
  const columns = [
    ...
    { header: 'Sample Sent Time', accessor: 'samplesenttime', sortable: true },
    { header: 'Turnaround Target', accessor: 'turnaroundtarget', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking ABGs, cultures, and routine bloods sent from OT and ICU.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Lab Orders</p>
