...
export default function VentilatorUsageReportPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Month', accessor: 'month', sortable: true },
    { header: 'Ventilator Days', accessor: 'ventilatordays', sortable: true },
    { header: 'Total Patients', accessor: 'totalpatients', sortable: true },
    { header: 'Avg Vent Days/Patient', accessor: 'avgventdayspatient', sortable: true },
    { header: 'VAP Cases', accessor: 'vapcases', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Ventilator Usage Report
          </h1>
          <p className="text-sm text-gray-400 mt-1">Statistics on mechanical ventilation days and VAP (Ventilator-Associated Pneumonia) rates.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Vent Days (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>850</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">VAP Rate (per 1000 days)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Successful Weans</p>
