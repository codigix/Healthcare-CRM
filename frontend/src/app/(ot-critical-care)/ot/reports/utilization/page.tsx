...
export default function OTUtilizationReportPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'OT Room', accessor: 'otroom', sortable: true },
    { header: 'Total Surgeries', accessor: 'totalsurgeries', sortable: true },
    { header: 'Utilization %', accessor: 'utilization', sortable: true },
    { header: 'Avg Turnaround Time', accessor: 'avgturnaroundtime', sortable: true },
    { header: 'Delay Hours', accessor: 'delayhours', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Metrics on theater usage, turnaround times, and delays.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>78%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Turnaround</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>28 mins</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Delay (Month)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>14 hrs</p>
        </div>
      </div>
