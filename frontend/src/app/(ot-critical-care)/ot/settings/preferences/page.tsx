...
export default function OTPreferencesPage() {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Global settings for booking lead times, overtime rules, and alerts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Auto-Cancellation</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Enabled</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SMS Alerts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Enabled</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Booking Lead Time</p>
