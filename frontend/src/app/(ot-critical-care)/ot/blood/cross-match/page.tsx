...
export default function CrossMatchStatusPage() {
  ...
  const columns = [
    ...
    { header: 'Sample Status', accessor: 'samplestatus', sortable: true },
    { header: 'Cross-match Result', accessor: 'crossmatchresult', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Live view of cross-matching progress for reserved units.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Samples in Lab</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Matches Found</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>6</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Antibody Screen Pos</p>
