...
export default function ICUKPIsPage() {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Key Performance Indicators for Intensive Care Units.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Ventilator Days/Patient</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>3.2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Readmission Rate (48h)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>2.1%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Central Line Days</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>4.5</p>
        </div>
      </div>
