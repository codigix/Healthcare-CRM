...
export default function BedUtilizationAnalyticsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Unit', accessor: 'unit', sortable: true },
    { header: 'Peak Occupancy Time', accessor: 'peakoccupancytime', sortable: true },
    { header: 'Turnaway Rate', accessor: 'turnawayrate', sortable: true },
    { header: 'Avg Vacant Time', accessor: 'avgvacanttime', sortable: true },
    { header: 'Throughput', accessor: 'throughput', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed heatmaps and trends of ICU bed occupancy and bottlenecks.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Peak Hour</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>14:00 - 18:00</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Turnaway (No Bed)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1/month</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bed Cleaning TAT</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>45 mins</p>
        </div>
      </div>
