...
export default function SurgeryDurationAnalysisPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Procedure Type', accessor: 'proceduretype', sortable: true },
    { header: 'Samples', accessor: 'samples', sortable: true },
    { header: 'Avg Scheduled Time', accessor: 'avgscheduledtime', sortable: true },
    { header: 'Avg Actual Time', accessor: 'avgactualtime', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Comparison of scheduled vs actual surgery times to optimize booking.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Underestimation</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12 mins</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highly Variable Proc</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>Laparotomy</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Scheduling Accuracy</p>
