...
export default function OTPerformanceAnalyticsPage() {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            OT Performance Analytics
          </h1>
          <p className="text-sm text-gray-400 mt-1">Dashboards showing on-time starts, cancellations, and turnaround efficiency.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">On-Time First Case</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>82%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>25m</p>
        </div>
      </div>
