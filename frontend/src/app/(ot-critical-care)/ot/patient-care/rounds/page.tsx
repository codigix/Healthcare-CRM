...
export default function DailyICURoundsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Round ID', accessor: 'roundid', sortable: true },
    { header: 'Bed ID', accessor: 'bedid', sortable: true },
    { header: 'Lead Intensivist', accessor: 'leadintensivist', sortable: true },
    { header: 'FASTHUG Status', accessor: 'fasthugstatus', sortable: true },
    { header: 'Goals Documented', accessor: 'goalsdocumented', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Multidisciplinary team round notes, FASTHUG checklists, and goals of care.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rounds Completed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>18/20</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Family Updates Done</p>
