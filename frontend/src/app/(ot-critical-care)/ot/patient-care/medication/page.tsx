...
export default function IntensiveMedicationChartPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Chart ID', accessor: 'chartid', sortable: true },
    ...
    { header: 'Administered By', accessor: 'administeredby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Intensive Medication Chart
          </h1>
          <p className="text-sm text-gray-400 mt-1">Administration record for routine meds, PRNs, and stat doses in ICU.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Doses Given (Shift)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>240</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missed Doses</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pharmacy Delays</p>
