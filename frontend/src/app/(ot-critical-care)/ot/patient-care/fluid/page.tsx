...
export default function FluidElectrolyteBalancePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Bed ID', accessor: 'bedid', sortable: true },
    { header: 'Target Fluid Balance', accessor: 'targetfluidbalance', sortable: true },
    { header: 'Latest K+', accessor: 'latestk', sortable: true },
    { header: 'Latest Na+', accessor: 'latestna', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Integration of lab electrolytes (Na, K, ABG) with fluid management plans.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Electrolyte Derangements</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Corrective Boluses Active</p>
