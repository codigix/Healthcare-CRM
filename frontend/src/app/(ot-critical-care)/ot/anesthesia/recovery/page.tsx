...
export default function ExtubationHandoverPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Handover ID', accessor: 'handoverid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Extubation Time', accessor: 'extubationtime', sortable: true },
    { header: 'Aldrete Score', accessor: 'aldretescore', sortable: true },
    { header: 'Handover To', accessor: 'handoverto', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Reversal of anesthesia, extubation notes, and handover to PACU.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Handovers Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>10</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Delayed Emergence</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Re-intubations</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
      </div>
