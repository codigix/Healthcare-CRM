...
export default function IntraoperativeMonitoringPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Monitor ID', accessor: 'monitorid', sortable: true },
    { header: 'OT Room', accessor: 'otroom', sortable: true },
    { header: 'Avg HR', accessor: 'avghr', sortable: true },
    { header: 'Avg MAP', accessor: 'avgmap', sortable: true },
    { header: 'EtCO2 Range', accessor: 'etco2range', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Automated vitals data capture (HR, BP, SpO2, EtCO2) from monitors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Connected Monitors</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>8/8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Alarms Triggered</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Data Integrity</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>99.9%</p>
        </div>
      </div>
