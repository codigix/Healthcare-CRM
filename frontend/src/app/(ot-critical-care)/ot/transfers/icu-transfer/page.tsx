...
export default function ICUtoICUTransfersPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Transfer ID', accessor: 'transferid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'From Unit', accessor: 'fromunit', sortable: true },
    { header: 'To Unit', accessor: 'tounit', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Moving patients between critical care units (e.g., SICU to Step-down).</p>
        </div>
