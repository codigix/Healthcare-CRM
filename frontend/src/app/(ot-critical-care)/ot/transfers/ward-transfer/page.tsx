...
export default function ICUtoWardTransfersPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Transfer ID', accessor: 'transferid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'From ICU', accessor: 'fromicu', sortable: true },
    { header: 'To Ward', accessor: 'toward', sortable: true },
    { header: 'Ward Nurse Notified', accessor: 'wardnursenotified', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Discharging stabilized patients from ICU to general wards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Step-downs Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>6</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Ward Beds</p>
