...
export default function IntraoperativeNotesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Note ID', accessor: 'noteid', sortable: true },
    { header: 'Surgery ID', accessor: 'surgeryid', sortable: true },
    { header: 'Sponge Count', accessor: 'spongecount', sortable: true },
    { header: 'Sharp Count', accessor: 'sharpcount', sortable: true },
    { header: 'Tourniquet Time', accessor: 'tourniquettime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Circulating nurse documentation of events, tourniquet times, and counts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Count Discrepancies</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Notes Finalized</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Draft Notes</p>
