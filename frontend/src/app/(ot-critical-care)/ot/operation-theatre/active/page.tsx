...
export default function ActiveSurgeriesDashboardPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'OT Room', accessor: 'otroom', sortable: true },
    { header: 'Surgery Phase', accessor: 'surgeryphase', sortable: true },
    { header: 'Time Elapsed', accessor: 'timeelapsed', sortable: true },
    { header: 'Surgeon', accessor: 'surgeon', sortable: true },
    { header: 'Anesthetist', accessor: 'anesthetist', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Active Surgeries Dashboard
          </h1>
          <p className="text-sm text-gray-400 mt-1">Real-time monitoring of currently ongoing operations and their phases.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Rooms</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>5/8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overtime Surgeries</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>1</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Closing Phase</p>
