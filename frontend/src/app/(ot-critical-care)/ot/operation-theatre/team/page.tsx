...
export default function SurgicalTeamLogsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Team Member', accessor: 'teammember', sortable: true },
    { header: 'Role', accessor: 'role', sortable: true },
    { header: 'OT Room', accessor: 'otroom', sortable: true },
    { header: 'Scrub In Time', accessor: 'scrubintime', sortable: true },
    { header: 'Scrub Out Time', accessor: 'scrubouttime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Check-in and scrub times for the surgical and anesthesia teams.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Surgeons</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>6</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Anesthetists</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Team Hours</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>142 hrs</p>
        </div>
      </div>
