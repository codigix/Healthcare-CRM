...
export default function ImplantsConsumablesPage() {
  ...
  const columns = [
    ...
    { header: 'Lot/Serial No', accessor: 'lotserialno', sortable: true },
    { header: 'Quantity Used', accessor: 'quantityused', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking of surgical implants, meshes, and high-value consumables used.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Implants Used</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cost Tracked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$12,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Wastage</p>
