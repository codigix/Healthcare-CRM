...
export default function PostOpPainManagementPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Initial VAS', accessor: 'initialvas', sortable: true },
    { header: 'Current VAS', accessor: 'currentvas', sortable: true },
    { header: 'Analgesics Given', accessor: 'analgesicsgiven', sortable: true },
    { header: 'Nausea/Vomiting (PONV)', accessor: 'nauseavomitingponv', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking of VAS scores and administration of rescue analgesia.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Patients in Pain (VAS > 4)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Comfortable</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">PONV Cases</p>
