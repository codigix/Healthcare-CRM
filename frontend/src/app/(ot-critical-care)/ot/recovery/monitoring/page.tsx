...
export default function PACUMonitoringDashboardPage() {
  ...
  const columns = [
    ...
    { header: 'Time in PACU', accessor: 'timeinpacu', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            PACU Monitoring Dashboard
          </h1>
          <p className="text-sm text-gray-400 mt-1">Post-Anesthesia Care Unit patient tracking and vitals monitoring.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>6/10</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Critical (Keep in PACU)</p>
