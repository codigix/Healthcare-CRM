...
export default function PACUNursingNotesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Note ID', accessor: 'noteid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Airway Status', accessor: 'airwaystatus', sortable: true },
    { header: 'Consciousness Level', accessor: 'consciousnesslevel', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Documentation of patient awakening, airway patency, and hemodynamic stability.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Notes Logged</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Airway Interventions</p>
