...
export default function PreOpWardChecklistPage() {
  ...
  const columns = [
    ...
    { header: 'NPO Confirmed', accessor: 'npoconfirmed', sortable: true },
    { header: 'Site Marked', accessor: 'sitemarked', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Ward nurse checklist before transferring patient to the OT (NPO status, site marking, etc).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Ready to Transfer</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Incomplete Prep</p>
