...
export default function PreAnesthesiaCheckupPACPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'PAC ID', accessor: 'pacid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Airway Class (Mallampati)', accessor: 'airwayclassmallampati', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Anesthesiologist clearance and airway assessment records.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">PACs Today</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unfit for Anesthesia</p>
