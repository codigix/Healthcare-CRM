...
export default function PatientPreparationPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Prep ID', accessor: 'prepid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Holding Bay', accessor: 'holdingbay', sortable: true },
    { header: 'IV Access', accessor: 'ivaccess', sortable: true },
    { header: 'Pre-Meds Given', accessor: 'premedsgiven', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Holding area notes, IV line insertion, and pre-medication tracking.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Patients in Holding</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fully Prepped</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Delayed</p>
