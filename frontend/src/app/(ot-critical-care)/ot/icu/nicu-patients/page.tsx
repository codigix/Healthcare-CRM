...
export default function NeonatalICUNICUPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Incubator ID', accessor: 'incubatorid', sortable: true },
    { header: 'Neonate Name', accessor: 'neonatename', sortable: true },
    { header: 'Gestational Age', accessor: 'gestationalage', sortable: true },
    { header: 'Birth Weight', accessor: 'birthweight', sortable: true },
    { header: 'Respiratory Support', accessor: 'respiratorysupport', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monitoring for premature and critically ill newborns.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Neonates</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">On Ventilator</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Ready to Step-down</p>
