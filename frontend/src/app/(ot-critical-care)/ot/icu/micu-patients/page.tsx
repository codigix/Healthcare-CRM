...
export default function MedicalICUMICUPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Bed ID', accessor: 'bedid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Primary System', accessor: 'primarysystem', sortable: true },
    { header: 'SOFA Score', accessor: 'sofascore', sortable: true },
    { header: 'Inotropes', accessor: 'inotropes', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Dashboard for severe medical conditions (sepsis, ARDS, DKA).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>14/15</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Septic Shock</p>
