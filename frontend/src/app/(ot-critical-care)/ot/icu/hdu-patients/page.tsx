...
export default function HighDependencyUnitHDUPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Bed ID', accessor: 'bedid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Transferred From', accessor: 'transferredfrom', sortable: true },
    { header: 'Monitoring Level', accessor: 'monitoringlevel', sortable: true },
    { header: 'Expected Ward Transfer', accessor: 'expectedwardtransfer', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Step-down unit for patients requiring close monitoring but not ICU level care.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Ready for Ward</p>
