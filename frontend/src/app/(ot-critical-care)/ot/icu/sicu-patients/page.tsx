...
export default function SurgicalICUSICUPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Bed ID', accessor: 'bedid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Surgical Procedure', accessor: 'surgicalprocedure', sortable: true },
    { header: 'Post-Op Day', accessor: 'postopday', sortable: true },
    { header: 'Drain Output', accessor: 'drainoutput', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Post-operative critical care and trauma recovery monitoring.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Occupied Beds</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>10/12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Ventilated</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Discharge Planned</p>
