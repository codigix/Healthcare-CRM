   ...
   const columns_0: Column<any>[] = [
      ...
      { header: "Supplier", accessor: (item) => (<>{item.supplier || "Direct Procurement"}</>) },
      {
         header: "Restock Request", accessor: (item) => (<>\n<button
            ...
            className="btn-primary py-1 px-3.5 text-xs flex items-center gap-1.5 mx-auto bg-emerald-600 hover:bg-emerald-500 text-white  transition-all shadow shadow-emerald-500/10"
         >
      ...
      <div className="space-y-6">
         <div className="flex justify-between items-center my-3 my-3">
            <div className="flex items-center gap-4">
               ...
               <div>
                  <h1 className="text-3xl ">Low Stock Medicines</h1>
         ...
         {loading ? (
            ...
            <div className="card text-center py-16">
               ...
               <h3 className="text-xl  text-white mb-2">Medication Stock is Safe</h3>
