...
export default function StockAdjustmentsPage() {
  ...
  const columns = [
    { header: 'Adj ID', accessor: 'adjid', sortable: true },
    { header: 'Medicine Name', accessor: 'medicinename', sortable: true },
    { header: 'System Qty', accessor: 'systemqty', sortable: true },
    { header: 'Physical Qty', accessor: 'physicalqty', sortable: true },
    { header: 'Difference', accessor: 'difference', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manual corrections for physical vs system stock discrepancies.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Adjustments (Month)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Net Value Change</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>-$150</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
