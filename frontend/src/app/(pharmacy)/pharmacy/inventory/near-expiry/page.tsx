...
export default function NearExpiryAlertsPage() {
  ...
  const columns = [
    ...
    { header: 'Months to Expiry', accessor: 'monthstoexpiry', sortable: true },
    { header: 'Current Stock', accessor: 'currentstock', sortable: true },
    { header: 'Action Plan', accessor: 'actionplan', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Medicines expiring in the next 3 to 6 months requiring fast-tracking.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Alerts Active</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Push to Wards</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>20</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Return Eligible</p>
