...
export default function DamagedBreakagePage() {
  ...
  const columns = [
    ...
    { header: 'Qty Damaged', accessor: 'qtydamaged', sortable: true },
    { header: 'Reported By', accessor: 'reportedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Log of vials broken, strips damaged, or cold-chain breaches.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Damaged Items (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>18</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Value Lost</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$320</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Written Off</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>15</p>
        </div>
      </div>
