...
export default function StockAvailabilitySearchPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Medicine Name', accessor: 'medicinename', sortable: true },
    { header: 'Generic Name', accessor: 'genericname', sortable: true },
    { header: 'Strength', accessor: 'strength', sortable: true },
    { header: 'Available Qty', accessor: 'availableqty', sortable: true },
    { header: 'Alternate Brands', accessor: 'alternatebrands', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Quick tool for doctors/nurses to check if a specific drug/brand is available.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Searches Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>145</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Found Rates</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>92%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Alt Substituted</p>
