...
export default function MedicineSalesReportPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Medicine Name', accessor: 'medicinename', sortable: true },
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Qty Sold', accessor: 'qtysold', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed report showing exact quantities and revenue generated per medicine.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Selling Item</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Paracetamol 500mg</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Revenue</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Meropenem 1g</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Low Margin Items</p>
