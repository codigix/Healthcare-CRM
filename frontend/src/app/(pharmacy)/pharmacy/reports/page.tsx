        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center my-3 my-3">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl ">Pharmacy Reports</h1>
            ...
            {loading ? (
                ...
                <>
                        ...
                        <div className="card border-l-4 border-teal-500 hover:translate-y-[-2px] transition-transform">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <h3 className="text-3xl  text-white mt-1">{totalDrugsCount} Formulations</h3>
                        ...
                        <div className="card border-l-4 border-blue-500 hover:translate-y-[-2px] transition-transform">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <h3 className="text-3xl  text-white mt-1">{totalPrescriptionsCount} Prescriptions</h3>
                        ...
                        <div className="card border-l-4 border-purple-500 hover:translate-y-[-2px] transition-transform">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <h3 className="text-3xl  text-white mt-1">{dispensationVolume.toLocaleString()} Units</h3>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="card">
                            <h3 className="text-lg  text-white mb-4">Invoiced Drug Revenue Trends (₹)</h3>
                        ...
                        <div className="card">
                            <h3 className="text-lg  text-white mb-4">Top 5 Clinically Dispensed Medications (qty)</h3>
                            <div className="h-[280px]">
                                <ResponsiveContainer width="100%" height="100%">
