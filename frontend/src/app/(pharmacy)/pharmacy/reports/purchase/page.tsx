...
export default function PurchaseVendorReportPage() {
  ...
  const columns = [
    ...
    { header: 'POs Raised', accessor: 'posraised', sortable: true },
    { header: 'Total Purchase Value', accessor: 'totalpurchasevalue', sortable: true },
    { header: 'GRN Value', accessor: 'grnvalue', sortable: true },
    { header: 'Pending Payments', accessor: 'pendingpayments', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Summary of all purchases made, vendor performance, and outstanding payables.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Purchases (MTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$120,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Outstanding Payables</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$45,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Vendor Returns</p>
