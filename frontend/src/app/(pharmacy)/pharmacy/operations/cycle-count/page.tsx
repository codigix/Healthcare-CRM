...
export default function DailyCycleCountsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Count ID', accessor: 'countid', sortable: true },
    { header: 'Location/Bin', accessor: 'locationbin', sortable: true },
    { header: 'Expected Qty', accessor: 'expectedqty', sortable: true },
    { header: 'Counted Qty', accessor: 'countedqty', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Continuous partial stocktakes (ABC analysis) to maintain inventory accuracy.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Bins Counted Today</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Variances Pending Auth</p>
