...
export default function PharmacyAuditsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Audit ID', accessor: 'auditid', sortable: true },
    { header: 'Category Audited', accessor: 'categoryaudited', sortable: true },
    { header: 'Total Items', accessor: 'totalitems', sortable: true },
    { header: 'Discrepancies Found', accessor: 'discrepanciesfound', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Formal periodic audits of physical stock against system records.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Discrepancy Value</p>
