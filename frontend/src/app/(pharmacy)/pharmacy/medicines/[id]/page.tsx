...
export default function MedicineViewPage({
    ...
    return (
      <>
        <div className="space-y-6">
          ...
          <div className="bg-red-500/10 border border-red-500/20 text-red-500 p-2 rounded flex items-center gap-2">
            <AlertCircle size={20} />
  ...
  const columns_1: Column<any>[] = [
    ...
    {
      header: "Type", accessor: (tx) => (<>\n<span className={`px-2.5 py-0.5 rounded text-xs  ${tx.type === 'RESTOCK' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' :
  ...
  return (
    <>
      <div className="space-y-6">
        <div className="flex justify-between items-center my-3 my-3">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="btn-secondary bg-emerald-600 hover:bg-emerald-500 text-white  border-none"
            >
              Add Stock
            </button>
        ...
        <div className="card">
          <h2 className="text-2xl  mb-6 pb-4 border-b border-dark-tertiary">
            {medicine.name}
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 pb-8 border-b border-dark-tertiary">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`w-4 h-4 rounded ${medicine.roomTemperature
                    ? "bg-emerald-500"
                    : "bg-dark-tertiary"
                    }`}
                ></div>
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`w-4 h-4 rounded ${medicine.refrigerated
                    ? "bg-emerald-500"
                    : "bg-dark-tertiary"
                    }`}
                ></div>
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`w-4 h-4 rounded ${medicine.frozen ? "bg-emerald-500" : "bg-dark-tertiary"
                    }`}
                ></div>
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`w-4 h-4 rounded ${medicine.protectFromLight
                    ? "bg-emerald-500"
                    : "bg-dark-tertiary"
                    }`}
                ></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="flex justify-between items-center my-3 my-3 text-mdmb-2">
              ...
              <div className="flex justify-between items-center my-3 my-3 text-mdpt-2 border-t border-dark-tertiary">
        ...
        <div className="card font-sans">
          <h3 className="text-xl  text-white mb-4">Active Batches</h3>
          {batches.length === 0 ? (
        ...
        <div className="card">
          <h3 className="text-xl  text-white mb-4">Stock History Logs</h3>
