...
export default function ColdChainManagementPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Item Name', accessor: 'itemname', sortable: true },
    { header: 'Batch No', accessor: 'batchno', sortable: true },
    { header: 'Received Temp', accessor: 'receivedtemp', sortable: true },
    { header: 'Current Storage', accessor: 'currentstorage', sortable: true },
    { header: 'Time Out of Fridge', accessor: 'timeoutoffridge', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking temperature-sensitive drugs (vaccines, insulin) from receipt to dispensing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cold Chain Items</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>340</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Breaches</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Deliveries In Transit</p>
