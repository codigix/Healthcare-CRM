...
export default function RefillManagementPage() {
  ...
  const columns = [
    { header: 'Refill ID', accessor: 'refillid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Medicine', accessor: 'medicine', sortable: true },
    { header: 'Next Due Date', accessor: 'nextduedate', sortable: true },
    { header: 'Patient Contacted', accessor: 'patientcontacted', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking and processing refill requests for chronic medication users.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Refills Due Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Refills Processed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>38</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missed Refills</p>
