...
export default function PharmacyProfilePage() {
  ...
  const columns = [
    ...
    { header: 'Updated By', accessor: 'updatedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Basic pharmacy details, license numbers, and operating hours.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Profile Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Complete</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Licenses</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Validated</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Next Renewal</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>31 Dec</p>
        </div>
      </div>
