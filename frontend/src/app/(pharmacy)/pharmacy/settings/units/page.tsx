...
export default function UnitsofMeasurementPage() {
  ...
  const columns = [
    { header: 'Unit ID', accessor: 'unitid', sortable: true },
    { header: 'Unit Name', accessor: 'unitname', sortable: true },
    { header: 'Abbreviation', accessor: 'abbreviation', sortable: true },
    { header: 'Base Unit Conversion', accessor: 'baseunitconversion', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Define pack sizes, strips, vials, and base dispensing units.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Units Defined</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Most Used Unit</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Strip (10 Tab)</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Custom Packs</p>
