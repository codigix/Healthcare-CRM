...
export default function NarcoticRegisterPage() {
  ...
  const columns = [
    ...
    { header: 'Opening Balance', accessor: 'openingbalance', sortable: true },
    { header: 'Received', accessor: 'received', sortable: true },
    { header: 'Issued', accessor: 'issued', sortable: true },
    { header: 'Closing Balance', accessor: 'closingbalance', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Strict inventory ledger for Schedule X, H1, and narcotic drugs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Narcotic Items</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$12,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
