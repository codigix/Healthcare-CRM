...
export default function PendingPrescriptionsPage() {
  ...
  const columns_0: Column<any>[] = [
    {
      header: "Patient Name", accessor: (pres) => (<>\n<div className="flex items-center gap-2">
        <div className="w-9 h-9 bg-gradient-to-br from-[#1abc9c]/20 to-[#1abc9c]/5 text-[#1abc9c] roundedex items-center justify-center  border border-[#1abc9c]/20">
          <User size={16} />
        </div>
        <div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-dark-secondary p-6 rounded-2xl border border-white/5 shadow-2xl">
        <div className="flex items-center gap-4">
          <Link
            ...
            className="p-3 bg-card/5 hover:bg-[#1abc9c]/20 hover:text-[#1abc9c] roundedansition-all duration-300"
          >
            <ArrowLeft size={20} />
          </Link>
          <div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          {/* Search bar */}
          <div className="relative bg-card/5 border border-white/5 focus-within:border-[#1abc9c]/50 rounded-3.5 py-2 flex items-center gap-2 w-64 transition-all">
          ...
          <select
            ...
            className="bg-[#181920] border border-white/5 hover:border-white/10 text-gray-300 text-sm rounded2 outline-none cursor-pointer transition-all"
          >
          ...
          <button
            ...
            className="p-2.5 bg-card/5 border border-white/5 hover:border-[#1abc9c]/30 hover:bg-[#1abc9c]/10 text-gray-300 hover:text-[#1abc9c] roundedex items-center justify-center transition-all duration-300 shadow-sm"
            title="Refresh Queue"
          >
            <RefreshCw size={15} />
          </button>
      ...
      {successMsg && (
        <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 rounded4 flex items-center gap-2 animate-fadeIn">
      ...
      {error && (
        <div className="bg-red-500/10 border border-red-500/20 text-red-400 p-4 roundedex items-center gap-2 animate-fadeIn">
          ...
          <div className="bg-[#13141b] border border-white/10 rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-2xl relative shadow-emerald-500/5 transition-all">
            ...
            <div className="space-y-2">
              ...
              {(modalDetails.hasStockError || modalDetails.missingMedicine) && (
                <div className="bg-red-500/10 border border-red-500/20 text-red-400 p-4 roundedex items-center gap-2">
              ...
              <div className="flex flex-col md:flex-row items-start justify-between gap-6 pt-4 border-t border-white/5">
                ...
                <div className="bg-card/5 rounded4 border border-white/5 w-full md:w-64 space-y-2.5">
            ...
            <div className="p-6 border-t border-white/5 bg-card/[0.01] flex justify-end gap-3 rounded-b-2xl">
              ...
              <button
                ...
                className="btn-primary py-2.5 px-6 roundedext-sm flex items-center justify-center gap-2 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {dispenseLoading ? (
                  <>
