...
export default function EPrescriptionsArchivePage() {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            E-Prescriptions Archive
          </h1>
          <p className="text-sm text-gray-400 mt-1">Searchable repository of all digital prescriptions generated by doctors.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total E-Rx (Month)</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Expired/Unused</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>300</p>
        </div>
      </div>
