...
export default function DuplicateTherapyPage() {
  ...
  const columns = [
    ...
    { header: 'Drug 1', accessor: 'drug1', sortable: true },
    { header: 'Drug 2', accessor: 'drug2', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Warnings for multiple drugs prescribed from the same therapeutic class.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Duplicates Detected</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Polypharmacy Cases</p>
