...
export default function HighRiskMedicinesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Ward', accessor: 'ward', sortable: true },
    { header: 'High Risk Drug', accessor: 'highriskdrug', sortable: true },
    { header: 'Latest Lab Value', accessor: 'latestlabvalue', sortable: true },
    { header: 'Pharmacist Review', accessor: 'pharmacistreview', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Special monitoring for narrow therapeutic index drugs (e.g., Digoxin, Insulin).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Patients on High-Risk</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>32</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Toxicity Risk</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Dose Optimized</p>
