...
export default function VendorManagementPage() {
  ...
  const columns = [
    ...
    { header: 'Credit Period', accessor: 'creditperiod', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">List of authorized suppliers, their performance ratings, and contracts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Vendors</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Delivery Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>3 Days</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
