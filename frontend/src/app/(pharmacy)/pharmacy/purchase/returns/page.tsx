...
export default function PurchaseReturnsPRTMPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Return ID', accessor: 'returnid', sortable: true },
    ...
    { header: 'Credit Note No', accessor: 'creditnoteno', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Purchase Returns (PRTM)
          </h1>
          <p className="text-sm text-gray-400 mt-1">Returning expired or damaged goods back to the supplier for credit notes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Returns</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Value Awaiting</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$1,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Credit Received</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$4,500</p>
        </div>
      </div>
