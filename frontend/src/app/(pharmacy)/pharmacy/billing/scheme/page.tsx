...
export default function GovtSchemeBillingPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Scheme ID', accessor: 'schemeid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Scheme Name', accessor: 'schemename', sortable: true },
    { header: 'Subsidized Amount', accessor: 'subsidizedamount', sortable: true },
    { header: 'Patient Share', accessor: 'patientshare', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Special billing for subsidized or free medicines under government health schemes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Scheme Patients</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Govt. Receivable</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$15,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Dispensed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>115</p>
        </div>
      </div>
