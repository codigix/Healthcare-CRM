    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Processing claims, co-pays, and pre-authorizations for insured patients.</p>
        </div>
