...
export default function CorporatePharmacyBillingPage() {
  ...
  const columns = [
    ...
    { header: 'Total Bills', accessor: 'totalbills', sortable: true },
    { header: 'Invoice Amount', accessor: 'invoiceamount', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            Corporate Pharmacy Billing
          </h1>
          <p className="text-sm text-gray-400 mt-1">Managing credit bills and consolidated invoices for corporate tie-ups.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Unbilled Amount</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$45,000</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Invoices Sent</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Payments Received</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$30,000</p>
        </div>
      </div>
