...
export default function DrugClassificationPage() {
  ...
  const columns = [
    ...
    { header: 'Class Name', accessor: 'classname', sortable: true },
    { header: 'Parent Class', accessor: 'parentclass', sortable: true },
    { header: 'Total Generics', accessor: 'totalgenerics', sortable: true },
    { header: 'Total Brands', accessor: 'totalbrands', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hierarchy of pharmacological classes (e.g., NSAIDs, Beta-blockers).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>85</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Sub-classes</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>340</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Most Populated</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Antibiotics</p>
        </div>
      </div>
