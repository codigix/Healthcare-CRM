...
export default function ManufacturersPage() {
  ...
  const columns = [
    { header: 'Mfg ID', accessor: 'mfgid', sortable: true },
    { header: 'Company Name', accessor: 'companyname', sortable: true },
    { header: 'Origin', accessor: 'origin', sortable: true },
    { header: 'Products Supplied', accessor: 'productssupplied', sortable: true },
    { header: 'Quality Rating', accessor: 'qualityrating', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Directory of pharmaceutical companies and their specific products.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Manufacturers</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>320</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Domestic</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>250</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">International</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>70</p>
        </div>
      </div>
