...
export default function BrandMedicinesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Brand ID', accessor: 'brandid', sortable: true },
    { header: 'Brand Name', accessor: 'brandname', sortable: true },
    { header: 'Manufacturer', accessor: 'manufacturer', sortable: true },
    { header: 'Primary Generic', accessor: 'primarygeneric', sortable: true },
    { header: 'Substitutes', accessor: 'substitutes', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Mapping of commercial brand names to their generic constituents.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Brands Listed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>9,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Multi-Salt Brands</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>3,400</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Selling Brand</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Augmentin</p>
        </div>
      </div>
