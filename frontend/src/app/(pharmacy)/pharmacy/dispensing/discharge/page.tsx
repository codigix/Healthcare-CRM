...
export default function DischargeMedicinesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Discharge ID', accessor: 'dischargeid', sortable: true },
    ...
    { header: 'Counseling Done', accessor: 'counselingdone', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Bulk dispensing of take-home medications for patients leaving the hospital.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Discharges</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Ready for Pickup</p>
