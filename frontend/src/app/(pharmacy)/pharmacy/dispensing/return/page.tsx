...
export default function MedicineReturnsPage() {
  ...
  const columns = [
    ...
    { header: 'Patient/Ward', accessor: 'patientward', sortable: true },
    { header: 'Items Returned', accessor: 'itemsreturned', sortable: true },
    { header: 'Refund Amount', accessor: 'refundamount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Processing returned medicines from wards (unused) or patients (allergies).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Returns Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Restocked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>6</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Discarded</p>
