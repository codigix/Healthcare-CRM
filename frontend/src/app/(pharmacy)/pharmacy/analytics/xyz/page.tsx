...
export default function XYZAnalysisPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Item Count', accessor: 'itemcount', sortable: true },
    { header: 'Demand Predictability', accessor: 'demandpredictability', sortable: true },
    { header: 'Buffer Stock Policy', accessor: 'bufferstockpolicy', sortable: true },
    { header: 'Stockout Risk', accessor: 'stockoutrisk', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Categorizing inventory by predictability of demand (X=Steady, Y=Variable, Z=Erratic).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">X-Class (Steady)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Z-Class (Erratic)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Optimization Opportunities</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>120 Items</p>
        </div>
      </div>
