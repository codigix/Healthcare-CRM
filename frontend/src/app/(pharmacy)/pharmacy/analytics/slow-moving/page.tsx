...
export default function SlowMovingGoodsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Medicine Name', accessor: 'medicinename', sortable: true },
    { header: 'Last Sold Date', accessor: 'lastsolddate', sortable: true },
    { header: 'Current Stock', accessor: 'currentstock', sortable: true },
    { header: 'Value Locked', accessor: 'valuelocked', sortable: true },
    { header: 'Suggested Action', accessor: 'suggestedaction', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Identifying low-turnover stock to prevent expiration and free up capital.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Slow Moving Items</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>320</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Capital Locked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$15,400</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Liquidated (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$2,100</p>
        </div>
      </div>
