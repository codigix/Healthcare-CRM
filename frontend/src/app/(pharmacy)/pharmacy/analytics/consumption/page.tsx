...
export default function ConsumptionTrendsPage() {
  ...
  const columns = [
    ...
    { header: 'Top Prescribed Drug', accessor: 'topprescribeddrug', sortable: true },
    { header: 'Avg Cost per Rx', accessor: 'avgcostperrx', sortable: true },
    { header: 'Generic Prescribing %', accessor: 'genericprescribing', sortable: true },
    { header: 'Trend (vs Last Mo)', accessor: 'trendvslastmo', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Department-wise and doctor-wise medicine prescribing and consumption patterns.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Generic %</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>68%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Costliest Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Oncology</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Rx Cost</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$28</p>
        </div>
      </div>
