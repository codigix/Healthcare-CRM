...
export default function FacilityDashboardPage() {
  ...
  const columns = [
    ...
    { header: 'Key Metric', accessor: 'keymetric', sortable: true },
    { header: 'Performance vs Target', accessor: 'performancevstarget', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">High-level executive overview of all facility operations and costs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Facility Cost/SqFt</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$4.50</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
