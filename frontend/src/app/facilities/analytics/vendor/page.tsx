...
export default function VendorPerformancePage() {
  ...
  const columns = [
    ...
    { header: 'SLA Score', accessor: 'slascore', sortable: true },
    { header: 'Cost Competitiveness', accessor: 'costcompetitiveness', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Ranking vendors based on response time, cost-effectiveness, and quality.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Performing</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>CleanCo (98%)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Satisfaction</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4.2/5</p>
        </div>
      </div>
