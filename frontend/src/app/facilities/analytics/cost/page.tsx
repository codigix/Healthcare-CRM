...
export default function CostAnalysisPage() {
  ...
  const columns = [
    ...
    { header: 'Budget (Mo)', accessor: 'budgetmo', sortable: true },
    { header: 'Actual Spend', accessor: 'actualspend', sortable: true },
    { header: 'Variance', accessor: 'variance', sortable: true },
    { header: 'Cost Drivers', accessor: 'costdrivers', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Total cost of ownership (TCO) analysis for facility operations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Facility Spend</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$125,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overall Variance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>-$2,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Spend</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Utilities (35%)</p>
        </div>
      </div>
