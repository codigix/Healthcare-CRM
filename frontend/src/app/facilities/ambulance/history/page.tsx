...
export default function TripHistoryPage() {
  ...
  const columns = [
    { header: 'Trip ID', accessor: 'tripid', sortable: true },
    { header: 'Vehicle', accessor: 'vehicle', sortable: true },
    { header: 'Start Km', accessor: 'startkm', sortable: true },
    { header: 'End Km', accessor: 'endkm', sortable: true },
    { header: 'Total Distance', accessor: 'totaldistance', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Log book of all completed ambulance trips for auditing and maintenance scheduling.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Distance (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,500 Km</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Distance/Trip</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12 Km</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fuel Logged</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>450 Ltrs</p>
        </div>
      </div>
