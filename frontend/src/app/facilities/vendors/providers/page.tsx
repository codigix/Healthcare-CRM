...
export default function ServiceProvidersPage() {
  ...
  const columns = [
    { header: 'Provider Name', accessor: 'providername', sortable: true },
    { header: 'Trade/Skill', accessor: 'tradeskill', sortable: true },
    { header: 'Rate Card', accessor: 'ratecard', sortable: true },
    { header: 'Jobs Done (YTD)', accessor: 'jobsdoneytd', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">On-call or rate-contract providers for ad-hoc civil or electrical work.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Providers</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Jobs Assigned</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45 (Mo)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Response</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4 Hrs</p>
        </div>
      </div>
