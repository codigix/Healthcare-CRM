...
export default function VisitorVerificationPage() {
  ...
  const columns = [
    ...
    { header: 'Patient Visited', accessor: 'patientvisited', sortable: true },
    { header: 'Ward/Bed', accessor: 'wardbed', sortable: true },
    { header: 'In Time', accessor: 'intime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logging visitors, issuing passes, and enforcing visiting hour rules.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Passes Issued (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>340</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Overstaying Visitors</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Banned Persons</p>
