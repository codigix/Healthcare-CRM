...
export default function CCTVMonitoringPage() {
  ...
  const columns = [
    { header: 'Camera ID', accessor: 'cameraid', sortable: true },
    ...
    { header: 'Recording retention', accessor: 'recordingretention', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Camera status, recording retention checks, and footage request logs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Cameras</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>240</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Offline Cameras</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Footage Requests</p>
