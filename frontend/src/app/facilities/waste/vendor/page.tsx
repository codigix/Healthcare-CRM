...
export default function VendorCollectionPage() {
  ...
  const columns = [
    ...
    { header: 'Contract Valid Till', accessor: 'contractvalidtill', sortable: true },
    { header: 'Rate/Kg', accessor: 'ratekg', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Contract details, pricing, and compliance certificates for the waste disposal vendor.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Vendor</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>EcoWaste Solutions</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">License Status</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Valid</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Next Renewal</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>6 Months</p>
        </div>
      </div>
