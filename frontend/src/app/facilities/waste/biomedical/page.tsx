    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking the generation and weighing of biomedical waste (Red, Yellow, Blue bins).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Waste Gen Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>450 Kg</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Yellow Bag Weight</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>200 Kg</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Red Bag Weight</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>150 Kg</p>
        </div>
      </div>
