...
export default function WasteDisposalPage() {
  ...
  const columns = [
    { header: 'Manifest No', accessor: 'manifestno', sortable: true },
    { header: 'Vehicle Reg', accessor: 'vehiclereg', sortable: true },
    { header: 'Total Weight (Kg)', accessor: 'totalweightkg', sortable: true },
    { header: 'Authorized Sign', accessor: 'authorizedsign', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Final manifest and tracking of waste handed over to the external authorized vendor.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Vendor Pickups (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>30</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Disposed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>14,500 Kg</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Disposal Cost</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$2,400</p>
        </div>
      </div>
