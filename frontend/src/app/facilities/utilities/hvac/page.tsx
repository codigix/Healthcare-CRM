...
export default function HVACMonitoringPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Chiller/AHU Unit', accessor: 'chillerahuunit', sortable: true },
    { header: 'Location Served', accessor: 'locationserved', sortable: true },
    { header: 'Set Temp', accessor: 'settemp', sortable: true },
    { header: 'Actual Temp', accessor: 'actualtemp', sortable: true },
    { header: 'Humidity', accessor: 'humidity', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Central air conditioning control, OT temperature/humidity monitoring, and chiller plant status.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Chiller Load</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>65%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">OT Compliance (Temp)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>100%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Filter Cleaning Due</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2 AHUs</p>
        </div>
      </div>
