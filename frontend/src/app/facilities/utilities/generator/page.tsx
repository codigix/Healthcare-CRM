...
export default function GeneratorMonitoringPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'DG Set ID', accessor: 'dgsetid', sortable: true },
    { header: 'Capacity', accessor: 'capacity', sortable: true },
    { header: 'Fuel Level', accessor: 'fuellevel', sortable: true },
    { header: 'Running Hrs', accessor: 'runninghrs', sortable: true },
    { header: 'Battery Health', accessor: 'batteryhealth', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Diesel Generator (DG) set health, fuel levels, and auto-start logs during power failures.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total DG Capacity</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1500 kVA</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fuel Stock</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1200 Ltrs</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Last Auto-Sync</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Success</p>
        </div>
      </div>
