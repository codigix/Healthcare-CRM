...
export default function ElectricityMonitoringPage() {
  ...
  const columns = [
    { header: 'Meter Location', accessor: 'meterlocation', sortable: true },
    { header: 'Current Reading', accessor: 'currentreading', sortable: true },
    { header: 'Consumption (kWh)', accessor: 'consumptionkwh', sortable: true },
    { header: 'Power Factor', accessor: 'powerfactor', sortable: true },
    { header: 'Cost Estimated', accessor: 'costestimated', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking main grid consumption, power factor, and department sub-metering.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Power (Today)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12,400 kWh</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Est. Cost</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$1,240</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Power Factor</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>0.98</p>
        </div>
      </div>
