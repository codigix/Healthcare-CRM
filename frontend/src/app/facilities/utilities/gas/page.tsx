...
export default function MedicalGasPipelinePage() {
  ...
  const columns = [
    { header: 'Gas Type', accessor: 'gastype', sortable: true },
    { header: 'Manifold Location', accessor: 'manifoldlocation', sortable: true },
    { header: 'Line Pressure', accessor: 'linepressure', sortable: true },
    { header: 'Alarm Status', accessor: 'alarmstatus', sortable: true },
    { header: 'Last Leak Check', accessor: 'lastleakcheck', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monitoring vacuum (suction), nitrous oxide, and compressed air pipelines across wards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">All Lines Pressure</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Nominal</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Vacuum Pumps</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Active</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Leak Alerts</p>
