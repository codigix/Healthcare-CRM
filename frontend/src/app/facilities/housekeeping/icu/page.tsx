...
export default function ICUCleaningPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'ICU Bed/Zone', accessor: 'icubedzone', sortable: true },
    { header: 'Last Clean', accessor: 'lastclean', sortable: true },
    { header: 'Disinfectant Used', accessor: 'disinfectantused', sortable: true },
    { header: 'Staff ID', accessor: 'staffid', sortable: true },
    { header: 'Supervisor Sign-off', accessor: 'supervisorsignoff', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Critical care zone cleaning logs maintaining high hygiene standards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ICU Compliance</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>100%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Deep Cleans Today</p>
