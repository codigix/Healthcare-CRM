...
export default function WardCleaningPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Ward Name', accessor: 'wardname', sortable: true },
    { header: 'Last Cleaned', accessor: 'lastcleaned', sortable: true },
    { header: 'Next Due', accessor: 'nextdue', sortable: true },
    { header: 'Cleaning Standard', accessor: 'cleaningstandard', sortable: true },
    { header: 'Checked By', accessor: 'checkedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Routine mopping and sanitization logs for general wards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Wards Cleaned</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>24/24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missed Schedules</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>0</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Infection Alerts</p>
