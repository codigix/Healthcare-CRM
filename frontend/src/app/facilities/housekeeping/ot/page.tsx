...
export default function OTCleaningPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'OT Number', accessor: 'otnumber', sortable: true },
    { header: 'Surgery Type', accessor: 'surgerytype', sortable: true },
    { header: 'Cleaning Phase', accessor: 'cleaningphase', sortable: true },
    { header: 'Carried Out By', accessor: 'carriedoutby', sortable: true },
    { header: 'Sterility Swap', accessor: 'sterilityswap', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Highly regulated sterile cleaning protocols between surgeries and deep cleaning.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">OTs Ready</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>5/8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Under Cleaning</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fumigation Due</p>
