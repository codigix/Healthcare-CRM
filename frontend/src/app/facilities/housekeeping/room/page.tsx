...
export default function RoomCleaningPage() {
  ...
  const columns = [
    ...
    { header: 'Patient Status', accessor: 'patientstatus', sortable: true },
    { header: 'Cleaning Type', accessor: 'cleaningtype', sortable: true },
    { header: 'Requested Time', accessor: 'requestedtime', sortable: true },
    { header: 'Completion Time', accessor: 'completiontime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking cleaning status of private rooms, especially post-discharge terminal cleaning.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rooms to Clean</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cleaned Today</p>
