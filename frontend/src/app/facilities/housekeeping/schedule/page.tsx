...
export default function CleaningSchedulePage() {
  ...
  const columns = [
    { header: 'Zone/Area', accessor: 'zonearea', sortable: true },
    { header: 'Frequency', accessor: 'frequency', sortable: true },
    { header: 'Shift', accessor: 'shift', sortable: true },
    { header: 'Assigned Staff', accessor: 'assignedstaff', sortable: true },
    { header: 'Supervisor', accessor: 'supervisor', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Roster and frequency (e.g., 2-hourly) planning for cleaning staff across zones.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total HK Staff</p>
