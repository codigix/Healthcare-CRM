...
export default function CleaningChecklistPage() {
  ...
  const columns = [
    ...
    { header: 'Checklist Item', accessor: 'checklistitem', sortable: true },
    { header: 'Time Logged', accessor: 'timelogged', sortable: true },
    { header: 'Completed By', accessor: 'completedby', sortable: true },
    { header: 'Image Proof', accessor: 'imageproof', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Digital sign-offs replacing paper sheets in washrooms and pantries.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Checklists Completed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>450/480</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missed Items</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Audits Done</p>
