...
export default function ServiceHistoryPage() {
  ...
  const columns = [
    ...
    { header: 'Date of Service', accessor: 'dateofservice', sortable: true },
    { header: 'WO/Ticket ID', accessor: 'woticketid', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Historical log of all maintenance activities per asset for lifecycle costing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Maint. Cost YTD</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$45,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Most Repaired Asset</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>Lift 3</p>
        </div>
      </div>
