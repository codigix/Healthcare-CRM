...
export default function BreakdownRequestsPage() {
  ...
  const columns = [
    ...
    { header: 'Issue Description', accessor: 'issuedescription', sortable: true },
    { header: 'Reported Time', accessor: 'reportedtime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Emergency requests for unexpected equipment or facility failures (e.g., pipe burst).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Breakdowns</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>3</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">MTTR</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1.2 Hrs</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
