...
export default function CorrectiveMaintenancePage() {
  ...
  const columns = [
    { header: 'CM Number', accessor: 'cmnumber', sortable: true },
    { header: 'Linked PM', accessor: 'linkedpm', sortable: true },
    { header: 'Asset Name', accessor: 'assetname', sortable: true },
    { header: 'Defect Found', accessor: 'defectfound', sortable: true },
    { header: 'Parts Required', accessor: 'partsrequired', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tasks identified during preventive checks that require repair or part replacement.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active CM Jobs</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Awaiting Parts</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Completed (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>34</p>
        </div>
      </div>
