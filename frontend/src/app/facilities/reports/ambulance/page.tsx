...
export default function AmbulanceReportPage() {
  ...
  const columns = [
    ...
    { header: 'Trips', accessor: 'trips', sortable: true },
    { header: 'Total Distance (Km)', accessor: 'totaldistancekm', sortable: true },
    { header: 'Fuel Efficiency', accessor: 'fuelefficiency', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Trip distances, fuel efficiency, and revenue generated vs maintenance costs.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fleet Revenue (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$24,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Running Cost</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$8,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Response</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>14 Mins</p>
        </div>
      </div>
