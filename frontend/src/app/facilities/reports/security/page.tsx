...
export default function SecurityReportPage() {
  ...
  const columns = [
    ...
    { header: 'Daily Average', accessor: 'dailyaverage', sortable: true },
    { header: 'Exceptions/Breaches', accessor: 'exceptionsbreaches', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Incident summaries, visitor volumes, and guard attendance metrics.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Visitors (Mo)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>12,450</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Security Incidents</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Guard Shortage</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2 Shifts</p>
        </div>
      </div>
