...
export default function MortuaryReportPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Month', accessor: 'month', sortable: true },
    { header: 'Admissions', accessor: 'admissions', sortable: true },
    { header: 'Releases', accessor: 'releases', sortable: true },
    { header: 'MLC Cases', accessor: 'mlccases', sortable: true },
    { header: 'Avg Storage Time', accessor: 'avgstoragetime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Utilization of cold cabinets, autopsy counts, and average storage durations.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Utilization %</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Longest Stored</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>14 Days</p>
        </div>
      </div>
