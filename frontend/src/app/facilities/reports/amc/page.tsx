...
export default function AMCReportPage() {
  ...
  const columns = [
    ...
    { header: 'Contract Value', accessor: 'contractvalue', sortable: true },
    { header: 'SLA Score', accessor: 'slascore', sortable: true },
    { header: 'Renewal Recommendation', accessor: 'renewalrecommendation', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Upcoming renewals, vendor SLA adherence, and contract value summaries.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total AMC Spend</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$450,000</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg SLA Score</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>92%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">To Renew (Next 30D)</p>
