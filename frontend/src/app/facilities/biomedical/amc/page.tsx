...
export default function AMCContractsPage() {
  ...
  const columns = [
    ...
    { header: 'OEM/Vendor', accessor: 'oemvendor', sortable: true },
    { header: 'Type (AMC/CMC)', accessor: 'typeamccmc', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Comprehensive Maintenance Contracts (CMC) and AMCs with Original Equipment Manufacturers (OEMs).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">CMC Value</p>
