...
export default function EquipmentRegisterPage() {
  ...
  const columns = [
    ...
    { header: 'Serial No', accessor: 'serialno', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Master database of all medical devices (MRI, Monitors, Ventilators).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$12.5M</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Equip.</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>1,150</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Decommissioned</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>90</p>
        </div>
      </div>
