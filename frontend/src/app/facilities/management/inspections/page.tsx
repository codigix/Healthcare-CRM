...
export default function FacilityInspectionsPage() {
  ...
  const columns = [
    ...
    { header: 'Area Checked', accessor: 'areachecked', sortable: true },
    { header: 'Inspector', accessor: 'inspector', sortable: true },
    { header: 'Date', accessor: 'date', sortable: true },
    { header: 'Issues Found', accessor: 'issuesfound', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Routine checklists for civil, electrical, and plumbing checks across buildings.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Passed Checks</p>
