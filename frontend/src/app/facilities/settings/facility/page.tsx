...
export default function FacilitySettingsPage() {
  ...
  const columns = [
    { header: 'Configuration Item', accessor: 'configurationitem', sortable: true },
    { header: 'Value', accessor: 'value', sortable: true },
    { header: 'Last Updated By', accessor: 'lastupdatedby', sortable: true },
    { header: 'Date', accessor: 'date', sortable: true },
    { header: 'Impact Area', accessor: 'impactarea', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configuration of hospital locations, buildings, and master spatial data.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Mapped Areas</p>
