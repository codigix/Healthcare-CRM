...
export default function WorkOrderTypesPage() {
  ...
  const columns = [
    { header: 'WO Type', accessor: 'wotype', sortable: true },
    { header: 'Approval Required', accessor: 'approvalrequired', sortable: true },
    { header: 'Mandatory Fields', accessor: 'mandatoryfields', sortable: true },
    { header: 'Closure Auth', accessor: 'closureauth', sortable: true },
    { header: 'Priority Matrix', accessor: 'prioritymatrix', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configuring WO workflows (Preventive, Breakdown, Modification) and approvals.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Workflows</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>5</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Auto-Approved</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>PMs (<$50)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Custom Fields</p>
