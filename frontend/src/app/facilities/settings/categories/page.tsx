...
export default function MaintenanceCategoriesPage() {
  ...
  const columns = [
    ...
    { header: 'Sub-categories', accessor: 'subcategories', sortable: true },
    { header: 'Default SLA', accessor: 'defaultsla', sortable: true },
    { header: 'Assigned Supervisor', accessor: 'assignedsupervisor', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Defining asset classes (e.g., Electrical, HVAC, Plumbing) for ticketing routing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Routes</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">SLA Definitions</p>
