...
export default function FireSafetyPage() {
  ...
  const columns = [
    { header: 'Asset/Area', accessor: 'assetarea', sortable: true },
    { header: 'Type', accessor: 'type', sortable: true },
    { header: 'Last Tested', accessor: 'lasttested', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Extinguisher expiry tracking, alarm testing, and fire exit clearance audits.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Extinguishers Active</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>450</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Due for Refill</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Alarms Functional</p>
