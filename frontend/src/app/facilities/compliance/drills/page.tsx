...
export default function EmergencyDrillsPage() {
  ...
  const columns = [
    { header: 'Drill Date', accessor: 'drilldate', sortable: true },
    { header: 'Scenario', accessor: 'scenario', sortable: true },
    { header: 'Participants', accessor: 'participants', sortable: true },
    { header: 'Evacuation Time', accessor: 'evacuationtime', sortable: true },
    { header: 'Observer Notes', accessor: 'observernotes', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Logging mock drills for fire, code blue, and mass casualty incidents.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Drills Conducted (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Evac Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>4m 30s</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Next Drill Due</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>October</p>
        </div>
      </div>
