...
export default function DisasterManagementPage() {
  ...
  const columns = [
    { header: 'Resource/Protocol', accessor: 'resourceprotocol', sortable: true },
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Last Updated', accessor: 'lastupdated', sortable: true },
    { header: 'Stock Level', accessor: 'stocklevel', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Emergency protocols, stock of disaster kits, and contact trees.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Disaster Kits Ready</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>10/10</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Protocols Updated</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>100%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Staff Trained</p>
