...
export default function MaintenanceMaterialsPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Indent ID', accessor: 'indentid', sortable: true },
    { header: 'Linked WO', accessor: 'linkedwo', sortable: true },
    { header: 'Engineer', accessor: 'engineer', sortable: true },
    { header: 'Spares Required', accessor: 'sparesrequired', sortable: true },
    { header: 'Store Availability', accessor: 'storeavailability', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Spares requested by engineers (Bulbs, wires, plumbing fittings) to close work orders.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Open Indents</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Out of Stock items</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>2</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Value Issued</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$450 (Today)</p>
        </div>
      </div>
