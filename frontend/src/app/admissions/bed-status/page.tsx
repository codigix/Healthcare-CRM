...
export default function LiveBedStatusPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Bed Number', accessor: 'bednumber', sortable: true },
    { header: 'Ward/Zone', accessor: 'wardzone', sortable: true },
    { header: 'Type', accessor: 'type', sortable: true },
    { header: 'Current Patient', accessor: 'currentpatient', sortable: true },
    { header: 'Turnover Time', accessor: 'turnovertime', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Real-time overview of bed availability and cleaning cycles.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>840</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Available</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>315</p>
        </div>
      </div>
