...
export default function CTScanPage() {
  ...
  const columns = [
    ...
    { header: 'Contrast Used', accessor: 'contrastused', sortable: true },
    { header: 'Creatinine Level', accessor: 'creatininelevel', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Computed Tomography (CT) scheduling, contrast consents, and studies.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Scheduled CTs</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Contrast Prep</p>
