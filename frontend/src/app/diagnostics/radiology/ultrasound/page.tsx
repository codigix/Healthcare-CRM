...
export default function UltrasoundSonographyPage() {
  ...
  const columns = [
    ...
    { header: 'Radiologist', accessor: 'radiologist', sortable: true },
    { header: 'Images Sent to PACS', accessor: 'imagessenttopacs', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">USG scheduling, patient queue, and study tracking.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending USG</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Scan Time</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>20 mins</p>
        </div>
      </div>
