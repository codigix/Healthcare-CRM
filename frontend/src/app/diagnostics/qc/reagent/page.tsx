...
export default function ReagentManagementPage() {
  ...
  const columns = [
    { header: 'Reagent ID', accessor: 'reagentid', sortable: true },
    { header: 'Name', accessor: 'name', sortable: true },
    { header: 'Lot Number', accessor: 'lotnumber', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking lot numbers, expiry dates, and new reagent validation.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Lots</p>
