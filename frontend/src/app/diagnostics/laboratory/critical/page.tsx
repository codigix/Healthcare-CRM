...
export default function CriticalValuesLogPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Result ID', accessor: 'resultid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Test', accessor: 'test', sortable: true },
    { header: 'Critical Value', accessor: 'criticalvalue', sortable: true },
    { header: 'Notified Doctor', accessor: 'notifieddoctor', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Log of life-threatening test results and mandatory doctor notifications.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Criticals Today</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Notification</p>
