...
export default function BarcodePrintingPage() {
  ...
  const columns = [
    ...
    { header: 'Test Code', accessor: 'testcode', sortable: true },
    { header: 'Container Type', accessor: 'containertype', sortable: true },
    { header: 'Barcode Status', accessor: 'barcodestatus', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Generate and print barcode labels for specimen tubes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Print</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Printed Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>180</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Printer Errors</p>
