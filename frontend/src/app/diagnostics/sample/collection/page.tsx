...
export default function SampleCollectionPage() {
  ...
  const columns = [
    ...
    { header: 'Tests', accessor: 'tests', sortable: true },
    { header: 'Container Type', accessor: 'containertype', sortable: true },
    { header: 'Fasting', accessor: 'fasting', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Phlebotomy dashboard for collecting blood and other specimens.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Awaiting Collection</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>35</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Collected Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>142</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missed/Refused</p>
