...
export default function SampleRejectionPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Barcode ID', accessor: 'barcodeid', sortable: true },
    ...
    { header: 'Rejected By', accessor: 'rejectedby', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Log of rejected samples due to hemolysis, clotting, or insufficient quantity.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Rejection Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>1.5%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Recollected</p>
