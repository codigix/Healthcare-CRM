...
export default function BloodInventoryPage() {
  ...
  const columns = [
    ...
    { header: 'Units Available', accessor: 'unitsavailable', sortable: true },
    { header: 'Expiring < 7 Days', accessor: 'expiring7days', sortable: true },
    { header: 'Min Reorder Level', accessor: 'minreorderlevel', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Current stock of Whole Blood, PRBC, FFP, Platelets, and Cryo.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Low Stock Groups</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>O-, B-</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
