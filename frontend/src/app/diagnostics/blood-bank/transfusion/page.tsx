...
export default function TransfusionMonitoringPage() {
  ...
  const columns = [
    ...
    { header: 'Reaction', accessor: 'reaction', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Post-issue tracking of transfusion start, end, and adverse reactions.</p>
        </div>
