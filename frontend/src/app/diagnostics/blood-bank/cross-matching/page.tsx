...
export default function CrossMatchingPage() {
  ...
  const columns = [
    { header: 'Match ID', accessor: 'matchid', sortable: true },
    { header: 'Patient Sample ID', accessor: 'patientsampleid', sortable: true },
    { header: 'Donor Unit No', accessor: 'donorunitno', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Compatibility testing between donor units and patient samples.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Matches Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>24</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Compatible</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>22</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Incompatible</p>
