...
export default function CalibrationCertificatesPage() {
  ...
  const columns = [
    ...
    { header: 'Calibrated By', accessor: 'calibratedby', sortable: true },
    { header: 'Date of Issue', accessor: 'dateofissue', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Digital repository of NABL/ISO calibration certificates.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Certificates</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>35</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Valid</p>
