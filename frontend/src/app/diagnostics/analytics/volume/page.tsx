...
export default function TestVolumeReportPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Report Date', accessor: 'reportdate', sortable: true },
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Total Tests', accessor: 'totaltests', sortable: true },
    { header: 'IPD vs OPD', accessor: 'ipdvsopd', sortable: true },
    { header: 'Revenue Gen', accessor: 'revenuegen', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analytics on the number of tests performed by category, machine, and day.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Daily Tests</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>1,200</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Vol Day</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Monday</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
