...
export default function TechnicianPerformancePage() {
  ...
  const columns = [
    { header: 'Tech ID', accessor: 'techid', sortable: true },
    { header: 'Name', accessor: 'name', sortable: true },
    { header: 'Samples Processed', accessor: 'samplesprocessed', sortable: true },
    { header: 'Avg Processing Time', accessor: 'avgprocessingtime', sortable: true },
    { header: 'Error Count', accessor: 'errorcount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Metrics on individual staff throughput, errors, and processing time.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Samples/Tech</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>120/day</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Zero Errors (Month)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>38 Staff</p>
        </div>
      </div>
