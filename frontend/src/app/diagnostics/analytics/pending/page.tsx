...
export default function PendingTestReportPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Department', accessor: 'department', sortable: true },
    { header: 'Tests Ordered', accessor: 'testsordered', sortable: true },
    { header: 'Pending > 24hrs', accessor: 'pending24hrs', sortable: true },
    { header: 'Pending > 48hrs', accessor: 'pending48hrs', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Daily overview of backlog and overdue tests.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Backlog</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>12</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Oldest Pending</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>72 hrs (Culture)</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cleared Today</p>
