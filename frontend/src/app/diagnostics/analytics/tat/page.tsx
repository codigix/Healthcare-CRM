...
export default function TATReportTurnAroundTimePage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Test Group', accessor: 'testgroup', sortable: true },
    { header: 'Target TAT', accessor: 'targettat', sortable: true },
    { header: 'Actual Avg TAT', accessor: 'actualavgtat', sortable: true },
    { header: 'Breaches', accessor: 'breaches', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            ...
            TAT Report (Turn Around Time)
          </h1>
          <p className="text-sm text-gray-400 mt-1">Detailed analysis of time taken from sample collection to report release.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>2.5 hrs</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Breaches (Today)</p>
