...
export default function RevenueReportPage() {
  ...
  const columns = [
    ...
    { header: 'External Referrals', accessor: 'externalreferrals', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Financial analytics for the diagnostics department.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$145k</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Growth</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>+8%</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Dues</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>$5k</p>
        </div>
      </div>
