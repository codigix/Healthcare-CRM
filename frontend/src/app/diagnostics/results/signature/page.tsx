...
export default function DigitalSignaturesPage() {
  ...
  const columns = [
    ...
    { header: 'Certificate ID', accessor: 'certificateid', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Manage digital signature tokens for pathologists and radiologists.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Active Tokens</p>
