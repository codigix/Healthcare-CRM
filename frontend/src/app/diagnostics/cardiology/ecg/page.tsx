...
export default function ECGEKGPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Test ID', accessor: 'testid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Indication', accessor: 'indication', sortable: true },
    { header: 'Technician', accessor: 'technician', sortable: true },
    { header: 'Machine Interpretation', accessor: 'machineinterpretation', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Electrocardiogram testing and digital tracing storage.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">ECGs Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Abnormal</p>
