...
export default function ReferenceRangesPage() {
  ...
  const columns = [
    { header: 'Parameter', accessor: 'parameter', sortable: true },
    { header: 'Gender', accessor: 'gender', sortable: true },
    { header: 'Age Range', accessor: 'agerange', sortable: true },
    { header: 'Min Range', accessor: 'minrange', sortable: true },
    { header: 'Max Range', accessor: 'maxrange', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Configure normal ranges based on age, gender, and methodology.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Parameters</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>3,500</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Updated This Year</p>
