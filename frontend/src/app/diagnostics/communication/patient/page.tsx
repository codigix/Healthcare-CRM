...
export default function PatientNotificationsPage() {
  ...
  const columns = [
    { header: 'Msg ID', accessor: 'msgid', sortable: true },
    { header: 'Patient Name', accessor: 'patientname', sortable: true },
    { header: 'Mobile/Email', accessor: 'mobileemail', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">SMS/Email updates to patients (e.g., "Report Ready for Download").</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>345</p>
        </div>
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
