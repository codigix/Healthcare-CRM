...
export default function ReferralOrdersPage() {
  ...
  const columns = [
    ...
    { header: 'Test/Procedure', accessor: 'testprocedure', sortable: true },
    { header: 'External Lab', accessor: 'externallab', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Samples or orders sent to external reference laboratories.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Referrals</p>
        ...
        <div className="bg-dark-secondary rounded-xl p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Results Received</p>
