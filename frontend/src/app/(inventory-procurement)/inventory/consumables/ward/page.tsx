...
export default function WardConsumablesPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Item Name', accessor: 'itemname', sortable: true },
    { header: 'Total Issued (MTD)', accessor: 'totalissuedmtd', sortable: true },
    { header: 'Avg Daily Use', accessor: 'avgdailyuse', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Usage tracking for cotton, syringes, IV sets in general wards.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Item</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>10ml Syringe</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Value Consumed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$4,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Low Stock Alerts</p>
