...
export default function LaboratoryConsumablesPage() {
  ...
  const columns = [
    ...
    { header: 'Lot No', accessor: 'lotno', sortable: true },
    { header: 'Tests Remaining (Est)', accessor: 'testsremainingest', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Reagents, vacutainers, slides, and testing chemicals.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reagent Stock Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>$8,400</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Near Expiry</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>2 Lots</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
