...
export default function AssetReportsPage() {
  ...
  const columns_0: Column<any>[] = [
    ...
    {
      header: "Condition", accessor: (a) => (<>\n<span className={`px-2 py-0.5 rounded text-xs font-semibold ${a.condition === "Excellent" || a.condition === "Good"
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center my-3 my-3">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl ">Durable Asset Reports</h1>
        ...
        <>
            ...
            <div className="card border-l-4 border-emerald-500 hover:translate-y-[-2px] transition-transform">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-2xl  text-white mt-1">₹{totalValuation.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</h3>
            ...
            <div className="card border-l-4 border-blue-500 hover:translate-y-[-2px] transition-transform">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-2xl  text-white mt-1">{assets.length} Durable Lines</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="card flex flex-col justify-between">
              <h3 className="text-lg  text-white mb-4">Asset Condition Breakdown</h3>
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="space-y-2 flex-1 w-full text-sm">
                  {conditionSummary.map((item, index) => (
                    <div key={item.name} className="flex justify-between items-center my-3 my-3 py-1 border-b border-white/5">
            ...
            <div className="card">
              <h3 className="text-lg  text-white mb-4">Asset Capital Expenditure (CAPEX)</h3>
          ...
          {/* Audit registry list */}
          <div className="card">
            <h3 className="text-lg  text-white mb-6">Asset Maintenance Registry</h3>
