...
export default function StockValuationPage() {
  ...
  const columns = [
    ...
    { header: 'Surgicals Value', accessor: 'surgicalsvalue', sortable: true },
    { header: 'Consumables Value', accessor: 'consumablesvalue', sortable: true },
    { header: 'Assets Value', accessor: 'assetsvalue', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Financial worth of the inventory based on FIFO, LIFO, or Weighted Average.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>Weighted Avg</p>
        </div>
      </div>
