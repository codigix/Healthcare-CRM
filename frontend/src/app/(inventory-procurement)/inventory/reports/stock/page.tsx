...
export default function StockReportPage() {
  ...
  const columns = [
    ...
    { header: 'In Stock', accessor: 'instock', sortable: true },
    { header: 'Low Stock', accessor: 'lowstock', sortable: true },
    { header: 'Out of Stock', accessor: 'outofstock', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Comprehensive snapshot of all current inventory levels.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Items Tracked</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>15,400</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Reports Run</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>45 (Today)</p>
        </div>
      </div>
