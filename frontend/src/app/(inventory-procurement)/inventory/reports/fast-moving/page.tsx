...
export default function FastMovingItemsPage() {
  ...
  const columns = [
    ...
    { header: 'Daily Consumption', accessor: 'dailyconsumption', sortable: true },
    { header: 'Current Stock', accessor: 'currentstock', sortable: true },
    { header: 'Days of Stock', accessor: 'daysofstock', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">High turnover items requiring frequent reordering and tight monitoring.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Urgent Orders</p>
