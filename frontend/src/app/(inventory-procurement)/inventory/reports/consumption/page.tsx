...
export default function ItemConsumptionPage() {
  ...
  const columns = [
    ...
    { header: 'Total (MTD)', accessor: 'totalmtd', sortable: true },
    { header: 'Projected (EoM)', accessor: 'projectedeom', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Detailed view of which items are being consumed at what rate.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Consumption Growth</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>+5.2%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Volume</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Syringes</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Cost Impact</p>
