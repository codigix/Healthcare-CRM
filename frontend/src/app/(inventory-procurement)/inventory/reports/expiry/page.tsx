...
export default function ExpiryReportPage() {
  ...
  const columns = [
    ...
    { header: 'Value at Risk', accessor: 'valueatrisk', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Financial risk analysis based on items nearing expiration.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Value at Risk</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>$4,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Items < 3 Mo</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Expired Written Off</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>$350</p>
        </div>
      </div>
