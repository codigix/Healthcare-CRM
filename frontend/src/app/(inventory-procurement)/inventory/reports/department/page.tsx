...
export default function DepartmentConsumptionPage() {
  ...
  const columns = [
    ...
    { header: 'Total Requisitions', accessor: 'totalrequisitions', sortable: true },
    { header: 'Items Issued', accessor: 'itemsissued', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Breakdown of inventory usage and costs by requesting department.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>OT</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Within Budget</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>15 Depts</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
