...
export default function StockMovementPage() {
  ...
  const columns = [
    ...
    { header: 'Closing Qty', accessor: 'closingqty', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analysis of inward and outward flow of goods over a specific period.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fastest Moving</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Gloves</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
