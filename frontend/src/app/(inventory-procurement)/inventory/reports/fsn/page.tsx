...
export default function FSNAnalysisPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Category', accessor: 'category', sortable: true },
    { header: 'Item Count', accessor: 'itemcount', sortable: true },
    { header: 'Avg Turnover Time', accessor: 'avgturnovertime', sortable: true },
    { header: 'Space Utilization', accessor: 'spaceutilization', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Categorizing by issue rate (F=Fast, S=Slow, N=Non-moving).</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fast Moving</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>20%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Non-moving</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>5%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Warehouse Space Freed</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>450 SqFt</p>
        </div>
      </div>
