...
export default function CycleCountPage() {
  ...
  const columns = [
    ...
    { header: 'Aisle/Rack', accessor: 'aislerack', sortable: true },
    { header: 'Items Counted', accessor: 'itemscounted', sortable: true },
    { header: 'Variances Found', accessor: 'variancesfound', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Daily partial counts (ABC analysis based) to maintain continuous accuracy.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Counts Today</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Accuracy (Week)</p>
