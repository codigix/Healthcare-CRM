...
export default function BrandsPage() {
  ...
  const columns = [
    ...
    { header: 'Items Supplied', accessor: 'itemssupplied', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Approved brands and manufacturers for inventory items.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Approved Brands</p>
