...
export default function BarcodeQRCodePage() {
  ...
  const columns = [
    ...
    { header: 'Last Printed', accessor: 'lastprinted', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Generation and management of inventory tracking barcodes.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Barcodes Generated</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>14,500</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">QR Codes</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>3,200</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missing Barcodes</p>
