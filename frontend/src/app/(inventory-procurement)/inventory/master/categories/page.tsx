...
export default function CategoriesPage() {
  ...
  const columns = [
    { header: 'Category ID', accessor: 'categoryid', sortable: true },
    { header: 'Category Name', accessor: 'categoryname', sortable: true },
    { header: 'Parent Category', accessor: 'parentcategory', sortable: true },
    { header: 'Items Linked', accessor: 'itemslinked', sortable: true },
    { header: 'Inventory Value', accessor: 'inventoryvalue', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Hierarchical categorization of inventory items.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Categories</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>45</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Sub-Categories</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Highest Value</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>Surgicals</p>
        </div>
      </div>
