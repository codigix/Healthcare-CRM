...
export default function PendingRequestsPage() {
  ...
  const columns = [
    ...
    { header: 'Items Pending', accessor: 'itemspending', sortable: true },
    { header: 'Oldest Request', accessor: 'oldestrequest', sortable: true },
    { header: 'Bottleneck', accessor: 'bottleneck', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Requisitions awaiting approval or stock fulfillment.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Fulfillment</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>15</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Partial Stock</p>
