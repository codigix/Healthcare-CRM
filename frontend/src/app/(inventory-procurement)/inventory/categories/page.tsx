        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center my-3 my-3">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl ">Inventory Categories</h1>
            ...
            {loading ? (
                ...
                <div className="card text-center py-16">
                    ...
                    <h3 className="text-xl  text-white mb-2">No Active Categories</h3>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4 py-2 border-y border-white/5 text-sm">
                                    <div>
                                        ...
                                        <span className="text-white ">{cat.totalItems} Items</span>
                                    </div>
                                    <div>
