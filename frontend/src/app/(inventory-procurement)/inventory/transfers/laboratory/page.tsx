...
export default function LaboratoryTransferPage() {
  const [searchTerm, setSearchTerm] = useState('');

  const columns = [
    { header: 'Transfer ID', accessor: 'transferid', sortable: true },
    { header: 'Lab Section', accessor: 'labsection', sortable: true },
    { header: 'Reagents Issued', accessor: 'reagentsissued', sortable: true },
    { header: 'Batch/Lot No', accessor: 'batchlotno', sortable: true },
    { header: 'Expiry Checked', accessor: 'expirychecked', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Issuing reagents and lab consumables to pathology.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Lab Requests</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>8</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Fulfilled</p>
