...
export default function PendingGRNPage() {
  ...
  const columns = [
    { header: 'Delivery ID', accessor: 'deliveryid', sortable: true },
    { header: 'Carrier/Vendor', accessor: 'carriervendor', sortable: true },
    { header: 'Gate Entry Date', accessor: 'gateentrydate', sortable: true },
    { header: 'Packages', accessor: 'packages', sortable: true },
    { header: 'Reason Pending', accessor: 'reasonpending', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Deliveries that arrived but lack PO matching or are awaiting QA checks.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending at Gate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>4</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">PO Mismatch</p>
