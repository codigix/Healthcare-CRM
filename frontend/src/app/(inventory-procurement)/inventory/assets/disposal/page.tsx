...
export default function AssetDisposalPage() {
  ...
  const columns = [
    ...
    { header: 'Depreciated Value', accessor: 'depreciatedvalue', sortable: true },
    { header: 'Recovery Amount', accessor: 'recoveryamount', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Formally writing off and auctioning/destroying obsolete assets.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          ...
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>120</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
