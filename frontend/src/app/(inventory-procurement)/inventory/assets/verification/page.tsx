...
export default function AssetVerificationPage() {
  ...
  const columns = [
    ...
    { header: 'Assets Found', accessor: 'assetsfound', sortable: true },
    { header: 'Assets Missing', accessor: 'assetsmissing', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Annual physical audits to reconcile the asset register.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Departments Audited</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>14/20</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Missing Assets</p>
