...
export default function AssetAllocationPage() {
  ...
  const columns = [
    ...
    { header: 'Allocated To', accessor: 'allocatedto', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Tracking which department or staff member currently holds an asset.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Allocated Assets</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>4,320</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Recently Moved</p>
