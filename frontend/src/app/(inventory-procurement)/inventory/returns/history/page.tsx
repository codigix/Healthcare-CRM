...
export default function ReturnHistoryPage() {
  ...
  const columns = [
    ...
    { header: 'Credited Value', accessor: 'creditedvalue', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Historical log of all accepted department returns.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Returns (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>320</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Value Credited</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>$12,400</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Top Returning Dept</p>
          <p className={"text-2xl font-bold mt-2 " + "text-gray-400"}>OT</p>
        </div>
      </div>
