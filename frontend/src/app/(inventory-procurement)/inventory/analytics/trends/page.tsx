...
export default function MonthlyTrendsPage() {
  ...
  const columns = [
    ...
    { header: 'Total Receipts Value', accessor: 'totalreceiptsvalue', sortable: true },
    { header: 'Total Issues Value', accessor: 'totalissuesvalue', sortable: true },
    { header: 'Net Inventory Growth', accessor: 'netinventorygrowth', sortable: true },
    { header: 'Forecast Accuracy', accessor: 'forecastaccuracy', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Visualizing seasonality and long-term consumption trends for forecasting.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Avg Forecast Accuracy</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>92%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Peak Consumption Month</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>August</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Inventory Growth (YTD)</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>+4.5%</p>
        </div>
      </div>
