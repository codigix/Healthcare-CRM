...
export default function StockTurnoverPage() {
  ...
  const columns = [
    ...
    { header: 'Avg Inventory Value', accessor: 'avginventoryvalue', sortable: true },
    { header: 'COGS', accessor: 'cogs', sortable: true },
    { header: 'Turnover Ratio', accessor: 'turnoverratio', sortable: true },
    { header: 'Days Sales of Inventory', accessor: 'dayssalesofinventory', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Analysis of how many times inventory is sold/used and replaced over a year.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Hospital Avg Ratio</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>12.4x</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Best Category</p>
          <p className={"text-2xl font-bold mt-2 " + "text-blue-400"}>Surgicals (24x)</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Slowest</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>Spares (2x)</p>
        </div>
      </div>
