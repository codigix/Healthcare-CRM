...
export default function StockAvailabilitySearchPage() {
  ...
  const columns = [
    ...
    { header: 'Main Store', accessor: 'mainstore', sortable: true },
    { header: 'OT Store', accessor: 'otstore', sortable: true },
    { header: 'ICU Store', accessor: 'icustore', sortable: true },
    { header: 'Ward Store', accessor: 'wardstore', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Quick search tool to check item availability across multiple warehouses.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Available Rate</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>94%</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Not Found</p>
          <p className={"text-2xl font-bold mt-2 " + "text-amber-400"}>6%</p>
        </div>
      </div>
