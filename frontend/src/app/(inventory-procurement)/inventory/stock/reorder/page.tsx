...
export default function ReorderLevelMonitoringPage() {
  ...
  const columns = [
    ...
    { header: 'Suggested Order', accessor: 'suggestedorder', sortable: true },
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">Monitoring items that have fallen below their defined reorder points.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Items Below ROL</p>
          <p className={"text-2xl font-bold mt-2 " + "text-red-400"}>85</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">POs Generated</p>
          <p className={"text-2xl font-bold mt-2 " + "text-emerald-400"}>40</p>
        </div>
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Pending Action</p>
