...
export default function WarehousesPage() {
  ...
  const columns = [
    { header: 'Warehouse ID', accessor: 'warehouseid', sortable: true },
    { header: 'Name', accessor: 'name', sortable: true },
    { header: 'Location', accessor: 'location', sortable: true },
    { header: 'Total Racks', accessor: 'totalracks', sortable: true },
    { header: 'Capacity Utilized', accessor: 'capacityutilized', sortable: true },
    {
      header: 'Status',
      accessor: (row: any) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">List of all main stores, sub-stores, and off-site warehouses.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">Total Facilities</p>
        ...
        <div className="bg-dark-secondary rounded p-4 border border-gray-800">
          <p className="text-sm text-gray-400 font-medium">At Capacity</p>
